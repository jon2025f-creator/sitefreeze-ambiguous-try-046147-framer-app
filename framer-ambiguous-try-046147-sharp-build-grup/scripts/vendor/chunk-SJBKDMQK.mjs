...
var S = function (t) {
  ...
  Ue = null,
  K = function (t, e, n) {
    let o = Ue || (Ue = document.createRange());
  ...
  re = function (t, e, n, o) {
    return n && (Ct(t, e, n, o, -1) || Ct(t, e, n, o, 1));
  },
  Bn = /^(img|br|input|textarea|hr)$/i;
function Ct(t, e, n, o, i) {
  for (var s; ;) {
    if (t == n && e == o) return !0;
    if (e == (i < 0 ? 0 : R(t))) {
      let r = t.parentNode;
      if (!r || r.nodeType != 1 || Me(t) || Bn.test(t.nodeName) || t.contentEditable == "false")
        return !1;
      ((e = S(t) + (i < 0 ? 0 : 1)), (t = r));
    } else if (t.nodeType == 1) {
      let r = t.childNodes[e + (i < 0 ? -1 : 0)];
      if (r.nodeType == 1 && r.contentEditable == "false")
        if (!((s = r.pmViewDesc) === null || s === void 0) && s.ignoreForSelection) e += i;
        else return !1;
      else ((t = r), (e = i < 0 ? R(t) : 0));
    } else return !1;
  }
}
function R(t) {
...
function In(t, e) {
  for (;;) {
    ...
    } else if (t.parentNode && !Me(t)) ((e = S(t)), (t = t.parentNode));
    else return null;
  }
}
function Fn(t, e) {
  for (;;) {
    ...
    } else if (t.parentNode && !Me(t)) ((e = S(t) + 1), (t = t.parentNode));
    else return null;
  }
}
function zn(t, e, n) {
...
function $n(t, e, n) {
  if (t.caretPositionFromPoint)
    try {
      ...
      if (o) return { node: o.offsetNode, offset: Math.min(R(o.offsetNode), o.offset) };
    } catch {}
  if (t.caretRangeFromPoint) {
    let o = t.caretRangeFromPoint(e, n);
    if (o) return { node: o.startContainer, offset: Math.min(R(o.startContainer), o.startOffset) };
  }
}
var L = typeof navigator < "u" ? navigator : null,
  Ot = typeof document < "u" ? document : null,
  Q = (L && L.userAgent) || "",
  Ye = /Edge\/(\d+)/.exec(Q),
  tn = /MSIE \d/.exec(Q),
  Ge = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Q),
  A = !!(tn || Ge || Ye),
  X = tn ? document.documentMode : Ge ? +Ge[1] : Ye ? +Ye[1] : 0,
  B = !A && /gecko\/(\d+)/i.test(Q);
B && +(/Firefox\/(\d+)/.exec(Q) || [0, 0])[1];
var Xe = !A && /Chrome\/(\d+)/.exec(Q),
  M = !!Xe,
  nn = Xe ? +Xe[1] : 0,
  x = !A && !!L && /Apple Computer/.test(L.vendor),
  ue = x && (/Mobile\/\w+/.test(Q) || (!!L && L.maxTouchPoints > 2)),
  V = ue || (L ? /Mac/.test(L.platform) : !1),
  qn = L ? /Win/.test(L.platform) : !1,
  H = /Android \d/.test(Q),
  xe = !!Ot && "webkitFontSmoothing" in Ot.documentElement.style,
  Kn = xe ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Hn(t) {
...
function Mt(t, e, n) {
  let o = t.someProp("scrollThreshold") || 0,
  ...
  for (let r = n || t.dom; r;) {
    ...
    if (
      (e.top < c.top + q(o, "top")
        ? (f = -(c.top - e.top + q(i, "top")))
        : e.bottom > c.bottom - q(o, "bottom") &&
          (f =
            e.bottom - e.top > c.bottom - c.top
              ? e.top + q(i, "top") - c.top
              : e.bottom - c.bottom + q(i, "bottom")),
      e.left < c.left + q(o, "left")
        ? (d = -(c.left - e.left + q(i, "left")))
        : e.right > c.right - q(o, "right") && (d = e.right - c.right + q(i, "right")),
      d || f)
    )
      if (a) s.defaultView.scrollBy(d, f);
      else {
        let p = l.scrollLeft,
          h = l.scrollTop;
...
function _n(t) {
  ...
  return { refDOM: o, refTop: i, stack: on(t.dom) };
}
function on(t) {
  let e = [],
    n = t.ownerDocument;
  for (
    let o = t;
    o && (e.push({ dom: o, top: o.scrollTop, left: o.scrollLeft }), t != n);
    o = he(o)
  );
  return e;
}
function jn({ refDOM: t, refTop: e, stack: n }) {
...
function rn(t, e) {
  ...
  for (let d = t.firstChild, f = 0; d; d = d.nextSibling, f++) {
    let u;
    if (d.nodeType == 1) u = d.getClientRects();
      ...
      if (h.top <= r && h.bottom >= l) {
        ...
        if (g < o) {
          ((n = d),
            ...
            d.nodeType == 1 && g && (s = f + (e.left >= (h.left + h.right) / 2 ? 1 : 0)));
          continue;
        }
      } else
        h.top > e.top &&
          ...
          h.left <= e.left &&
          h.right >= e.left &&
          ((a = d), (c = { left: Math.max(h.left, Math.min(h.right, e.left)), top: h.top }));
      !n &&
  ...
  for (let s = e, r = !1; s != t.dom;) {
    ...
    if (
      ...
      (l.node.isBlock &&
        ...
        ((!r && a.left > o.left) || a.top > o.top
          ? (i = l.posBefore)
          : ((!r && a.right < o.left) || a.bottom < o.top) && (i = l.posAfter),
        (r = !0)),
...
function ln(t, e, n) {
  ...
  if (o && n.top < n.bottom)
    for (
      let i = Math.max(
          0,
          Math.min(o - 1, Math.floor((o * (e.top - n.top)) / (n.bottom - n.top)) - 2)
        ),
        s = i;
      ;
    ) {
...
function Zn(t, e) {
  let n = t.dom.ownerDocument,
    ...
    s = $n(n, e.left, e.top);
  s && ({ node: o, offset: i } = s);
  let r = (t.root.elementFromPoint ? t.root : n).elementFromPoint(e.left, e.top),
    l;
  if (!r || !t.dom.contains(r.nodeType != 1 ? r.parentNode : r)) {
    let c = t.dom.getBoundingClientRect();
    if (!dt(e, c) || ((r = ln(t.dom, e, c)), !r)) return null;
  }
  if (x) for (let c = r; o && c; c = he(c)) c.draggable && (o = void 0);
  if (((r = Gn(r, e)), o)) {
    if (B && o.nodeType == 1 && ((i = Math.min(i, o.childNodes.length)), i < o.childNodes.length)) {
      let d = o.childNodes[i],
        f;
      d.nodeName == "IMG" &&
    ...
    (xe &&
      ...
      e.top > o.lastChild.getBoundingClientRect().bottom
        ...
        : (i == 0 || o.nodeType != 1 || o.childNodes[i - 1].nodeName != "BR") &&
          (l = Jn(t, o, i, e)));
  }
  l == null && (l = Xn(t, r, e));
...
function U(t, e) {
  ...
  return Array.prototype.find.call(n, xt) || t.getBoundingClientRect();
}
var Qn = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function an(t, e, n) {
  let { node: o, offset: i, atom: s } = t.docView.domFromPos(e, n < 0 ? -1 : 1),
    r = xe || B;
  if (o.nodeType == 3)
    if (r && (Qn.test(o.nodeValue) || (n < 0 ? !i : i == o.nodeValue.length))) {
      let a = U(K(o, i, i), n);
      if (B && i && /\s/.test(o.nodeValue[i - 1]) && i < o.nodeValue.length) {
        let c = U(K(o, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let d = U(K(o, i, i + 1), -1);
          if (d.top != a.top) return ye(d, d.left < c.left);
        }
      }
      return a;
    } else {
  ...
  if (!t.state.doc.resolve(e - (s || 0)).parent.inlineContent) {
    if (s == null && i && (n < 0 || i == R(o))) {
      ...
      if (a.nodeType == 1) return Ke(a.getBoundingClientRect(), !1);
    }
    if (s == null && i < R(o)) {
      let a = o.childNodes[i];
      if (a.nodeType == 1) return Ke(a.getBoundingClientRect(), !0);
    }
    return Ke(o.getBoundingClientRect(), n >= 0);
  }
  if (s == null && i && (n < 0 || i == R(o))) {
    let a = o.childNodes[i - 1],
      c =
...
function wn(t, e, n) {
  ...
  return cn(t, e, () => {
    ...
    for (let l = s.firstChild; l; l = l.nextSibling) {
      ...
      else if (l.nodeType == 3) a = K(l, 0, l.nodeValue.length).getClientRects();
      else continue;
      for (let c = 0; c < a.length; c++) {
        ...
        if (
          d.bottom > d.top + 1 &&
          (n == "up"
            ? r.top - d.top > (d.bottom - r.top) * 2
            : d.bottom - r.bottom > (r.bottom - d.top) * 2)
        )
          return !1;
      }
    }
...
function eo(t, e, n) {
  ...
  let i = o.parentOffset,
    ...
    l = t.domSelection();
  return l
    ? !vn.test(o.parent.textContent) || !l.modify
      ? n == "left" || n == "backward"
        ? s
        : r
      : cn(t, e, () => {
          ...
          let p = o.depth ? t.docView.domAfterPos(o.before()) : t.dom,
...
function to(t, e, n) {
  return kt == e && Tt == n
    ? Pt
    : ((kt = e), (Tt = n), (Pt = n == "up" || n == "down" ? wn(t, e, n) : eo(t, e, n)));
}
var I = 0,
  At = 1,
  te = 2,
  ...
  le = class {
    ...
    localPosFromDOM(e, n, o) {
      if (this.contentDOM && this.contentDOM.contains(e.nodeType == 1 ? e : e.parentNode))
        if (o < 0) {
          ...
          for (; s && !((r = s.pmViewDesc) && r.parent == this);) s = s.previousSibling;
          ...
          for (; s && !((r = s.pmViewDesc) && r.parent == this);) s = s.nextSibling;
          return s ? this.posBeforeChild(r) : this.posAtEnd;
        }
      let i;
      if (e == this.dom && this.contentDOM) i = n > S(this.contentDOM);
      ...
      for (let o = !0, i = e; i; i = i.parentNode) {
        ...
        if (s && (!n || s.node))
          if (
            o &&
            (r = s.nodeDOM) &&
            !(r.nodeType == 1 ? r.contains(e.nodeType == 1 ? e : e.parentNode) : r == e)
          )
            o = !1;
          else return s;
      }
    ...
    getDesc(e) {
      let n = e.pmViewDesc;
      for (let o = n; o; o = o.parent) if (o == this) return n;
    }
    posFromDOM(e, n, o) {
      for (let i = e; i; i = i.parentNode) {
        let s = this.getDesc(i);
        if (s) return s.localPosFromDOM(e, n, o);
      }
      return -1;
    }
    descAt(e) {
      for (let n = 0, o = 0; n < this.children.length; n++) {
        ...
        if (e < s) return i.descAt(e - o - i.border);
        o = s;
      }
    }
    domFromPos(e, n) {
      ...
      for (let s = 0; o < this.children.length; o++) {
        let r = this.children[o],
          l = s + r.size;
        if (l > e || r instanceof Ee) {
          i = e - s;
          break;
        }
        s = l;
      }
      if (i) return this.children[o].domFromPos(i - this.children[o].border, n);
      for (let s; o && !(s = this.children[o - 1]).size && s instanceof Pe && s.side >= 0; o--);
      if (n <= 0) {
        let s,
          r = !0;
        for (
          ;
          (s = o ? this.children[o - 1] : null), !(!s || s.dom.parentNode == this.contentDOM);
          o--, r = !1
        );
        return s && n && r && !s.border && !s.domAtom
          ? s.domFromPos(s.size, n)
          : { node: this.contentDOM, offset: s ? S(s.dom) + 1 : 0 };
      } else {
        let s,
          r = !0;
        for (
          ;
          (s = o < this.children.length ? this.children[o] : null),
            !(!s || s.dom.parentNode == this.contentDOM);
          o++, r = !1
        );
        return s && r && !s.border && !s.domAtom
          ? s.domFromPos(0, n)
          : { node: this.contentDOM, offset: s ? S(s.dom) : this.contentDOM.childNodes.length };
      }
    }
    parseRange(e, n, o = 0) {
    ...
    setSelection(e, n, o, i = !1) {
      ...
      for (let p = 0, h = 0; p < this.children.length; p++) {
        let g = this.children[p],
          m = h + g.size;
        if (s > h && r < m) return g.setSelection(e - h - g.border, n - h - g.border, o, i);
        h = m;
      }
      let l = this.domFromPos(e, e ? -1 : 1),
        a = n == e ? l : this.domFromPos(n, n ? -1 : 1),
        c = o.root.getSelection(),
        d = o.domSelectionRange(),
        f = !1;
      if ((B || x) && e == n) {
...
`
      ...
      if (
        !(i || (f && x)) &&
        re(l.node, l.offset, d.anchorNode, d.anchorOffset) &&
        re(a.node, a.offset, d.focusNode, d.focusOffset)
      )
        return;
      let u = !1;
      if ((c.extend || e == n) && !(f && B)) {
      ...
      for (let o = 0, i = 0; i < this.children.length; i++) {
        ...
        if (o == r ? e <= r && n >= o : e < r && n > o) {
          let l = o + s.border,
            a = r - s.border;
          if (e >= l && n <= a) {
            ((this.dirty = e == o || n == r ? te : At),
              e == l && n == a && (s.contentLost || s.dom.parentNode != this.contentDOM)
                ? (s.dirty = $)
                : s.markDirty(e - l, n - l));
            return;
          } else
  ...
  pe = class t extends le {
    ...
    static create(e, n, o, i) {
      let s = i.nodeViews[n.type.name],
        r = s && s(n, i, o);
      return (
        (!r || !r.dom) && (r = ge.renderSpec(document, n.type.spec.toDOM(n, o), null, n.attrs)),
        new t(e, n, r.dom, r.contentDOM || r.dom, r)
      );
    }
    parseRule() {
      return this.dirty & $ || this.mark.type.spec.reparseInView
        ? null
    ...
    slice(e, n, o) {
      let i = t.create(this.parent, this.mark, !0, o),
        s = this.children,
        r = this.size;
      (n < r && (s = ve(s, n, r, o)), e > 0 && (s = ve(s, 0, e, o)));
  ...
  J = class t extends le {
    ...
    static create(e, n, o, i, s, r) {
      ...
      if (n.isText) {
        ...
        d ||
          ({ dom: d, contentDOM: f } = ge.renderSpec(
            document,
            n.type.spec.toDOM(n),
            null,
            n.attrs
      ...
      return (
        (d = hn(d, o, n)),
        c
          ? (a = new Ze(e, n, o, i, d, f || null, u, c, s, r + 1))
          : n.isText
            ? new Ae(e, n, o, i, d, u, s)
            : new t(e, n, o, i, d, f || null, u, s, r + 1)
      );
    }
    parseRule() {
    ...
    matchesNode(e, n, o) {
      return this.dirty == I && e.eq(this.node) && Ve(n, this.outerDeco) && o.eq(this.innerDeco);
    }
    get size() {
    ...
    updateChildren(e, n) {
      ...
      (so(
        ...
        a.destroyRest(),
        (a.changed || this.dirty == te) &&
          (r && this.protectLocalComposition(e, r),
          dn(this.contentDOM, this.children, e),
          ue && ro(this.dom)));
    }
    localCompositionInfo(e, n) {
      let { from: o, to: i } = e.state.selection;
      if (!(e.state.selection instanceof C) || o < n || i > n + this.node.content.size) return null;
      let s = e.input.compositionNode;
      if (!s || !this.dom.contains(s.parentNode)) return null;
      if (this.node.inlineContent) {
        let r = s.nodeValue,
          l = lo(this.node.content, r, o - n, i - n);
    ...
    protectLocalComposition(e, { node: n, pos: o, text: i }) {
      ...
      let r = new Je(this, s, n, i);
      (e.input.compositionNodes.push(r),
        (this.children = ve(this.children, o, o + i.length, e, r)));
    }
    update(e, n, o, i) {
...
function Et(t, e, n, o, i) {
  hn(o, e, t);
  let s = new J(void 0, t, e, n, o, o, o, i, 0);
  return (s.contentDOM && s.updateChildren(i, 0), s);
}
var Ae = class t extends J {
    ...
    update(e, n, o, i) {
      return this.dirty == $ || (this.dirty != I && !this.inParent()) || !e.sameMarkup(this.node)
        ? !1
        : (this.updateOuterDeco(n),
  ...
  Ze = class extends J {
    ...
    setSelection(e, n, o, i) {
      this.spec.setSelection
        ? this.spec.setSelection(e, n, o.root)
        : super.setSelection(e, n, o, i);
    }
    destroy() {
      (this.spec.destroy && this.spec.destroy(), super.destroy());
    }
...
function dn(t, e, n) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    if (r instanceof pe) {
      ...
      (dn(r.contentDOM, r.children, n), (o = a ? a.nextSibling : t.firstChild));
    }
  }
  for (; o;) ((o = Vt(o)), (i = !0));
...
function Qe(t, e, n) {
  ...
  for (let s = 0; s < t.length; s++) {
    ...
    if (r) {
      r.nodeName && i.push((o = new be(r.nodeName)));
      for (let l in r) {
        let a = r[l];
        a != null &&
          (n && i.length == 1 && i.push((o = new be(e.isInline ? "span" : "div"))),
          l == "class"
...
function fn(t, e, n, o) {
  ...
  for (let s = 0; s < o.length; s++) {
    ...
    if (s) {
      let a;
      ((l &&
        l.nodeName == r.nodeName &&
        i != t &&
        (a = i.parentNode) &&
        a.nodeName.toLowerCase() == r.nodeName) ||
        ((a = document.createElement(r.nodeName)),
        (a.pmIsDeco = !0),
        a.appendChild(i),
        (l = ne[0])),
        (i = a));
...
function no(t, e, n) {
  ...
  if (e.class != n.class) {
    ...
    for (let s = 0; s < o.length; s++) i.indexOf(o[s]) == -1 && t.classList.remove(o[s]);
    for (let s = 0; s < i.length; s++) o.indexOf(i[s]) == -1 && t.classList.add(i[s]);
  ...
  if (e.style != n.style) {
    if (e.style) {
      let o = /\s*([\w\-\xa1-\uffff]+)\s*:(?:"(?:\\.|[^"])*"|'(?:\\.|[^'])*'|\(.*?\)|[^;])*/g,
        i;
      for (; (i = o.exec(e.style));) t.style.removeProperty(i[1]);
    }
    n.style && (t.style.cssText += n.style);
  }
}
function hn(t, e, n) {
  return fn(t, t, ne, Qe(e, n, t.nodeType != 1));
}
function Ve(t, e) {
...
var we = class {
  constructor(e, n, o) {
    ((this.lock = n),
      ...
      (this.changed = !1),
      (this.top = e),
      (this.preMatch = oo(e.node.content, e)));
  }
  destroyBetween(e, n) {
    if (e != n) {
      for (let o = e; o < n; o++) this.top.children[o].destroy();
  ...
  syncToMarks(e, n, o) {
    ...
    for (; s < e.length;) {
      ...
      if (l > -1)
        ...
        let a = pe.create(this.top, e[s], n, o);
  ...
  findNodeMatch(e, n, o, i) {
    ...
    if (
      ...
      (r = this.preMatch.matches[i - this.preMatch.index]).parent == this.top &&
      r.matchesNode(e, n, o)
    )
  ...
  updateNodeAt(e, n, o, i, s) {
    ...
    return (
      r.dirty == $ && r.dom == r.contentDOM && (r.dirty = te),
      r.update(e, n, o, s) ? (this.destroyBetween(this.index, i), this.index++, !0) : !1
    );
  }
      ...
      if (n == this.top.contentDOM) {
        ...
        if (o) {
          for (let i = this.index; i < this.top.children.length; i++)
            if (this.top.children[i] == o) return i;
        }
        return -1;
      }
      e = n;
      ...
      if (a instanceof J) {
        ...
        if (!u && (f = this.recreateWrapper(a, e, n, o, i, r)))
          return (
            ...
            f.contentDOM && ((f.dirty = te), f.updateChildren(i, r + 1), (f.dirty = I)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  recreateWrapper(e, n, o, i, s, r) {
    if (
      ...
      return null;
    let l = J.create(this.top, n, o, i, s, r);
    if (l.contentDOM) {
  ...
  addNode(e, n, o, i, s) {
    let r = J.create(this.top, e, n, o, i, s);
    (r.contentDOM && r.updateChildren(i, s + 1),
  ...
  addTextblockHacks() {
    let e = this.top.children[this.index - 1],
      n = this.top;
    for (; e instanceof pe;) ((n = e), (e = n.children[n.children.length - 1]));
    (!e ||
      !(e instanceof Ae) ||
      /\n$/.test(e.node.text) ||
      (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
      ((x || M) && e && e.dom.contentEditable == "false" && this.addHackNode("IMG", n),
  ...
  e: for (; i > 0;) {
    ...
    for (;;)
      if (o) {
        ...
        if (c instanceof pe) ((n = c), (o = c.children.length));
        else {
          ((l = c), o--);
          break;
        }
...
function so(t, e, n, o) {
  ...
  for (let c = 0; ;) {
    ...
    if (d)
      if (f) {
        f.sort(io);
        for (let m = 0; m < f.length; m++) n(f[m], c, !!a);
      } else n(d, c, !!a);
    let u, p;
    if (a) ((p = -1), (u = a), (a = null));
    else if (c < t.childCount) ((p = c), (u = t.child(c++)));
    else break;
    for (let m = 0; m < l.length; m++) l[m].to <= s && l.splice(m--, 1);
    for (; r < i.length && i[r].from <= s && i[r].to > s;) l.push(i[r++]);
    let h = s + u.nodeSize;
    if (u.isText) {
      let m = h;
      r < i.length && i[r].from < m && (m = i[r].from);
      for (let y = 0; y < l.length; y++) l[y].to < m && (m = l[y].to);
      m < h && ((a = u.cut(m - s)), (u = u.cut(0, m - s)), (h = m), (p = -1));
    } else for (; r < i.length && i[r].to < h;) r++;
...
function lo(t, e, n, o) {
  for (let i = 0, s = 0; i < t.childCount && s <= o;) {
    ...
    if (s >= n) {
      if (s >= o && a.slice(o - e.length - l, o - l) == e) return o - e.length;
      let c = l < o ? a.lastIndexOf(e, o - l - 1) : -1;
      if (c >= 0 && c + e.length + l >= n) return l + c;
      if (n == o && a.length >= o + e.length - l && a.slice(o - l, o - l + e.length) == e) return o;
    }
  }
  return -1;
}
function ve(t, e, n, o, i) {
  ...
  for (let r = 0, l = 0; r < t.length; r++) {
    ...
    c >= n || d <= e
      ? s.push(a)
      : (c < e && s.push(a.slice(0, e - c, o)),
        i && (s.push(i), (i = void 0)),
        d > n && s.push(a.slice(n - c, a.size, o)));
  }
  return s;
}
function ft(t, e = null) {
  ...
  let i = t.docView.nearestDesc(n.focusNode),
    s = i && i.size == 0,
    r = t.docView.posFromDOM(n.focusNode, n.focusOffset, 1);
  if (r < 0) return null;
  let l = o.resolve(r),
    a,
    c;
  if (Le(n)) {
    for (a = r; i && !i.node;) i = i.parent;
    let f = i.node;
    if (
      i &&
      f.isAtom &&
      D.isSelectable(f) &&
      i.parent &&
      !(f.isInline && zn(n.focusNode, n.focusOffset, i.dom))
    ) {
      let u = i.posBefore;
    ...
    if (n instanceof t.dom.ownerDocument.defaultView.Selection && n.rangeCount > 1) {
      ...
      for (let p = 0; p < n.rangeCount; p++) {
        ...
        ((f = Math.min(f, t.docView.posFromDOM(h.startContainer, h.startOffset, 1))),
          (u = Math.max(u, t.docView.posFromDOM(h.endContainer, h.endOffset, -1))));
      }
      if (f < 0) return null;
...
function un(t) {
  return t.editable
    ? t.hasFocus()
    : mn(t) && document.activeElement && document.activeElement.contains(t.dom);
}
function W(t, e = !1) {
  ...
  if ((pn(t, n), !!un(t))) {
    if (!e && t.input.mouseDown && t.input.mouseDown.allowDefault && M) {
      ...
      if (
        o.anchorNode &&
        i.anchorNode &&
        re(o.anchorNode, o.anchorOffset, i.anchorNode, i.anchorOffset)
      ) {
        ((t.input.mouseDown.delayedSelectionSync = !0), t.domObserver.setCurSelection());
        return;
      }
    }
    if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) co(t);
    else {
      ...
      (Rt &&
        !(n instanceof C) &&
        (n.$from.parent.inlineContent || (s = Bt(t, n.from)),
        !n.empty && !n.$from.parent.inlineContent && (r = Bt(t, n.to))),
        ...
        n.visible
          ...
          : (t.dom.classList.add("ProseMirror-hideselection"),
            "onselectionchange" in document && ao(t)));
    }
...
var Rt = x || (M && nn < 63);
function Bt(t, e) {
  let { node: n, offset: o } = t.docView.domFromPos(e, 0),
    i = o < n.childNodes.length ? n.childNodes[o] : null,
    s = o ? n.childNodes[o - 1] : null;
  if (x && i && i.contentEditable == "false") return He(i);
...
function He(t) {
  return (
    ...
    x && t.draggable && ((t.draggable = !1), (t.wasDraggable = !0)),
    t
  );
}
function It(t) {
  ...
  e.addEventListener(
    ...
    (t.input.hideSelectionGuard = () => {
      (n.anchorNode != o || n.anchorOffset != i) &&
        (e.removeEventListener("selectionchange", t.input.hideSelectionGuard),
        setTimeout(() => {
          (!un(t) || t.state.selection.visible) &&
            t.dom.classList.remove("ProseMirror-hideselection");
        }, 20));
    })
  );
...
function co(t) {
  ...
  let n = t.cursorWrapper.dom,
    o = n.nodeName == "IMG";
  (o ? e.collapse(n.parentNode, S(n) + 1) : e.collapse(n, 0),
    !o && !t.state.selection.visible && A && X <= 11 && ((n.disabled = !0), (n.disabled = !1)));
}
function pn(t, e) {
  if (e instanceof D) {
    let n = t.docView.descAt(e.from);
    n != t.lastSelectedViewDesc && (Ft(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
  } else Ft(t);
}
function Ft(t) {
...
function ht(t, e, n, o) {
  return t.someProp("createSelectionBetween", (i) => i(t, e, n)) || C.between(e, n, o);
}
function zt(t) {
  return t.editable && !t.hasFocus() ? !1 : mn(t);
}
function mn(t) {
...
function et(t, e) {
  let { $anchor: n, $head: o } = t.selection,
    i = e > 0 ? n.max(o) : n.min(o),
  ...
  if (o instanceof C)
    if (n.indexOf("s") > -1) {
      ...
      if (t.endOfTextblock(e > 0 ? "forward" : "backward")) {
        ...
        return s.isAtom || ((r = t.docView.descAt(l)) && !r.contentDOM)
          ? D.isSelectable(s)
            ? Y(t, new D(e < 0 ? t.state.doc.resolve(i.pos - s.nodeSize) : i))
            : xe
              ? Y(t, new C(t.state.doc.resolve(e < 0 ? l : l + s.nodeSize)))
              : !1
          : !1;
      }
    } else return !1;
  else {
    if (o instanceof D && o.node.isInline) return Y(t, new C(e > 0 ? o.$to : o.$from));
    {
      let i = et(t.state, e);
      return i ? Y(t, i) : !1;
    }
...
function ho(t) {
  ...
  let i,
    s,
    r = !1;
  for (B && n.nodeType == 1 && o < Re(n) && De(n.childNodes[o], -1) && (r = !0); ;)
    if (o > 0) {
      if (n.nodeType != 1) break;
      {
        let l = n.childNodes[o - 1];
        if (De(l, -1)) ((i = n), (s = --o));
        else if (l.nodeType == 3) ((n = l), (o = n.nodeValue.length));
        else break;
      }
    } else {
      if (gn(n)) break;
      {
        ...
        for (; l && De(l, -1);) ((i = n.parentNode), (s = S(l)), (l = l.previousSibling));
        if (l) ((n = l), (o = Re(n)));
        else {
...
function uo(t) {
  ...
  for (;;)
    if (o < i) {
      ...
      {
        let l = n.nextSibling;
        for (; l && De(l, 1);) ((s = l.parentNode), (r = S(l) + 1), (l = l.nextSibling));
        if (l) ((n = l), (o = 0), (i = Re(n)));
        else {
          if (((n = n.parentNode), n == t.dom)) break;
          o = i = 0;
...
function po(t, e) {
  for (; t && e == t.childNodes.length && !Me(t);) ((e = S(t) + 1), (t = t.parentNode));
...
function mo(t, e) {
  for (; t && !e && !Me(t);) ((e = S(t)), (t = t.parentNode));
  for (; t && e;) {
...
function tt(t, e, n) {
  if (e.nodeType != 3) {
    let s, r;
    (r = po(e, n)) ? ((e = r), (n = 0)) : (s = mo(e, n)) && ((e = s), (n = s.nodeValue.length));
  }
...
function $t(t, e) {
  ...
  if (!(M || qn) && n.parent.inlineContent) {
...
function qt(t, e, n) {
  let o = t.state.selection;
  if ((o instanceof C && !o.empty) || n.indexOf("s") > -1 || (V && n.indexOf("m") > -1)) return !1;
  let { $from: i, $to: s } = o;
  if (!i.parent.inlineContent || t.endOfTextblock(e < 0 ? "up" : "down")) {
    let r = et(t.state, e);
    if (r && r instanceof D) return Y(t, r);
  }
  if (!i.parent.inlineContent) {
    let r = e < 0 ? i : s,
      l = o instanceof St ? v.near(r, e) : v.findFrom(r, e);
    return l ? Y(t, l) : !1;
  }
  return !1;
}
function Kt(t, e) {
  if (!(t.state.selection instanceof C)) return !0;
  ...
  if (s && !s.isText) {
    let r = t.state.tr;
    return (
      e < 0 ? r.delete(n.pos - s.nodeSize, n.pos) : r.delete(n.pos, n.pos + s.nodeSize),
      t.dispatch(r),
      !0
    );
  }
...
function go(t) {
  if (!x || t.state.selection.$head.parentOffset > 0) return !1;
  let { focusNode: e, focusOffset: n } = t.domSelectionRange();
  if (e && e.nodeType == 1 && n == 0 && e.firstChild && e.firstChild.contentEditable == "false") {
    let o = e.firstChild;
    (Ht(t, o, "true"), setTimeout(() => Ht(t, o, "false"), 20));
  }
  return !1;
}
function yo(t) {
...
function bo(t, e) {
  let n = e.keyCode,
    o = yo(e);
  if (n == 8 || (V && n == 72 && o == "c")) return Kt(t, -1) || ce(t, -1);
  if ((n == 46 && !e.shiftKey) || (V && n == 68 && o == "c")) return Kt(t, 1) || ce(t, 1);
  if (n == 13 || n == 27) return !0;
  if (n == 37 || (V && n == 66 && o == "c")) {
    let i = n == 37 ? ($t(t, t.state.selection.from) == "ltr" ? -1 : 1) : -1;
    return Lt(t, i, o) || ce(t, i);
  } else if (n == 39 || (V && n == 70 && o == "c")) {
    let i = n == 39 ? ($t(t, t.state.selection.from) == "ltr" ? 1 : -1) : 1;
    return Lt(t, i, o) || ce(t, i);
  } else {
    if (n == 38 || (V && n == 80 && o == "c")) return qt(t, -1, o) || ce(t, -1);
    if (n == 40 || (V && n == 78 && o == "c")) return go(t) || qt(t, 1, o) || ce(t, 1);
    if (o == (V ? "m" : "c") && (n == 66 || n == 73 || n == 89 || n == 90)) return !0;
  }
  return !1;
}
function ut(t, e) {
  ...
  let n = [],
    { content: o, openStart: i, openEnd: s } = e;
  ...
  let r = t.someProp("clipboardSerializer") || ge.fromSchema(t.state.schema),
    l = Sn(),
  ...
  let c = a.firstChild,
    d,
    f = 0;
  for (; c && c.nodeType == 1 && (d = Nn[c.nodeName.toLowerCase()]);) {
  ...
  c &&
    c.nodeType == 1 &&
    c.setAttribute("data-pm-slice", `${i} ${s}${f ? ` -${f}` : ""} ${JSON.stringify(n)}`);
  let u =
...
function pt(t, e, n, o, i) {
  ...
  if (a) {
    if (
      (t.someProp("transformPastedText", (u) => {
        e = u(e, s || o, t);
      }),
      s)
    )
...
`
  ...
  if (
    ...
    l = Mo(Wt(l, +d[1], +d[2]), d[4]);
  else if (((l = j.maxOpen(No(l.content, i), !0)), l.openStart || l.openEnd)) {
    let f = 0,
      u = 0;
    for (
    ...
    if (
      (t.forEach((l) => {
        ...
        let a = i.findWrapping(l.type),
          c;
        if (!a) return (r = null);
        if ((c = r.length && s.length && bn(a, s, l, r[r.length - 1], 0))) r[r.length - 1] = c;
        else {
          r.length && (r[r.length - 1] = Dn(r[r.length - 1], s.length));
          let d = yn(l, a);
...
function yn(t, e, n = 0) {
  for (let o = e.length - 1; o >= n; o--) t = e[o].create(null, z.from(t));
  return t;
}
function bn(t, e, n, o, i) {
  if (i < t.length && i < e.length && t[i] == e[i]) {
    let s = bn(t, e, n, o.lastChild, i + 1);
    ...
    if (o.contentMatchAt(o.childCount).matchType(i == t.length - 1 ? n.type : t[i + 1]))
      return o.copy(o.content.append(z.from(yn(n, t, i + 1))));
  }
}
function Dn(t, e) {
  if (e == 0) return t;
  let n = t.content.replaceChild(t.childCount - 1, Dn(t.lastChild, e - 1)),
    o = t.contentMatchAt(t.childCount).fillBefore(z.empty, !0);
  return t.copy(n.append(o));
}
function nt(t, e, n, o, i, s) {
  let r = e < 0 ? t.firstChild : t.lastChild,
    l = r.content;
  return (
    t.childCount > 1 && (s = 0),
    i < o - 1 && (l = nt(l, e, n, o, i + 1, s)),
    i >= n &&
      (l =
        e < 0
          ? r
              ...
              .fillBefore(l, s <= i)
              .append(l)
          : l.append(r.contentMatchAt(r.childCount).fillBefore(z.empty, !0))),
    t.replaceChild(e < 0 ? 0 : t.childCount - 1, r.copy(l))
  );
}
function Wt(t, e, n) {
  return (
    e < t.openStart && (t = new j(nt(t.content, -1, e, t.openStart, 0, t.openEnd), e, t.openEnd)),
    n < t.openEnd && (t = new j(nt(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
    t
  );
}
var Nn = {
  ...
  _t = null;
function Sn() {
  return _t || (_t = document.implementation.createHTMLDocument("title"));
}
var We = null;
function So(t) {
  ...
  return e
    ? (We ||
        (We = e.defaultPolicy || e.createPolicy("ProseMirrorClipboard", { createHTML: (n) => n })),
      We.createHTML(t))
    : t;
}
function Co(t) {
  ...
  let n = Sn().createElement("div"),
    o = /<([a-z][^>\s]+)/i.exec(t),
    i;
  if (
    ((i = o && Nn[o[1].toLowerCase()]) &&
      (t =
        i.map((s) => "<" + s + ">").join("") +
        t +
        i
...
function Oo(t) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    o.childNodes.length == 1 &&
      o.textContent == "\xA0" &&
      o.parentNode &&
      o.parentNode.replaceChild(t.ownerDocument.createTextNode(" "), o);
  }
}
function Mo(t, e) {
  if (!t.size) return t;
...
function ko(t) {
  for (let e in k) {
    ...
    t.dom.addEventListener(
      e,
      (t.input.eventHandlers[e] = (o) => {
        Po(t, o) && !mt(t, o) && (t.editable || !(o.type in T)) && n(t, o);
      }),
      xo[e] ? { passive: !0 } : void 0
    );
  }
  (x && t.dom.addEventListener("input", () => null), it(t));
}
function G(t, e) {
  ...
  t.someProp("handleDOMEvents", (e) => {
    for (let n in e)
      t.input.eventHandlers[n] ||
        t.dom.addEventListener(n, (t.input.eventHandlers[n] = (o) => mt(t, o)));
  });
}
function mt(t, e) {
...
function Ao(t, e) {
  !mt(t, e) && k[e.type] && (t.editable || !(e.type in T)) && k[e.type](t, e);
}
T.keydown = (t, e) => {
  let n = e;
  if (
    ...
    if (
      ...
      ue && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
    ) {
      let o = Date.now();
      ((t.input.lastIOSEnter = o),
        (t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          t.input.lastIOSEnter == o &&
            (t.someProp("handleKeyDown", (i) => i(t, ee(13, "Enter"))), (t.input.lastIOSEnter = 0));
        }, 200)));
    } else
      t.someProp("handleKeyDown", (o) => o(t, n)) || bo(t, n) ? n.preventDefault() : G(t, "key");
};
T.keyup = (t, e) => {
...
T.keypress = (t, e) => {
  let n = e;
  if (On(t, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (V && n.metaKey)) return;
  if (t.someProp("handleKeyPress", (i) => i(t, n))) {
    n.preventDefault();
    return;
  }
  let o = t.state.selection;
  if (!(o instanceof C) || !o.$from.sameParent(o.$to)) {
    let i = String.fromCharCode(n.charCode),
      s = () => t.state.tr.insertText(i).scrollIntoView();
    (!/[\r\n]/.test(i) &&
      !t.someProp("handleTextInput", (r) => r(t, o.$from.pos, o.$to.pos, i, s)) &&
      t.dispatch(s()),
      n.preventDefault());
  }
};
...
function gt(t, e, n, o, i) {
  ...
  for (let r = s.depth + 1; r > 0; r--)
    if (
      t.someProp(e, (l) =>
        r > s.depth
          ? l(t, n, s.nodeAfter, s.before(r), i, !0)
          : l(t, n, s.node(r), s.before(r), i, !1)
      )
    )
      return !0;
  return !1;
...
function fe(t, e, n) {
  ...
  (n == "pointer" && o.setMeta("pointer", !0), t.dispatch(o));
}
function Vo(t, e) {
  if (e == -1) return !1;
  let n = t.state.doc.resolve(e),
    o = n.nodeAfter;
  return o && o.isAtom && D.isSelectable(o) ? (fe(t, new D(n), "pointer"), !0) : !1;
}
function Ro(t, e) {
  if (e == -1) return !1;
  let n = t.state.selection,
  ...
  for (let r = s.depth + 1; r > 0; r--) {
    ...
    if (D.isSelectable(l)) {
      o && n.$from.depth > 0 && r >= n.$from.depth && s.before(n.$from.depth + 1) == n.$from.pos
        ? (i = s.before(n.$from.depth))
        : (i = s.before(r));
      break;
    }
  }
  return i != null ? (fe(t, D.create(t.state.doc, i), "pointer"), !0) : !1;
}
function Bo(t, e, n, o, i) {
  return (
    gt(t, "handleClickOn", e, n, o) ||
    t.someProp("handleClick", (s) => s(t, e, o)) ||
    (i ? Ro(t, n) : Vo(t, n))
  );
}
function Io(t, e, n, o) {
  return (
    gt(t, "handleDoubleClickOn", e, n, o) || t.someProp("handleDoubleClick", (i) => i(t, e, o))
  );
}
function Fo(t, e, n, o) {
  return (
    gt(t, "handleTripleClickOn", e, n, o) ||
    t.someProp("handleTripleClick", (i) => i(t, e, o)) ||
    zo(t, n, o)
  );
}
function zo(t, e, n) {
  ...
  let o = t.state.doc;
  if (e == -1) return o.inlineContent ? (fe(t, C.create(o, 0, o.content.size), "pointer"), !0) : !1;
  let i = o.resolve(e);
  for (let s = i.depth + 1; s > 0; s--) {
    let r = s > i.depth ? i.nodeAfter : i.node(s),
      l = i.before(s);
    if (r.inlineContent) fe(t, C.create(o, l + 1, l + 1 + r.content.size), "pointer");
    else if (D.isSelectable(r)) fe(t, D.create(o, l), "pointer");
    else continue;
    return !0;
  }
}
...
k.mousedown = (t, e) => {
  ...
  (i - t.input.lastClick.time < 500 &&
    Eo(n, t.input.lastClick) &&
    !n[Cn] &&
    t.input.lastClick.button == n.button &&
    (t.input.lastClick.type == "singleClick"
      ? (s = "doubleClick")
      : t.input.lastClick.type == "doubleClick" && (s = "tripleClick")),
    (t.input.lastClick = { time: i, x: n.clientX, y: n.clientY, type: s, button: n.button }));
  let r = t.posAtCoords($e(n));
  r &&
    (s == "singleClick"
      ? (t.input.mouseDown && t.input.mouseDown.done(), (t.input.mouseDown = new st(t, r, n, !!o)))
      : (s == "doubleClick" ? Io : Fo)(t, r.pos, r.inside, n)
        ? n.preventDefault()
        : G(t, "pointer"));
};
var st = class {
  constructor(e, n, o, i) {
    ((this.view = e),
      ...
      (this.selectNode = !!o[Cn]),
      (this.allowDefault = o.shiftKey));
    let s, r;
    if (n.inside > -1) ((s = e.state.doc.nodeAt(n.inside)), (r = n.inside));
    else {
      let d = e.state.doc.resolve(n.pos);
      ((s = d.parent), (r = d.depth ? d.before() : 0));
    }
    let l = i ? null : o.target,
      a = l ? e.docView.nearestDesc(l, !0) : null;
    this.target = a && a.nodeDOM.nodeType == 1 ? a.nodeDOM : null;
    let { selection: c } = e.state;
    (((o.button == 0 && s.type.spec.draggable && s.type.spec.selectable !== !1) ||
      (c instanceof D && c.from <= r && c.to > r)) &&
      (this.mightDrag = {
        node: s,
        pos: r,
    ...
    (this.view.root.removeEventListener("mouseup", this.up),
      ...
      this.mightDrag &&
        ...
        this.view.domObserver.start()),
      this.delayedSelectionSync && setTimeout(() => W(this.view)),
      (this.view.input.mouseDown = null));
  }
  up(e) {
    if ((this.done(), !this.view.dom.contains(e.target))) return;
    let n = this.pos;
    (this.view.state.doc != this.startDoc && (n = this.view.posAtCoords($e(e))),
      this.updateAllowDefault(e),
      this.allowDefault || !n
        ? G(this.view, "pointer")
        : Bo(this.view, n.pos, n.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
              (this.flushed ||
                (x && this.mightDrag && !this.mightDrag.node.isAtom) ||
                (M &&
            ...
            ? (fe(this.view, v.near(this.view.state.doc.resolve(n.pos)), "pointer"),
              e.preventDefault())
            : G(this.view, "pointer"));
  }
  move(e) {
    (this.updateAllowDefault(e), G(this.view, "pointer"), e.buttons == 0 && this.done());
  }
...
k.touchstart = (t) => {
  ((t.input.lastTouch = Date.now()), yt(t), G(t, "pointer"));
};
k.touchmove = (t) => {
  ((t.input.lastTouch = Date.now()), G(t, "pointer"));
};
k.contextmenu = (t) => yt(t);
function On(t, e) {
  return t.composing
    ? !0
    : x && Math.abs(e.timeStamp - t.input.compositionEndedAt) < 500
  ...
  if (!t.composing) {
    ...
    if (
      ...
      (e.storedMarks ||
        (!n.textOffset &&
          n.parentOffset &&
          n.nodeBefore.marks.some((o) => o.type.spec.inclusive === !1)))
    )
      ((t.markCursor = t.state.storedMarks || n.marks()), Ne(t, !0), (t.markCursor = null));
    else if (
      (Ne(t, !e.selection.empty),
      B && e.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
    ) {
      let o = t.domSelectionRange();
...
function Mn(t, e) {
  (clearTimeout(t.input.composingTimeout),
    e > -1 && (t.input.composingTimeout = setTimeout(() => Ne(t), e)));
}
function xn(t) {
  for (
    t.composing && ((t.input.composing = !1), (t.input.compositionEndedAt = qo()));
...
function $o(t) {
  ...
  let n = In(e.focusNode, e.focusOffset),
    o = Fn(e.focusNode, e.focusOffset);
  if (n && o && n != o) {
    let i = o.pmViewDesc,
      s = t.domObserver.lastChangedTextNode;
    if (n == s || o == s) return s;
    if (!i || !i.isText(o.nodeValue)) return o;
    if (t.input.compositionNode == o) {
      let r = n.pmViewDesc;
      if (!(!r || !r.isText(n.nodeValue))) return o;
    }
  }
  return n || o;
}
...
function Ne(t, e = !1) {
  if (!(H && t.domObserver.flushingSoon >= 0)) {
    if ((t.domObserver.forceFlush(), xn(t), e || (t.docView && t.docView.dirty))) {
      let n = ft(t),
        o = t.state.selection;
      return (
        n && !n.eq(o)
          ? t.dispatch(t.state.tr.setSelection(n))
          : (t.markCursor || e) && !o.$from.node(o.$from.sharedDepth(o.to)).inlineContent
...
var Se = (A && X < 15) || (ue && Kn < 604);
k.copy = T.cut = (t, e) => {
  let n = e,
    o = t.state.selection,
    i = n.type == "cut";
  if (o.empty) return;
  let s = Se ? null : n.clipboardData,
    r = o.content(),
    { dom: l, text: a } = ut(t, r);
  (s
    ? (n.preventDefault(),
...
function Wo(t, e) {
  ...
  let n = t.input.shiftKey || t.state.selection.$from.parent.type.spec.code,
    o = t.dom.parentNode.appendChild(document.createElement(n ? "textarea" : "div"));
  ...
  setTimeout(() => {
    (t.focus(),
      ...
      n ? Ce(t, o.value, null, i, e) : Ce(t, o.textContent, o.innerHTML, i, e));
  }, 50);
}
function Ce(t, e, n, o, i) {
  let s = pt(t, e, n, o, t.state.selection.$from);
  if (t.someProp("handlePaste", (a) => a(t, i, s || j.empty))) return !0;
  if (!s) return !1;
  let r = Ho(s),
    l = r ? t.state.tr.replaceSelectionWith(r, o) : t.state.tr.replaceSelection(s);
...
T.paste = (t, e) => {
  let n = e;
  if (t.composing && !H) return;
  let o = Se ? null : n.clipboardData,
    i = t.input.shiftKey && t.input.lastKeyCode != 45;
  o && Ce(t, kn(o), o.getData("text/html"), i, n) ? n.preventDefault() : Wo(t, n);
};
var Be = class {
    constructor(e, n, o) {
...
k.dragstart = (t, e) => {
  ...
  let i = t.state.selection,
    s = i.empty ? null : t.posAtCoords($e(n)),
    r;
  if (!(s && s.pos >= i.from && s.pos <= (i instanceof D ? i.to - 1 : i.to))) {
    if (o && o.mightDrag) r = D.create(t.state.doc, o.mightDrag.pos);
    else if (n.target && n.target.nodeType == 1) {
      let f = t.docView.nearestDesc(n.target, !0);
      f && f.node.type.spec.draggable && f != t.docView && (r = D.create(t.state.doc, f.posBefore));
    }
  }
  let l = (r || t.state.selection).content(),
    { dom: a, text: c, slice: d } = ut(t, l);
  ((!n.dataTransfer.files.length || !M || nn > 120) && n.dataTransfer.clearData(),
    n.dataTransfer.setData(Se ? "Text" : "text/html", a.innerHTML),
    (n.dataTransfer.effectAllowed = "copyMove"),
    Se || n.dataTransfer.setData("text/plain", c),
    (t.dragging = new Be(d, Tn(t, n), r)));
};
k.dragend = (t) => {
  let e = t.dragging;
  window.setTimeout(() => {
...
T.drop = (t, e) => {
  ...
  r
    ...
    : (r = pt(t, kn(n.dataTransfer), Se ? null : n.dataTransfer.getData("text/html"), !1, s));
  let l = !!(o && Tn(t, n));
  ...
  if (!r) return;
  n.preventDefault();
  let a = r ? Nt(t.state.doc, s.pos, r) : s.pos;
  a == null && (a = s.pos);
  let c = t.state.tr;
  if (l) {
    let { node: h } = o;
  ...
  let d = c.mapping.map(a),
    f = r.openStart == 0 && r.openEnd == 0 && r.content.childCount == 1,
    u = c.doc;
  ...
  if (
    f &&
    D.isSelectable(r.content.firstChild) &&
    p.nodeAfter &&
    p.nodeAfter.sameMarkup(r.content.firstChild)
  )
    c.setSelection(new D(p));
  else {
    let h = c.mapping.map(a);
    (c.mapping.maps[c.mapping.maps.length - 1].forEach((g, m, y, E) => (h = E)),
      c.setSelection(ht(t, p, c.doc.resolve(h))));
  }
...
k.beforeinput = (t, e) => {
  if (M && H && e.inputType == "deleteContentBackward") {
    ...
    setTimeout(() => {
      if (
        t.input.domChangeCount != o ||
        (t.dom.blur(), t.focus(), t.someProp("handleKeyDown", (s) => s(t, ee(8, "Backspace"))))
      )
        return;
...
var Ie = class t {
      ...
      return (
        ...
        (e instanceof t &&
          ((this.spec.key && this.spec.key == e.spec.key) ||
            (this.toDOM == e.toDOM && Oe(this.spec, e.spec))))
      );
    }
    destroy(e) {
  ...
  oe = class t {
    ...
    map(e, n, o, i) {
      let s = e.map(n.from + i, this.spec.inclusiveStart ? -1 : 1) - o,
        r = e.map(n.to + i, this.spec.inclusiveEnd ? 1 : -1) - o;
    ...
    eq(e) {
      return this == e || (e instanceof t && Oe(this.attrs, e.attrs) && Oe(this.spec, e.spec));
    }
    static is(e) {
  ...
  rt = class t {
    ...
    valid(e, n) {
      let { index: o, offset: i } = e.content.findIndex(n.from),
        s;
  ...
  Z = class t {
    ...
    static widget(e, n, o) {
      return new t(e, e, new Ie(n, o));
    }
    static inline(e, n, o, i) {
      return new t(e, n, new oe(o, i));
    }
    static node(e, n, o, i) {
      return new t(e, n, new rt(o, i));
    }
    get spec() {
  ...
  F = class t {
    ...
    mapInner(e, n, o, i, s) {
      ...
      return this.children.length
        ? jo(this.children, r || [], e, n, o, i, s)
        : r
          ? new t(r.sort(se), de)
          : O;
    }
    add(e, n) {
      return n.length ? (this == O ? t.create(e, n) : this.addInner(e, n, 0)) : this;
    }
    addInner(e, n, o) {
      let i,
        s = 0;
      e.forEach((l, a) => {
        ...
        if ((d = An(n, l, c))) {
          ...
          (i[s] == a
            ? (i[s + 2] = i[s + 2].addInner(l, d, c + 1))
            : i.splice(s, 0, a, a + l.nodeSize, ze(d, l, c + 1, ie)),
            (s += 3));
        }
      });
      let r = Pn(s ? En(n) : n, -o);
      for (let l = 0; l < r.length; l++) r[l].type.valid(e, r[l]) || r.splice(l--, 1);
      return new t(r.length ? this.local.concat(r).sort(se) : this.local, i || this.children);
    }
    remove(e) {
    ...
    removeInner(e, n) {
      ...
      return o == this.children && i == this.local ? this : i.length || o.length ? new t(i, o) : O;
    }
    forChild(e, n) {
      ...
      for (let l = 0; l < this.local.length; l++) {
        let a = this.local[l];
        if (a.from < r && a.to > s && a.type instanceof oe) {
      ...
      if (i) {
        let l = new t(i.sort(se), de);
        return o ? new Fe([l, o]) : l;
      }
      return o || O;
    }
    eq(e) {
    ...
    locals(e) {
      return bt(this.localsInner(e));
    }
    localsInner(e) {
      if (this == O) return de;
      if (e.inlineContent || !this.local.some(oe.is)) return this.local;
      let n = [];
      for (let o = 0; o < this.local.length; o++)
        this.local[o].type instanceof oe || n.push(this.local[o]);
      return n;
    }
    forEachSet(e) {
      e(this);
...
var O = F.empty,
  Fe = class t {
    ...
    map(e, n) {
      let o = this.members.map((i) => i.map(e, n, ie));
      return t.from(o);
    }
    forChild(e, n) {
      if (n.isLeaf) return F.empty;
      let o = [];
      for (let i = 0; i < this.members.length; i++) {
        let s = this.members[i].forChild(e, n);
        s != O && (s instanceof t ? (o = o.concat(s.members)) : o.push(s));
      }
      return t.from(o);
    }
    eq(e) {
      ...
      for (let i = 0; i < this.members.length; i++) {
        ...
        if (s.length)
          if (!n) n = s;
            ...
            o && ((n = n.slice()), (o = !1));
            for (let r = 0; r < s.length; r++) n.push(s[r]);
          }
      }
      return n ? bt(o ? n : n.sort(se)) : de;
    }
    static from(e) {
      switch (e.length) {
        case 0:
        ...
        default:
          return new t(
            e.every((n) => n instanceof F)
              ? e
              : e.reduce((n, o) => n.concat(o instanceof F ? o : o.members), [])
          );
      }
    }
    forEachSet(e) {
...
function jo(t, e, n, o, i, s, r) {
  ...
  for (let c = 0; c < l.length; c += 3)
    if (l[c + 1] < 0) {
      ...
      let u = n.map(t[c + 1] + s, -1),
        p = u - i,
        { index: h, offset: g } = o.content.findIndex(f),
        m = o.maybeChild(h);
...
function Uo(t, e, n, o, i, s, r) {
  ...
  for (let a = 0; a < t.length; a += 3) t[a + 1] == -1 && l(t[a + 2], e[a] + s + 1);
  return n;
}
function An(t, e, n) {
    ...
    if (o.from != o.to)
      for (let i = n + 1; i < e.length; i++) {
        ...
        if (s.from == o.from) {
          s.to != o.to &&
            (e == t && (e = t.slice()),
            (e[i] = s.copy(s.from, o.to)),
            jt(e, i + 1, s.copy(o.to, s.to)));
          continue;
        } else {
          s.from < o.to &&
            (e == t && (e = t.slice()),
            (e[n] = o.copy(o.from, s.from)),
            jt(e, i, o.copy(s.from, o.to)));
          break;
        }
      }
  }
...
function _e(t) {
  ...
  return (
    ...
    t.cursorWrapper && e.push(F.create(t.state.doc, [t.cursorWrapper.deco])),
    Fe.from(e)
  );
}
var Yo = {
  ...
  at = class {
      ...
      ((this.view = e),
        ...
        (this.observer =
          ...
          new window.MutationObserver((o) => {
            for (let i = 0; i < o.length; i++) this.queue.push(o[i]);
            A &&
            X <= 11 &&
            o.some(
              (i) =>
    ...
    start() {
      (this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, Yo)),
        this.onCharData &&
    ...
    onSelectionChange() {
      if (zt(this.view)) {
        if (this.suppressingSelectionUpdates) return W(this.view);
        if (A && X <= 11 && !this.view.state.selection.empty) {
    ...
    ignoreSelectionChange(e) {
      ...
      let n = new Set(),
        o;
      for (let s = e.focusNode; s; s = he(s)) n.add(s);
      ...
      if (i && i.ignoreMutation({ type: "selection", target: o.nodeType == 3 ? o.parentNode : o }))
    ...
    flush() {
      ...
      Le(o) &&
      (c = ft(e)) &&
      c.eq(v.near(e.state.doc.resolve(0), 1))
        ? ((e.input.lastFocus = 0), W(e), this.currentSelection.set(o), e.scrollToSelection())
        : (s > -1 || i) &&
          (s > -1 && (e.docView.markDirty(s, r), Xo(e)),
          this.handleDOMChange(s, r, l, a),
          e.docView && e.docView.dirty
            ? e.updateState(e.state)
            : this.currentSelection.eq(o) || W(e),
    ...
    registerMutation(e, n) {
      ...
      if (e.type == "childList") {
        ...
        let r = i && i.parentNode == e.target ? S(i) + 1 : 0,
          l = o.localPosFromDOM(e.target, r, -1),
          a = s && s.parentNode == e.target ? S(s) : e.target.childNodes.length,
...
function Xo(t) {
  if (
    ...
    if (((t.requiresGeckoHackNode = B), Yt)) return;
    (console.warn(
...
function Gt(t, e) {
  let n = e.startContainer,
    ...
    i = e.endContainer,
    s = e.endOffset,
    r = t.domAtPos(t.state.selection.anchor);
  return (
    re(r.node, r.offset, i, s) && ([n, o, i, s] = [i, s, n, o]),
    { anchorNode: n, anchorOffset: o, focusNode: i, focusOffset: s }
  );
}
function Jo(t, e) {
  ...
  return (
    t.dom.addEventListener("beforeinput", o, !0),
    document.execCommand("indent"),
    t.dom.removeEventListener("beforeinput", o, !0),
    n ? Gt(t, n) : null
  );
}
function Zo(t, e) {
...
function Qo(t, e, n) {
  let { node: o, fromOffset: i, toOffset: s, from: r, to: l } = t.docView.parseRange(e, n),
  ...
  if (
    (d &&
      ...
      Le(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
    M && t.input.lastKeyCode === 8)
  )
    for (let m = s; m > i; m--) {
      let y = o.childNodes[m - 1],
        E = y.pmViewDesc;
      if (y.nodeName == "BR" && !E) {
        s = m;
        break;
  ...
  let f = t.state.doc,
    u = t.someProp("domParser") || qe.fromSchema(t.state.schema),
    p = f.resolve(r),
    h = null,
    g = u.parse(o, {
      topNode: p.parent,
...
function ei(t, e, n, o, i) {
  ...
  if (((t.input.compositionPendingChanges = 0), e < 0)) {
    let b = t.input.lastSelectionTime > Date.now() - 50 ? t.input.lastSelectionOrigin : null,
      N = ft(t, b);
    if (N && !t.state.selection.eq(N)) {
      if (
        ...
        t.someProp("handleKeyDown", (Vn) => Vn(t, ee(13, "Enter")))
      )
        return;
      let P = t.state.tr.setSelection(N);
      (b == "pointer" ? P.setMeta("pointer", !0) : b == "key" && P.scrollIntoView(),
        s && P.setMeta("composition", s),
        t.dispatch(P));
    }
    return;
  }
  ...
  (t.input.lastKeyCode === 8 && Date.now() - 100 < t.input.lastKeyCodeTime
    ? ((u = t.state.selection.to), (p = "end"))
    : ((u = t.state.selection.from), (p = "start")),
    (t.input.lastKeyCode = null));
  let h = oi(f.content, c.doc.content, c.from, u, p);
  if (
    (h && t.input.domChangeCount++,
    ((ue && t.input.lastIOSEnter > Date.now() - 225) || H) &&
      i.some((b) => b.nodeType == 1 && !vo.test(b.nodeName)) &&
      (!h || h.endA >= h.endB) &&
      t.someProp("handleKeyDown", (b) => b(t, ee(13, "Enter"))))
  ) {
  ...
  (t.state.selection.from < t.state.selection.to &&
    h.start == h.endB &&
    t.state.selection instanceof C &&
  ...
  if (
    ...
    ni(d, h.start, h.endA, g, m) &&
    t.someProp("handleKeyDown", (b) => b(t, ee(8, "Backspace")))
  ) {
    H && M && t.domObserver.suppressSelectionUpdates();
    return;
  }
  (M && h.endB == h.start && (t.input.lastChromeDelete = Date.now()),
    H &&
      !E &&
      g.start() != m.start() &&
      m.parentOffset == 0 &&
  ...
  let _ = h.start,
    w = h.endA,
    ke = (b) => {
      let N = b || t.state.tr.replace(_, w, c.doc.slice(h.start - c.from, h.endB - c.from));
      if (c.sel) {
        let P = Xt(t, N.doc, c.sel);
        P &&
          !(
            (M &&
              t.composing &&
              ...
              (P.head == _ || P.head == N.mapping.map(w) - 1)) ||
            (A && P.empty && P.head == _)
          ) &&
          N.setSelection(P);
      }
  ...
  if (E) {
    if (g.pos == m.pos) {
      A &&
        X <= 11 &&
        g.parentOffset == 0 &&
        (t.domObserver.suppressSelectionUpdates(), setTimeout(() => W(t), 20));
      let b = ke(t.state.tr.delete(_, w)),
        N = d.resolve(h.start).marksAcross(d.resolve(h.endA));
      ...
      let b = ke(t.state.tr);
      (Te.type == "add" ? b.addMark(_, w, Te.mark) : b.removeMark(_, w, Te.mark), t.dispatch(b));
    } else if (
      g.parent.child(g.index()).isText &&
      g.index() == m.index() - (m.textOffset ? 0 : 1)
    ) {
      let b = g.parent.textBetween(g.parentOffset, m.parentOffset),
        N = () => ke(t.state.tr.insertText(b, _, w));
      t.someProp("handleTextInput", (P) => P(t, _, w, b, N)) || t.dispatch(N());
    }
  } else t.dispatch(ke());
}
function Xt(t, e, n) {
  return Math.max(n.anchor, n.head) > e.content.size
    ? null
    : ht(t, e.resolve(n.anchor), e.resolve(n.head));
}
function ti(t, e) {
  let n = t.firstChild.marks,
    ...
    l,
    a;
  for (let d = 0; d < o.length; d++) i = o[d].removeFromSet(i);
  for (let d = 0; d < n.length; d++) s = n[d].removeFromSet(s);
  ...
  if (z.from(c).eq(t)) return { mark: l, type: r };
}
function ni(t, e, n, o, i) {
  if (n - e <= i.pos - o.pos || je(o, !0, !1) < i.pos) return !1;
  let s = t.resolve(e);
  ...
  let r = t.resolve(je(s, !0, !0));
  return !r.parent.isTextblock || r.pos > n || je(r, !0, !1) < n
    ? !1
...
function je(t, e, n) {
  let o = t.depth,
    i = e ? t.end() : t.pos;
  for (; o > 0 && (e || t.indexAfter(o) == t.node(o).childCount);) (o--, i++, (e = !1));
  if (n) {
...
function oi(t, e, n, o, i) {
  ...
  if (r < s && t.size < e.size) {
    let a = o <= s && o >= r ? s - o : 0;
    ((s -= a),
      s && s < e.size && Jt(e.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1),
      (l = s + (l - r)),
      (r = s));
  } else if (l < s) {
    let a = o <= s && o >= l ? s - o : 0;
    ((s -= a),
      s && s < t.size && Jt(t.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1),
      (r = s + (r - l)),
      (l = s));
  }
  ...
  ct = class {
    constructor(e, n) {
      ((this._root = null),
        ...
        (this.editable = wt(this)),
        Qt(this),
        (this.nodeViews = vt(this)),
        (this.docView = Et(this.state.doc, Zt(this), _e(this), this.dom, this)),
        (this.domObserver = new at(this, (o, i, s, r) => ei(this, o, i, s, r))),
    ...
    update(e) {
      e.handleDOMEvents != this._props.handleDOMEvents && it(this);
      let n = this._props;
      ((this._props = e),
        e.plugins && (e.plugins.forEach(en), (this.directPlugins = e.plugins)),
        this.updateStateInner(e.state, n));
    }
    setProps(e) {
      let n = {};
      for (let o in this._props) n[o] = this._props[o];
      n.state = this.state;
    ...
    updateStateInner(e, n) {
      ...
      let i = this.state,
        s = !1,
        r = !1;
      (e.storedMarks && this.composing && (xn(this), (r = !0)), (this.state = e));
      ...
      ((l || n.handleDOMEvents != this._props.handleDOMEvents) && it(this),
        (this.editable = wt(this)),
        Qt(this));
      let a = _e(this),
        c = Zt(this),
      ...
      let u = d == "preserve" && r && this.dom.style.overflowAnchor == null && _n(this);
      if (r) {
        ...
        !(
          ...
          ? W(this, p)
          : (pn(this, e.selection), this.domObserver.setCurSelection()),
          this.domObserver.start());
      }
      ...
      if (!(!e || !this.dom.contains(e.nodeType == 1 ? e : e.parentNode))) {
        if (!this.someProp("handleScrollToSelection", (n) => n(this)))
          if (this.state.selection instanceof D) {
            ...
            n.nodeType == 1 && Mt(this, n.getBoundingClientRect(), e);
          } else Mt(this, this.coordsAtPos(this.state.selection.head, 1), e);
      }
    }
    destroyPluginViews() {
      let e;
    ...
    updateDraggedNode(e, n) {
      ...
      this.dragging = new Be(e.slice, e.move, i < 0 ? void 0 : D.create(this.state.doc, i));
    }
    someProp(e, n) {
      let o = this._props && this._props[e],
        i;
      if (o != null && (i = n ? n(o) : o)) return i;
    ...
    focus() {
      (this.domObserver.stop(), this.editable && Un(this.dom), W(this), this.domObserver.start());
    }
    get root() {
      let e = this._root;
      if (e == null) {
    ...
    endOfTextblock(e, n) {
      return to(this, n || this.state, e);
    }
    pasteHTML(e, n) {
      return Ce(this, "", e, !1, n || new ClipboardEvent("paste"));
    }
    pasteText(e, n) {
      return Ce(this, e, null, !0, n || new ClipboardEvent("paste"));
    }
    ...
    destroy() {
      this.docView &&
        ...
        this.mounted
          ? (this.docView.update(this.state.doc, [], _e(this), this), (this.dom.textContent = ""))
    ...
    domSelectionRange() {
      ...
      return e
        ? (x &&
            ...
            Ln(this.dom.ownerDocument) == this.dom &&
            Jo(this, e)) ||
            e
...
ct.prototype.dispatch = function (t) {
      ...
      if ((typeof n == "function" && (n = n(t.state)), n))
        for (let o in n)
          o == "class"
            ? (e.class += " " + n[o])
            : o == "style"
              ? (e.style = (e.style ? e.style + ";" : "") + n[o])
              : !e[o] && o != "contenteditable" && o != "nodeName" && (e[o] = String(n[o]));
    }),
...
function Qt(t) {
  if (t.markCursor) {
    ...
    ((e.className = "ProseMirror-separator"),
      ...
      (t.cursorWrapper = {
        dom: e,
        deco: Z.widget(t.state.selection.from, e, { raw: !0, marks: t.markCursor }),
      }));
...
function vt(t) {
  let e = Object.create(null);
  function n(o) {
    for (let i in o) Object.prototype.hasOwnProperty.call(e, i) || (e[i] = o[i]);
  }
...
export { Z as a, F as b, ci as c, di as d, ct as e };
//# sourceMappingURL=chunk-SJBKDMQK.mjs.map
