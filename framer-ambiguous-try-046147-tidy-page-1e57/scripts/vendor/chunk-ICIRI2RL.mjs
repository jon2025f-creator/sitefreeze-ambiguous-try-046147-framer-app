import { a as Cr, c as ct, d as Nr } from "chunk-VPDJYJ6F.mjs";
import {
  $d as qr,
  Ba as Vr,
  C as Hr,
...
import { vb as Se, wb as Oe } from "chunk-JXMEFPSI.mjs";
import {
  Au as xr,
  Ci as Pr,
  Fm as br,
...
function Ss(e, t) {
  ...
  for (let i of r) if (!Nt(i, e[i], t[i])) return !1;
  return !0;
}
function Jr(e) {
  return e._data || e;
...
function Rt(e, t, r, s) {
  ...
  let h = s._deleted;
  if (h && d) for (let A of h) d[A] !== void 0 && (T || (T = { ...d }), delete T[A]);
  if (!T) return null;
  let _ = t.asDraft(e),
    p = { ...o };
  return (
    ur(T) ? delete p[r] : (p[r] = T),
    _.setProp("replicaInfo", { ...i, overrides: p }),
    (_.cache.rebuildReplica = !0),
    _
  );
}
function Nc(e, t, r) {
...
function tn(e, t, r, s, i) {
  return t === r || ((t = en(e, t)), (r = en(e, r)), w(t, r))
    ? !1
...
function rn(e, t, r, s) {
  ...
  if (i) return { id: Ds(e, t), from: d, to: o };
}
function Ls(e, t, r) {
  if (!(Q(t) || Q(r))) return;
  let s = t ? t.id : r ? r.id : "",
...
function bt(e, t, r, s, i) {
  ...
  if (!o || (_t(o) && !o.isLoaded())) return null;
  let d = cn(e, t, r, s);
...
function Ms(e) {
  let t = "styledText";
  return e != null && typeof e[t] == "object" && e[t] !== null && bs(e[t]);
}
function dn(e, t) {
  e.has(t) && e.remove(t);
}
...
function Lt(e) {
  let t = {};
  for (let r in e) r !== "_deleted" && (t[r] = Tn(r, e[r]));
  return t;
}
...
function Bs(e, t, r, s = !1) {
  ...
  for (let h in r) {
    ...
    let _ = h;
    if (_ === "id" || _ === "__class") continue;
    let p = r[h];
    if (h === "replicaInfo" && p) {
      let C = t.replicaInfo;
      if (C?.master === p.master && C?.inheritsFrom === p.inheritsFrom) continue;
      p = { ...p, overrides: C?.overrides ?? {} };
    }
    if (St(h, t[_], p)) continue;
    i || (i = t.asDraft(e));
    let A = pt.reviveProperty(h, p);
    (h.startsWith("$") ? i.setProp(h, A) : on(i, _, A), (d ||= o && st(h)));
  }
  let T = r._deleted;
  if (T)
    for (let h of T) {
      ...
      _ === "id" ||
        ...
        (t[_] !== void 0 &&
          (i || (i = t.asDraft(e)),
          an(h) ? i.deleteProp(h) : s ? i.resetToDefault(h) : on(i, _, void 0),
          (d ||= o && st(h))));
    }
...
function xs(e, t, r) {
  ...
  Fs(o, s) || t.asDraft(e).setProp("children", new Er(s));
}
function Fs(e, t) {
      ...
      for (; t.length > 0;) {
        ...
        for (let o = 0, d = t.length; o < d; o++) {
          ...
          T.added
            ...
            : T.removed || (Pt(e, T.id, T.to) ? i.push(T) : (Us(e, T, s), ae(e, h, T)));
        }
...
var ws = { id: !0, cache: !0, children: !0, mutable: !0, update: !0, _deleted: !0 },
  Ys = { parentid: !0, replicaInfo: !0, originalid: !0, duplicatedFrom: !0 };
function Vs(e, t) {
  let r = e.length;
  if (r !== t.length) return !1;
...
function Ks(e, t, r) {
  ...
  for (let h of T) {
    if (o) {
      ...
      if (h === "children") {
        (Ws(r, e.children, t.children), (r.fromChildren || r.toChildren) && (d = !0));
        continue;
      }
      if (h in ws) continue;
    }
    ...
    St(h, p, A) ||
      ...
      A === void 0 ? (i._deleted || (i._deleted = []), i._deleted.push(h)) : (i[h] = Ot(h, A)),
      (d = !0));
  }
  if (!(!d && !r.added && !r.removed)) return r;
}
pt.setGeneric("reviveProperty", Tn);
function yt(e) {
...
var En = ["contentManagementSyncState", "save", "transient"];
function dl(e) {
  return En.some((t) => t === e);
}
function Qs(e) {
  let t = yt(e);
  for (let r of En) {
...
function Gs(e, t, r, s, i) {
  let o = t.to.parentid;
  if (!o) return !1;
  let d = e.get(o);
  return !d || (_t(d) && !d.isLoaded()) || r.getParentId(t.id) === q
    ? !1
...
function Mt(e, t, r, s, i, o, d, T) {
  ...
  let { children: _, parentid: p, id: A, ...C } = h,
...
function zs(e, t, r, s, i) {
  ...
  for (; _.length > 0;) {
    ...
    for (let A of _) {
      ...
      if (A.added) {
        if (e.has(C)) ae(e, C, A, !0);
        else if (bt(e, C, A.added, A.to, A.position) && r && !o)
          for (let D of r.getChildrenIds(C))
            d.has(D) || (r.getParentId(D) !== q && Mt(e, D, C, void 0, r, d, void 0, s));
      } else ae(e, C, A, !0);
    }
    if (p.length === 0 || p.length === _.length) break;
    _ = p;
  }
  for (let p of T) {
    ...
    let S = e.get(A);
    if (!S && o) continue;
    let D = S ? null : s?.get(A),
      I = S ?? D;
    if (!I) {
      F(r, "Store must be defined to write data-only changes");
      let x = Qs(nn(p.to, q));
      r.updateNestedObject([A, "replicaInfo", "overrides", C], x);
      continue;
    }
  ...
  let o = t
    .map((d) => {
      let T = d.id,
        ...
        p = d.to,
        A = d.from;
      if (!A) throw Error("Changes cannot be reversed if they lack the 'from' field.");
...
function be(e, t, r) {
  return (
    ...
    Zt(e) || j(e) ? r(e) : { type: "LiteralValue", value: mt(t, void 0) }
  );
}
function $s(e, t, r, s) {
  function i(o) {
  ...
  switch ((F(rt(e.name), `Transform is not a valid expression: ${e.name}`), e.name)) {
    ...
    case "convertFromEnum": {
      if (r?.type !== "enum") return { type: "LiteralValue", value: mt(e.outputType, void 0) };
      let o = new Set(),
        d = [];
...
function Zs(e, t, r, s, i, o) {
  ...
  let d = e.collectionFilters.filters,
    T = [];
  for (let { itemKey: p, transforms: A } of d) {
    let I = function (R) {
      return (Js(R, t) && D.push(R), i(R));
    };
    var _ = I;
    if (!p) continue;
    let S = t?.get(e.getPrimaryId())?.get(p);
    if (!S || (r.add(p), S.type !== "boolean" && A.length === 0)) continue;
    let D = [],
      O = A.some((R) => {
      ...
      x = Me(p, S, r, s, o, O);
    for (let R of A) nt(R.name) && (x = $s(R, x, S, I));
    T.push({ expression: x, optionalVariables: D });
  }
  let h = e.collectionFiltersOperator ?? br;
  switch (h) {
    case "all":
      return ei(T, i);
    case "any":
...
function ei(e, t) {
  if (e.length !== 0)
    return e.reduce(
      (r, s) => {
        let i = ri(s.expression, s.optionalVariables, t);
...
function ti(e, t) {
  ...
  let r = e.reduce(
    (o, d) => {
      let T = ni(d.expression, d.optionalVariables, t);
...
function oi(e, t, r, s, i) {
  ...
  for (let T of r) {
    ...
    for (let _ = 1; _ < h.length; _++) {
      let p = h.slice(0, _).join("."),
        A = t.get(p);
      if (A?.type !== "collectionreference") continue;
      let C = A.dataIdentifier;
      d.set(p, C);
    }
  }
  for (let [T, h] of d) {
...
function yl(e, t, r, s, i) {
  let o = {},
    d = new Set(),
    T = qs(e);
  e.collectionFilters && (o.where = Zs(e, t, d, T, s, i));
  let h = t.get(e.getPrimaryId());
  F(h, "Control map of repeater must exist");
  let _ = ii(e, h, d, T, s, i);
  (_.length > 0 && (o.orderBy = _),
  ...
  let p = ci(h, r, d, T, i);
  return { from: oi(e.dataIdentifier, h, d, T, i), select: p, ...o };
}
...
function $(e) {
  var t;
  return (t = li.get(e)) !== null && t !== void 0 ? t : n.UNKNOWN;
}
var m = n,
  hn = {
    [f.HTML]: new Set([
  ...
  Ml = new Set([E.STYLE, E.SCRIPT, E.XMP, E.IFRAME, E.NOEMBED, E.NOFRAMES, E.PLAINTEXT]);
var B = {
  createDocument() {
...
function xe(e) {
  return (e >= 64976 && e <= 65007) || Ti.has(e);
}
var u;
(function (e) {
  ...
  Fe = class {
    ...
    _processSurrogate(t) {
      if (this.pos !== this.html.length - 1) {
        ...
        if (fn(r)) return (this.pos++, this._addGap(), mn(t, r));
...
function _n(e) {
  return An(e) || e === a.SOLIDUS || e === a.GREATER_THAN_SIGN;
}
function pi(e) {
  return e === a.NULL
...
var le = class {
  ...
  _emitCodePoint(t) {
    let r = An(t) ? N.WHITESPACE_CHARACTER : t === a.NULL ? N.NULL_CHARACTER : N.CHARACTER;
  ...
  _stateScriptDataDoubleEscapeStart(t) {
    if (this.preprocessor.startsWith(k.SCRIPT, !1) && _n(this.preprocessor.peek(k.SCRIPT.length))) {
      this._emitCodePoint(t);
  ...
  _stateCharacterReference() {
    ...
    t === 0
      ? ((this.preprocessor.pos = this.entityStartPos),
        ...
        (this.state =
          !this._isCharacterReferenceInAttribute() && pn(this.preprocessor.peek(1))
...
var gn = new Set([n.DD, n.DT, n.LI, n.OPTGROUP, n.OPTION, n.P, n.RB, n.RP, n.RT, n.RTC]),
  Cn = new Set([...gn, n.CAPTION, n.COLGROUP, n.TBODY, n.TD, n.TFOOT, n.TH, n.THEAD, n.TR]),
  ve = new Set([n.APPLET, n.CAPTION, n.HTML, n.MARQUEE, n.OBJECT, n.TABLE, n.TD, n.TEMPLATE, n.TH]),
  _i = new Set([...ve, n.OL, n.UL]),
  Ai = new Set([...ve, n.BUTTON]),
  Nn = new Set([n.ANNOTATION_XML, n.MI, n.MN, n.MO, n.MS, n.MTEXT]),
  In = new Set([n.DESC, n.FOREIGN_OBJECT, n.TITLE]),
  Ci = new Set([n.TR, n.TEMPLATE, n.HTML]),
  Ni = new Set([n.TBODY, n.TFOOT, n.THEAD, n.TEMPLATE, n.HTML]),
  Ii = new Set([n.TABLE, n.TEMPLATE, n.HTML]),
  gi = new Set([n.TD, n.TH]),
  we = class {
    ...
    hasInListItemScope(t) {
      return this.hasInDynamicScope(t, _i);
    }
    hasInButtonScope(t) {
    ...
    generateImpliedEndTags() {
      for (; this.currentTagId !== void 0 && gn.has(this.currentTagId);) this.pop();
    }
    generateImpliedEndTagsThoroughly() {
      for (; this.currentTagId !== void 0 && Cn.has(this.currentTagId);) this.pop();
    }
    generateImpliedEndTagsWithExclusion(t) {
      for (; this.currentTagId !== void 0 && this.currentTagId !== t && Cn.has(this.currentTagId);)
        this.pop();
    }
  };
var U;
  ...
  Ye = class {
    ...
    _getNoahArkConditionCandidates(t, r) {
      ...
      for (let T = 0; T < this.entries.length; T++) {
        ...
        if (h.type === U.Marker) break;
        let { element: _ } = h;
        if (this.treeAdapter.getTagName(_) === o && this.treeAdapter.getNamespaceURI(_) === d) {
...
var On = "html",
  ...
  Oi = [...Dn, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"],
  Di = new Set([
    "-//w3o//dtd w3 html strict 3.0//en//",
    "-/w3c/dtd html 4.0 transitional/en",
    "html",
  ]),
  Ln = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"],
  Li = [...Ln, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"];
function Sn(e, t) {
  return t.some((r) => e.startsWith(r));
}
function Pn(e) {
  return e.name === On && e.publicId === null && (e.systemId === null || e.systemId === Ri);
}
function yn(e) {
  if (e.name !== On) return M.QUIRKS;
  let { systemId: t } = e;
  if (t && t.toLowerCase() === Si) return M.QUIRKS;
  let { publicId: r } = e;
  if (r !== null) {
    if (((r = r.toLowerCase()), Di.has(r))) return M.QUIRKS;
    let s = t === null ? Oi : Dn;
    if (Sn(r, s)) return M.QUIRKS;
    if (((s = t === null ? Ln : Li), Sn(r, s))) return M.LIMITED_QUIRKS;
  }
  return M.NO_QUIRKS;
}
...
function kn(e, t, r, s) {
  return ((!s || s === f.HTML) && Hi(e, t, r)) || ((!s || s === f.MATHML) && Fi(e, t));
}
var Ui = "hidden",
  vi = 8,
  wi = 3,
...
var Yi = { startLine: -1, startCol: -1, startOffset: -1, endLine: -1, endCol: -1, endOffset: -1 },
  vn = new Set([n.TABLE, n.TBODY, n.TFOOT, n.THEAD, n.TR]),
  Fn = { scriptingEnabled: !0, sourceCodeLocationInfo: !1, treeAdapter: B, onParseError: null },
  pe = class {
    ...
    _err(t, r, s) {
      ...
      let o = (i = t.location) !== null && i !== void 0 ? i : Yi,
        d = {
          code: r,
    ...
    _insertCharacters(t) {
      ...
      if (this.treeAdapter.getNodeSourceCodeLocation(d)) {
        let { endLine: h, endCol: _, endOffset: p } = t.location;
        this.treeAdapter.updateNodeSourceCodeLocation(d, { endLine: h, endCol: _, endOffset: p });
      } else
        this.options.sourceCodeLocationInfo &&
    ...
    onEndTag(t) {
      ((this.skipNextNewLine = !1),
        (this.currentToken = t),
        this.currentNotInHTML ? Co(this, t) : this._endTagOutsideForeignContent(t));
    }
...
function Ut(e, t) {
  for (let r = 0; r < vi; r++) {
    ...
    let o = Ki(e, i, s.element),
      d = e.openElements.getCommonAncestor(s.element);
    (e.treeAdapter.detachNode(o), d && Gi(e, d, o), Xi(e, i, s));
  }
}
function Ft(e, t) {
...
function qi(e, t) {
  ...
  let r = t.forceQuirks ? M.QUIRKS : yn(t);
  (Pn(t) || e._err(t, u.nonConformingDoctype),
...
function fe(e, t) {
  let r = t.type === N.EOF ? u.openElementsLeftAfterEof : u.disallowedContentInNoscriptInHead;
...
function Wn(e) {
  let t = He(e, V.TYPE);
  return t != null && t.toLowerCase() === Ui;
}
function Na(e, t) {
  (e._reconstructActiveFormattingElements(),
    e._appendElement(t, f.HTML),
...
function Ra(e, t) {
  ((t.tagName = E.IMG), (t.tagID = n.IMG), Vn(e, t));
}
function Sa(e, t) {
  (e._insertElement(t, f.HTML),
    (e.skipNextNewLine = !0),
...
function y(e, t) {
  switch (t.tagID) {
    ...
    case n.NOSCRIPT: {
      e.options.scriptingEnabled ? Hn(e, t) : Un(e, t);
      break;
    }
    case n.PLAINTEXT: {
      ha(e, t);
...
function xa(e, t) {
  e.openElements.hasInScope(n.BODY) && ((e.insertionMode = l.AFTER_BODY), Zn(e, t));
}
function Fa(e, t) {
  let r = t.tagID;
...
function Qn(e, t) {
  e.tmplInsertionModeStack.length > 0 ? Jn(e, t) : vt(e, t);
}
function Ka(e, t) {
  var r;
  (t.tagID === n.SCRIPT &&
...
function xt(e, t) {
  if (e.openElements.currentTagId !== void 0 && vn.has(e.openElements.currentTagId))
    switch (
...
function Ja(e, t) {
  (Wn(t) ? e._appendElement(t, f.HTML) : Ae(e, t), (t.ackSelfClosing = !0));
}
function Za(e, t) {
  !e.formElement &&
    e.openElements.tmplCount === 0 &&
...
var zn = new Set([n.CAPTION, n.COL, n.COLGROUP, n.TBODY, n.TD, n.TFOOT, n.TH, n.THEAD, n.TR]);
function eo(e, t) {
  let r = t.tagID;
  zn.has(r)
...
function so(e, t) {
  ...
  switch (r) {
    ...
    case n.THEAD:
    case n.TR: {
      e.openElements.hasInTableScope(r) && (e._closeTableCell(), jn(e, t));
      break;
    }
    case n.BODY:
    case n.CAPTION:
...
function Ao(e, t) {
  if (Mn(t)) (es(e), e._startTagOutsideForeignContent(t));
  else {
    let r = e._getAdjustedCurrentElement(),
      s = e.treeAdapter.getNamespaceURI(r);
    (s === f.MATHML ? Bt(t) : s === f.SVG && (Bn(t), kt(t)),
      Ve(t),
...
function Io(e) {
  return !K(e) || e.type !== "object"
    ...
    : e.value === null
      ? !0
      : Object.values(e.value).every(No);
}
function Rd(e) {
  return er(e) && e.every((t) => fr(t) && Io(t));
}
var go = /^(.*?)(?:([^/])\.([^/.]+))?$/;
function Od(e) {
  let t = e.match(go);
...
var Ro = "data-framer-link",
  ns = "data-framer-open-in-new-tab",
  ss = "data-framer-smooth-scroll",
  So = "data-framer-click-tracking-id",
  is = "data-framer-rel",
  Oo = "data-framer-preserve-params",
  Do = "framer-module",
  Lo = "data-module-identifier",
  Po = "data-module-props",
  yo = "data-module-width",
  bo = "data-module-alignment",
  Mo = /\s+/u;
function qe(e, t) {
  let r = ts(e),
...
function ko(e) {
  ...
  switch (e.tagName) {
    ...
    case "img":
      return as(t, "image");
    case "video":
      return Yt(t, "framer-image") || t.get("src") ? as(t, "video") : void 0;
    case Do:
    case "template":
      return vo(t);
    case "table":
...
function Fo(e, t, r) {
  return { id: L(), type: "bulletedList", textDirection: Kt(t, r), childNodes: Es(e) };
}
function Ho(e, t, r) {
...
function as(e, t) {
  ...
  if (t === "image") {
    let i = e.get("alt");
    i !== void 0 && (r.alt = i);
    let o = Ts(e.get("data-framer-width"));
    o !== void 0 && (r.pixelWidth = o);
    let d = Ts(e.get("data-framer-height"));
...
function Yo(e) {
  let t = [];
  for (let r of ne(e)) (r.tagName !== "td" && r.tagName !== "th") || t.push(Vo(r));
...
function hs(e) {
  ...
  if (r === void 0) return;
  let s = re(e.get(is)) ?? re(e.get("rel")) ?? cs(e.get("rel")) ?? cs(e.get(is)) ?? [],
    i = {
      id: L(),
      link: r,
      openInNewTab: re(e.get(ns)) ?? ds(e.get(ns)),
      smoothScroll: re(e.get(ss)) ?? ds(e.get(ss)),
      relValues: s,
    },
    o = e.get(So);
...
function zo(e, t) {
  ...
  return (i && fs(Ce(i).get("style")).get("list-style-type")) || "decimal";
}
function re(e) {
...
function $o(e) {
  return !qo(e) || typeof e.type != "string"
    ? !1
    : e.type === "url"
      ? typeof e.url == "string"
      : e.type === "webPage"
...
function eT(e) {
  return typeof e == "string"
    ? it(e)
    : H(e)
      ? mr(ee(e), { preserveTrailingEmptyBlockNewLine: !0 })
      : "";
}
function ms(e) {
  return typeof e == "string" ? it(e).length === 0 : H(e) ? !Jo(ee(e)) : !0;
}
function Jo(e) {
  return (
    Br(e, {
...
var Xt = "[a-z1-9]+(?:-[a-z1-9]+)*",
  tc = `${Xt}="[^"]*"`,
  rc = String.raw`(?:\s+${tc})*`,
  nc = String.raw`<${Xt}${rc}\s*>`,
  sc = `(?:${nc})+`,
  ic = String.raw`<\/\s*${Xt}\s*>`,
  ac = `(?:${ic})+`,
  oc = "[^<>]*",
  _s = String.raw`\s*`,
  cc = new RegExp(`^${_s}${sc}${oc}${ac}${_s}$`, "iu");
function _T(e) {
  return H(e)
    ? lc(e)
    ...
    if (ht(I)) {
      ...
      for (let b of I.marks)
        ((O ||= lt(b)),
          ...
          Ir(b) && (R = b.attrs.inlineStyles));
      (_.push(Y), p.push(X), O && T.push(R), x && h.push(R));
    }
  });
  let A = ft(Ec(t, r), r),
    C = A.tr,
    S = new Map();
  A.doc.descendants((I, O, x) => {
    if (ut(I)) {
      let R = i[I.attrs.tag] ?? [],
    ...
    if (ht(I)) {
      ...
      for (let Z of I.marks) {
        if (((R ||= lt(Z)), (Y ||= Et(Z)), dt(Z))) {
          ...
          C.addMark(O, O + I.nodeSize, r.marks.link.create({ ...Z.attrs, linkStylePreset: Ze }));
        }
        if (Tt(Z)) {
      ...
      (R && (X = T.length > 1 ? T.shift() : T[0]),
        ...
        X && C.addMark(O, O + I.nodeSize, r.marks.inlineStyles.create({ inlineStyles: X })));
      let b = _.length > 1 ? _.shift() : _[0];
      b && C.addMark(O, O + I.nodeSize, r.marks.backgroundMask.create(b));
      let zt = p.length > 1 ? p.shift() : p[0];
      zt && C.addMark(O, O + I.nodeSize, r.marks.backgroundStyles.create(zt));
    }
  });
  let D = A.apply(C);
  return Sr(D.doc, r);
...
function Ec(e, t) {
  return typeof e == "string" ? e : Or(e, t);
}
function VT(e, t) {
...
function QT(e) {
  return typeof e == "string" ? e === "" || uc.test(e) : ms(e);
}
export {
  nn as a,
  Pe as b,
...
//# sourceMappingURL=chunk-ICIRI2RL.mjs.map
