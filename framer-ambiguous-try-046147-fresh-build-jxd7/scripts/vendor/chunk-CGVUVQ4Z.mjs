import { d as z } from "chunk-JVZZSDAN.mjs";
...
function Ie(e) {
  return c(e)
    ? {
        provider: se(e.provider) ? e.provider : t.provider,
...
var Me = { low: 1024, medium: 2048, high: 4096 };
function Se(e, n) {
  if (C(e)) return Fe(n);
  switch (e) {
    case "enabled":
...
function dn(e, n) {
  if (!(C(e) || !L(n) || !Pe(e))) return { verbosity: e };
}
var X = "effort";
function mn(e, n) {
  let a = Se(e, n);
...
function Tn(e = f) {
  return be(e) !== void 0 || ye(e) !== void 0 || ke(e) !== void 0;
}
function ve(e) {
  return e * 1024 * 1024;
}
...
async function kn({
  ...
  if (a.size > E) {
    if (E < K && B) B(a.size);
      ...
      let l = new Intl.NumberFormat("en", { style: "unit", unit: "megabyte" }).format(M ?? K / I);
      g({
        type: "add",
        key: h,
        variant: "error",
...
//# sourceMappingURL=chunk-CGVUVQ4Z.mjs.map
