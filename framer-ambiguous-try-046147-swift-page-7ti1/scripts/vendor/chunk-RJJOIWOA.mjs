import { b as L, c as V, d as W } from "chunk-4GRAV26W.mjs";
import { a as o } from "chunk-HW3SIB37.mjs";
import { a as n, b as T } from "chunk-HZOFQ3CX.mjs";
import { a as c, b as r, c as e } from "chunk-INI2PL3A.mjs";
import { a as S, b as R, c as f } from "chunk-ISW56VHA.mjs";
import { a as O } from "chunk-QFU6OGL3.mjs";
import { a as M } from "chunk-2FCXHKEL.mjs";
import { a as lr } from "chunk-SWYZG2NI.mjs";
import { b as F } from "chunk-4JY5UMT2.mjs";
import { e as C } from "chunk-WLHSDIGQ.mjs";
var i = C(lr());
var s = "shadow";
var nr = (t) => (t === "light" ? e : o),
  sr = (t) =>
...
var g = "0px 3px 6px 0px rgba(0, 0, 0, 0.08)",
  ...
  b = `inset 0px 0px 0px 1px ${c(r.white100, 0.07)}`;
var pr = { popoverInset: b },
  ur = { tokens: pr, scope: s },
  q = f([ur]);
var Br = {
  ...
  xr = { tokens: br, scope: n },
  N = f([xr]),
  Tr = { tokens: Br, scope: n },
  hr = { tokens: kr, scope: s },
  Q = f([Tr, hr]);
var vr = { tooltipBackground: r.dark81 },
  Cr = { tokens: vr, scope: n },
  J = f([Cr]);
var P = {
    light: a(
      "light",
      ...
      {
        inputBorderActive: e.warningTint,
    ...
    dark: a(
      ...
      {
        inputBorderActive: o.warningTint,
        selectionBackground: "color(display-p3 1 0.733 0 / 0.15)",
      }
    ),
  },
  D = {
    light: a(
      "light",
      { [e.tint]: e.tint, [e.inputBorder]: e.inputBorder, [e.tintDimmed]: e.tintDimmed },
      { inputBorderActive: e.inputBorderActive }
    ),
    dark: a(
      "dark",
      { [o.tint]: o.tint, [o.inputBorder]: o.inputBorder, [o.tintDimmed]: o.tintDimmed },
      { inputBorderActive: o.inputBorderActive }
    ),
  };
var X = {
...
var A = i.default.createContext(void 0);
A.displayName = "BaseThemeContext";
var H = i.default.createContext(void 0);
H.displayName = "ThemeOverrideModeContext";
function cr() {
  return i.default.useContext(A);
}
function fr() {
  return i.default.useContext(H);
}
var ar = i.default.forwardRef(function ({ mode: m, children: l, className: B, ...k }, p) {
    let x = fr(),
      d = cr(),
      v = m || x || d,
      tr = Ir(v) ? or[v] : void 0;
    return (0, u.jsx)(H.Provider, {
      value: v,
      children: (0, u.jsx)("div", { ref: p, className: O(er, tr, B), ...k, children: l }),
    });
  }),
  oe = i.default.memo(function ({ mode: m, children: l }) {
    let B = cr();
    return (
      F(
        B === void 0,
      ...
      (0, u.jsx)(A.Provider, { value: m, children: (0, u.jsx)(ar, { children: l }) })
    );
  }),
  ee = i.default.memo(function ({ children: m }) {
    let l = fr();
    return (0, u.jsx)(ar, { mode: l === "warning" ? "warningReset" : l, children: m });
  });
export { Mo as a, cr as b, fr as c, ar as d, oe as e, ee as f };
//# sourceMappingURL=chunk-RJJOIWOA.mjs.map
