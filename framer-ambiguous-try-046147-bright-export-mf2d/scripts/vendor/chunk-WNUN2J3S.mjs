import { e as F } from "chunk-6RIBVZ4H.mjs";
import {
  De as N,
  E as pe,
  Hd as fe,
...
import { Ln as ae, Vi as se, mp as le } from "chunk-UJD34LBT.mjs";
import {
  $j as E,
  Ci as A,
  Fi as R,
...
function ue(t) {
  if (!ce(t) || t === null) throw Error("Invalid document.");
...
function he(t, e = []) {
  let o = t.children,
    n = o.find(we);
  n === void 0 &&
    (e.push(`${t.id}: Root does not contain a page`), (n = new pe({ id: de(t) })), o.push(n));
...
//# sourceMappingURL=chunk-WNUN2J3S.mjs.map
