import { d as z } from "chunk-OB2IQCY3.mjs";
import { b as w, i as f } from "chunk-G5MFIWCZ.mjs";
...
function Ae(e) {
  return c(e)
    ? {
        provider: oe(e.provider) ? e.provider : t.provider,
...
var j = [
  ...
  T = re,
  $e = j.map((e) => e.languageModel),
  k = new Map(T.map((e) => [e.languageModel, e]));
function p(e) {
  return k.has(e);
}
function Qe(e, n) {
...
function Te(e, n) {
  ...
  switch (e) {
    ...
    case "high": {
      ...
      return L(n) ? { enabled: !0 } : { effort: e, enabled: !0 };
    }
    case "max":
      return { effort: e, enabled: !0 };
    case "xhigh":
...
function un(e, n) {
  if (!(C(e) || !L(n) || !Ge(e))) return { verbosity: e };
}
var q = "effort";
function dn(e, n) {
  let a = Te(e, n);
...
function pn(e, n) {
  if (n) {
    if (X[e]) return "fast";
    if (Z[e]) return "priority";
  }
}
var Me = Se["openai/gpt-5.6-sol"];
function s(e, n, a) {
  return { multiplier: n, description: { name: e, body: a(`${n}\xD7`, Me) } };
}
var _ = {
...
function i(e) {
  return { allowedFileTypes: ["image/*"], maxAttachments: Y, totalSizeLimit: J, ...e };
}
var A = {
  "openai/gpt-5.1": i(),
  "openai/gpt-5.2": i(),
...
function Cn(e = f) {
  return xe(e) !== void 0 || Oe(e) !== void 0 || we(e) !== void 0;
}
function be(e) {
  return e * 1024 * 1024;
}
...
async function yn({
  ...
  if (a.size > E) {
    if (E < K && B) B(a.size);
      ...
      let l = new Intl.NumberFormat("en", { style: "unit", unit: "megabyte" }).format(S ?? K / I);
      g({
        type: "add",
        key: h,
        variant: "error",
  ...
  try {
    ...
    F = !0;
    let x = l instanceof Error ? (ne?.(l) ?? l.message) : String(l),
      d = ee(x.trim()),
...
//# sourceMappingURL=chunk-ZE4XHD75.mjs.map
