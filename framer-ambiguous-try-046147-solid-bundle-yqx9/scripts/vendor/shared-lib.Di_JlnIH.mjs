  ...
  vo = t(() => {
    (h(),
      ...
      (go = be(
        ...
        [
          `.framer-FcX9Q.framer-lux5qc, .framer-FcX9Q .framer-lux5qc { display: block; }`,
          `.framer-FcX9Q.framer-72rtr7 { background: linear-gradient(180deg, #26fcbc 20.078461745689655%, rgb(3, 196, 255) 100%); height: 1000px; overflow: var(--overflow-clip-fallback, clip); position: relative; width: 1200px; }`,
          `.framer-FcX9Q .framer-yb0cla { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; flex: none; height: auto; left: 50%; position: absolute; top: 126px; transform: translateX(-50%); white-space: pre; width: auto; }`,
          `.framer-FcX9Q .framer-ltqj2q { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; flex: none; height: auto; left: 50%; position: absolute; top: 242px; transform: translateX(-50%); white-space: pre; width: auto; }`,
        ],
        `framer-FcX9Q`
      )),
      (go.displayName = `Home`),
...
//# sourceMappingURL=shared-lib.Di_JlnIH.mjs.map
