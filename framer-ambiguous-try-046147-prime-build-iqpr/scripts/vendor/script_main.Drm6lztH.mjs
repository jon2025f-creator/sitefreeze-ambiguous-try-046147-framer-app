  ...
  let g = y(z, {
    children: y(L, {
      children: y(I, {
        ...
        framerSiteId: J,
        notFoundPage: k(() => import(`./shared-lib.BjnZf-aG.mjs`).then((e) => (e.i(), e.r))),
        ...
        loadSnippetsModule: new F(
          () => import(`./aohXcfCEH7eLshUz3Ru8hwERbjwVtxq5cCDnwgn579k.aI2pNhfT.mjs`)
        ),
...
e(() => {
  if (
    ...
    (W = {
      augiA20Il: {
        elements: {},
        page: k(() => import(`./saWEnytdNcncwWxq4I4s0VLE7bWbKw5he3D4XtJ0mpE.Dr60vheW.mjs`)),
        path: `/`,
      },
    }),
    ...
    (K = {}),
    (q = void 0),
    (J = `b77e50deb4ed244889d5b6af0ef30960e74b60971089cf84e31d8a41a798e135`),
    (Y = typeof document < `u`),
    ...
    Y &&
      l(() => {
        v(
          ...
          y(m, {}, y(g(() => import(`./shared-lib.BjnZf-aG.mjs`).then((e) => (e.n(), e.t)))))
        );
      });
  })();
})();
export { V as getPageRoot };
//# sourceMappingURL=script_main.Drm6lztH.mjs.map
