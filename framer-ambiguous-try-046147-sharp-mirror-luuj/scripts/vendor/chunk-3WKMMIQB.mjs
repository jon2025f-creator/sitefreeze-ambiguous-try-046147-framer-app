...
var e = r((K, f) => {
  "use strict";
  var m = function (u) {
    if (u === void 0) throw new Error("invariant(...): Second argument must be a string.");
  };
  function G(u, A) {
    for (var F = arguments.length, E = new Array(F > 2 ? F - 2 : 0), i = 2; i < F; i++)
      E[i - 2] = arguments[i];
    if ((m(A), !u)) {
      var D;
      if (A === void 0)
...
var s = r((Q, g) => {
  ...
  function v(u) {
    return (o(u) || n(!1), u === a ? "ltr" : "rtl");
  }
  function U(u, A) {
    return (o(u) || n(!1), o(A) || n(!1), u === A ? null : v(u));
  }
  function d(u) {
    t = u;
  }
  ...
  function O() {
    return (t || this.initGlobalDir(), t || n(!1), t);
  }
  var M = {
    NEUTRAL: S,
    LTR: a,
...
var h = r((W, p) => {
  ...
  var B = s(),
    ...
    H = new RegExp("[" + C.L + C.R + C.AL + "]"),
    q = new RegExp("[" + C.R + C.AL + "]");
  function L(u) {
    var A = H.exec(u);
  ...
  function T(u) {
    var A = L(u);
    return A == null ? B.NEUTRAL : q.exec(A) ? B.RTL : B.LTR;
  }
  function R(u, A) {
    if (((A = A || B.NEUTRAL), !u.length)) return A;
    var F = T(u);
    return F === B.NEUTRAL ? A : F;
  }
  function c(u, A) {
    return (A || (A = B.getGlobalDir()), B.isStrong(A) || V(!1), R(u, A));
  }
  function I(u, A) {
    return c(u, A) === B.LTR;
  }
...
var J = r(($, x) => {
  ...
  function N(u, A, F) {
    return (
      A in u
        ? Object.defineProperty(u, A, { value: F, enumerable: !0, configurable: !0, writable: !0 })
        : (u[A] = F),
      u
    );
  }
    ...
    Z = (function () {
      function u(F) {
        (N(this, "_defaultDir", void 0),
          ...
          F ? b.isStrong(F) || z(!1) : (F = b.getGlobalDir()),
          (this._defaultDir = F),
          this.reset());
      }
      var A = u.prototype;
      return (
        ...
        (A.getDirection = function (E) {
          return ((this._lastDir = Y.getDirection(E, this._lastDir)), this._lastDir);
        }),
        u
      );
    })();
