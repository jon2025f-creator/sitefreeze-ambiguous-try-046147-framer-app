import { D as le, l as We } from "chunk-VJYACAJ6.mjs";
import { a as ee } from "chunk-SPWSWTND.mjs";
import { c as Be } from "chunk-SO5ON6VP.mjs";
import { a as Ge } from "chunk-VIXMWY7O.mjs";
import { o as Ve } from "chunk-QSKUF35U.mjs";
import { be as Q, u as Ae, ue as J } from "chunk-L2NAOVBC.mjs";
import { b as Y } from "chunk-BI7NXQR7.mjs";
import { a as Ce } from "chunk-TP3OWBPX.mjs";
import {
  Bk as ze,
  Di as De,
  Fw as Fe,
...
import { g as Re } from "chunk-HFUJNNAN.mjs";
...
import { f as X, g as Z, h as K, k as H } from "chunk-VHFKZWVR.mjs";
import { i as _ } from "chunk-VJ7UYMJI.mjs";
var N = _("PartialTreeReceiver"),
  $e = class {
    constructor(e) {
      this.componentLoader = e;
      (Be(Ae), (this.tree = J.createWithRouteSegmentRoot()));
    }
    componentLoader;
    name = "uninitialized";
    tree;
  ...
  Xe = class {
    ...
    processRenderMainImage = () => {
      ...
      for (let t of this.scheduledRenderings) {
        ...
        if (n && (this.renderImage(n), n.show !== 0 && (e++, e > it))) break;
      }
...
var G = new DOMMatrixReadOnly(),
  te = class {
      ...
      return (
        [...o, e].forEach((c) => {
          let l = this.getSize(c),
            ...
            U = y.fromPoints(y.points(m).map((rt) => t.transformPoint(rt))),
            { x: k, y: v, matrix: O } = Ge(a, C, U, g),
            D = M(j(k + b), j(v + I)),
            W = n ? f.x : 0,
            A = n ? f.y : 0,
            ...
            { rect: E, paintDelta: $, translation: P } = yt(i, D, l, h, F, f),
            z = dt(F, q, f, D, w);
          ((i.x += z.x),
            (i.y += z.y),
            (i.paintX += $.x),
    ...
    getTransformAncestors(e) {
      let t = [],
        n = e.parentElement;
      for (; !be(n) && !_e(n) && n !== e.ownerDocument?.documentElement;)
...
function ft({ x: s, y: e, width: t, height: n }, r) {
...
function pt({ x: s, y: e, width: t, height: n }, r, o) {
...
function gt(s, e, { width: t, height: n }, r) {
  let { rotation: o, translation: i } = Ie(r),
    a = M(e.x - i.x, e.y - i.y),
    u = s.x + T(a.x),
    d = s.y + T(a.y),
...
function yt(s, e, t, n, r, o) {
  ...
  if (K()) {
    ...
    if (r) {
      let { paintedRect: I, snappedLayoutRect: p, translation: R } = ft(d, n),
  ...
  if (Z() || X()) {
    let f = ne(d),
      b = y.offset(f, { x: u.x + a.x, y: u.y + a.y });
    if (r) {
      let { paintedRect: I, snappedLayoutRect: p, translation: R } = pt(d, n, o),
        C = y.offset(I, { x: u.x + a.x, y: u.y + a.y }),
        g = y.offset(p, R);
      return ((i = { x: g.x - I.x, y: g.y - I.y }), { rect: C, paintDelta: i, translation: R });
    }
  ...
  et = class {
    ...
    process({ scopeId: e, zoom: t, offsetX: n, offsetY: r, tree: o, groundNodesInViewport: i }) {
      this.previousScopeNodeId !== e &&
        ...
        tt(o.get(this.previousScopeNodeId)),
        (this.previousScopeNodeId = e),
      ...
      if (
        ...
        (u || a) && t > Je && this.processRefinementRequests(c),
        S.trace("process:", this.size()),
        this.size() === 0)
      )
        return [];
      let l = Ct.scale(t).translateSelf(-n, -r),
        m = [],
        h = new Map(),
        f = new te();
      ...
      let b = xt(this.measureRequests.values(), o, l),
        I = new Set();
      for (let [p, R] of this.measureRequests) {
...
function xt(s, e, t) {
  ...
  for (let { nodeId: o } of s) {
    ...
    n.set(o, { id: d?.id, matrix: i, rect: d ? qe(d) : null });
  }
  return n;
}
function tt(s) {
...
function kn(s, e, t) {
  ...
  try {
    ...
    return e.errorControlProp ? nt(s, e.errorControlProp) : n;
  }
}
export { $e as a, Ot as b, Xe as c, Pn as d, nt as e, kn as f, je as g, et as h };
//# sourceMappingURL=chunk-7LKNV2F4.mjs.map
