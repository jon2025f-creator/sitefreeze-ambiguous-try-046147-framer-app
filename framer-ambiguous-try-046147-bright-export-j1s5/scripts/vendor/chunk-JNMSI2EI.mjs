import { D as le, l as $e } from "chunk-C5RPNOOH.mjs";
import { a as ee } from "chunk-SPWSWTND.mjs";
import { c as Ge } from "chunk-HLXA44R3.mjs";
import { a as We } from "chunk-24GZ7APG.mjs";
import { o as Be } from "chunk-YAK3Q3YF.mjs";
import { De as Q, ke as K, u as Fe } from "chunk-AMN7HW25.mjs";
import { b as Y } from "chunk-RAQLVEMS.mjs";
import { a as Ce } from "chunk-YHDRMICA.mjs";
import {
  Fk as ze,
  Hi as De,
  Pw as He,
...
var N = _("PartialTreeReceiver"),
  Xe = class {
    constructor(e) {
      ...
      (Ge(Fe), (this.tree = Q.createWithRouteSegmentRoot()));
    }
    componentLoader;
    name = "uninitialized";
    tree;
...
function Lt(s) {
  ...
  for (let t of s) {
    ...
    (Ae(t) && Object.assign(i, { outputs: JSON.parse(JSON.stringify(t.outputs)) }),
      t.type === "shader" &&
        Oe(n) &&
        Object.assign(i, {
          fragment: n.fragment,
...
var Ue = class {
  ...
  async getHiddenStateForModuleControls({ moduleIdentifier: e, controlNames: t, moduleProps: n }) {
    ...
    return _e(t ?? Object.keys(r), r, He(r, n, o));
  }
};
...
//# sourceMappingURL=chunk-JNMSI2EI.mjs.map
