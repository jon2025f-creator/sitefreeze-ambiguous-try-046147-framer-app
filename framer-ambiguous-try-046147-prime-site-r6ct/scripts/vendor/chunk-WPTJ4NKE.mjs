import {
  ...
  l as F,
  m as xe,
} from "chunk-D57NLMK3.mjs";
import { b as oe } from "chunk-2FDBUZ2H.mjs";
import { n as ie, o as ae } from "chunk-P55GOYYS.mjs";
import { b as ne } from "chunk-WPWSHZF5.mjs";
import { a as fe } from "chunk-OGQCKB6U.mjs";
import { a as me } from "chunk-EUSLTDZF.mjs";
import { a as re } from "chunk-K6L5GVTR.mjs";
import { b as se } from "chunk-P6Q3LWLD.mjs";
import { b as ce } from "chunk-TS24LVSZ.mjs";
import { b as V } from "chunk-H44I2EDG.mjs";
import { b as $, d as te } from "chunk-TQKBBB5D.mjs";
import { b as ee } from "chunk-3PIOJLHR.mjs";
import { b as X } from "chunk-R2DMEYVU.mjs";
import { f as H } from "chunk-7EKSSWIK.mjs";
...
var Ve = { Alt: !0, Control: !0, Meta: !0, Shift: !0 };
function k(e, t, r) {
  let n = [...e];
  return ((n[t] = r), j(n));
}
...
function je(e) {
  ...
  (e.altKey && t.push("Alt"),
    ...
    e.shiftKey && !De.test(e.key) && t.push("Shift"));
...
function zt(e) {
  ...
  let g = l?.itemsWhenEnded ?? t,
    ...
    B = !!P,
    Se = v.default.useCallback(
      (s) => {
        if (!l || !h.current) return;
        let p;
        if (et(s.client, h.current)) p = B ? null : l.index;
        else {
          let u = D.add(s.client, s.centerOfGravityOffset);
          p = tt(u, h.current, l);
        }
...
var lt = { x: -V.values.tooltipOffset, y: V.values.tooltipOffset * 2 };
...
//# sourceMappingURL=chunk-WPTJ4NKE.mjs.map
