...
var N = ({ size: r, inline: h = !1, className: u, ...z }) => {
  let n = r ?? "normal",
    { viewBoxSize: t, innerPathSize: g } = w(n),
    s = t / 2,
    i = g / 2;
  return (0, e.jsx)("div", {
    className: l(u, p, k(n), !h && b),
    ...z,
    children: (0, e.jsxs)("svg", {
      ...
      "aria-hidden": "true",
      children: [
        (0, e.jsx)("circle", { className: m, cx: s, cy: s, r: i, pathLength: "100" }),
        (0, e.jsx)("circle", { className: v, cx: s, cy: s, r: i, pathLength: "100" }),
      ],
    }),
  });
};
export { N as a };
//# sourceMappingURL=chunk-TFHKNJXV.mjs.map
