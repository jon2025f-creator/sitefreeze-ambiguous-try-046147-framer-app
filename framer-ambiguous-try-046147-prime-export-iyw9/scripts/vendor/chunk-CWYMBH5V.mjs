import { a as Ir, c as Tt, d as gr } from "chunk-VPDJYJ6F.mjs";
import {
  C as Ur,
  Da as Wr,
  Hc as Xr,
...
import { c as oe, e as q } from "chunk-3Q7ROSGO.mjs";
import { wb as Oe, xb as De } from "chunk-VBY4CAWC.mjs";
import {
  $g as Rr,
  Ag as Et,
  Gt as At,
...
import { h as $t, y as Jt } from "chunk-DTSMQR7C.mjs";
import { a as W } from "chunk-7BWPFUCH.mjs";
import { q as st } from "chunk-3EW3IBXX.mjs";
import { a as tr, b as X, e as ie, f as z, k as rr } from "chunk-LA34HORX.mjs";
import { b as x, c as V } from "chunk-4JY5UMT2.mjs";
import { b as nt } from "chunk-VJ7UYMJI.mjs";
function Ss(e, t) {
...
function Os(e, t) {
  ...
  for (let i of r) if (!Rt(i, e[i], t[i])) return !1;
  return !0;
}
function Zr(e) {
  return e instanceof te ? e.toJS() : e;
}
function Ds(e, t) {
  return W(Zr(e), Zr(t));
}
      ...
      (Rt(p, d?.[p], s[p]) ||
        ...
        p === "masks"
          ...
          : p === "styledText"
            ...
            : (T[be(p)] = Le(s[p]))));
  let u = s._deleted;
  if (u && d) for (let p of u) d[p] !== void 0 && (T || (T = { ...d }), delete T[p]);
  if (!T) return null;
  let A = t.asDraft(e),
    _ = { ...o };
  return (
    fr(T) ? delete _[r] : (_[r] = T),
    A.setProp("replicaInfo", { ...i, overrides: _ }),
...
function tn(e, t) {
  return e === "styledText" && t?.toJS ? t.toJS() : t;
}
function rn(e, t, r, s, i) {
  return t === r || ((t = tn(e, t)), (r = tn(e, r)), W(t, r))
    ? !1
    : (t === void 0 ? (s._deleted || (s._deleted = []), s._deleted.push(e)) : (s[en(e)] = t),
      r === void 0 ? (i._deleted || (i._deleted = []), i._deleted.push(e)) : (i[en(e)] = r),
      !0);
}
function nn(e, t, r, s) {
  let i = !1,
    o = {},
    d = {};
  for (let T in s) i = rn(T, r[T], s[T], d, o) || i;
  for (let T in r) T in s || (i = rn(T, r[T], s[T], d, o) || i);
...
function Dt(e) {
  ...
  if (ge(e)) return new oe({ ...e });
  if (Array.isArray(e)) return e.map(Dt);
  if (z(e) && e.constructor === Object) {
    let t = {};
...
var ys = ["contentManagementSyncState", "save", "transient"];
function bs(e) {
  return ys.some((t) => t === e);
}
function Ms(e, t) {
  let r = Dt(t);
  return r instanceof oe ? r : bs(e) && z(r) ? new oe(r) : r;
}
function an(e) {
  let t = { ...e };
  for (let r in e) Reflect.set(t, r, Ms(r, e[r]));
  return t;
}
function Bs(e, t) {
...
function dn(e, t, r, s) {
  ...
  if (o) {
    ...
    if (!d || !Re(d)) throw Error("broken diff, replica without master: " + t + " " + o.master);
    let T = gt(o);
    return br.create(e, d, {
  ...
  return qr(i)
    ? (x(Kr(t), "Invalid EntityReferenceNode ID: " + t), new i({ ...bt(s), id: t }))
    : new i({ ...bt(s), id: t });
}
function Tn(e) {
...
function hn(e, t) {
  return e === "guidesX" || e === "guidesY"
    ? Jr(t)
    : (sr(e) || e === "formSelectOptions") && Array.isArray(t)
      ? t
      : e === "replicaInfo"
        ? gt(t)
        : yr(e) || Pr(e) || $r(e)
...
function bt(e) {
  let t = {};
  for (let r in e) r !== "_deleted" && (t[r] = hn(r, e[r]));
  return t;
}
function ce(e, t, r, s = !1) {
  let i = e.get(t);
  if (!i) return null;
  let o = r.to;
  ...
  let d = Fs(e, i, o, s);
  return (d && o.replicaInfo && K(d) && (d.cache.rebuildReplica = !0), d);
}
function ln(e, t, r) {
  e.setProp(t, r);
}
function Fs(e, t, r, s = !1) {
  let i = null,
    o = nr(t),
    d = !1;
  for (let u in r) {
    ...
    let A = u;
    if (A === "id" || A === "__class") continue;
    let _ = r[u];
    if (u === "replicaInfo" && _) {
      let C = t.replicaInfo;
      if (C?.master === _.master && C?.inheritsFrom === _.inheritsFrom) continue;
      _ = { ..._, overrides: C?.overrides ?? {} };
    }
    if (Lt(u, t[A], _)) continue;
    i || (i = t.asDraft(e));
    let p = Ct.reviveProperty(u, _);
    (u.startsWith("$") ? i.setProp(u, p) : ln(i, A, p), (d ||= o && ot(u)));
  }
  let T = r._deleted;
  if (T)
    for (let u of T) {
      ...
      A === "id" ||
        ...
        (t[A] !== void 0 &&
          (i || (i = t.asDraft(e)),
          cn(u) ? i.deleteProp(u) : s ? i.resetToDefault(u) : ln(i, A, void 0),
          (d ||= o && ot(u))));
    }
  return (d && t.cache.controlPropVersion++, i);
}
function Mt(e, t, r) {
  let s = r.replicaInfo;
  if (s?.master) {
...
function Hs(e, t, r) {
  ...
  Us(o, s) || t.asDraft(e).setProp("children", new ur(s));
}
function Us(e, t) {
...
function dl(e, t) {
  x(e.id === t.id, "must be the same id");
  let r = e.to._deleted,
    s = t.to._deleted;
  if ((Object.assign(e.to, t.to), Be(e.to, r, s), e.from && t.from)) {
    let i = e.from._deleted,
      o = t.from._deleted;
    (Object.assign(e.from, t.from, { ...e.from }), Be(e.from, o, i));
  }
  ...
  for (let s of e)
    for (let i of s.changes) {
      ...
      if (!o)
        ...
        let d = o.to?._deleted,
          T = i.to?._deleted;
        (Object.assign(o.to, i.to), Be(o.to, d, T));
      ...
      for (; t.length > 0;) {
        ...
        for (let o = 0, d = t.length; o < d; o++) {
          ...
          T.added
            ...
            : T.removed || (Mt(e, T.id, T.to) ? i.push(T) : (ws(e, T, s), ce(e, u, T)));
        }
...
var Vs = { id: !0, cache: !0, children: !0, mutable: !0, update: !0, _deleted: !0 },
  Ws = { parentid: !0, replicaInfo: !0, originalid: !0, duplicatedFrom: !0 };
function Ks(e, t) {
  let r = e.length;
  if (r !== t.length) return !1;
  ...
  if ((r && (delete i.to.parentid, delete i.from.parentid), !!o))
    return (
      (t instanceof Yr ||
        ...
        t instanceof vr ||
        t instanceof zr ||
        (i.added && t instanceof Wr) ||
        (i.added && t instanceof Ur) ||
...
function Gs(e, t, r) {
  ...
  for (let u of T) {
    if (o) {
      ...
      if (u === "children") {
        (Qs(r, e.children, t.children), (r.fromChildren || r.toChildren) && (d = !0));
        continue;
      }
      if (u in Vs) continue;
    }
    let A = u,
      ...
      p = t[A];
    Lt(u, _, p) ||
      (_ === void 0 ? (s._deleted || (s._deleted = []), s._deleted.push(u)) : (s[u] = Pt(u, _)),
      p === void 0 ? (i._deleted || (i._deleted = []), i._deleted.push(u)) : (i[u] = Pt(u, p)),
      (d = !0));
  }
  if (!(!d && !r.added && !r.removed)) return r;
}
Ct.setGeneric("reviveProperty", hn);
function yt(e, t, r) {
  if (e.removed) {
    t.remove(e.id);
    return;
  ...
  if (e.added) {
    if (!Tn(e.to)) return;
    if (!t.has(e.id)) {
      let T = dn(t.getCanvasTreeProxy(), e.id, e.added, e.to);
  ...
  if (e.to.parentid || e.position !== e.fromPosition) {
    ...
    u && u !== q && r.moveNode(e.id, u, e.position);
  }
...
function zs(e, t, r, s) {
  ...
  for (let T of i)
    for (let u of r.getChildrenIds(T)) o.has(u) || e.has(u) || d(u) || r.removeNode(u);
}
function js(e, t, r, s, i) {
  ...
  r && !o && zs(e, t, r, s);
  let d = new Set();
  for (let _ of t) (_.added || _.to.parentid) && d.add(_.id);
  let T = t,
    u = new Set(),
    A = t.filter((_) => !Me(_.id));
  for (; A.length > 0;) {
    let _ = [];
    for (let p of A) {
      let C = p.id;
      ...
      if (p.added) {
        if (e.has(C)) ce(e, C, p, !0);
        else if (Bt(e, C, p.added, p.to, p.position) && r && !o)
          for (let D of r.getChildrenIds(C))
            d.has(D) || (r.getParentId(D) !== q && kt(e, D, C, void 0, r, d, void 0, s));
      } else ce(e, C, p, !0);
    }
  ...
  for (let _ of T) {
    if (u.has(_.id) || !Me(_.id)) continue;
    let [p, C] = St(_.id);
    if (!p || !C) continue;
    let S = e.get(p);
    if (!S && o) continue;
    let D = S ? null : s?.get(p),
      I = S ?? D;
    if (!I) {
      x(r, "Store must be defined to write data-only changes");
      let F = an(sn(_.to, q));
      r.updateNestedObject([p, "replicaInfo", "overrides", C], F);
      continue;
    }
...
function ke(e, t, r) {
  return (
    x(t === "boolean", () => `Unsupported enum output type: ${t}`),
    tr(e) || j(e) ? r(e) : { type: "LiteralValue", value: At(t, void 0) }
  );
}
function Js(e, t, r, s) {
  function i(o) {
  ...
  switch ((x(it(e.name), `Transform is not a valid expression: ${e.name}`), e.name)) {
    case "contains":
    ...
    case "convertFromEnum": {
      if (r?.type !== "enum") return { type: "LiteralValue", value: At(e.outputType, void 0) };
      let o = new Set(),
        d = [];
        ...
        o.has(T.from) ||
          (r.options.includes(T.from) &&
            ...
            d.push({
              ...
              then: ke(T.to, e.outputType, i),
            })));
      return { type: "Case", value: t, conditions: d, else: ke(e.default, e.outputType, i) };
    }
...
function ei(e, t, r, s, i, o) {
  ...
  let d = e.collectionFilters.filters,
    T = [];
  for (let { itemKey: _, transforms: p } of d) {
    let I = function (R) {
    ...
    let D = [],
      ...
      F = Fe(_, S, r, s, o, O);
    for (let R of p) at(R.name) && (F = Js(R, F, S, I));
    T.push({ expression: F, optionalVariables: D });
  }
  let u = e.collectionFiltersOperator ?? Mr;
  switch (u) {
    case "all":
      return ti(T, i);
    case "any":
...
function ri(e, t) {
  ...
  return (
    x(i.length > 0, "allUsedOptionalVariables should have at least one element"),
    ii(r, i, t)
  );
}
function ni(e, t, r) {
...
function ai(e, t, r, s, i, o) {
  if (e.collectionOrder && e.collectionOrder.length > 0) {
    ...
    for (let { itemKey: T, direction: u } of e.collectionOrder) {
      ...
      if (!A) continue;
      let _ = Fe(T, A, r, s, o);
      (u === "desc" && (_.direction = "desc"), d.push(_));
    }
    return d;
  }
  if (e.collectionFilters?.filters.length === 1) {
    let d = e.collectionFilters.filters.at(0);
    if ((x(d, "filter should exist"), d.itemKey)) {
      let T = t.get(d.itemKey),
        u = Fe(d.itemKey, T, r, s, o),
        A = oi(e, d.transforms, u, T, i);
      if (A) return [A];
    }
  }
...
function oi(e, t, r, s, i) {
  ...
  let o = t[0];
  if ((x(o, "Transform must exist"), o.name === "isIncludedIn" && j(o.value)))
    return {
      type: "FunctionCall",
...
function li(e, t, r, s, i) {
  ...
  for (let d of t) {
    ...
    let T = e.get(d),
      u = Fe(d, T, r, s, i);
    ((u.type !== "Identifier" || d !== u.name) && (u.alias = d), o.push(u));
  }
  return o;
}
function kl(e, t, r, s, i) {
  let o = {},
    d = new Set(),
    T = $s(e);
  e.collectionFilters && (o.where = ei(e, t, d, T, s, i));
  let u = t.get(e.getPrimaryId());
  x(u, "Control map of repeater must exist");
  let A = ai(e, u, d, T, s, i);
  (A.length > 0 && (o.orderBy = A),
    ie(e.collectionStartOffset) &&
      (o.offset = { type: "LiteralValue", value: e.collectionStartOffset }),
    ie(e.collectionLimit) && (o.limit = { type: "LiteralValue", value: e.collectionLimit }));
  let _ = li(u, r, d, T, i);
  return { from: ci(e.dataIdentifier, u, d, T, i), select: _, ...o };
}
function Fe(e, t, r, s, i, o = !0) {
  (o && t?.type === "collectionreference" && !xr(e) && (e += ".id"), r.add(e));
  let [d, T] = un(e, s);
...
function $(e) {
  var t;
  return (t = di.get(e)) !== null && t !== void 0 ? t : n.UNKNOWN;
}
var m = n,
  fn = {
    [f.HTML]: new Set([
  ...
  le = new Set([m.H1, m.H2, m.H3, m.H4, m.H5, m.H6]),
  xl = new Set([E.STYLE, E.SCRIPT, E.XMP, E.IFRAME, E.NOEMBED, E.NOFRAMES, E.PLAINTEXT]);
var B = {
  createDocument() {
  ...
  insertTextBefore(e, t, r) {
    ...
    s && B.isTextNode(s) ? (s.value += t) : B.insertBefore(e, B.createTextNode(t), r);
  },
  adoptAttributes(e, t) {
...
function Ue(e) {
  return (e >= 64976 && e <= 65007) || Ei.has(e);
}
var h;
(function (e) {
  ...
  ve = class {
    ...
    _checkForProblematicCharacters(t) {
      He(t)
        ...
        : Ue(t) && this._err(h.noncharacterInInputStream);
    }
    retreat(t) {
...
function An(e) {
  return Cn(e) || e === a.SOLIDUS || e === a.GREATER_THAN_SIGN;
}
function _i(e) {
  return e === a.NULL
...
var Te = class {
  constructor(t, r) {
    ((this.options = t),
      ...
      (this.preprocessor = new ve(r)),
      (this.currentLocation = this.getCurrentLocation(-1)),
      (this.entityDecoder = new gr(
        Ir,
        (s, i) => {
  ...
  _emitCodePoint(t) {
    let r = Cn(t) ? N.WHITESPACE_CHARACTER : t === a.NULL ? N.NULL_CHARACTER : N.CHARACTER;
  ...
  _startCharacterReference() {
    ((this.returnState = this.state),
      ...
      this.entityDecoder.startEntity(
        this._isCharacterReferenceInAttribute() ? Tt.Attribute : Tt.Legacy
      ));
  }
  ...
  _stateTagOpen(t) {
    if (Q(t)) (this._createStartTagToken(), (this.state = c.TAG_NAME), this._stateTagName(t));
    else
      switch (t) {
  ...
  _stateEndTagOpen(t) {
    if (Q(t)) (this._createEndTagToken(), (this.state = c.TAG_NAME), this._stateTagName(t));
    else
      switch (t) {
  ...
  _stateTagName(t) {
    ...
    switch (t) {
      ...
      default:
        r.tagName += String.fromCodePoint(de(t) ? Ye(t) : t);
    }
  }
  ...
  _stateScriptDataDoubleEscapeStart(t) {
    if (this.preprocessor.startsWith(k.SCRIPT, !1) && An(this.preprocessor.peek(k.SCRIPT.length))) {
      this._emitCodePoint(t);
      for (let r = 0; r < k.SCRIPT.length; r++) this._emitCodePoint(this._consume());
  ...
  _stateAttributeName(t) {
    switch (t) {
      ...
      default:
        this.currentAttr.name += String.fromCodePoint(de(t) ? Ye(t) : t);
    }
  }
  ...
  _stateMarkupDeclarationOpen(t) {
    this._consumeSequenceIfMatch(k.DASH_DASH, !0)
      ? (this._createCommentToken(k.DASH_DASH.length + 1), (this.state = c.COMMENT_START))
  ...
  _stateDoctypeName(t) {
    ...
    switch (t) {
      ...
      default:
        r.name += String.fromCodePoint(de(t) ? Ye(t) : t);
    }
  }
  ...
  _stateCharacterReference() {
    ...
    t === 0
      ? ((this.preprocessor.pos = this.entityStartPos),
        ...
        (this.state =
          !this._isCharacterReferenceInAttribute() && _n(this.preprocessor.peek(1))
...
var Rn = new Set([n.DD, n.DT, n.LI, n.OPTGROUP, n.OPTION, n.P, n.RB, n.RP, n.RT, n.RTC]),
  Nn = new Set([...Rn, n.CAPTION, n.COLGROUP, n.TBODY, n.TD, n.TFOOT, n.TH, n.THEAD, n.TR]),
  Ve = new Set([n.APPLET, n.CAPTION, n.HTML, n.MARQUEE, n.OBJECT, n.TABLE, n.TD, n.TEMPLATE, n.TH]),
  Ai = new Set([...Ve, n.OL, n.UL]),
  Ci = new Set([...Ve, n.BUTTON]),
  In = new Set([n.ANNOTATION_XML, n.MI, n.MN, n.MO, n.MS, n.MTEXT]),
  gn = new Set([n.DESC, n.FOREIGN_OBJECT, n.TITLE]),
  Ni = new Set([n.TR, n.TEMPLATE, n.HTML]),
  Ii = new Set([n.TBODY, n.TFOOT, n.THEAD, n.TEMPLATE, n.HTML]),
  gi = new Set([n.TABLE, n.TEMPLATE, n.HTML]),
  Ri = new Set([n.TD, n.TH]),
  We = class {
    ...
    popUntilNumberedHeaderPopped() {
      this.popUntilPopped(le, f.HTML);
    }
    popUntilTableCellPopped() {
      this.popUntilPopped(Ri, f.HTML);
    }
    ...
    clearBackToTableContext() {
      this.clearBackTo(gi, f.HTML);
    }
    clearBackToTableBodyContext() {
      this.clearBackTo(Ii, f.HTML);
    }
    clearBackToTableRowContext() {
      this.clearBackTo(Ni, f.HTML);
    }
    remove(t) {
      let r = this._indexOf(t);
      r >= 0 &&
    ...
    hasInListItemScope(t) {
      return this.hasInDynamicScope(t, Ai);
    }
    hasInButtonScope(t) {
      return this.hasInDynamicScope(t, Ci);
    }
    ...
    generateImpliedEndTags() {
      for (; this.currentTagId !== void 0 && Rn.has(this.currentTagId);) this.pop();
    }
    generateImpliedEndTagsThoroughly() {
      for (; this.currentTagId !== void 0 && Nn.has(this.currentTagId);) this.pop();
    }
    generateImpliedEndTagsWithExclusion(t) {
      for (; this.currentTagId !== void 0 && this.currentTagId !== t && Nn.has(this.currentTagId);)
        this.pop();
    }
  };
var U;
...
var Dn = "html",
  Si = "about:legacy-compat",
  Oi = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd",
  Ln = [
  ...
  Di = [...Ln, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"],
  Li = new Set([
    "-//w3o//dtd w3 html strict 3.0//en//",
    "-/w3c/dtd html 4.0 transitional/en",
    "html",
  ]),
  Pn = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"],
  Pi = [...Pn, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"];
function On(e, t) {
  return t.some((r) => e.startsWith(r));
}
function yn(e) {
  return e.name === Dn && e.publicId === null && (e.systemId === null || e.systemId === Si);
}
function bn(e) {
  if (e.name !== Dn) return M.QUIRKS;
  let { systemId: t } = e;
  if (t && t.toLowerCase() === Oi) return M.QUIRKS;
  let { publicId: r } = e;
  if (r !== null) {
    if (((r = r.toLowerCase()), Li.has(r))) return M.QUIRKS;
    let s = t === null ? Di : Ln;
    if (On(r, s)) return M.QUIRKS;
    if (((s = t === null ? Pn : Pi), On(r, s))) return M.LIMITED_QUIRKS;
  }
  return M.NO_QUIRKS;
}
var Mn = { TEXT_HTML: "text/html", APPLICATION_XML: "application/xhtml+xml" },
  bi = "definitionurl",
  Mi = "definitionURL",
  Bi = new Map(
    [
...
function Bn(e) {
  ...
  return (
    (t === n.FONT &&
      e.attrs.some(({ name: s }) => s === Y.COLOR || s === Y.SIZE || s === Y.FACE)) ||
    xi.has(t)
  );
}
function Ft(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === bi) {
      e.attrs[t].name = Mi;
      break;
    }
}
...
function Ui(e, t, r) {
  if (t === f.MATHML && e === n.ANNOTATION_XML) {
    for (let s = 0; s < r.length; s++)
      if (r[s].name === Y.ENCODING) {
        let i = r[s].value.toLowerCase();
        return i === Mn.TEXT_HTML || i === Mn.APPLICATION_XML;
      }
  }
  return t === f.SVG && (e === n.FOREIGN_OBJECT || e === n.DESC || e === n.TITLE);
}
function Fn(e, t, r, s) {
  return ((!s || s === f.HTML) && Ui(e, t, r)) || ((!s || s === f.MATHML) && Hi(e, t));
}
var vi = "hidden",
  wi = 8,
  Yi = 3,
...
var Vi = { startLine: -1, startCol: -1, startOffset: -1, endLine: -1, endCol: -1, endOffset: -1 },
  wn = new Set([n.TABLE, n.TBODY, n.TFOOT, n.THEAD, n.TR]),
  Hn = { scriptingEnabled: !0, sourceCodeLocationInfo: !1, treeAdapter: B, onParseError: null },
  Ae = class {
    constructor(t, r, s = null, i = null) {
      ((this.fragmentContext = s),
        ...
        (this.tokenizer = new Te(this.options, this)),
        (this.activeFormattingElements = new Ke(this.treeAdapter)),
    ...
    _insertCharacters(t) {
      ...
      if (this.treeAdapter.getNodeSourceCodeLocation(d)) {
        ...
        this.treeAdapter.updateNodeSourceCodeLocation(d, { endLine: u, endCol: A, endOffset: _ });
      } else
        this.options.sourceCodeLocationInfo &&
    ...
    onEndTag(t) {
      ((this.skipNextNewLine = !1),
        (this.currentToken = t),
        this.currentNotInHTML ? No(this, t) : this._endTagOutsideForeignContent(t));
    }
...
function Qi(e, t, r) {
  ...
  for (let o = 0, d = i; d !== r; o++, d = i) {
    ...
    let T = e.activeFormattingElements.getElementEntry(d),
      u = T && o >= Yi;
    !T || u
      ? (u && e.activeFormattingElements.removeEntry(T), e.openElements.remove(d))
      : ((d = Gi(e, T)),
...
function wt(e, t) {
  for (let r = 0; r < wi; r++) {
    ...
    let o = Qi(e, i, s.element),
      d = e.openElements.getCommonAncestor(s.element);
    (e.treeAdapter.detachNode(o), d && Xi(e, d, o), zi(e, i, s));
  }
}
function Ut(e, t) {
...
function $i(e, t) {
  ...
  let r = t.forceQuirks ? M.QUIRKS : bn(t);
  (yn(t) || e._err(t, h.nonConformingDoctype),
    e.treeAdapter.setDocumentMode(e.document, r),
    (e.insertionMode = l.BEFORE_HTML));
}
function Ee(e, t) {
  (e._err(t, h.missingDoctype, !0),
    e.treeAdapter.setDocumentMode(e.document, M.QUIRKS),
    (e.insertionMode = l.BEFORE_HTML),
    e._processToken(t));
}
function Ji(e, t) {
  t.tagID === n.HTML ? (e._insertElement(t, f.HTML), (e.insertionMode = l.BEFORE_HEAD)) : ue(e, t);
}
function Zi(e, t) {
  let r = t.tagID;
  (r === n.HTML || r === n.HEAD || r === n.BODY || r === n.BR) && ue(e, t);
}
function ue(e, t) {
...
function _e(e, t) {
  (e._insertFakeElement(E.BODY, n.BODY), (e.insertionMode = l.IN_BODY), je(e, t));
}
function je(e, t) {
  switch (t.type) {
    case N.CHARACTER: {
...
function Ta(e, t) {
  (e.openElements.hasInButtonScope(n.P) && e._closePElement(),
    e.openElements.currentTagId !== void 0 &&
      le.has(e.openElements.currentTagId) &&
      e.openElements.pop(),
    e._insertElement(t, f.HTML));
}
function Ea(e, t) {
...
function Na(e, t) {
  (e.treeAdapter.getDocumentMode(e.document) !== M.QUIRKS &&
...
function y(e, t) {
  switch (t.tagID) {
    ...
    case n.NOSCRIPT: {
      e.options.scriptingEnabled ? Un(e, t) : vn(e, t);
      break;
    }
    case n.PLAINTEXT: {
      fa(e, t);
...
function xa(e, t) {
  e.openElements.hasInScope(n.BODY) && ((e.insertionMode = l.AFTER_BODY), es(e, t));
}
function Ha(e, t) {
  let r = t.tagID;
...
function Gn(e, t) {
  e.tmplInsertionModeStack.length > 0 ? Zn(e, t) : Yt(e, t);
}
function Qa(e, t) {
  var r;
  (t.tagID === n.SCRIPT &&
...
function Ht(e, t) {
  if (e.openElements.currentTagId !== void 0 && wn.has(e.openElements.currentTagId))
    switch (
...
function Za(e, t) {
  (Kn(t) ? e._appendElement(t, f.HTML) : Ne(e, t), (t.ackSelfClosing = !0));
}
function eo(e, t) {
  !e.formElement &&
    e.openElements.tmplCount === 0 &&
...
function Ne(e, t) {
  ...
  ((e.fosterParentingEnabled = !0), je(e, t), (e.fosterParentingEnabled = r));
}
function Xn(e, t) {
...
function he(e, t) {
  ...
  if (e.hasNonWhitespacePendingCharacterToken)
    for (; r < e.pendingCharacterTokens.length; r++) Ne(e, e.pendingCharacterTokens[r]);
  else
    for (; r < e.pendingCharacterTokens.length; r++)
      e._insertCharacters(e.pendingCharacterTokens[r]);
  ((e.insertionMode = e.originalInsertionMode), e._processToken(t));
}
var jn = new Set([n.CAPTION, n.COL, n.COLGROUP, n.TBODY, n.TD, n.TFOOT, n.TH, n.THEAD, n.TR]);
function to(e, t) {
  let r = t.tagID;
  jn.has(r)
...
function io(e, t) {
  ...
  switch (r) {
    ...
    case n.THEAD:
    case n.TR: {
      e.openElements.hasInTableScope(r) && (e._closeTableCell(), qn(e, t));
      break;
    }
    case n.BODY:
    case n.CAPTION:
...
function ze(e, t) {
  ((e.insertionMode = l.IN_BODY), je(e, t));
}
function Eo(e, t) {
  switch (t.tagID) {
    case n.HTML: {
...
function Co(e, t) {
  if (Bn(t)) (ts(e), e._startTagOutsideForeignContent(t));
  else {
    let r = e._getAdjustedCurrentElement(),
      s = e.treeAdapter.getNamespaceURI(r);
    (s === f.MATHML ? Ft(t) : s === f.SVG && (kn(t), xt(t)),
      Qe(t),
...
function No(e, t) {
  if (t.tagID === n.P || t.tagID === n.BR) {
    (ts(e), e._endTagOutsideForeignContent(t));
    return;
  }
...
function rs(e, t, r) {
  ...
  let s = Ae.getFragmentParser(e, r);
  return (s.tokenizer.write(t, !0), s.getFragment());
}
function Io(e) {
  return dr(e) && Hr(e.type);
}
function go(e) {
  return !z(e) || e.type !== "object"
    ? !1
    : e.value === null
      ? !0
      : Object.values(e.value).every(Io);
}
function Ld(e) {
  return rr(e) && e.every((t) => pr(t) && go(t));
}
var Ro = /^(.*?)(?:([^/])\.([^/.]+))?$/;
function yd(e) {
  let t = e.match(Ro);
...
function Hd(e, t, r) {
  ...
  o !== void 0 &&
    i &&
    ((r ??= Zt(i.width, i.height)), r && (s = r.find(({ maxSideSize: T }) => T >= o)));
  let d = s?.maxSideSize;
  return $t(e, d, t === "lossless");
}
function Yd(e) {
  if (!z(e)) return !1;
  let t = e.identifier,
...
function Ze(e, t) {
  let r = rs(e),
    s = { id: L(), type: "richText", variant: t, childNodes: tt(r) };
  return ee(s);
}
function ko(e) {
  let t = [];
...
function Fo(e) {
  ...
  switch (e.tagName) {
    ...
    case "img":
      return os(t, "image");
    case "video":
      return Wt(t, "framer-image") || t.get("src") ? os(t, "video") : void 0;
    case Lo:
    case "template":
      return wo(t);
    case "table":
    ...
    case "figure": {
      ...
      let s = se(e).find((i) => i.tagName === "table");
...
function xo(e, t, r) {
  return {
    ...
    type: "textBlock",
    tag: e.tagName,
    textDirection: Gt(t, r),
    childNodes: Ko(et(e), {}),
  };
}
function Ho(e, t, r) {
  return { id: L(), type: "bulletedList", textDirection: Gt(t, r), childNodes: hs(e) };
}
function Uo(e, t, r) {
  let s = Kt(t.get("start")) ?? 1,
    i = jo(e, r);
  return {
    id: L(),
    type: "numberedList",
...
function hs(e) {
  return se(e)
    ...
    .map((t) => ({ id: L(), type: "listItem", childNodes: tt(t) }));
}
function vo(e) {
  return { id: L(), type: "blockquote", childNodes: tt(e) };
}
function os(e, t) {
...
function Yo(e) {
  ...
  for (let r of se(e)) {
    ...
    if (!(r.tagName !== "tbody" && r.tagName !== "thead" && r.tagName !== "tfoot"))
      for (let s of se(r)) s.tagName === "tr" && t.push(s);
  }
  return t;
}
function Vo(e) {
  let t = [];
  for (let r of se(e)) (r.tagName !== "td" && r.tagName !== "th") || t.push(Wo(r));
...
function us(e, t, r) {
  for (let s of e) {
    ...
    if (!Xt(s)) continue;
    if (s.tagName === "br") {
      if (Wt(Ie(s), "trailing-break")) continue;
      r.push(zo());
      continue;
    }
    let i = Qo(s, t);
...
function fs(e) {
  ...
  if (r === void 0) return;
  let s = ne(e.get(as)) ?? ne(e.get("rel")) ?? ls(e.get("rel")) ?? ls(e.get(as)) ?? [],
    i = {
      id: L(),
      link: r,
      openInNewTab: ne(e.get(ss)) ?? Ts(e.get(ss)),
      smoothScroll: ne(e.get(is)) ?? Ts(e.get(is)),
      relValues: s,
    },
    o = e.get(Oo);
  o && (i.clickTrackingId = ne(o) ?? o);
  let d = e.get(Do);
  return (d !== void 0 && (i.preserveParams = ne(d) ?? d !== "false"), i);
}
function ls(e) {
...
function jo(e, t) {
  ...
  if (s) return s;
  let i = se(e).find((o) => o.tagName === "li");
  return (i && ms(Ie(i).get("style")).get("list-style-type")) || "decimal";
}
function ne(e) {
...
function Ie(e) {
  let t = new Map();
  for (let r of B.getAttrList(e)) t.set(r.name, r.value);
  return t;
}
function Wt(e, t) {
  let r = e.get("class");
...
function nT(e, t) {
  ...
  if (typeof e != "string") return zt(t);
  try {
    return Ze(e, t);
  } catch (r) {
    return (nt(r), zt(t));
...
function sT(e) {
  return typeof e == "string"
    ? ct(e)
    : H(e)
      ? _r(ee(e), { preserveTrailingEmptyBlockNewLine: !0 })
      : "";
}
function ps(e) {
  return typeof e == "string" ? ct(e).length === 0 : H(e) ? !Zo(ee(e)) : !0;
}
function Zo(e) {
  return (
    kr(e, {
...
function _s(e, t, r) {
  ...
  ((t.cache.parentDirected = e.layout),
    cr(e) &&
      ...
      (t.cache.parentDirectedColumnCount = ie(e.gridColumnCount) ? e.gridColumnCount : void 0)),
    ge(e.stackDirection) && r
      ? (t.cache.parentDirection = e.resolveValue("stackDirection") ?? ar)
      : (t.cache.parentDirection = e.stackDirection ?? null),
    lr(e) && ((t.cache.parentWidthType = e.widthType), (t.cache.parentHeightType = e.heightType)));
}
function dT(e, t) {
  _s(e, t, !1);
}
  ...
  if (lt(e))
    return e.type === void 0
      ? X(e.value)
        ...
        : { ...e, type: void 0, value: dt(e, { preserveNewLines: !0 }) }
      : { ...e, type: void 0, value: dt(e, { preserveNewLines: !0 }) };
}
function tc(e, t) {
  if (lt(e)) {
    if (H(e.value)) {
      let r = e.value;
      return { ...e, type: "rich-text", value: { ...r, variant: ae(r.variant) } };
    }
    if (e.type === "rich-text" && X(e.value)) return { ...e, type: "rich-text", value: e.value };
    if (X(e.value))
      return H(t)
        ? { ...e, type: "rich-text", value: { ...De(t, e.value), variant: ae(t.variant) } }
...
var jt = "[a-z1-9]+(?:-[a-z1-9]+)*",
  rc = `${jt}="[^"]*"`,
  nc = String.raw`(?:\s+${rc})*`,
  sc = String.raw`<${jt}${nc}\s*>`,
  ic = `(?:${sc})+`,
  ac = String.raw`<\/\s*${jt}\s*>`,
  oc = `(?:${ac})+`,
  cc = "[^<>]*",
  As = String.raw`\s*`,
...
function Ns(e, t) {
  let r = Jt(t) ? Ze(t, ae(e.variant)) : t;
  return !Er(e) || !Tc(r) ? r : Ec(e, r);
}
function Tc(e) {
    ...
    if (pt(I)) {
      ...
      for (let b of I.marks)
        ((O ||= Et(b)),
          ...
          Cr(b) && (w ??= b.attrs),
          Nr(b) && (G ??= b.attrs),
          ht(b) && o.push(b.attrs.linkStylePreset),
          ut(b) && d.push(b.attrs.inlineCodeStylePreset),
          Rr(b) && (R = b.attrs.inlineStyles));
      (A.push(w), _.push(G), O && T.push(R), F && u.push(R));
    }
  });
  let p = _t(hc(t, r), r),
    C = p.tr,
    S = new Map();
  p.doc.descendants((I, O, F) => {
    if (mt(I)) {
      let R = i[I.attrs.tag] ?? [],
        w = R.length > 1 ? R.shift() : R[0];
      w && (S.set(I, w.inlineStyles), C.setNodeMarkup(O, I.type, { ...I.attrs, ...w }));
    }
    if (pt(I)) {
      let R = !1,
        w = !1,
      ...
      for (let Z of I.marks) {
        if (((R ||= Et(Z)), (w ||= ft(Z)), ht(Z))) {
          let rt = o.length > 1 ? o.shift() : o[0];
          C.addMark(O, O + I.nodeSize, r.marks.link.create({ ...Z.attrs, linkStylePreset: rt }));
        }
        if (ut(Z)) {
          let rt = d.length > 1 ? d.shift() : d[0];
          C.addMark(
            O,
            O + I.nodeSize,
            r.marks.inlineCode.create({ ...Z.attrs, inlineCodeStylePreset: rt })
          );
        }
      }
      (R && (G = T.length > 1 ? T.shift() : T[0]),
        w && (G = u.length > 1 ? u.shift() : u[0]),
      ...
      let qt = _.length > 1 ? _.shift() : _[0];
      qt && C.addMark(O, O + I.nodeSize, r.marks.backgroundStyles.create(qt));
    }
  });
  let D = p.apply(C);
  return Dr(D.doc, r);
...
function hc(e, t) {
  return typeof e == "string" ? e : Lr(e, t);
}
function GT(e, t) {
  return t.type !== "rich-text"
    ? H(e)
      ...
      : Oe(e, t.value)
    : H(e)
      ? (x(hr(e), "getStyledLocalizedRichTextHTML: first argument must not be localized"),
        Ns(e, t.value))
      : H(t.value)
        ? gs(e, t.value)
        : Is(e, t.value);
}
var uc = /^<(\w+)[^>]*><br class="trailing-break"><\/\1>$/u;
function jT(e) {
  return typeof e == "string" ? e === "" || uc.test(e) : ps(e);
}
export {
  sn as a,
  Me as b,
...
//# sourceMappingURL=chunk-CWYMBH5V.mjs.map
