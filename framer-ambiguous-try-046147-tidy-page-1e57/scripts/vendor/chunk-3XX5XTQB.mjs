...
import { a as H } from "chunk-D3SZBJZX.mjs";
import { c as y } from "chunk-T77FBH5Y.mjs";
import { a as ut } from "chunk-K6L5GVTR.mjs";
import { a as oe } from "chunk-DWEQS5LX.mjs";
import { f as tt } from "chunk-R4C2D46O.mjs";
import { e as w, f as S, j as D, k as ue } from "chunk-HFUJNNAN.mjs";
import { a as C, b as F } from "chunk-WRBBN7SY.mjs";
import { a as B } from "chunk-RNHTTH2C.mjs";
import { b as ze } from "chunk-AYNVEX5D.mjs";
import { a as fe } from "chunk-2FCXHKEL.mjs";
import { g as Ie, q as K } from "chunk-ZYPCDWHY.mjs";
import { f as ye, m as ve } from "chunk-LA34HORX.mjs";
import { b as g } from "chunk-4JY5UMT2.mjs";
import { l as pe } from "chunk-MQDP3TYU.mjs";
import { b as h, i as O } from "chunk-VJ7UYMJI.mjs";
...
function yt(i, e, t, n, r) {
  ...
  let d = m.positioning,
    u = k(d.width - j.maxX(t), o),
    v = k(d.height - j.maxY(t), o);
  Y(r.right)
...
var Lr = (i, e) => {
  ...
  vt = (i, e, t, n) => {
    let r = new c({ ...Di(i), fillEnabled: !1, ...e });
    g(V(r));
    let o = e.gridType === $,
      a = Li(o, w(e.height) ? e.height : void 0, w(r.gap) ? r.gap : void 0);
    for (let s = 0; s < t; s++) {
      let m = {};
      if (a) {
  ...
  St = Pe.width,
  Ti = (i, e, t, n, r, o) => {
    let a = { x: b, y: b, right: b, bottom: b };
    (yt(i, e, t, n, a),
  ...
  Vi = (i, e, t, n, r, o) => {
    (Ti(i, e, t, n, r, o), !(r > St) && (T(e) && Ai(e, o), V(e) && Oi(e, o)));
  },
  qi = (i, e, t, n, r, o) => {
    let a = e.getPrimaryId(),
      s = {};
    if ((Vi(i, e, t, n, r, s), (o[a] = s), Ce(e) && e.stackWrapEnabled && r <= St)) {
      let d = bi(e);
...
function Ar(i, e, t) {
  ...
  for (let m in s) {
    ...
    let u = {};
    (qi(i.tree, n, a, r, d.width, u), It(i.tree, d, u));
  }
}
function br(i, e, t, n = i.getParent(t.id), r = Ee(i, t)) {
  let o = {
    width: { 2: !0, 0: !0, 3: !0, 1: !0, 4: !0, 5: !0 },
    height: { 2: !0, 0: !0, 3: !0, 1: !0, 4: !0, 5: !0 },
  };
  if (
    (!n || !P(t) || (it(t) && t.autoSize === !0) || Fe(t)
      ? ((o.width[1] = !1),
        (o.height[1] = !1),
        (o.width[3] = !1),
        (o.height[3] = !1),
      ...
      : V(n)
        ? G(t, n)
          ? ((o.width[3] = !0), (o.height[3] = n.gridRowHeightType !== "fit" && n.gridType !== $))
          : ((o.width[3] = !1), (o.height[3] = !1))
        : T(n)
          ? (G(t, n) || (o.width[3] = !1), G(t, n) || (o.height[3] = !1))
          : ((o.width[3] = !1), (o.height[3] = !1)),
    et(t) &&
      ...
      (o.height[3] = !1),
      (o.height[4] = !1)),
    (!Ue(t) || A(t)) && ((o.width[5] = !1), (o.height[5] = !1)),
    De(t))
  ) {
  ...
  return (
    ke(t) && ve(t.layout) && Oe(t) && !qe(t) && ((o.width[2] = !1), (o.height[2] = !1)),
    r || ((o.width[4] = !1), (o.height[4] = !1)),
    ((A(n) && _e(n) && ge(n.heightType)) || Q(n)) && ((o.height[3] = !1), (o.height[1] = !1)),
...
var Pi = [
  ...
  Pr = new Set(Pi.map((i) => i.vectorSetModuleId));
async function ae(i) {
  let e;
  try {
...
var se = class {
    ...
    async uploadImage(
      ...
      try {
        ...
        (y({
          ...
          _.reportError(a, { fileName: e.name, fileSize: e.size, fileType: e.type }));
      }
    }
    async uploadVideo(
      e,
    ...
    async uploadAssetByURL(e, { silent: t = !1, refreshAssetService: n = !0 } = {}) {
      let r = ue(e),
        ...
        s = { asset: a, filename: S(a), originalFilename: a.name, url: D(a) };
      return (
        n && (await this.assetService.refresh().catch(h)),
        a.mimeType.startsWith("image/")
          ? { ...s, type: "image", imageSize: Pt(a) }
    ...
    async uploadFile(
      ...
      if (a)
        return (
          o && (await this.assetService.refresh().catch(h)),
          { type: "file", asset: a, filename: S(a), originalFilename: a.name, url: D(a) }
        );
    }
    async uploadFonts(e, { refreshAssetService: t = !0 } = {}) {
      ...
      try {
        for (let r of e) {
          let o = await H(r.content, r.originalFilename),
    ...
    async uploadImageByURL(e, { refreshAssetService: t = !0 } = {}) {
      ...
      try {
        ...
        _.warn("Failed to add image by URL:", r);
      }
      return n;
    }
  },
  { service: Gt, resolve: Mi } = qt();
function en(i, e) {
  Mi(new se(i, e));
}
...
var _t = "https://app.framerstatic.com/image@2x-J24ALEQ5.png";
var Et = "https://app.framerstatic.com/mp3-light@2x-7JFI5VH3.png";
...
function na() {
  return new te({
    ...
    slotsAreChildNodes: K.isOn("componentSlotsAreChildNodes"),
  });
}
async function aa(i, e, t) {
  t.stores.chromeStore.notifyTilingImageUploadStarted(e.id);
  let n = await H(i.imageUrl, i.originalFilename),
...
async function E(i, e) {
  ...
  let t = f[e],
    { module: n } = await i.stores.modulesStore.lookUpModule($e(t));
...
async function Qi(i) {
  return E(i, "submitButton");
}
async function sa(i) {
  return E(i, "infiniteScroll");
}
async function la(i) {
  return E(i, "loadMoreButton");
}
async function ma(i) {
  return E(i, "tab");
}
...
function X(i, e = "rgb(136, 136, 136)") {
...
function Jt({ label: i, type: e, placeholder: t, name: n }) {
  ...
  return new c({
    ...z,
    children: new N([
      new x({ heightType: 2, widthType: 2, html: X(i) }),
      new lt({
        ...me,
  ...
  return new c({
    ...
    children: new N([
      ...
      new x({
        ...
        widthType: 2,
        userSelect: "none",
        html: X("Subscribe to Newsletter"),
      }),
    ]),
  });
}
function de(i, e, t, n = !1) {
  return new c({
    ...
    children: new N([
      ...
      new x({ heightType: 2, widthType: 2, userSelect: "none", html: X(i) }),
    ]),
  });
}
function eo() {
  let i = { ...M(), value: "", title: "Select\u2026", disabled: !0 };
  return new c({
    ...z,
    children: new N([
      new x({ heightType: 2, widthType: 2, html: X("Location") }),
      new mt({
        ...Zt,
        formInputRequired: !0,
        ...
        formSelectOptions: [
          i,
          { ...M(), value: "amsterdam", title: "Amsterdam" },
          { ...M(), value: "barcelona", title: "Barcelona" },
        ],
        formInputValue: i.id,
      }),
    ]),
...
var yo = {
  ...
  cs = Ie.isDevelopment ? "An0UANtQVLDyjlmK1idl" : "6wAE2eMb2Tl3zrU7u4UL",
  vo = {
    key: "search",
...
//# sourceMappingURL=chunk-3XX5XTQB.mjs.map
