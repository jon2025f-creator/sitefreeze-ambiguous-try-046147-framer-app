import { a as je } from "chunk-LRJC53OH.mjs";
import { a as me } from "chunk-SCCCCPCG.mjs";
import { a as Ke } from "chunk-BFUL2V4K.mjs";
import { Id as Be, Xo as Ne, f as de } from "chunk-5ZU56KH3.mjs";
import { j as Ue, k as ie, n as Ge } from "chunk-MSZ2MPO7.mjs";
import { t as Xe } from "chunk-A4MMFDG2.mjs";
import { a as et, b as tt, i as ot } from "chunk-XAXFEYHI.mjs";
import { a as ze } from "chunk-SR2NVY3J.mjs";
import { a as $e } from "chunk-N2DJHBJE.mjs";
import { a as nt } from "chunk-CAJDAY24.mjs";
import { a as Ze, b as _e } from "chunk-P6Q3LWLD.mjs";
import { a as Je, b as Qe } from "chunk-TS24LVSZ.mjs";
import { a as qe } from "chunk-VD6KMVU6.mjs";
import { b as He } from "chunk-F3WIGDOL.mjs";
import { b as Ae } from "chunk-B45SUEOE.mjs";
import { a as Ye } from "chunk-AHBUMA74.mjs";
import { a as O } from "chunk-QFU6OGL3.mjs";
import { b as G, c as Ve, d as $, h as pe } from "chunk-C552IH6P.mjs";
import { g as fe } from "chunk-EQXTYSGC.mjs";
import { a as Fe } from "chunk-RNHTTH2C.mjs";
import { a as Me, d as ee } from "chunk-7BWPFUCH.mjs";
import { b as Le } from "chunk-YSP5ZHDJ.mjs";
import { a as M } from "chunk-2FCXHKEL.mjs";
import { t as Se } from "chunk-E2L4WW4T.mjs";
...
import { l as ke } from "chunk-MQDP3TYU.mjs";
...
var ae = b(M()),
  se = S.default.forwardRef(function (e, t) {
    let {
      ...
      P = S.default.useRef(d);
    P.current = d;
    let g = S.default.useRef(!1),
      v = S.default.useRef(null),
      [p, x] = S.default.useState(null),
      ...
      V = S.default.useCallback(
        (y) => {
          ...
          ((v.current = C),
            !(!T || !C) &&
              (w.mouseTrackerWillStart && w.mouseTrackerWillStart(), r && r(C), n(C), x(T)));
        },
        [w, r, n, u]
      );
    return (
      S.default.useLayoutEffect(() => {
        ...
        let y = !1,
          ...
          I = (R) => {
            ...
            ((v.current = N), P.current.onDrag(N));
          },
          K = (R) => {
            let W = st(R, l, p);
            ...
            ((v.current = W), P.current.onDrag(W));
          };
        return (
          ...
          () => {
            ...
            let R = v.current;
            (y
              ? (P.current.onDragEnd?.(R), w.mouseTrackerDidEnd?.())
              : queueMicrotask(() => {
                  (P.current.onDragEnd?.(R), w.mouseTrackerDidEnd?.());
                }),
              (v.current = null),
...
var ce = class extends U.default.Component {
    ...
    render() {
      ...
      if (z(t)) {
        let I = dt(t);
        I?.unit === "%" && ((d = fe(0, 100, I.value)), (P = 100 - I.value));
      }
      ...
      return (0, L.jsxs)("div", {
        ...
        children: [
            ...
            children: [
              (0, L.jsx)("div", {
                style: {
                  ...
                  maxHeight: `var(--floating-window-fixed-top, ${x})`,
                },
              }),
              (0, L.jsx)("div", {
          ...
          (0, L.jsx)("div", {
            style: { width: 0, flexGrow: `var(--floating-window-right, ${P})` },
          }),
        ],
      });
    }
    ...
    setRect(e, { rubberBandingEnabled: t, snapToEdges: n, fixedTop: r }) {
      ...
      if (n) {
        let p = Math.abs(f - s),
          ...
          w = Math.abs(l - a),
          h = Math.abs(l - u);
        (p < 16 ? (f = s) : x < 16 && (f = c), w < 16 ? (l = a) : h < 16 && (l = u));
      }
      let m = 0,
        d = 0;
...
var be = b(D(), 1);
var Pe = b(D(), 1),
  mt = Pe.default.createContext(!1),
  an = mt.Provider;
function vt() {
  return Pe.default.useContext(mt);
}
var te = be.default.createContext(void 0);
te.displayName = "VariableProviderInfoContext";
function Pn(o = !0) {
  let e = G(),
    t = vt(),
    n = be.default.useContext(te),
    r = je(
...
var ue = b(D(), 1),
  xe = (0, ue.createContext)(!1);
xe.displayName = "ShaderControlContext";
var gt = xe.Provider;
function ht() {
  return (0, ue.useContext)(xe);
}
var E = b(D(), 1),
  xt = b(M(), 1),
...
function bt({ children: o, variantOverrideTraitTypes: e, variantOverrideKeys: t }) {
  let n = (0, E.useRef)(),
    r = (0, E.useMemo)(() => {
      let i = new Set();
      return {
  ...
  return (
    ...
    (0, xt.jsx)(we.Provider, { value: r.addListener, children: o })
  );
}
var wt = "pvjhuxd",
  yt = "pcpv5lz",
...
function mo({
  ...
  return (
    ...
    { present: J, dismiss: Q, isPresenting: V, ref: x }
  );
}
function Ot(o) {
...
var vo = B.default.forwardRef(function (
  ...
  let {
    ...
    ne = {
      ...
      className: O(c, !d && !P && O(wt, oe && yt, t && It)),
      onKeyDown: Mt(Y, u),
      [Wt]: !0,
      ...I,
    },
    ...
    ({
      ...
      j.default.useEffect(() => {
        ...
        let d = !1,
          ...
          g = (p) => {
            d = !0;
            let x = this.getOutsidePointerDownBehavior(p.target);
            ((P = x === "keep-open"), x === "close" && this.closeIfPointerDownOutside(p));
          },
          v = (p) => {
            if (d) {
              if (P) {
...
//# sourceMappingURL=chunk-CHXVQ5AG.mjs.map
