import { a as d } from "chunk-ZHEXTBMH.mjs";
import { a as b } from "chunk-5ZU56KH3.mjs";
import { l as t } from "chunk-MQDP3TYU.mjs";
import { e as g } from "chunk-WLHSDIGQ.mjs";
function c(a) {
  t.isApiPlugin && performance.mark(`framer-loading-${a}`);
}
var l = g(b(), 1);
function M() {
...
var S = M(),
  ...
  u = class {
    ...
    dynamicMarks = [];
    isComplete = !1;
    handlePerformanceMark(e, o) {
      if (e in this.marks) {
        t.isDebugBuild && console.warn("Performance mark already exists", e);
        return;
      }
      ((this.marks[e] = o), e === "showUI" && (this.isComplete = !0));
    }
    handleDynamicMark(e) {
      this.dynamicMarks.push(e);
    }
  },
  m = class extends l.default {
    marksStore = new u();
    loadingInfoValue;
    constructor() {
      (super(),
    ...
    setLoadingInfo(e) {
      ((this.loadingInfoValue = e), this.emit("loading:info", e));
    }
    getLoadingInfo() {
      return this.loadingInfoValue;
    }
    wsInitialUpdatesValue;
    setWsInitialUpdates(e) {
      ((this.wsInitialUpdatesValue = e), this.emit("ws:init", e));
    }
    initialModuleLoadStatsValue;
    setInitialModuleLoadStats(e) {
      this.initialModuleLoadStatsValue = e;
    }
    ...
    getTtfb() {
      ...
      return (
        e instanceof PerformanceNavigationTiming &&
          (this.ttfbValue = Math.round(e.responseStart - e.startTime)),
        this.ttfbValue
      );
    }
  },
  p = t.isTest || t.isAutomation || t.isE2E,
  n = p ? null : new m();
function r() {
  return p
    ? !1
...
function y(a, e = f()) {
  ...
  let o = performance.now(),
    i = n?.isComplete() ? "post-loading" : "loading";
  (d(a, s, o, i), (s = o), n?.emit("performance:mark", a, e));
}
function E(a, e, o = f()) {
  if (!r()) return;
  let i = performance.now();
  (d(a, s, i, "post-loading"),
    (s = i),
    n?.emit("performance:dynamicMark", { name: a, label: e, value: o }));
}
function P(a) {
  r() && n?.setLoadingInfo(a);
}
function D(a) {
  r() && n?.setWsInitialUpdates(a);
}
function F(a) {
  r() && n?.setInitialModuleLoadStats(a);
}
export { l as a, S as b, R as c, n as d, y as e, E as f, P as g, D as h, F as i };
//# sourceMappingURL=chunk-MJX3NLH3.mjs.map
