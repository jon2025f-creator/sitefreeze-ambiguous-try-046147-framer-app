...
import { f as xe, h as we, m as _e } from "chunk-LA34HORX.mjs";
  ...
  (function () {
    ...
    ((s.prototype.load = function (l, d) {
      ...
      return new Promise(function (g, N) {
        if (w(u.context) && !h(u.context)) {
          var O = new Promise(function (I, T) {
              function v() {
                new Date().getTime() - B >= x
...
function yt(t, e, n, i) {
  ...
  return (
    Ft(e) && r.searchParams.set("scale-down-to", `${e}`),
...
var q = "BI;",
  z = class {
      ...
      for (let i of e) {
        ...
        let { properties: o } = i,
          ...
          p = {
            ...
            variant: F,
            file: h,
            hasOpenTypeFeatures: W(a),
            variationAxes: w,
            category: o.font.fontCategory,
            weight: m ? xt(w, o.font.faceDescriptors?.weight) : ce(F),
            style: je(F),
            cssFamilyName: k(r, m),
          };
    ...
    static parseVariant(e) {
      let n = Ke(e),
        o = n === "variable" || n === "variable-italic" ? 400 : $e[n],
        r = je(e);
...
var de = class t {
  ...
  importFonts(e) {
    ...
    for (let o of e) {
      ...
      let { family: r, variant: s, weight: a, style: c } = Ct(o.properties.font),
        ...
        x = Tt(u.fonts, f);
      if (x?.projectDuplicate) f.owner === "team" && ((u.fonts[x.index] = f), (n[y] = f));
      else if (x) {
        bt.debug("Duplicate font found for:", f, "with existing font:", x.existingFont);
        let g = x.existingFont,
          N = f.file?.endsWith(".woff2") ?? !1,
          O = g.file?.endsWith(".woff2") ?? !1,
          K = N && !O,
          I = N === O,
          T = f.owner === "team" || g.owner !== "team";
        (K || (I && T)) && ((u.fonts[x.index] = f), (n[y] = f));
      } else (u.fonts.push(f), (n[y] = f));
      (this.assetsByKey.set(o.key, o), Vt(i, r, s).fonts.push({ font: f, asset: o, selected: !1 }));
    }
...
var j = "FS;",
  ...
  Je = Object.keys(Xe),
  Ut = new RegExp(`^(?:${[...Je, "italic", "variable"].join("|")})`, "u"),
  X = class t {
    name = "fontshare";
    fontFamilies = [];
    byFamilyName = new Map();
    ...
    static parseVariant(e) {
      let n = e.toLowerCase().split(" "),
        i = Je.find((a) => n.includes(a)),
        o = e.toLowerCase().includes("italic") ? "italic" : "normal";
      return { weight: (i && Xe[i]) || 400, style: o === "italic" ? o : "normal" };
    }
    parseSelector(e) {
    ...
    async importFonts(e, n) {
      ...
      for (let r of e) {
        ...
        let w = t.createMetadataSelector(r.name),
          p = i[w];
        for (let l of a) {
          let {
              variantBold: d,
...
var Pt = {
  ...
  J = class t {
    ...
    static getDraftFontPropertiesBySelector(e) {
      if (!e.startsWith(Ye) && !e.startsWith(Mt)) return null;
      let n = e.split("-"),
        [i, o = ""] = n;
      if (!i) return null;
...
var $ = "GF;",
  Y = class t {
    ...
    parseSelector(e) {
      ...
      return !o || !r
        ? null
        : { name: o.replace($, ""), variant: r, source: this.name, isVariable: n };
    }
    static createSelector(e, n, i) {
      return `${$}${e}-${i ? "variable-" : ""}${n}`;
    }
    static createMetadataSelector(e) {
      return `${$}${e}`;
    }
...
var Wt = "System Default",
  pe = class {
    ...
    importFonts() {
      ...
      for (let [o, r] of Object.entries(et)) this.addFontAlias(o, r);
...
function ho(t) {
  return Q(t) && ot(t.return);
}
function So(t) {
  return Q(t) && ot(t.then);
}
function xo(t) {
...
var jt = () => {},
  ...
  $t = it && typeof window.requestIdleCallback == "function",
  _o = $t ? window.requestIdleCallback : setTimeout;
function bo(t) {
  return `url('${Kt(t)}')`;
}
function Kt(t) {
...
async function ct(t, e, n = 0) {
  ...
  if (!ye.has(m) || n > 0) {
    let F = new FontFace(i, `url(${o})`, {
      ...
      h = F.load()
        .then(() => (e.fonts.add(F), Re.set(m, { fontFace: F, doc: e }), Ve(i, c, a)))
        .catch((w) => {
...
async function Ve(t, e, n) {
  let i = lt(t, e, n);
  if (!fe.has(i)) {
    let r = new at.default(t, { style: e, weight: n }).load(null, rt);
    fe.set(i, r);
  }
  try {
    await fe.get(i);
    ...
    throw new ge(
      `Failed to check if font is ready (${rt}ms timeout exceeded): ${JSON.stringify({ family: t, style: e, weight: n })}`
    );
  }
}
function Ae(t) {
  let e = t.style || "normal",
    ...
    r = st(n, e, o, i),
    s = Re.get(r);
  (s && (s.doc.fonts.delete(s.fontFace), Re.delete(r)), ye.delete(r), fe.delete(lt(n, e, o)));
}
var Ne = {
  "FR;Inter": [
...
function ut(t) {
  return Q(t) && Object.values(t).every(Zt);
}
function zt(t) {
  return Q(t) && Fe(t.tag);
}
...
var Ue = class {
    ...
    importCustomFonts(e) {
      ...
      for (let [o, r] of n) {
        ...
        (s && s.file === r.file) ||
          ...
          r.file && Ae({ family: r.cssFamilyName, url: r.file, weight: r.weight, style: r.style }));
      }
    ...
    getDraftPropertiesBySelector(e) {
      ...
      if (i) {
        let a = Y.parseVariant(i.variant);
        if (P(a))
          return {
            style: a.style,
            weight: a.weight,
      ...
      if (o) {
        let a = X.parseVariant(o.variant);
        if (P(a))
          return {
            style: a.style,
            weight: a.weight,
      ...
      if (r) {
        let a = z.parseVariant(r.variant);
        if (P(a))
          return {
            style: a.style,
            weight: a.weight,
            variant: r.variant,
            cssFamilyName: se(r, "builtIn"),
            source: "builtIn",
            category: void 0,
          };
      }
    ...
    async loadFont(e) {
      ...
      switch (o) {
        ...
        case "framer":
          if ((Le() || (await Ve(n.family.name, n.style, n.weight)), r)) {
    ...
    async loadMissingFonts(e, n) {
      let i = e.filter((r) => !Be.loadedSelectors.has(r));
      if (i.length === 0) return;
      (await Be.loadWebFontsFromSelectors(i),
        i.every((r) => Be.loadedSelectors.has(r)) && n && n());
    }
...
((i) => {
  function t(o, r, s) {
    for (let a of Object.keys(o)) en(r, a) || delete o[a];
    for (let a of Object.keys(r))
      if (o[a] === void 0) {
        if (a === "id") {
          o[a] = s();
    ...
    return (Object.setPrototypeOf(o, Object.getPrototypeOf(r)), o);
  }
  ...
  i.writeOnce = e;
  function n(o, r) {
    return Object.assign(Object.create(Object.getPrototypeOf(o)), o, r);
  }
  i.update = n;
})((tn ||= {}));
var nn;
((o) => {
  ...
  function e(r, ...s) {
    let a = new Set(r);
    for (let c of s) a.delete(c);
    return a;
  }
  o.remove = e;
  function n(...r) {
    let s = new Set();
    for (let a of r) for (let c of a) s.add(c);
    return s;
  }
  o.union = n;
  function i(r, s) {
    return r.has(s) ? o.remove(r, s) : o.add(r, s);
  }
  o.toggle = i;
})((nn ||= {}));
var on;
((i) => {
  function t(o, ...r) {
    ...
    let a = !1;
    for (let c of r) c && (c.forEach((m, F) => s.set(F, m)), (a = !0));
    return a ? s : o;
  }
  i.merge = t;
  function e(o, r, s) {
...
//# sourceMappingURL=chunk-T6DXIA74.mjs.map
