import { d as Re, e as Be } from "chunk-4S6AOCBM.mjs";
import { Ma as ge, ri as z, si as Ae, ui as U } from "chunk-2K5QSXAJ.mjs";
import { r as $, u as q } from "chunk-NDW4C7EE.mjs";
import { a as we, b as ve, c as Pe, d as k, e as Te, f as Ce } from "chunk-OZAKPX5P.mjs";
import { a as ye, b as be, d as J, e as f, g as N } from "chunk-BTIAZMDQ.mjs";
import { a as Ie } from "chunk-CQFDQWO5.mjs";
import { a as F, b as O, e as Le, h as De, i as A } from "chunk-PI4LEFBH.mjs";
import { Yd as pe, _d as W, fe as L, ye as fe } from "chunk-HJB2NA6N.mjs";
import { a as Y } from "chunk-ZHEXTBMH.mjs";
import { Si as he, Ye as ce, gv as le } from "chunk-GB62NWOV.mjs";
import { mb as ie, nb as de } from "chunk-TQAEZDSC.mjs";
import { a as me, b as K, r as Se } from "chunk-MJMVAKGI.mjs";
import { a as y } from "chunk-GBD3AMAR.mjs";
import { f as ue } from "chunk-S4TNZLB6.mjs";
import { a as Ne } from "chunk-24G7FGVN.mjs";
import { z as M } from "chunk-DTSMQR7C.mjs";
import { e as ne } from "chunk-LA34HORX.mjs";
import { b as g } from "chunk-4JY5UMT2.mjs";
import { l as ae } from "chunk-MQDP3TYU.mjs";
...
function qe(c) {
  try {
    let o = localStorage.getItem(Ee(c));
    return o && o !== y ? o : null;
  } catch {
    return null;
  }
...
function ke(c, o) {
  try {
    let e = Ee(c);
    o === y ? localStorage.removeItem(e) : localStorage.setItem(e, o);
  } catch {}
}
var Oe = 300 * 1024 * 1024,
  T = {
    ASCII: 128,
    TWO_BYTE: 224,
    TWO_BYTE_VALUE: 192,
...
I[b.TAB] = 1;
I[b.NEWLINE] = 1;
I[b.CARRIAGE_RETURN] = 1;
var G = class {
    bytes;
    u32View;
    constructor(o) {
      this.bytes = o;
      let e = Math.floor(o.length / D);
    ...
    scanUtf16UnitsToByteOffset(o, e) {
      ...
      for (; r < e && s < this.bytes.length;) {
        ...
        a < T.ASCII
          ? (r++, s++)
          : (a & T.TWO_BYTE) === T.TWO_BYTE_VALUE
            ? (r++, (s += 2))
            : (a & T.THREE_BYTE) === T.THREE_BYTE_VALUE
              ? (r++, (s += 3))
              : (a & T.FOUR_BYTE) === T.FOUR_BYTE_VALUE
                ? ((r += 2), (s += 4))
                : s++;
      }
      return s;
    ...
    tryFastAsciiScan(o, e) {
      ...
      let t = o / D,
        r = e,
        s = t;
      for (; r >= D && s < this.u32View.length;)
        if ((this.u32View[s] & He) === 0) ((r -= D), s++);
        else return null;
      return r === 0 ? s * D : null;
    }
  },
  X = class {
    ...
    childrenKeyBytes = this.encoder.encode(F);
    ...
    parsePageInternal(o, e, t) {
      ...
      if (t) {
        let i = r + this.childrenKeyBytes.length - 1,
          n = e - 1;
        a.children = this.parseChildrenArray(i, n);
      } else a.children = [];
      return a;
    }
    ...
    parseChildrenArray(o, e) {
      return e - o < Oe ? this.parseJsonSlice(o, e) : this.parseChildrenByteLevel(o, e);
    }
    parseChildrenByteLevel(o, e) {
      let t = [],
        r = o + 1;
      for (; r < e && I[this.bytes[r]] === 1;) r++;
      for (; r < e - 1 && this.bytes[r] !== b.CLOSE_BRACKET;) {
        let s = r,
          a = 0,
          i = !1,
          n = !1;
        for (; r < e;) {
          let d = this.bytes[r];
          if (n) n = !1;
          else if (d === b.BACKSLASH) n = !0;
          else if (d === b.QUOTE && !n) i = !i;
          else if (!i) {
            if (d === b.OPEN_BRACE) a++;
            else if (d === b.CLOSE_BRACE && (a--, a === 0)) {
              r++;
              break;
            }
          }
        ...
        if (r > s)
          if (r - s >= Oe) t.push(this.parsePageInternal(s, r, !0));
          else {
            let l = this.bytes.subarray(s, r),
              m = this.decoder.decode(l),
              v = JSON.parse(m);
            t.push(v);
          }
    ...
    skipCommaAndWhitespace(o, e) {
      for (; o < e;) {
        let t = this.bytes[o];
        if (t === b.COMMA || this.isWhitespace(t)) o++;
        else break;
      }
      return o;
    }
    ...
    indexOfPattern(o, e, t) {
      ...
      for (; i <= s - a;) {
        let n = a - 1;
        for (; n >= 0 && o[n] === this.bytes[e + i + n];) n--;
        if (n < 0) return e + i;
        {
          let d = this.bytes[e + i + n],
            l = r[d] ?? -1;
          i += Math.max(1, n - l);
        }
      }
  ...
  _ = class {
    ...
    constructor(o, e = {}) {
      ((this.bytes = o),
        ...
        (this.scanner = new G(o)),
        (this.jsonParser = new X(o)));
      let {
        root: t,
        version: r,
        header: s,
    ...
    parseHeaderAndRoot() {
      let o = this.encoder.encode(F),
        e = this.jsonParser.indexOfPattern(o, 0, this.bytes.length);
      if (e === -1)
        throw new Error(
          `Document format error: '${F}' key not found in ${this.bytes.length} byte document`
        );
      let t = e + o.length,
    ...
    getHomePageNodeID() {
      if (De(this.root, "homePageNodeId") && typeof this.root.homePageNodeId == "string")
    ...
    getPartialDocumentForPageIds(o) {
      for (let t of O) this.parseFullPage(t);
      let e = new Set();
    ...
    parseDependentPages(o) {
      ...
      for (let t of o) {
        ...
        for (let s of this.parsePagesContainingId(t)) A(s, s, e, !1);
      }
...
var Me = w("DocumentLoader"),
  ...
  V = class c {
    ...
    readFirstPage() {
      ...
      if (
        (this.settings.activeNodeId &&
          ...
          (o = e.some((t) => U(this.parser.getShallowPage(t))))),
        !o)
      ) {
        let t = this.parser.getShallowPages(),
          { maybeFirstPage: r } = z(t, this.parser.getHomePageNodeID());
        e.push(r.id);
        let s = 0,
          a;
        for (let i of t) {
          if ((ie(i, !0) && s++, s > 1)) break;
          de(i, !0) && (a ??= i.id);
        }
      ...
      return (
        ...
        Ce(this.parser, this.componentLoader, e, this.settings.treeServices)
      );
    }
    getScopesToLoad() {
    ...
    buildPage(o) {
      if (!o) return;
      let e = [],
        t = Q.isLoggingTraceMessages() ? [] : void 0,
        r = L(o, this.parser.root.id, { extraChecksAndFixes: !0, errors: e, warnings: t });
      if (
        (r && k(r, e),
        e.length > 0 &&
          Q.warn(
...
function ct(c, o) {
  ...
  try {
    ...
    Z.error(`Retrieving document \u201C${c}\u201D failed. (${r})`);
  }
  return ee(e, o);
}
function ze(c) {
...
function ee(c, o) {
  ...
  try {
    ...
    throw (ze(e), Z.warn("tree failed to verify:", t), t);
  }
}
var h = w("DocumentLoader"),
  E = 10,
  R = 1e3;
function C(c) {
  return c < 1024 * 0.75
...
var j = class extends ye.default {
  constructor(e, t, r, s) {
    super();
    ...
    this.documentURL = r;
    this.settings = s;
    ((this.scheduler = new Be(s.isUserIdleCallback)),
      h.debug("new:", this.treeVersion, this.documentURL));
  }
  componentLoader;
  treeVersion;
  documentURL;
  ...
  pauseLoadingScopes() {
    this.loadingScopesPaused ||
      ...
      h.debug("pauseLoadingScopes"),
      this.updatePauseResumeState());
  }
  resumeLoadingScopes() {
    this.loadingScopesPaused &&
      ((this.loadingScopesPaused = !1),
      h.debug("resumeLoadingScopes"),
      this.updatePauseResumeState());
  }
  prioritizeLoadingAllData(e) {
    ...
    ((this.loadAllDataPriority = Math.max(1, this.loadAllDataPriority + 1)),
      h.debug("prioritizeLoadingScopes:", this.loadAllDataPriority),
      this.updatePauseResumeState());
    let a = t || ("doNotTrack" in e && e.doNotTrack),
      ...
      m = (d ? d === "crdt" : pe())
        ? this.afterAllDataLoaded(() => {
            ...
            h.reportError(new Error("Full tree loaded"), v, { operationName: e.operationName });
          })
        : void 0;
    return () => {
      i || ((i = !0), n?.(), m?.(), this.stopPrioritizingLoadingAllData());
    };
  }
  stopPrioritizingLoadingAllData() {
    ((this.loadAllDataPriority -= 1),
      h.debug("stopPrioritizingLoadingScopes:", this.loadAllDataPriority),
      this.updatePauseResumeState());
  }
  debugPause() {
    this.debugPaused ||
      ((this.debugPaused = !0), h.debug("debugPause"), this.updatePauseResumeState());
  }
  debugResume() {
    this.debugPaused &&
      ((this.debugPaused = !1), h.debug("debugResume"), this.updatePauseResumeState());
  }
  isDebugPaused() {
  ...
  async start() {
    return this.scheduler.run(async () => {
      (h.debug("start"), f("parsingInit"), this.updatePauseResumeState());
      let e = performance.now(),
        t = await this.loadData();
      ((this.loadingDuration = performance.now() - e), f("documentBytesReady"));
      ...
      if (
        ...
        !this.settings.partialParsing || (typeof t == "string" && !Le(t)))
      )
  ...
  async loadData() {
    ...
    h.debug("Document in cache is not up to date. Tree version:", this.treeVersion);
    let e = this.settings.initData,
      t = e?.version === this.treeVersion,
      r = e?.prefetchPromise;
    if ((e && (e.prefetchPromise = void 0), t && r)) {
      h.debug("loadData: prefetch");
      let n = await r;
      if (
        (r
          .then((d) => d.duration)
        ...
        h.debug("loadData: prefetch bytes parser");
        let d = await n.buffer;
        return (
          await this.scheduler.resumeOrThrow(),
      ...
      if (n.text) {
        ...
        return (
          await this.scheduler.resumeOrThrow(),
          n.status < 200 || n.status >= 300 ? this.handleErrorAndRetry(n.status, d) : d
        );
      }
    }
    h.debug("loadData: fetch");
    let s;
    ...
    function i(n) {
      ...
      let d = new URLSearchParams(window.location.search).has("bytes"),
        ...
        m = parseInt(n.headers.get("Uncompressed-Content-Length") ?? "0", 10) > 2e8;
      return (d && (document.cookie = "bytes-parser=true; path=/;"), d || l || m);
    }
    if ((f("dataLoad"), a.status < 200 || a.status >= 300)) {
      let n = await a.text();
      return this.handleErrorAndRetry(a.status, n);
    }
    if (i(a)) {
      h.debug("loadData: using streaming parser");
      let n = await a.arrayBuffer();
      return new Uint8Array(n);
    } else {
      h.debug("loadData: using text parser");
      let n = await a.text();
  ...
  async handleErrorAndRetry(e, t) {
    ...
    if (r && this.retryCount < E)
      return (
        h.debug("onErrorStatusLoaded, retry:", this.retryCount),
  ...
  parseFullDocumentSync(e) {
    ...
    let r = JSON.parse(e);
    if (!ne(r.version)) throw Error("cannot read document version");
    if (
      ...
      return;
    let s = ee(r, this.componentLoader);
  ...
  async loadDocumentVersion(e) {
    let t = performance.now(),
      r = await V.createPartialParser(e, this.componentLoader, this.settings);
    return (
  ...
  async loadFirstTree(e) {
    ...
    return (
      (this.parsingDuration += performance.now() - t),
      h.debug("loadFirstTree", S(this.parsingDuration)),
      await this.emitWrapped(() => {
        if (this.scheduler.isDone()) return;
        let s = performance.now();
  ...
  async loadScopeAsync(e) {
    ...
    await this.emitWrapped(() => {
      ...
      let s = performance.now(),
        ...
        i = a.take();
      if (!i) return;
      this.emit("loadedScope", i);
      let n = performance.now();
      ((this.parsingDuration += a.duration + n - s),
        this.signalScopeLoadCallbacks(i.id),
        h.debug(
          "loadScopeAsync:",
          e,
          S(a.duration),
  ...
  loadScope(e) {
    ...
    return (
      ...
      h.debug("loadScope:", e, S(r.duration)),
      this.signalScopeLoadCallbacks(e),
      Y("loadScope", t, s, "vekter"),
      r.take()
    );
  }
  ...
  async nodeIdsToLoad() {
    ...
    return (h.debug("nodeIdsToLoad", t.size, S(performance.now() - e)), t);
  }
  addedByDiff = new Set();
...
function Ue(c, o) {
  if (o && (c.add(o.id), !!o.children)) for (let e of o.children) Ue(c, e);
}
var B = class {
    constructor(o, e) {
      this.node = o;
  ...
  te = class {
    ...
    force() {
      ...
      return (
        ...
        (this.loadedScope = new B(e, performance.now() - o)),
        this.loadedScope
      );
    }
  };
var re = class {
    ...
    loadScopeDataFromStore() {
      ...
      if (!o) {
        p.debug("No object with id " + this.id + " in the store");
        return;
      }
      return o;
    }
    ...
    force() {
      ...
      let o = performance.now(),
        ...
        r = performance.now() - o;
      return ((this.loadedScope = new B(t, r)), this.loadedScope);
    }
    buildPage(o) {
      if (!o) return;
      let e = [],
        t = p.isLoggingTraceMessages() ? [] : void 0,
        r = L(o, void 0, { extraChecksAndFixes: !0, errors: e, warnings: t });
      if (
        (r && k(r, e),
        e.length > 0 &&
          p.warn(
...
`)
  ...
  _e = class {
    ...
    loadSnapshot(o) {
      ((this.branches?.getStore(y) ?? this.mainStore).fromBuffer(o), this.branches?.reset());
    }
    reset() {
  ...
  xe = class extends j {
    ...
    applySeqWatermarkToStore(e) {
      ...
      let t = me().getSeqWatermark(this.projectId, e.branchId);
      if (t === void 0) return;
      let { from: r, to: s } = e.ensureMinSeq(t);
      r !== s &&
        p.warn("seq watermark applied", {
    ...
    loadFirstCrdtTreeFromStore(e) {
      ...
      let a = [],
        ...
        d = n ? this.store.getObjectWithShallowChildren(n, 1) : void 0;
      ...
      U(d)
        ? a.push(d.id)
        : ((i = z(s.children ?? [], s?.homePageNodeId)), a.push(i.maybeFirstPage.id));
      let l = L(s, null, { extraChecksAndFixes: !0, errors: t, warnings: t });
      g(l, "Unable to load document");
      for (let u of l.children) ((u.cache.isShallowLoad = !0), O.includes(u.id) && a.push(u.id));
      for (let u of a) {
        if (!u) continue;
        let H = this.store.getObject(u);
        if (!H) {
          p.debug("No value for " + u);
          continue;
        }
        let P = L(H);
        (g(P, "Scope node instance could not be created"),
          (P.cache.isShallowLoad = !1),
          P.cache.setSerializedCache(P, H),
          this.trackSerializedScopeCache(P));
        let oe = l.children.findIndex((Ve) => Ve.id === u);
        (oe >= 0 && l.children.splice(oe, 1, P), this.parsedIds.add(u));
        let se = P;
        u === i?.maybeFirstPage.id &&
          i.firstDesignPage &&
          Ae(se, i.firstDesignPage) !== se &&
          a.push(i.firstDesignPage.id);
      }
      Pe(l, t);
      ...
      let m = fe.createByAdoptingRoot(l, { ...this.settings.treeServices, mode: "crdt" });
      (m.verify(),
        (m = he.treeDidLoad(m, this.componentLoader, []).didNonLinearMove(this.componentLoader)));
      let v = [];
      return (
        we(m, v) &&
          (v.forEach((u) => {
            (t.push(`${u.id}: code component links itself via ${u.stack}`), Te(m, u.id, u.stack));
          }),
          (m = m.commit(this.componentLoader))),
        (m.chunkingHints = this.computeChunkingHints()),
        m.setService("loader", this),
        m
      );
    }
    computeChunkingHints() {
      if (this.documentSize < 0)
        return (
          p.warn("document size not set, skipping chunking hints:", this.documentSize),
          new Set()
        );
      let e = new Set();
      ...
      let s = t.sizeWithoutReplicas(),
        ...
        i = t.getChildrenIds(r);
      for (let n of i) t.getSubtreeCount(n) * a * We > 2e8 && e.add(n);
      return e;
    }
    ...
    async createTreeFromBuffer(e) {
      ...
      let t = q.loadVersionFromBuffer(e);
    ...
    async createTreeFromCachedState(e, t = 0) {
      ...
      let r = q.loadVersionFromBuffer(e.snapshot);
      if (r < $)
        return (
          p.reportError(
      ...
      try {
        (this.storeTarget.loadSnapshot(e.snapshot),
          this.applySeqWatermark(),
          f("buildStore"),
          e.rows.length > 0 && (this.addCachedRowsToStores(e.rows), f("addedRows")));
        let s = e;
        if (((s.snapshot = void 0), t)) {
          let i = this.store.getHierarchy().computeTreeHash();
          if (t !== i)
            return (
              p.reportCriticalError("hierarchy hash mismatch, falling back to full document load", {
                version: this.treeVersion,
                hierarchyHash: t,
                computedHierarchyHash: i,
                documentSize: this.documentSize,
              }),
              this.settings.localCache?.abortAndClearCache(),
              this.storeTarget.reset(),
    ...
    addCachedRowsToStores(e) {
      function* t(n) {
        for (let d of n) for (let l of d.rows) yield l;
      }
      this.branches && g(this.store === this.branches.getStore(y), "main store mismatch");
      let r = ge(t(e)),
        s = r.get(y);
      if ((s && this.store.addSerializableRows(s), r.delete(y), r.size === 0)) return;
      let a = this.branches;
      g(a, "branch registry is required to load cached branch rows");
      let i = [...r].sort(([n], [d]) => a.getBranchPath(n).length - a.getBranchPath(d).length);
      for (let [n, d] of i) a.getStore(n).addSerializableRows(d);
    }
    async start() {
      await this.scheduler.run(async () => {
        (p.debug("start"), f("parsingInit"), this.updatePauseResumeState());
        let e = [],
          t = performance.now(),
          r = this.settings.localCache;
        if (r && !r.aborted)
          try {
            let i = !!this.settings.initData?.prefetchSyncPromise;
            e.push(i ? "prefetch-sync" : "sync");
            ...
            (this.settings.initData && delete this.settings.initData.prefetchSyncPromise,
              n
                ...
                .then((l) => f("dataLoad", l))
                .catch(() => {}));
            let d = await r.syncCrdtData(n);
            if (((n = void 0), d && d.version >= this.treeVersion)) {
              if (
                ((this.loadingDuration = performance.now() - t),
                f("documentBytesReady"),
                N({
                  format: "crdt",
                  strategy: d.syncStrategy,
                  sources: e,
                  snapshotBytes: d.snapshot.byteLength,
                  snapshotSource: d.snapshotSource,
                  cacheBackend: d.cacheBackend,
                  cachedRows: d.cachedRows,
                  cachedRowBytes: d.cachedRowBytes,
                  downloadedRows: d.downloadedRows,
                  downloadedRowBytes: d.downloadedRowBytes,
                }),
                await this.scheduler.yield(),
                await this.createTreeFromCachedState(d, d.hierarchyHash))
              )
                return;
              p.warn("local cache failed to create tree, falling back to full document load");
            } else
              d
                ? p.warn(
                    "local cache behind websocket init tree version, falling back to full document load"
                  )
                : p.warn("local cache failed, falling back to full document load");
          } catch (i) {
            if (this.storeTargetInstalled) throw (r.abortAndClearCache(), i);
            p.warn("tree/sync failed, falling back to full document load:", i);
          }
    ...
    async fetchTreeSync() {
      ...
      J && !J.isComplete() && (a = be);
      let i;
      this.settings.refreshAccessToken && (i = await this.settings.refreshAccessToken({}));
      let n = await fetch(s, i),
        d = "Sync-Strategy";
      return {
        status: n.status,
        headers: n.headers,
        duration: Promise.resolve(performance.now() - a),
        updates: n.headers.get(d) === "incremental" ? n.json() : void 0,
        snapshot: n.headers.get(d) === "snapshot" ? n.arrayBuffer() : void 0,
      };
    }
    async loadCrdtData(e = []) {
      if (this.settings.loadedData && this.settings.loadedData instanceof Uint8Array)
        return (p.debug("loadData: loadedData"), e.push("loaded-data"), this.settings.loadedData);
      let t = this.settings.initData;
      if ((p.debug("loadData: prefetch"), t?.prefetchPromise)) {
        let s = t.prefetchPromise;
        if ((delete t.prefetchPromise, t.version === this.treeVersion)) {
          e.push("prefetch-tree");
          let a = await s;
          if (
            (a.duration.then((i) => f("dataLoad", i)).catch(() => {}),
            a.status < 200 || a.status >= 300)
          )
            throw new Error(`Failed to fetch project data. Status code: ${a.status}`);
          if (a.buffer) {
            p.debug("loadData: prefetch bytes parser");
            let i = await a.buffer;
            return (await this.scheduler.yield(), new Uint8Array(i));
          }
        }
      }
      if (t?.prefetchSyncPromise) {
        ...
        if (Number(a.headers.get("Tree-Version")) === this.treeVersion) {
          if (
            (a.duration.then((n) => f("dataLoad", n)).catch(() => {}),
            a.status < 200 || a.status >= 300)
          )
            throw new Error(`Failed to fetch project data. Status code: ${a.status}`);
          if (a.snapshot) {
            (e.push("prefetch-sync"), p.debug("loadData: prefetch sync snapshot"));
            let n = await a.snapshot;
            return (await this.scheduler.yield(), new Uint8Array(n));
          }
        }
      }
      (e.push("tree-download"), p.debug("loadData: fetch"));
      let r;
      this.settings.refreshAccessToken &&
      ...
      for (let s = 0; s < E; ++s)
        try {
          ...
          if (!(a instanceof K) || !a.isTemporary || s === E - 1) throw a;
          (p.debug("temporary error loading document, retry:", s),
            await this.scheduler.sleep(s * R + Math.random() * R));
        }
      throw Error(`Failed to fetch project data after attempting ${E} times`);
    }
    ...
    createLoadingScope(e) {
      return new re(e, this.store, (t) => this.trackSerializedScopeCache(t));
    }
...
export { qe as a, ke as b, ct as c, ee as d, j as e, _e as f, xe as g };
//# sourceMappingURL=chunk-7OJY3LXK.mjs.map
