...
var te,
  ...
  Ae = t(() => {
    ((te = Object.create),
        ...
        for (var y = r.length - 1; y >= 0; y--)
          ((l = ve(d, n, (c = {}), e[3], _)),
            d &&
              ...
              d ^ 3 &&
                (u.get = p ? (e) => (d ^ 1 ? Te : De)(e, i, d ^ 4 ? a : v.get) : (e) => e[n]),
              d > 2 &&
      ...
      (De = (e, t, n) => (Ce(e, t, `access private method`), n)),
      (Oe = (e, t, n) => {
        if (t != null) {
          typeof t != `object` && typeof t != `function` && se(`Object expected`);
          var r, i;
          (n && (r = t[oe(`asyncDispose`)]),
            r === void 0 && ((r = t[oe(`dispose`)]), n && (i = r)),
            typeof r != `function` && se(`Object not disposable`),
            i &&
              (r = function () {
                try {
                  i.call(this);
...
function Ye(e) {
  let t = Ge(e);
  return qe(t)(t.values.map((e, n) => Vc(e, t.split[n])));
}
function Xe(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function Ze({ hue: e, saturation: t, lightness: n, alpha: r }) {
  ((e /= 360), (t /= 100), (n /= 100));
  let i = 0,
    a = 0,
    o = 0;
  if (!t) i = a = o = n;
    ...
    let r = n < 0.5 ? n * (1 + t) : n + t - n * t,
      s = 2 * n - r;
    ((i = Xe(s, r, e + 1 / 3)), (a = Xe(s, r, e)), (o = Xe(s, r, e - 1 / 3)));
  }
  return {
...
function it(e, t) {
  let n = { ...e, ...t },
    r = {};
  for (let i in n) e[i] !== void 0 && t[i] !== void 0 && (r[i] = nt(e[i])(e[i], t[i]));
  return (e) => {
...
function vt(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
  let a = e.length;
...
function Ct({ duration: e = 300, keyframes: t, times: n, ease: r = `easeInOut` }) {
  let i = nc(r) ? r.map(oc) : oc(r),
    a = { done: !1, value: t[0] },
    o = vt(xt(n && n.length === t.length ? n : bt(t), e), t, {
      ease: Array.isArray(i) ? i : St(t, i),
    });
  return { calculatedDuration: e, next: (t) => ((a.value = o(t)), (a.done = t >= e), a) };
}
function wt(e, { repeat: t, repeatType: n = `loop` }, r, i = 1) {
  let a = e.filter(tl),
...
function Mt() {
  if (Cl) {
    ...
    (t.forEach((e) => {
      ...
      e.forEach((e) => {
        e.suspendedScrollY !== void 0 && f.scrollTo(0, e.suspendedScrollY);
      }));
  }
...
function Bt({ type: e, ...t }) {
  return zt(e) && Al() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Vt(e) {
  return e in Pl;
}
function Ht(e) {
  typeof e.ease == `string` && Vt(e.ease) && (e.ease = Pl[e.ease]);
}
function Ut(e) {
...
function qt(e, t, n, r) {
  ...
  let a = e[e.length - 1],
    o = Vl(i, t),
    s = Vl(a, t);
  return (`${t}${i}${a}${o ? a : i}`, !o || !s ? !1 : Kt(e) || ((n === `spring` || zt(n)) && r));
}
function Jt(e, t) {
  let n = 0;
...
function en(e, t, n = 1) {
  ...
  let [r, i] = $t(e);
  if (!r) return;
  let a = f.getComputedStyle(t).getPropertyValue(r);
  if (a) {
    let e = a.trim();
    return Ns(e) ? parseFloat(e) : e;
  }
  return mc(i) ? en(i, t, n + 1) : i;
}
function tn(e) {
  let t = [{}, {}];
  return (
...
function rn(e, t, n) {
  let r = e.getProps();
  return nn(r, t, n === void 0 ? r.custom : n, e);
}
function an(e, t, n) {
...
function sn(e, t) {
  let { transitionEnd: n = {}, transition: r = {}, ...i } = rn(e, t) || {};
  i = { ...i, ...n };
  for (let t in i) an(e, t, on(i[t]));
}
function cn(e) {
  return !!(X(e) && e.add);
}
...
function pn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  let d = [],
    ...
    m = a?.path;
  m && m.animateVisualElement(e, s, a, n, d);
  for (let t in s) {
    let r = e.getValue(t, e.latestValues[t] ?? null),
      i = s[t];
    if (i === void 0 || (p && fn(p, t))) continue;
    let o = { delay: n, ...Zt(a || {}, t) };
    ...
    if (f.MotionHandoffAnimation) {
      let n = dn(e);
      if (n) {
        let e = f.MotionHandoffAnimation(n, t, R);
        e !== null && ((o.startTime = e), (m = !0));
      }
    }
    ln(e, t);
    let h = l ?? e.shouldReduceMotion;
    r.start(nu(t, r, i, h && iu.has(t) ? { type: !1 } : o, e, m));
    let g = r.animation;
    g && d.push(g);
  }
  if (o) {
...
function mn(e, t, n = {}) {
  let r = rn(e, t, n.type === `exit` ? e.presenceContext?.custom : void 0),
    { transition: i = e.getDefaultTransition() || {} } = r || {};
  n.transitionOverride && (i = n.transitionOverride);
  let a = r ? () => Promise.all(pn(e, r, n)) : () => Promise.resolve(),
    o =
      e.variantChildren && e.variantChildren.size
        ? (r = 0) => {
            let { delayChildren: a = 0, staggerChildren: o, staggerDirection: s } = i;
            return hn(e, t, r, a, o, s, n);
          }
        : () => Promise.resolve(),
    { when: s } = i;
  if (s) {
...
function hn(e, t, n = 0, r = 0, i = 0, a = 1, o) {
  let s = [];
  for (let c of e.variantChildren)
    (c.notify(`AnimationStart`, t),
      s.push(
        mn(c, t, {
          ...o,
          delay: n + (typeof r == `function` ? 0 : r) + Yt(e.variantChildren, c, r, i, a),
...
function gn(e, t, n = {}) {
  ...
  let r;
  if (Array.isArray(t)) {
    let i = t.map((t) => mn(e, t, n));
    r = Promise.all(i);
  } else if (typeof t == `string`) r = mn(e, t, n);
  else {
    let i = typeof t == `function` ? rn(e, t, n.custom) : t;
    r = Promise.all(pn(e, i, n));
  }
  return r.then(() => {
...
function bn(e, t, n) {
  ...
  if (i && n) for (let r of t) e[r] = vn(n, i);
}
function xn(e, t, n) {
  if (e == null) return [];
  ...
  return (
    r.forEach((e) => {
      let n = !1,
        ...
        c = (e) => {
          ((n = !1),
            f.removeEventListener(`pointerup`, c),
            f.removeEventListener(`pointercancel`, c),
            r && ((r = !1), s(e)));
        },
        l = () => {
          ((n = !0),
            f.addEventListener(`pointerup`, c, i),
            f.addEventListener(`pointercancel`, c, i));
        },
        u = (e) => {
...
function Nn(e, t, n = {}) {
  let [r, i, a] = Tn(e, n),
    o = (e) => {
      ...
      if (!Mn(e) || Nu.has(e)) return;
      (ju.add(r), n.stopPropagation && Nu.add(e));
      let a = t(r, e),
        o = { ...i, capture: !0 },
        s = (e, t) => {
          (f.removeEventListener(`pointerup`, c, o),
            f.removeEventListener(`pointercancel`, l, o),
            ju.has(r) && ju.delete(r),
            Mn(e) && typeof a == `function` && a(e, { success: t }));
        },
        c = (e) => {
          s(e, r === f || r === document || n.useGlobalTarget || Du(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
      (f.addEventListener(`pointerup`, c, o), f.addEventListener(`pointercancel`, l, o));
    };
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? f : e).addEventListener(`pointerdown`, o, i),
        Sn(e) &&
          (e.addEventListener(`focus`, (e) => Mu(e, i)),
          !On(e) && !e.hasAttribute(`tabindex`) && (e.tabIndex = 0)));
    }),
    a
  );
}
...
function Fn({ target: e, borderBoxSize: t }) {
  Pu.get(e)?.forEach((n) => {
    n(e, {
      get width() {
        return Lu(e, t);
...
function Ln() {
  typeof ResizeObserver > `u` || (Fu = new ResizeObserver(In));
}
function Rn(e, t) {
  Fu || Ln();
  let n = xn(e);
  ...
  return (
    ...
    () => {
      (zu.delete(e),
        !zu.size &&
          typeof Bu == `function` &&
          (f.removeEventListener(`resize`, Bu), (Bu = void 0)));
    }
  );
}
function Vn(e, t) {
  return typeof e == `function` ? Bn(e) : Rn(e, t);
}
function Hn(e, t) {
  let n,
    r = () => {
...
function Gn(e = 0.1, { startDelay: t = 0, from: n = 0, ease: r } = {}) {
  return (i, a) => {
    let o = typeof n == `number` ? n : Wn(n, a),
      s = e * Math.abs(o - i);
    if (r) {
      let t = a * e;
      s = oc(r)(s / t) * t;
...
function qn(e, t, n = {}) {
  ...
  if (
    (e.attach((e, t) => {
      ((a = e), (o = (e) => t(Jn(e, s))), R.postRender(u));
    }, c),
    X(t))
  ) {
    let r = n.skipInitialAnimation === !0,
      i = t.on(`change`, (t) => {
        r ? ((r = !1), e.jump(Jn(t, s), !1)) : e.set(Jn(t, s));
      }),
      a = e.on(`destroy`, i);
    return () => {
      (i(), a());
...
function er(e) {
  return Qn(e.animate) || Yu.some((t) => $n(e[t]));
}
function tr(e) {
...
function dr(e) {
  return ur(e) || fr(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY;
}
function fr(e) {
...
function hr(e, t, n, r, i) {
  return (i !== void 0 && (e = mr(e, i, r)), mr(e, n, r) + t);
}
function gr(e, t = 0, n = 1, r, i) {
  ((e.min = hr(e.min, t, n, r, i)), (e.max = hr(e.max, t, n, r, i)));
}
function _r(e, { x: t, y: n }) {
...
function vr(e, t, n, r = !1) {
  ...
  for (let s = 0; s < i; s++) {
    ...
    (i && i.props.style && i.props.style.display === `contents`) ||
      ...
      o && ((t.x *= o.x.scale), (t.y *= o.y.scale), _r(e, o)),
      r && dr(a.latestValues) && xr(e, a.latestValues, a.layout?.layoutBox));
  }
...
function yr(e, t, n, r, i = 0.5) {
  gr(e, t, n, q(e.min, e.max, i), r);
}
function br(e, t) {
...
function xr(e, t, n) {
  let r = n ?? e;
  (yr(e.x, br(t.x, r.x), t.scaleX, t.scale, t.originX),
    yr(e.y, br(t.y, r.y), t.scaleY, t.scale, t.originY));
}
function Sr(e, t) {
  return or(cr(e.getBoundingClientRect(), t));
}
function Cr(e, t, n) {
  let r = Sr(e, n),
    { scroll: i } = t;
...
function Tr(e, t, n) {
  ...
  if (
    (t.transform || (o || n ? (r.transform = wr(t, e.transform, n)) : (r.transform &&= `none`)), s)
  ) {
    let { originX: e = `50%`, originY: t = `50%`, originZ: n = 0 } = a;
    r.transformOrigin = `${e} ${t} ${n}`;
  }
}
function Er(e, { style: t, vars: n }, r, i) {
  let a = e.style,
    o;
  for (o in t) a[o] = t[o];
...
function kr(e, { layout: t, layoutId: n }) {
  return (
...
function Ar(e, t, n) {
  ...
  if (!r) return a;
  for (let t in r)
    (X(r[t]) || (i && X(i[t])) || kr(t, e) || n?.getValue(t)?.liveStyle !== void 0) &&
      (a[t] = r[t]);
  return a;
}
function jr(e) {
...
function Pr(
  ...
  (t !== void 0 && (d.x = t),
    n !== void 0 && (d.y = n),
    r !== void 0 && (d.scale = r),
    i !== void 0 && Nr(d, i, a, o, !1));
}
function Fr(e, t, n, r) {
  Er(e, t, void 0, r);
  for (let n in t.attrs) e.setAttribute(gd.has(n) ? n : un(n), t.attrs[n]);
}
function Ir(e, t, n) {
  let r = Ar(e, t, n);
  for (let n in e)
...
function zr(e) {
  return (t) => Promise.all(t.map(({ animation: t, options: n }) => gn(e, t, n)));
}
function Br(e) {
  let t = zr(e),
    n = Ur(),
    ...
    i = !1,
    a = (t) => (n, r) => {
      let i = rn(e, r, t === `exit` ? e.presenceContext?.custom : void 0);
      if (i) {
  ...
  function s(o) {
    ...
    for (let t = 0; t < xd; t++) {
      ...
      if (
        ...
        (m.protectedKeys = { ...d }),
        (!m.isActive && _ === null) || (!h && !m.prevProp) || Qn(h) || typeof h == `boolean`)
      )
        continue;
          ...
          ...S.map((t) => {
            ...
            if (typeof t == `string` && (r || i) && !te && e.manuallyAnimateOnMount && e.parent) {
              ...
              if (r.enteringChildren && i) {
                ...
                n.delay = Yt(r.enteringChildren, e, t);
              }
            }
    ...
    if (u.size) {
      ...
      if (typeof s.initial != `boolean`) {
        let n = rn(e, Array.isArray(s.initial) ? s.initial[0] : s.initial);
...
function Jr(e, t, n, r) {
  (qr(e.x, t.x, n.x, r ? r.originX : void 0), qr(e.y, t.y, n.y, r ? r.originY : void 0));
}
...
function Qr(e, t, n, r) {
  (Zr(e.x, t.x, n.x, r?.x), Zr(e.y, t.y, n.y, r?.y));
}
function $r(e, t, n, r, i) {
  return ((e -= t), (e = mr(e, 1 / n, r)), i !== void 0 && (e = mr(e, 1 / i, r)), e);
}
function ei(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  if (
  ...
  (e === a && (s -= t), (e.min = $r(e.min, t, n, s, i)), (e.max = $r(e.max, t, n, s, i)));
}
function ti(e, t, [n, r, i], a, o) {
  ei(e, t[n], t[r], t[i], t.scale, a, o);
}
function ni(e, t, n, r) {
  (ti(e.x, t, Od, n ? n.x : void 0, r ? r.x : void 0),
    ti(e.y, t, kd, n ? n.y : void 0, r ? r.y : void 0));
}
function ri(e) {
...
function bi(e) {
  ...
  if (f.MotionHasOptimisedAnimation(n, `transform`)) {
    ...
    f.MotionCancelOptimisedAnimation(n, `transform`, R, !(t || r));
  }
  let { parent: r } = e;
  r && !r.hasCheckedOptimisedAppear && bi(r);
}
function xi({
  ...
  return class {
    ...
    mount(t) {
      ...
      ((this.isSVG = Pn(t) && !Un(t)), (this.instance = t));
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              Rd.hasAnimatedSinceResize &&
                ((Rd.hasAnimatedSinceResize = !1), this.nodes.forEach(Mi)));
          }));
      }
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              let a = this.options.transition || i.getDefaultTransition() || Ud,
                ...
                c = !this.targetLayout || !ci(this.targetLayout, r),
                l = !t && n;
              if (
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0), this.nodes && this.nodes.forEach(Fi), this.animationId++);
    }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (f.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && bi(this),
    ...
    clearAllSnapshots() {
      (this.nodes.forEach(Ei), this.sharedNodes.forEach(Ii));
    }
    ...
    resetTransform() {
      ...
      let e = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout,
        t = this.projectionDelta && !ii(this.projectionDelta),
        n = this.getTransformTemplate(),
        r = n ? n(this.latestValues, ``) : void 0,
        a = r !== this.prevTransformTemplateValue;
      e &&
        this.instance &&
        (t || dr(this.latestValues) || a) &&
    ...
    measurePageBox() {
      ...
      if (!(this.scroll?.wasRoot || this.path.some(Wi))) {
    ...
    applyTransform(e, t = !1, n) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        (!t &&
          ...
          dr(n.latestValues) && xr(r, n.latestValues, n.layout?.layoutBox));
      }
      return (dr(this.latestValues) && xr(r, this.latestValues, this.layout?.layoutBox), r);
    }
    removeTransform(e) {
      let t = Q();
      k(t, e);
      for (let e = 0; e < this.path.length; e++) {
        let n = this.path[e];
        if (!dr(n.latestValues)) continue;
        let r;
        (n.instance &&
          (ur(n.latestValues) && n.updateSnapshot(), (r = Q()), k(r, n.measurePageBox())),
          ni(t, n.latestValues, n.snapshot?.layoutBox, r));
      }
      return (dr(this.latestValues) && ni(t, this.latestValues), t);
    }
    setTargetDelta(e) {
          ...
          this.relativeParent.target
            ...
            : this.targetDelta
              ? (this.resumingFrom
                ...
                _r(this.target, this.targetDelta))
              : k(this.target, this.layout.layoutBox),
          this.attemptToResolveRelativeTarget &&
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || ur(this.parent.latestValues) || fr(this.parent.latestValues)))
    ...
    createRelativeTarget(e, t, n) {
      ((this.relativeParent = e),
        ...
        Qr(this.relativeTargetOrigin, t, n, this.options.layoutAnchor || void 0),
    ...
    calcProjection() {
      ...
      let a = this.treeScale.x,
        o = this.treeScale.y;
      (vr(this.layoutCorrected, this.treeScale, this.path, t),
        e.layout &&
          !e.target &&
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        : (Gr(this.prevProjectionDelta.x, this.projectionDelta.x),
          Gr(this.prevProjectionDelta.y, this.projectionDelta.y)),
        Jr(this.projectionDelta, this.layoutCorrected, s, this.latestValues),
        (this.treeScale.x !== a ||
          this.treeScale.y !== o ||
          !ui(this.projectionDelta.x, this.prevProjectionDelta.x) ||
          !ui(this.projectionDelta.y, this.prevProjectionDelta.y)) &&
          ((this.hasProjected = !0),
          this.scheduleRender(),
    ...
    setAnimationOrigin(e, t = !1, n) {
      ...
      let s = Q(),
        ...
        d = !!(c && !u && this.options.crossfade === !0 && !this.path.some(Bi));
      this.animationProgress = 0;
      let f,
      ...
      ((this.mixTargetDelta = (t) => {
        ...
        (r
          ...
          this.relativeTarget &&
            ...
            zi(this.relativeTarget, this.relativeTargetOrigin, s, n),
            f && oi(this.relativeTarget, f) && (this.isProjectionDirty = !1),
            (f ||= Q()),
            k(f, this.relativeTarget)),
          c && ((this.animationValues = a), fi(a, i, this.latestValues, n, d, u)),
          r &&
            r.rotate !== void 0 &&
      ...
      (this.notifyListeners(`animationStart`),
        ...
        (this.pendingAnimation = R.update(() => {
          ((Rd.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = hi(this.motionValue, [0, 1e3], {
              ...e,
              velocity: 0,
              isSync: !0,
              onUpdate: (t) => {
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        if (
          ...
          this.layout &&
          r &&
          Ui(this.options.animationType, this.layout.layoutBox, r.layoutBox)
        ) {
          n = this.target || Q();
        ...
        (k(t, n), xr(t, i), Jr(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    ...
    resetSkewAndRotation() {
      ...
      if (
        ...
        return;
      let r = {};
      n.z && yi(`z`, e, r, this.animationValues);
      for (let t = 0; t < Bd.length; t++)
        (yi(`rotate${Bd[t]}`, e, r, this.animationValues),
          yi(`skew${Bd[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
    ...
    applyProjectionStyles(e, t) {
      ...
      if (this.needsReset) {
        ((this.needsReset = !1),
          (e.visibility = ``),
          (e.opacity = ``),
          (e.pointerEvents = vi(t?.pointerEvents) || ``),
      ...
      let a = di(this.projectionDeltaWithTransform, this.treeScale, i);
      ...
      this.options.layoutId && (e.pointerEvents = r === this ? vi(t?.pointerEvents) || `` : `none`);
    }
    clearSnapshot() {
...
function Ci(e) {
  ...
  if (e.isLead() && e.layout && t && e.hasListeners(`didUpdate`)) {
    ...
    if (i === `size`)
      ...
      let e = i === `x` ? `y` : `x`;
      Wr(a ? t.measuredBox[e] : t.layoutBox[e], n[e]);
    } else
      Ui(i, t.layoutBox, n) &&
        j((r) => {
    ...
    Jr(o, n, t.layoutBox);
    let s = Gu();
    a ? Jr(s, e.applyTransform(r, !0), t.measuredBox) : Jr(s, n, t.layoutBox);
    let c = !ii(o),
      l = !1;
    if (!e.resumeFrom) {
      ...
      if (r && !r.resumeFrom) {
        ...
        if (i && a) {
          let o = e.options.layoutAnchor || void 0,
            s = Q();
          Qr(s, t.layoutBox, i.layoutBox, o);
          let c = Q();
          (Qr(c, n, a.layoutBox, o),
            ci(s, c) || (l = !0),
...
function zi(e, t, n, r) {
  (Ri(e.x, t.x, n.x, r), Ri(e.y, t.y, n.y, r));
}
function Bi(e) {
...
function Ui(e, t, n) {
  return e === `position` || (e === `preserve-aspect` && !Kr(li(t), li(n), 0.2));
}
function Wi(e) {
...
function Yi({ children: e, isPresent: t, anchorX: n, anchorY: r, root: a, pop: o }) {
  let s = w(),
    c = i(null),
    l = i({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0, direction: `ltr` }),
    { nonce: d } = y($),
    f = Ji(c, e.props?.ref ?? e?.ref);
  return (
    p(() => {
      let { width: e, height: i, top: u, left: f, right: p, bottom: m, direction: h } = l.current;
      if (t || o === !1 || !c.current || !e || !i) return;
      let g = h === `rtl`,
...
function aa(e) {
  typeof e == `function` && (lf = (t) => (t.startsWith(`on`) ? !ia(t) : e(t)));
}
function oa(e, t, n) {
  let r = {};
  for (let i in e)
...
function sa({ children: e, isValidProp: t, ...r }) {
  t && aa(t);
  let i = y($);
  ((r = { ...i, ...r }),
    (r.transition = Xt(r.transition, i.transition)),
    (r.isStatic = M(() => r.isStatic)));
  let a = n(
    () => r,
    [JSON.stringify(r.transition), r.transformPagePoint, r.reducedMotion, r.skipAnimations]
  );
  return m($.Provider, { value: a, children: e });
}
function ca({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, i) {
  return { latestValues: la(n, r, i, e), renderState: t() };
}
function la(e, t, n, r) {
  let i = {},
    a = r(e, {});
  for (let e in a) i[e] = vi(a[e]);
...
function da(e) {
  let { initial: t, animate: r } = ua(e, y(uf));
  return n(() => ({ initial: t, animate: r }), [fa(t), fa(r)]);
}
function fa(e) {
  return Array.isArray(e) ? e.join(` `) : e;
}
function pa(e, t, n) {
  for (let r in t) !X(t[r]) && !kr(r, n) && (e[r] = t[r]);
}
...
function ha(e, t) {
  let n = e.style || {},
    r = {};
  return (pa(r, n, e), Object.assign(r, ma(e, t)), r);
}
function ga(e, t) {
  let n = {},
    r = ha(e, t);
...
function _a(e, t, r, i) {
  let a = n(() => {
    let n = mf();
    return (Pr(n, t, _d(i), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
    (pa(t, e.style, e), (a.style = { ...t, ...a.style }));
  }
  return a;
}
function va(e) {
...
function ya(e, t, r, { latestValues: i }, a, o = !1, s) {
  let c = ((s ?? va(e)) ? _a : ga)(t, i, a, e),
    u = oa(t, typeof e == `string`, o),
    d = e === l ? {} : { ...u, ...c, ref: r },
    { children: f } = t,
    p = n(() => (X(f) ? f.get() : f), [f]);
...
function Sa(e, t, n, r, a, o) {
  ...
  let v = g.current,
    b = y(ff);
  v && !v.projection && a && (v.type === `html` || v.type === `svg`) && Ca(g.current, n, a, b);
  let x = i(!1);
  p(() => {
    v && x.current && v.update(n, u);
  });
  let S = n[su],
    C = i(
      !!S && f !== void 0 && !f.MotionHandoffIsComplete?.(S) && f.MotionHasOptimisedAnimation?.(S)
    );
  return (
    js(() => {
      ((_.current = !0),
    ...
    c(() => {
      v &&
        ...
        (C.current &&=
          (queueMicrotask(() => {
            f.MotionHandoffMarkAsComplete?.(S);
          }),
          !1)),
...
function Ca(e, t, n, r) {
  ...
  ((e.projection = new n(e.latestValues, t[`data-framer-portal-id`] ? void 0 : wa(e.parent))),
    e.projection.setOptions({
      layoutId: i,
      layout: a,
      alwaysMeasureLayout: !!o || (s && xa(s)),
      visualElement: e,
...
function wa(e) {
  if (e) return e.options.allowProjection === !1 ? wa(e.parent) : e.projection;
}
function Ta(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  r && ra(r);
  let a = n ? n === `svg` : va(e),
    o = a ? _f : gf;
  function s(n, s) {
    ...
    if (!u && f !== void 0) {
      Da(l, r);
      let t = Oa(l);
      ((c = t.MeasureLayout), (d.visualElement = Sa(e, p, l, i, t.ProjectionNode, a)));
    }
    return b(uf.Provider, {
      value: d,
      children: [
        c && d.visualElement ? m(c, { visualElement: d.visualElement, ...l }) : null,
        ya(e, n, ba(p, d.visualElement, s), p, u, t, a),
      ],
    });
  }
...
function ka(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) => (a === `create` ? r : (n.has(a) || n.set(a, Ta(a, void 0, e, t)), n.get(a))),
  });
}
function Aa(e) {
...
function Fa({ point: e }, t) {
  return { point: e, delta: Pa(e, La(t)), offset: Pa(e, Ia(t)), velocity: Ra(t, 0.1) };
}
function Ia(e) {
  return e[0];
}
...
function Va(e, { top: t, left: n, bottom: r, right: i }) {
  return { x: Ba(e.x, n, i), y: Ba(e.y, t, r) };
}
function Ha(e, t) {
  let n = t.min - e.min,
    r = t.max - e.max;
...
function Ua(e, t) {
  return { x: Ha(e.x, t.x), y: Ha(e.y, t.y) };
}
function Wa(e, t) {
  let n = 0.5,
    r = A(e),
...
function Ka(e = kf) {
  return (
    e === !1 ? (e = 0) : e === !0 && (e = kf),
    { x: qa(e, `left`, `right`), y: qa(e, `top`, `bottom`) }
  );
}
function qa(e, t, n) {
  return { min: Ja(e, t), max: Ja(e, n) };
}
function Ja(e, t) {
...
function $a(e) {
  let [t, n] = Zi(),
    r = y(ks);
  return m(If, { ...e, layoutGroup: r, switchLayoutGroup: y(ff), isPresent: t, safeToRemove: n });
}
function eo(e, t, n) {
  let { props: r } = e;
  e.animationState && r.whileHover && e.animationState.setActive(`whileHover`, n === `Start`);
  let i = r[`onHover` + n];
  i && R.postRender(() => i(t, Aa(t)));
}
function to(e, t, n) {
  let { props: r } = e;
...
function oo(e, t, n) {
  (ao(e, `x`, t, n), ao(e, `y`, t, n), (t.time = n));
}
function so(e, t) {
  let n = { x: 0, y: 0 },
    r = e;
...
function fo(e, t, n) {
  let { offset: r = rp.All } = n,
    ...
    o = a === `y` ? `height` : `width`,
    s = i === e ? ip : so(i, e),
    c = i === e ? { width: e.scrollWidth, height: e.scrollHeight } : uo(i),
    l = { width: e.clientWidth, height: e.clientHeight };
  t[a].offset.length = 0;
  let u = !t[a].interpolate,
    d = r.length;
  for (let e = 0; e < d; e++) {
    let n = lo(r[e], l[o], c[o], s[a]);
    (!u && n !== t[a].interpolatorOffsets[e] && (u = !0), (t[a].offset[e] = n));
  }
  (u &&
    ((t[a].interpolate = vt(t[a].offset, bt(r), { clamp: !1 })),
...
function mo(e, t, n, r = {}) {
  return {
    measure: (t) => {
      (po(e, r.target, n), oo(e, n, t), (r.offset || r.target) && fo(e, n, r));
    },
    notify: () => t(n),
  };
}
function ho(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  if (!t) return F;
  let i = sp.get(t);
  ...
  if ((i.add(a), !ap.has(t))) {
    ...
    ap.set(t, r);
    let a = up(t);
    (f.addEventListener(`resize`, r),
      t !== document.documentElement && op.set(t, Vn(t, r)),
...
function bo(e) {
  ...
  for (let [t, n] of dp) if (yo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function xo(e) {
  let t = { value: 0 };
  return {
...
function So({ source: e, container: t, ...n }) {
  let { axis: r } = n;
  e && (t = e);
  let i = pp.get(t);
...
function Co(e, t) {
  let n = So(t),
    r = t.target ? bo(t.offset) : void 0,
    i = t.target ? go(t.target) && !!r : go();
...
function Do(e, { axis: t = `y`, container: n = document.scrollingElement, ...r } = {}) {
  if (!n) return F;
  let i = { axis: t, container: n, ...r };
  return typeof e == `function` ? Eo(e, i) : Co(e, i);
}
function Oo(e, t, n, r) {
  return {
    factory: (i) => {
...
function ko(e, t) {
  return f === void 0 ? !1 : e ? kl() && !!bo(t) : Ol();
}
function Ao({ container: e, target: t, ...n } = {}) {
  let r = M(mp);
  ko(t, n.offset) &&
    ((r.scrollXProgress.accelerate = Oo(`x`, n, e, t)),
    (r.scrollYProgress.accelerate = Oo(`y`, n, e, t)));
  let a = i(null),
    o = i(!1),
    s = v(
      () => (
...
function No(e) {
  ((Jl.current = []), e());
  let t = Mo(Jl.current, e);
  return ((Jl.current = void 0), t);
}
function Po(e, t, n, r) {
  if (typeof e == `function`) return No(e);
  if (n !== void 0 && !Array.isArray(n) && typeof t != `function`) return Io(e, t, n, r);
  let i = typeof t == `function` ? t : Kn(t, n, r),
    a = Array.isArray(e) ? Fo(e, i) : Fo([e], ([e]) => i(e)),
...
function Io(e, t, n, r) {
  let i = M(() => Object.keys(n)),
    a = M(() => ({}));
  for (let o of i) a[o] = Po(e, t, n[o], r);
  return a;
}
function Lo(e, t = {}) {
  let { isStatic: n } = y($),
  ...
  if (n) return Po(r);
  let i = jo(r());
  return (p(() => qn(i, e, t), [i, JSON.stringify(t)]), i);
}
function Ro(e, t = {}) {
  return Lo(e, { type: `spring`, ...t });
}
function zo() {
  !Zu.current && rr();
  let [e] = d(Xu.current);
...
function Uo(e, t) {
  if (Array.isArray(t)) return Ho(e, t);
  if (typeof t == `string`) return Ho(e, [t]);
  sn(e, t);
}
function Wo() {
  let e = new Set(),
    t = {
      ...
      start(t, n) {
        ...
        return (
          e.forEach((e) => {
            r.push(gn(e, t, { transitionOverride: n }));
          }),
          Promise.all(r)
        );
      },
...
function $o(e, { defaultTransition: t = {}, ...n } = {}, r, i) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if (
          (ee > 0 && yt(u, ee), c.length === 1 && c.unshift(null), m && `${m}${vp}`, m && m < vp)
        ) {
          let e = b > 0 ? _ / b : 0;
          b = qo(b, m, _);
          let t = [...c],
          ...
          for (let s = 0; s < m; s++) {
            ...
            for (let e = 0; e < d.length; e++)
              (u.push(n[e] + p), y.push(e === 0 ? `linear` : Le(f, e - 1)));
          }
          Zo(u, m, e);
        }
        let T = w + b;
        (Xo(r, c, y, u, w, T), (g = Math.max(x + b, g)), (f = Math.max(T, f)));
      };
    if (X(p)) {
      let e = es(p, s);
      _(m, h, ts(`default`, e));
      ...
      for (let n = 0; n < t; n++) {
        ...
        let r = e[n],
          i = es(r, s);
        for (let e in m) _(m[e], rs(h, e), ts(e, i), n, t);
      }
    }
    ((u = d), (d += g));
  }
...
function os(e, t) {
  return X(e) || typeof e == `number` || (typeof e == `string` && !Go(t));
}
function ss(e, t, n, r) {
  let i = [];
  if (os(e, t)) i.push(hi(e, (Go(t) && t.default) || t, n && (n.default || n)));
  else {
    if (e == null) return i;
    let a = Ko(e, t, r),
      o = a.length;
    for (let e = 0; e < o; e++) {
      let r = a[e],
        s = r instanceof Element ? is : as;
      qu.has(r) || s(r);
      let c = qu.get(r),
        l = { ...n };
      (`delay` in l && typeof l.delay == `function` && (l.delay = l.delay(e, o)),
        i.push(...pn(c, { ...t, transition: l }, {})));
    }
  }
  return i;
}
...
function us(e = {}) {
  ...
  function i(e, i, a) {
    let o = [],
      s,
      c = {};
    if ((n !== void 0 && (c.reduceMotion = n), r !== void 0 && (c.skipAnimations = r), ls(e))) {
      let { onComplete: n, ...r } = i || {};
      (typeof n == `function` && (s = n), (o = cs(e, { ...c, ...r }, t)));
    } else {
      let { onComplete: n, ...r } = a || {};
      (typeof n == `function` && (s = n), (o = ss(e, i, { ...c, ...r }, t)));
    }
    let l = new Gl(o);
    return (
      s && l.finished.then(s),
...
function _s(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
  let a = xn(e),
    o = new WeakMap(),
...
function bs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: a, ...o }, s) {
  let l = M(() => Yf[t]),
    u = [],
    d = i(!1),
    f = i(null),
    p = {
      ...
      registerItem: (e, t) => {
        ...
        (r === -1 ? u.push({ value: e, layout: t[n] }) : (u[r].layout = t[n]), u.sort(xs));
      },
      updateOrder: (e, t, n) => {
        if (d.current) return;
        let i = ys(u, e, t, n);
        if (u !== i) {
          ...
          for (let t = 0; t < i.length; t++)
            if (u[t].value !== i[t].value) {
              let n = a.indexOf(u[t].value),
                r = a.indexOf(i[t].value);
  ...
  let h = (e) => {
    ...
    g = { overflowAnchor: `none`, ...o.style };
  return m(l, {
    ...o,
    style: g,
    ref: h,
    ignoreStrict: !0,
    children: m(Ep.Provider, { value: p, children: e }),
  });
}
function xs(e, t) {
...
function Ts(e, t, n) {
  let r = t.getBoundingClientRect(),
    ...
    a = n === `x` ? Math.min(f.innerWidth, r.right) : Math.min(f.innerHeight, r.bottom),
    o = e - i,
    s = a - e;
  if (o < Op) {
    let e = 1 - o / Op;
...
function Es(e, t, n, r) {
  ...
  let i = ws(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Ts(t - (n === `x` ? f.scrollX : f.scrollY), i, n);
  if (o === null) {
  ...
  if (s !== o) {
    ...
    let e =
      n === `x`
        ? i.scrollWidth - (c ? f.innerWidth : i.clientWidth)
        : i.scrollHeight - (c ? f.innerHeight : i.clientHeight);
    jp.set(i, e);
  }
  if (a > 0) {
    let e = jp.get(i);
    if ((n === `x` ? (c ? f.scrollX : i.scrollLeft) : c ? f.scrollY : i.scrollTop) >= e) return;
  }
  n === `x`
    ? c
      ? f.scrollBy({ left: a })
...
function Os(
  ...
  let l = M(() => Yf[r]),
    u = y(Ep),
    d = { x: Ds(t.x), y: Ds(t.y) },
    f = Po([d.x, d.y], ([e, t]) => (e || t ? 1 : `unset`)),
    { axis: p, registerItem: h, updateOrder: g, groupRef: _ } = u;
  return m(l, {
    drag: p,
    ...s,
    dragSnapToOrigin: !0,
    ...
    onDrag: (e, t) => {
      let { velocity: r, point: a } = t,
        o = d[p].get();
      (g(n, o, r[p]), Es(_.current, a[p], p, r[p]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Ss(), a && a(e, t));
    },
  ...
  Fp = t(() => {
    (o(),
      ...
      (Rs = class {
        ...
        add(e) {
          return (je(this.subscriptions, e), () => Me(this.subscriptions, e));
        }
        notify(e, t, n) {
      ...
      ({
        ...
        state: B,
        steps: lc,
      } = ze(typeof requestAnimationFrame < `u` ? requestAnimationFrame : F, !0)),
      (V = {
        now: () => (
          uc === void 0 &&
      ...
      (Dc = { test: Sc(`#`), parse: Ue, transform: Ec.transform }),
      (Oc = (e) => ({
      ...
      (K = { test: We, parse: Ke, createTransformer: Je, getAnimatableNone: Ye }),
      (q = (e, t, n) => e + (t - e) * n),
      (Hc = (e, t, n) => {
        let r = e * e,
          i = n * (t * t - r) + r;
      ...
      (rl = { decay: gt, inertia: gt, tween: Ct, keyframes: Ct, spring: mt }),
      (il = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (ol = class extends il {
        ...
        initAnimation() {
          ...
          s !== Ct &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Is(al, ot(o[0], o[1]))), (o = [0, 100]));
        ...
        tick(e, t = !1) {
          ...
          return (
            S && p !== gt && (b.value = wt(l, this.options, h, this.speed)),
            m && m(b.value),
            S && this.finish(),
            b
          );
        ...
        getGeneratorVelocity() {
          ...
          return ht((e) => this.generator.next(e).value, e, t);
        }
        get speed() {
      ...
      (Tl = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (xl.add(this), Sl || ((Sl = !0), R.read(Nt), R.resolveKeyframes(Mt)))
      ...
      (El = (e) => e.startsWith(`--`)),
      (Dl = {}),
      (Ol = It(() => f.ScrollTimeline !== void 0, `scrollTimeline`)),
      (kl = It(() => f.ViewTimeline !== void 0, `viewTimeline`)),
      (Al = It(() => {
        try {
      ...
      (Nl = class extends il {
        constructor(e) {
          ...
          let c = Bt(e);
          ((this.animation = Rt(t, n, r, c, i)),
            c.autoplay === !1 && this.animation.pause(),
            (this.animation.onfinish = () => {
              if (((this.finishedTime = this.time), !i)) {
                let e = wt(r, this.options, o, this.speed);
      ...
      (Bl = Pe(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Vl = (e, t) =>
        t !== `zIndex` &&
        !!(
          typeof e == `number` ||
      ...
      (Ul = class extends il {
        ...
        onKeyframesResolved(e, t, n, r) {
          ...
          qt(e, i, a, o) ||
            ((u = !1),
            (P.instantAnimations || !s) && l?.(wt(e, n, t)),
            (e[0] = e[e.length - 1]),
            Ut(n),
            (n.repeat = 0));
          let d = {
        ...
        get animation() {
          return (this._animation || (this.keyframeResolver?.resume(), Pt()), this._animation);
        }
        get duration() {
      ...
      (Su = class extends Tl {
        ...
        resolveNoneKeyframes() {
          let { unresolvedKeyframes: e, name: t } = this,
            n = [];
          for (let t = 0; t < e.length; t++) (e[t] === null || yn(e[t])) && n.push(t);
          n.length && bn(e, n, t);
        }
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = f.pageYOffset),
            (this.measuredOrigin = Y[n](e.measureViewportBox(), f.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = Y[t](e.measureViewportBox(), f.getComputedStyle(e.current))),
      ...
      ({ schedule: Tu, cancel: Eu } = ze(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      ...
      (Mu = (e, t) => {
        ...
        let r = An(() => {
          ...
          (n.addEventListener(`keyup`, e, t), n.addEventListener(`blur`, () => jn(n, `cancel`), t));
        });
      ...
      (Pu = new WeakMap()),
      (Iu = (e, t, n) => (r, i) =>
        i && i[0] ? i[0][e + `Size`] : Pn(r) && `getBBox` in r ? r.getBBox()[t] : r[n]),
      ...
      (td = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (Zu.current || rr(), (this.shouldReduceMotion = Xu.current)),
        ...
        bindToMotionValue(e, t) {
          ...
          let r = t.on(`change`, (t) => {
            ...
            i;
          (f !== void 0 && f.MotionCheckAppearSync && (i = f.MotionCheckAppearSync(this, e, t)),
            this.valueSubscriptions.set(e, () => {
              (r(), i && i());
            }));
        }
        ...
        getBaseTarget(e) {
          ...
          if (typeof t == `string` || typeof t == `object`) {
            let r = nn(this.props, t, this.presenceContext?.custom);
            r && (n = r[e]);
          }
      ...
      (dd = class extends nd {
        ...
        readValueFromInstance(e, t) {
          if (_l.has(t)) return this.projection?.isProjecting ? Ot(t) : hl(e, t);
          {
            let n = jr(e),
      ...
      (vd = class extends nd {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = gd.has(t) ? t : un(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Ir(e, t, n);
        }
        build(e, t, n) {
          Pr(e, t, this.isSVGTag, n.transformTemplate, n.style);
        }
      ...
      (Ld = class {
        ...
        remove(e) {
          if (
            (Me(this.members, e), e === this.prevLead && (this.prevLead = void 0), e === this.lead)
          ) {
      ...
      (Wd = (e) => s !== void 0 && s.userAgent && s.userAgent.toLowerCase().includes(e)),
      ...
      (Yd = xi({
        ...
        defaultParent: () => {
          if (!Jd.current) {
            let e = new Kd({});
            (e.mount(f), e.setOptions({ layoutScroll: !0 }), (Jd.current = e));
          }
          return Jd.current;
        },
        resetTransform: (e, t) => {
      ...
      (Xd = class extends h {
        getSnapshotBeforeUpdate(e) {
          ...
          if (Sn(t) && e.isPresent && !this.props.isPresent && this.props.pop !== !1) {
            let e = t.offsetParent,
              n = (Sn(e) && e.offsetWidth) || 0,
              r = (Sn(e) && e.offsetHeight) || 0,
      ...
      (Zd = ({
            ...
            () => (
              (v = !1),
              {
                ...
                register: (e) => (
                  p.set(e, !1),
                  () => {
                    (p.delete(e), !g.current && !p.size && _.current?.());
                  }
                ),
              }
            ),
        ...
        return (
          ...
          m(Ms.Provider, { value: y, children: e })
        );
      }),
      (Qd = (e) => e.key || ``),
      ($d = ({
        ...
        let [p, h] = Zi(c),
          ...
          [T, te] = d(g);
        js(() => {
          ((v.current = !1), (b.current = g));
          for (let e = 0; e < T.length; e++) {
            let t = Qd(T[e]);
            _.includes(t) ? (x.delete(t), C.current.delete(t)) : x.get(t) !== !0 && x.set(t, !1);
          }
        }, [T, _.length, _.join(`-`)]);
        let E = [];
        if (g !== w) {
          ...
          return (s === `wait` && E.length && (e = E), te(Qi(e)), ee(g), null);
        }
        let { forceRender: ne } = y(ks);
        return m(S, {
          children: T.map((e) => {
            let n = Qd(e),
              i = c && !p ? !1 : g === T || _.includes(n);
            return m(
              Zd,
              {
                isPresent: i,
      ...
      (rf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        l.current === null &&
          (nf(r) && u && (t = t ? u + `-` + t : u),
          (l.current = { id: t, group: (tf(r) && a.group) || Gi() }));
        let d = n(() => ({ ...l.current, forceRender: s }), [c]);
        return m(ks.Provider, { value: d, children: e });
      }),
      (af = a({ strict: !1 })),
      (of = {
        animation: [
      ...
      (lf = (e) => !ia(e)));
    try {
      aa(ue(`@emotion/is-prop-valid`).default);
    } catch {}
    ((uf = a({})),
      (df = (e) => (t, n) => {
        let r = y(uf),
      ...
      (gf = df({ scrapeMotionValuesFromProps: Ar, createRenderState: pf })),
      (_f = df({ scrapeMotionValuesFromProps: Ir, createRenderState: mf })),
      (vf = Symbol.for(`motionComponentSymbol`)),
      (yf = class extends rd {
        constructor(e) {
          (super(e), (e.animationState ||= Br(e)));
        }
      ...
      (Cf = (e) => (t) => Ou(t) && e(t, Aa(t))),
      (wf = (e, t) => Math.abs(e - t)),
      (Tf = (e, t) => ((t.isSVG ?? va(e)) ? new vd(t) : new dd(t, { allowProjection: e !== l }))),
      ...
      (Of = class {
        constructor(
          ...
          if (
            ...
            (this.updatePoint = () => {
              ...
              this.lastRawMoveEventInfo &&
                (this.lastMoveEventInfo = Na(this.lastRawMoveEventInfo, this.transformPagePoint));
              let e = Fa(this.lastMoveEventInfo, this.history),
                t = this.startEvent !== null,
                n = Ma(e.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
              if (!t && !n) return;
              let { point: r } = e,
                { timestamp: i } = B;
            ...
            (this.handlePointerMove = (e, t) => {
              ((this.lastMoveEvent = e),
                ...
                (this.lastMoveEventInfo = Na(t, this.transformPagePoint)),
          ...
          let s = Na(Aa(e), this.transformPagePoint),
            { point: c } = s,
            { timestamp: l } = B;
          this.history = [{ ...c, timestamp: l }];
          let { onSessionStart: u } = t;
          u && u(e, Fa(s, this.history));
          let d = { passive: !0, capture: !0 };
          ((this.removeListeners = Is(
            ja(this.contextWindow, `pointermove`, this.handlePointerMove, d),
            ja(this.contextWindow, `pointerup`, this.handlePointerUp, d),
            ja(this.contextWindow, `pointercancel`, this.handlePointerUp, d)
          )),
        ...
        startScrollTracking(e) {
          ...
          (this.scrollPositions.set(f, { x: f.scrollX, y: f.scrollY }),
            f.addEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
            f.addEventListener(`scroll`, this.onWindowScroll),
            (this.removeScrollListeners = () => {
              (f.removeEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
                f.removeEventListener(`scroll`, this.onWindowScroll));
            }));
        }
        handleScroll(e) {
          ...
          if (!t) return;
          let n = e === f,
            r = n ? { x: f.scrollX, y: f.scrollY } : { x: e.scrollLeft, y: e.scrollTop },
      ...
      (jf = class {
        ...
        start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
          ...
          let i = (e) => {
              (t && this.snapToCursor(Aa(e).point), this.stopAnimation());
            },
            a = (e, t) => {
              ...
              ((this.latestPointerEvent = e),
                ...
                ln(this.visualElement, `transform`));
        ...
        updateAxis(e, t, n) {
          ...
          if (!n || !Za(e, r, this.currentDirection)) return;
          let i = this.getAxisMotionValue(e),
            a = this.originPoint[e] + n[e];
          (this.constraints &&
            this.constraints[e] &&
            (a = za(a, this.constraints[e], this.elastic[e])),
            i.set(a));
        }
        resolveConstraints() {
          ...
          (e && xa(e)
            ...
            : e && n
              ? (this.constraints = Va(n.layoutBox, e))
              : (this.constraints = !1),
            (this.elastic = Ka(t)),
            r !== this.constraints &&
              !xa(e) &&
              ...
              j((e) => {
                this.constraints !== !1 &&
                  ...
                  (this.constraints[e] = Ga(n.layoutBox[e], this.constraints[e]));
              }));
        }
        resolveRefConstraints() {
          ...
          let i = Cr(n, r.root, this.visualElement.getTransformPagePoint()),
            a = Ua(r.layout.layoutBox, i);
          if (t) {
            let e = t(sr(a));
            ((this.hasMutatedConstraints = !!e), e && (a = or(e)));
          }
          return a;
        }
        startAnimation(e) {
          let {
            ...
            s = this.constraints || {},
            c = j((o) => {
              if (!Za(o, t, this.currentDirection)) return;
              let c = (s && s[o]) || {};
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (ln(this.visualElement, e), n.start(nu(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        snapToCursor(e) {
          j((t) => {
            ...
            if (!Za(t, n, this.currentDirection)) return;
        ...
        scalePositionWithinConstraints() {
          ...
          if (!xa(t) || !n || !this.constraints) return;
          this.stopAnimation();
          let r = { x: 0, y: 0 };
          j((e) => {
            ...
            if (t && this.constraints !== !1) {
              let n = t.get();
              r[e] = Wa({ min: n, max: n }, this.constraints[e]);
            }
          });
          ...
          let e = this.visualElement.current,
            ...
            r = () => {
              ...
              xa(t) &&
                t.current &&
                ((this.constraints = this.resolveRefConstraints()),
                (n ||= Xa(e, t.current, () => this.scalePositionWithinConstraints())));
            },
            { projection: i } = this.visualElement,
            a = i.addEventListener(`measure`, r);
          (i && !i.layout && (i.root && i.root.updateScroll(), i.updateLayout()), R.read(r));
          let o = gi(f, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (Pf = class extends rd {
        ...
        mount() {
          this.removePointerDownListener = ja(this.node.current, `pointerdown`, (e) =>
      ...
      (Lf = { pan: { Feature: Pf }, drag: { Feature: Mf, ProjectionNode: Yd, MeasureLayout: $a } }),
      (Rf = class extends rd {
        mount() {
          ...
          e &&
            (this.unmount = Dn(
              e,
              (e, t) => (eo(this.node, t, `Start`), (e) => eo(this.node, e, `End`))
            ));
        }
        unmount() {}
      }),
      ...
      (Bf = class extends rd {
        mount() {
          ...
          this.unmount = Nn(
            e,
            (e, t) => (
              to(this.node, t, `Start`),
              (e, { success: t }) => to(this.node, e, t ? `End` : `Cancel`)
            ),
      ...
      (Kf = class extends rd {
        ...
        startObserver() {
          ...
          this.stopObserver = ro(this.node.current, a, o);
        }
        mount() {
          this.startObserver();
        }
        update() {
          ...
          [`amount`, `margin`, `root`].some(io(e, t)) && this.startObserver();
        }
        unmount() {
      ...
      (Jf = { layout: { ProjectionNode: Yd, MeasureLayout: $a } }),
      (Yf = ka({ ...Sf, ...qf, ...Lf, ...Jf }, Tf)),
      ...
      (cp = new WeakMap()),
      (lp = new WeakMap()),
      (up = (e) => (e === document.scrollingElement ? f : e)),
      (dp = [
        [rp.Enter, `entry`],
        [rp.Exit, `exit`],
        [rp.Any, `cover`],
...
//# sourceMappingURL=motion.DQ9lNKau.mjs.map
