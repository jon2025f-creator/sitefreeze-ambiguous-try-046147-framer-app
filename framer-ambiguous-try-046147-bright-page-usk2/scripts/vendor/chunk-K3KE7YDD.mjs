import { za as d } from "chunk-L2NAOVBC.mjs";
import { Qj as i, Rk as k, Tk as m, qp as T } from "chunk-KYA46HAJ.mjs";
...
function P(o, e, r) {
  let t = o.cloneWithIds(),
    a = Object.values(v(e));
  for (let n of t.walk()) n.assign(k(n, a, r));
  return t;
}
function w(o, e, r) {
  if (!e) return;
...
export { y as a, h as b, F as c, v as d, P as e, w as f };
//# sourceMappingURL=chunk-K3KE7YDD.mjs.map
