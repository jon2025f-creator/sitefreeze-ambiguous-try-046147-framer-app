...
import { q as In } from "chunk-ZA6L5DVI.mjs";
...
function Q(n, e) {
  ((n.isExternalMaster = e.isExternalMaster),
    ...
    (n.replicaInfo = e.replicaInfo ? Pn(e.replicaInfo) : null));
}
function b(n, e) {
...
function Je(n, e) {
  ((n.altAttribute = e.altAttribute),
    ...
    (n.hookIdentifier = e.hookIdentifier),
    (n.htmlTag = e.htmlTag),
...
function rt(n, e) {
  (i(n, e), c(n, e), Yn(n, e), Gn(n, e), Ce(n, e));
  for (let t in e) t.startsWith("$control__") && (n[t] = e[t]);
}
function at(n, e) {
  (i(n, e), o(n, e), c(n, e), U(n, e), $n(n, e), Le(n, e));
...
function st(n, e) {
  (i(n, e), o(n, e), Yn(n, e), $n(n, e), Fe(n, e));
}
function _n(n, e) {
  (i(n, e), o(n, e), c(n, e));
}
...
function ft(n, e) {
  (i(n, e), o(n, e), Kn(n, e), Ke(n, e));
}
function lt(n, e) {
  (i(n, e), o(n, e), v(n, e), wn(n, e), On(n, e), Kn(n, e), he(n, e));
}
function kt(n, e) {
  (i(n, e), o(n, e), W(n, e), Vn(n, e), ye(n, e));
}
function pt(n, e) {
  (i(n, e),
    k(n, e),
...
function gt(n, e) {
  (i(n, e), o(n, e), Qn(n, e), qe(n, e));
}
function ut(n, e) {
  (i(n, e), me(n, e));
}
function xt(n, e) {
  (i(n, e), o(n, e), W(n, e), dn(n, e), Pe(n, e));
}
function ht(n, e) {
  (i(n, e), o(n, e), c(n, e), k(n, e), u(n, e), m(n, e), E(n, e), y(n, e));
}
function St(n, e) {
  (i(n, e), o(n, e), c(n, e), k(n, e), u(n, e), E(n, e), y(n, e), fe(n, e));
}
function Ct(n, e) {
  (i(n, e), o(n, e), c(n, e), F(n, e), U(n, e), cn(n, e), Hn(n, e));
}
function Et(n, e) {
  (i(n, e), o(n, e), c(n, e), Ln(n, e), ue(n, e));
}
function yt(n, e) {
  (i(n, e), _e(n, e));
}
...
function zt(n, e) {
  (i(n, e), o(n, e), C(n, e), Q(n, e), nn(n, e), We(n, e));
}
function Bt(n, e) {
  (i(n, e),
    s(n, e),
...
function _t(n, e) {
  (i(n, e), o(n, e), W(n, e), dn(n, e), Vn(n, e));
}
function At(n, e) {
  (i(n, e), o(n, e), W(n, e), dn(n, e), qn(n, e), Ie(n, e));
}
function Ft(n, e) {
  (i(n, e),
    o(n, e),
...
function Lt(n, e) {
  (i(n, e), o(n, e), vn(n, e), Ze(n, e));
  for (let t in e) t.startsWith("$plugin__") && (n[t] = e[t]);
}
function Dt(n, e) {
  (i(n, e), o(n, e), mn(n, e), Re(n, e));
}
function Ht(n, e) {
  (i(n, e), o(n, e), Ge(n, e));
}
...
function Xt(n, e) {
  (i(n, e), o(n, e), s(n, e), f(n, e), l(n, e), g(n, e), h(n, e), A(n, e));
}
function Wt(n, e) {
  (i(n, e), o(n, e), Me(n, e));
}
function qt(n, e) {
  (i(n, e), o(n, e), c(n, e), x(n, e), F(n, e), U(n, e), cn(n, e), ln(n, e), Hn(n, e), Ee(n, e));
  for (let t in e) t.startsWith("$plugin__") && (n[t] = e[t]);
}
function Ut(n, e) {
  (i(n, e),
...
function Gt(n, e) {
  (i(n, e), o(n, e), c(n, e), k(n, e), u(n, e), E(n, e), X(n, e), Te(n, e));
}
function $t(n, e) {
  (i(n, e), o(n, e), c(n, e), Q(n, e), an(n, e), An(n, e), Fn(n, e), Xn(n, e), xe(n, e));
  for (let t in e) t.startsWith("$plugin__") && (n[t] = e[t]);
}
function Jt(n, e) {
  (i(n, e), o(n, e), c(n, e), F(n, e), U(n, e));
}
function Kt(n, e) {
  (i(n, e),
    o(n, e),
...
var Qt = "generated";
function bt(n) {
  return Zt(n) && Qt in n && n.generated === !0;
}
function jn(n) {
  return typeof n == "string" || bt(n) ? n : null;
}
function en(n, e) {
  if (n.charCodeAt(0) < 109) {
    ...
    if (a !== -1 && a < 111) {
      ...
      if (d !== -1 && d < 110) {
        if (n === "fillConicGradient") return w(e);
        if (n === "fillLinearGradient") return w(e);
        if (n === "fillRadialGradient") return w(e);
      } else {
      ...
      if (d !== -1 && d < 114) {
        ...
        if (n === "exportOptions") return w(e);
      } else {
        if (n === "formBooleanInputCheckedBoxShadow") return w(e);
        if (n === "formInputFocusedBoxShadow") return w(e);
        if (n === "boxShadows") return w(e);
      }
    }
  } else {
    let a = n.length < 2 ? -1 : n.charCodeAt(1);
    if (a !== -1 && a < 104) {
      let d = n.length < 3 ? -1 : n.charCodeAt(2);
      if (d !== -1 && d < 115) {
        if (n === "name") return jn(e);
        if (n === "replicaInfo") return Bn(e);
      } else {
        if (n === "masks") return Mn(e);
        if (n === "pathSegments") return w(e);
      }
    } else {
      let d = n.length < 3 ? -1 : n.charCodeAt(2);
      if (d !== -1 && d < 105) {
        if (n === "shadows") return w(e);
        if (n === "previewSettings") return w(e);
      } else {
        if (n === "whileHoverBoxShadow") return w(e);
        if (n === "whileTapBoxShadow") return w(e);
        if (n === "styledText") return Rn(e);
      }
    }
  }
  return e;
...
var $ = Object.values({ valueFromNode: I, reviveProperty: en }).every((n) => n !== ne);
function vt() {
...
async function ei(n) {
  ...
  (t.add("baseline", () => J.generics.valueFromNode(n)),
    ...
    await t.warmup(),
    await t.run());
  let a = ee(t.results[0]?.mean ?? 0, t.table()),
    d = [...n.walk()].length;
...
async function ti(n, e) {
  let {
      ...
      loadOneRootChild: a,
      TreeAssembler: d,
    } = await import("https://app.framerstatic.com/partialDocument-UYYC2QRN.mjs"),
    { VekterEngine: te } = await import("https://app.framerstatic.com/VekterEngine-4PUZABPS.mjs"),
    { DocumentParser: ie } =
    ...
    { default: re } = await import("https://app.framerstatic.com/dist-2WCISAY3.mjs"),
    ae = oe(n.toJS()),
    xn = new ie(ae),
    hn = () => {
      let Sn = new te(),
        se = t(xn, Sn.componentLoader, e),
        Cn = new Map();
      for (; !a(xn, Cn););
      let En = new d(Sn, se, Cn);
  ...
  (V.add("baseline", hn),
    ...
    console.log("run"),
    await V.run());
  let de = ee(V.results[0]?.mean ?? 0, V.table());
  console.table(de);
}
export { ei as a, ti as b, ni as c };
//# sourceMappingURL=chunk-LXFRT36K.mjs.map
