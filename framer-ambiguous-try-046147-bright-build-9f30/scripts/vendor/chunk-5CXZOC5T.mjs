...
import { c as S } from "chunk-5TISSQW7.mjs";
import { a as ht } from "chunk-K6L5GVTR.mjs";
import { a as re } from "chunk-DWEQS5LX.mjs";
import { f as ot } from "chunk-7T2Y45IF.mjs";
import { e as w, f as F, j as b, k as he } from "chunk-DTSMQR7C.mjs";
import { a as P, b as D } from "chunk-WRBBN7SY.mjs";
import { a as Te } from "chunk-RNHTTH2C.mjs";
import { b as Xe } from "chunk-AYNVEX5D.mjs";
import { a as ge } from "chunk-2FCXHKEL.mjs";
import { q as j } from "chunk-E2L4WW4T.mjs";
...
var gt = ({ naturalWidth: i, naturalHeight: e }) => ({
...
function U(i) {
  ...
  let o = Math.round(parseFloat(n) * ((r && di[r]) || 1));
  return o <= 0 ? 0 : o;
}
function oo(i) {
  let e = li(i);
...
function li(i) {
  let e = Ve(i, "image/svg+xml"),
    t = e.rootElement || e.childNodes[0];
  if (t?.nodeName.toUpperCase() === "SVG") return t;
}
var mi = 5e4,
  ci = 'xlink:href="data:image/',
  yt = /xlink:href=['"]data:image\/[^;]+;base64,([A-Za-z\d+=/]+)/gu;
function ro(i) {
  return i.length > mi || i.includes(ci);
}
function It(i) {
  let e = 0,
    t;
...
function ne(i, e, t) {
  let { nonZeroNaturalWidth: n, nonZeroNaturalHeight: r } = gt(i.imageSize);
  return je({
...
function lo(i) {
  let e = i[0];
  return e?.filename ? ne(e, e.preferredSize) : null;
}
function co(i, e, t, n) {
...
function wt(i, e, t, n, r) {
  ...
  if (
    (K(r.x)
      ? ((r.x = a), (r.y = s))
      : (!D(r.x) && r.x !== a && (r.x = P), !D(r.y) && r.y !== s && (r.y = P)),
    !G(e) || !n)
  )
    return;
  let d = tt(i, e);
  if (!d?.positioning) return;
  let m = d.positioning,
    c = R(m.width - Z.maxX(t), o),
    v = R(m.height - Z.maxY(t), o);
  K(r.right)
    ? ((r.right = c), (r.bottom = v))
    : (!D(r.right) && r.right !== c && (r.right = P),
      !D(r.bottom) && r.bottom !== v && (r.bottom = P));
}
var u = {
  padding: 0,
  gridRowCount: 2,
...
var xt = 10,
  ae = (i = "horizontal", e = !0, t) => {
    let n = t?.stores.persistedUserDefaults.layoutGap ?? xt;
    return {
      layout: "stack",
      stackDirection: i,
      ...
      stackWrapEnabled: !1,
      paddingPerSide: !1,
      padding: e ? n : u.padding,
      paddingTop: u.padding,
      paddingBottom: u.padding,
  ...
  ui = {
    ...
    layout: "grid",
    gridColumnCount: u.gridColumnCount,
    gridAlignment: "center",
    gridColumnWidthType: "minmax",
    gridColumnWidth: u.gridColumnWidth,
    gridColumnMinWidth: 50,
    gridRowHeightType: "auto",
    gridRowCount: u.gridRowCount,
    gridRowHeight: u.gridRowHeight,
    gridType: void 0,
    gap: i?.stores.persistedUserDefaults.layoutGap ?? xt,
    paddingPerSide: !1,
    padding: u.padding,
    paddingTop: u.padding,
    paddingBottom: u.padding,
...
var tr = (i, e) => {
  ...
  yi = (i, e, t, n, r, o) => {
    let a = new p({ ...ae(t, r, i), fillEnabled: !1, ...e });
    h(V(a));
  ...
  St = (i, e, t, n) => {
    let r = new p({ ...fi(i), fillEnabled: !1, ...e });
    h(A(r));
    let o = e.gridType === Y,
      a = Ii(o, w(e.height) ? e.height : void 0, w(r.gap) ? r.gap : void 0);
    for (let s = 0; s < t; s++) {
      let d = {};
      if (a) {
        let v = s === 0 || s === t - 1 ? a.tallHeight : a.smallHeight;
        Object.assign(d, { heightType: 0, height: v, gridItemFillCellHeight: void 0 });
      } else
        switch (n) {
          case 3:
            s === 0 && (d.gridItemRowSpan = 2);
            break;
          case 4:
            s + 1 === t && (d.gridItemColumnSpan = 2);
            break;
          default:
            break;
        }
  ...
  ir = (i, e, t, n = !1) => {
    if (e === 2) return St(i, t, n ? 0 : 4);
    if (e === 3 || e === 4) return St(i, t, n ? 0 : 3, e);
    let r = n ? 0 : 2;
    return yi(i, t, t.stackDirection ?? "horizontal", r, !1);
  },
  Ft = Ge.width,
  vi = (i, e, t, n, r, o) => {
    let a = { x: W, y: W, right: W, bottom: W };
    (wt(i, e, t, n, a),
  ...
  Ni = (i, e, t, n, r, o) => {
    (vi(i, e, t, n, r, o), !(r > Ft) && (V(e) && wi(e, o), A(e) && xi(e, o)));
  },
  Fi = (i, e, t, n, r, o) => {
    let a = e.getPrimaryId(),
      s = {};
    if ((Ni(i, e, t, n, r, s), (o[a] = s), Re(e) && e.stackWrapEnabled && r <= Ft)) {
      let m = Si(e);
      for (let c in m) o[c] = { ...o[c], ...m[c] };
    }
  };
function or(i, e, t) {
  ...
  for (let d in s) {
    if (d === t) continue;
    let m = i.tree.getNode(d);
    if (!m || !We(m) || !_e(m)) continue;
    let c = {};
    (Fi(i.tree, n, a, r, m.width, c), vt(i.tree, m, c));
  }
}
function rr(i, e, t, n = i.getParent(t.id), r = Be(i, t)) {
  let o = {
    width: { 2: !0, 0: !0, 3: !0, 1: !0, 4: !0, 5: !0 },
    height: { 2: !0, 0: !0, 3: !0, 1: !0, 4: !0, 5: !0 },
  };
  if (
    (!n || !G(t) || (rt(t) && t.autoSize === !0) || Pe(t)
      ? ((o.width[1] = !1),
        (o.height[1] = !1),
        (o.width[3] = !1),
        (o.height[3] = !1),
    ...
    it(t) &&
      ...
      (o.height[3] = !1),
      (o.height[4] = !1)),
    (!Ue(t) || L(t)) && ((o.width[5] = !1), (o.height[5] = !1)),
    ke(t))
  ) {
    let s = t.getSupportedLayout(e);
    (J(s.width) || (o.width[2] = !1),
      J(s.height) || (o.height[2] = !1),
      Q(s.width) || ((o.width[0] = !1), (o.width[1] = !1), (o.width[3] = !1), (o.width[4] = !1)),
      Q(s.height) ||
        ((o.height[0] = !1), (o.height[1] = !1), (o.height[3] = !1), (o.height[4] = !1)));
  } else if (T(t)) {
    if (L(t)) {
      ((o.width[2] = !1),
        ee(t) && ((o.height[0] = !1), (o.height[1] = !1), (o.height[3] = !1), (o.height[4] = !1)));
      let s = i.get(t.parentid);
      xe(s) && (o.height[2] = !1);
    }
    t.children.length === 0 && ((o.width[2] = !1), (o.height[2] = !1));
  } else T(t) || Fe(t) || Ce(t) || ((o.width[2] = !1), $e(t) || (o.height[2] = !1));
  return (
    be(t) && we(t.layout) && Oe(t) && !Me(t) && ((o.width[2] = !1), (o.height[2] = !1)),
    r || ((o.width[4] = !1), (o.height[4] = !1)),
    ((L(n) && qe(n) && ye(n.heightType)) || ee(n)) && ((o.height[3] = !1), (o.height[1] = !1)),
...
var Ci = [
  ...
  lr = new Set(Ci.map((i) => i.vectorSetModuleId));
async function se(i) {
  let e;
  try {
          ...
          return (...s) => {
            ...
            return new Promise((m, c) => {
              (i !== void 0 &&
                ...
                t
                  .then((v) => {
                    (window.clearTimeout(d), typeof v[o] == "function" ? m(v[o](...s)) : m(v[o]));
                  })
                  .catch(c));
            });
          };
...
function de({ silent: i = !1, quiet: e = !1 }) {
  return i
    ? Te
    : e
      ? (t) => {
          (t.type === "add" && t.variant !== "error") || S(t);
        }
      : (t) => S(t);
}
function bi(i) {
...
var le = class {
    ...
    async uploadImage(
      ...
      try {
        let s = de({ silent: t, quiet: n });
        if (!et.includes(e.type)) {
          s({
            variant: "error",
            icon: "error",
            duration: 1 / 0,
        ...
        let d = await this.api.uploadAsset(e, {
          maxFileSize: r,
          onExceedsCustomMaxSize: o,
          onToast: s,
        });
        ...
        (S({
          ...
          q.reportError(s, { fileName: e.name, fileSize: e.size, fileType: e.type }));
      }
    }
    async uploadVideo(
      e,
      ...
      try {
        let s = de({ silent: t, quiet: n }),
          d = await Promise.all([
            re(se(e), 1e4, "Measuring the video took more than 10 seconds"),
            this.api.uploadAsset(e, { maxFileSize: r, onExceedsCustomMaxSize: o, onToast: s }),
          ]),
          [m, c] = d;
        return c
          ? (a && (await this.assetService.refresh().catch(y)),
    ...
    async uploadFile(
      ...
      let s = de({ silent: t, quiet: n }),
        d = await this.api.uploadAsset(e, {
          maxFileSize: r,
          onExceedsCustomMaxSize: o,
          onToast: s,
        });
      if (d)
        return (
          a && (await this.assetService.refresh().catch(y)),
          { type: "file", asset: d, filename: F(d), originalFilename: d.name, url: b(d) }
        );
    }
  ...
  { service: _t, resolve: Ri } = Mt();
function br(i, e) {
  Ri(new le(i, e));
}
var zt = "https://app.framerstatic.com/apple-music@2x-QNINHCQB.png";
var Ht = "https://app.framerstatic.com/dotlottie@2x-PO7EYB72.png";
var Et = "https://app.framerstatic.com/gif@2x-YJLRSG23.png";
var Ut = "https://app.framerstatic.com/image-light@2x-ZNDSNRGK.png";
var qt = "https://app.framerstatic.com/image@2x-J24ALEQ5.png";
var Bt = "https://app.framerstatic.com/mp3-light@2x-7JFI5VH3.png";
var Xt = "https://app.framerstatic.com/mp3@2x-3HRSK7AW.png";
var $t = "https://app.framerstatic.com/podcasts@2x-3YVIB6RX.png";
var Zt = "https://app.framerstatic.com/simplecast@2x-4KWTR2UC.png";
var jt = "https://app.framerstatic.com/soundcloud@2x-A2MP7SBC.png";
var Yt = "https://app.framerstatic.com/spotify@2x-FVAZWFD4.png";
var Kt = "https://app.framerstatic.com/video-light@2x-SALVCONI.png";
var Jt = "https://app.framerstatic.com/video@2x-XC7DTFDW.png";
var me = {
  ...
  Qt = { ...ce, formInputIconColor: z };
function ti() {
  return new p({ width: 400, height: 300, fillEnabled: !0, fillType: "image", fillColor: "#333" });
}
function Vn() {
  return new ie({
    width: 300,
...
async function Ln(i, e, t) {
  ...
  let n = await E(i.imageUrl, i.originalFilename),
    r = await _t.uploadImage(n, { silent: !0 });
...
async function B(i, e) {
  ...
  let t = N[e],
    { module: n } = await i.stores.modulesStore.lookUpModule(Ye(t));
  if (!n?.files.module) return;
  let r = Ie(
    n.id,
    n.saveId,
    n.files.module,
    "exportSpecifier" in t && Xe(t.exportSpecifier) ? t.exportSpecifier : "default"
  );
  return (
...
function ei({ label: i, type: e, placeholder: t, name: n }) {
  let r = Ze(e);
  return new p({
    ...X,
    children: new x([
      new C({ heightType: 2, widthType: 2, html: $(i) }),
      new mt({
        ...ce,
        formInputPlaceholderColor: dt,
        height: 40,
        heightType: 0,
        width: 1,
        widthType: 3,
...
function pe(i, e, t, n = !1) {
  return new p({
    ...
    children: new x([
      ...
      new C({ heightType: 2, widthType: 2, userSelect: "none", html: $(i) }),
    ]),
  });
}
function Ui() {
  ...
  return new p({
    ...X,
    children: new x([
      new C({ heightType: 2, widthType: 2, html: $("Location") }),
      new ct({
        ...Qt,
        formInputRequired: !0,
        formInputName: "Location",
        formInputInvalidTextColor: lt,
        height: 40,
        heightType: 0,
        width: 1,
        widthType: 3,
...
async function _n(i) {
  let e = Le(),
    t = new p({
      ...
      fillEnabled: !1,
      children: new x([
        ei({ label: "Name", type: "text", placeholder: "Jane Smith", name: "Name" }),
        ei({ label: "Email", type: "email", placeholder: "jane@framer.com", name: "Email" }),
        Ui(),
      ]),
    });
  return (Bi(i, t, e), t);
...
function zn(i) {
  let e = ae("horizontal", !1, i),
    ...
    a = new p(o);
  a.addChild(new ft({ width: 80, height: 80, fillColor: n, radius: 8 }));
  let s = new p(o);
  s.addChild(new pt({ width: 85, height: 85, fillColor: n, fillEnabled: !0, fillType: "color" }));
  let d = new p(o);
  return (
    d.addChild(
      new ut({
...
var ii = [
  ...
  ca = [
    ...
    I(ii, "giphy", "image"),
    Ke,
    I(Zi, "dotlottie", "animation"),
    I(k, "spotify", "audio"),
    I(k, "apple music", "audio"),
    I(k, "soundcloud", "audio"),
    I(k, "apple podcasts", "audio"),
    I(k, "simplecast", "audio"),
  ];
var ri = "https://app.framerstatic.com/embed-light@2x-PS76WMQ2.png";
var ni = "https://app.framerstatic.com/embed@2x-6J66YCPC.png";
var Ia = {
  key: "embed",
  title: "Embed",
  keywords: "iframe",
  previewImage: ni,
  previewImageLight: ri,
...
//# sourceMappingURL=chunk-5CXZOC5T.mjs.map
