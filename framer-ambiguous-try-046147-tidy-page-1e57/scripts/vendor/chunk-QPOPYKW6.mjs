import { g as Zs } from "chunk-SR2NVY3J.mjs";
import { a as na } from "chunk-I46TPHMS.mjs";
import { a as si } from "chunk-YGN7H5WF.mjs";
import { b as ni } from "chunk-WPWSHZF5.mjs";
import { e as Xs } from "chunk-7AUGB2CM.mjs";
import { a as Js } from "chunk-ZRYKVWJA.mjs";
import { a as Qs, c as ea } from "chunk-YY75G3LC.mjs";
import { c as ra } from "chunk-JOTEA4IC.mjs";
import { a as oa, b as ia } from "chunk-VLGNAOWL.mjs";
import { a as ta } from "chunk-VD6KMVU6.mjs";
import { d as ii } from "chunk-DMP2ZDLW.mjs";
import { a as Qo } from "chunk-5ZFCTKOG.mjs";
import { b as _t } from "chunk-XVTPET7X.mjs";
...
import { b as Er, e as Ks, h as Us, m as Dt, o as Tt, s as $s } from "chunk-LA34HORX.mjs";
import { a as X } from "chunk-SWYZG2NI.mjs";
import { b as ri, c as zs } from "chunk-4JY5UMT2.mjs";
import { l as js } from "chunk-MQDP3TYU.mjs";
import { d as $e, u as Zr, v as Ws } from "chunk-VHFKZWVR.mjs";
import { d as Bs } from "chunk-VJ7UYMJI.mjs";
...
var Sf = Object.defineProperty,
  ...
  la = (e, t, o) =>
    t in e ? Sf(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : (e[t] = o),
  C = (e, t) => {
...
function pa(e) {
  return Pf(e) ? C({}, e.props).ref || e.ref : null;
}
function va(e, t) {
  let o = C({}, e);
  for (let r in t) {
...
function fn(e, t, o) {
  let r = e.onLoadedMetadataCapture,
    n = (0, ve.useMemo)(() => Object.assign(() => {}, T(C({}, r), { [t]: o })), [r, t, o]);
...
function Af(e) {
  let t = e.movementX || e.screenX - Sa,
    o = e.movementY || e.screenY - Ca;
  return ((Sa = e.screenX), (Ca = e.screenY), t || o || !1);
}
function Df(e) {
  Af(e) && (vi = !0);
}
...
var je = F(X(), 1),
  mr = F(ie(), 1);
function W(e) {
  let t = je.forwardRef((o, r) => e(T(C({}, o), { ref: r })));
...
function Ee(e = [], t = []) {
  let o = je.createContext(void 0),
    ...
    a = (c) =>
      e.reduceRight(
        (f, m) => (0, mr.jsx)(m, T(C({}, c), { children: f })),
...
function Uf(e) {
  let t = e.target;
  t && "hasAttribute" in t && (t.hasAttribute("data-focus-visible") || (Ci = !1));
}
function $f(e) {
  e.metaKey || e.ctrlKey || e.altKey || (Ci = !0);
}
var Bt = U(function (t) {
    var o = t,
    ...
    ((0, Qe.useEffect)(() => {
      r && (qa || (xe("mousedown", Uf, !0), xe("keydown", $f, !0), (qa = !0)));
    }, [r]),
      Ka &&
        (0, Qe.useEffect)(() => {
          if (!r) return;
    ...
    let d = Si(a.onKeyPressCapture, c),
      v = Si(a.onMouseDownCapture, c),
      p = Si(a.onClickCapture, c),
      x = a.onMouseDown,
      b = $((E) => {
        if ((x?.(E), E.defaultPrevented || !r)) return;
        let D = E.currentTarget;
        if (!Ka || on(E) || (!Ge(D) && !$a(D))) return;
        let K = !1,
          I = () => {
            K = !0;
          },
        ...
        (Ua(N, !0),
          gt(D, "mouseup", () => {
            (D.removeEventListener("focusin", I, !0), Ua(N, !1), !K && hn(D));
          }));
      }),
      g = (E, D) => {
      ...
      S = a.onFocusCapture,
      P = $((E) => {
        if ((S?.(E), E.defaultPrevented || !r)) return;
        if (!Ae(E)) {
          l(!1);
          return;
        }
        let D = E.currentTarget,
          K = () => g(E, D);
        Ci || Bf(E.target) ? gt(E.target, "focusout", K) : l(!1);
      }),
      M = a.onBlur,
      A = $((E) => {
        (M?.(E), r && bt(E) && (E.currentTarget.removeAttribute("data-focus-visible"), l(!1)));
      }),
      ...
      h = r && zf(H),
      O = a.style,
      k = (0, Qe.useMemo)(() => (f ? C({ pointerEvents: "none" }, O) : O), [f, O]);
    return (
      (a = T(
        C(
          {
  ...
  ho = U(function (t) {
    ...
    let [c, f] = (0, rr.useState)(!1),
      ...
      x = $((w) => {
        ...
        if (w.defaultPrevented || d || l || !Ae(w) || ke(y) || y.isContentEditable) return;
        let S = r && w.key === "Enter",
          P = n && w.key === " ",
          M = w.key === "Enter" && !r,
          A = w.key === " " && !n;
      ...
      g = $((w) => {
        ...
        let y = n && w.key === " ";
        if (m.current && y && ((m.current = !1), !Xa(w))) {
          (w.preventDefault(), f(!1));
          let S = w.currentTarget,
            P = w,
            { view: M } = P,
            A = j(P, ["view"]);
          queueMicrotask(() => di(S, A));
        }
      });
    return (
      (i = T(C(C({ "data-active": c || void 0, type: a ? "button" : void 0 }, v), i), {
        ref: ee(s, i.ref),
        onKeyDown: x,
        onKeyUp: g,
      })),
...
var St = F(X(), 1),
  ...
  Qa = () => () => {};
function fe(e, t = to) {
  let o = St.useCallback((n) => (e ? Jt(e, null, n) : Qa()), [e]),
    r = () => {
...
function bo(e, t) {
  let o = St.useRef({}),
    r = St.useCallback((i) => (e ? Jt(e, null, i) : Qa()), [e]),
    n = () => {
      let i = e?.getState(),
        s = !1,
        a = o.current;
...
function ze(e, t) {
  let [o, r] = St.useState(() => e(t));
  Q(() => Mr(o), [o]);
  let n = St.useCallback((a) => fe(o, a), [o]),
    i = St.useMemo(() => T(C({}, o), { useState: n }), [o, n]),
    s = $(() => {
...
var _r = U(function (t) {
    ...
    let d = De(m.id),
      ...
      H = $((I) => {
        ...
        if (
          (r.setActiveId(d),
          uo(I.currentTarget) && Fa(I.currentTarget),
        ...
        (Lt() &&
          ...
          (_.current = !0),
          I.relatedTarget === N || dr(r, I.relatedTarget) ? Ha(N) : N.focus());
      }),
      B = m.onBlurCapture,
      h = $((I) => {
      ...
      D = $((I) => {
        ...
        let { currentTarget: q } = I,
          ...
          Oe = () => !!(Ce || J || !N.baseElement || !ke(N.baseElement)),
          Ue = {
            ArrowUp: (Ce || ye) && r.up,
            ArrowRight: (Ce || J) && r.next,
            ArrowDown: (Ce || ye) && r.down,
            ArrowLeft: (Ce || J) && r.previous,
            Home: () => {
              if (Oe()) return !Ce || I.ctrlKey ? r?.first() : r?.previous(-1);
            },
            End: () => {
              if (Oe()) return !Ce || I.ctrlKey ? r?.last() : r?.next(-1);
            },
    ...
    return (
      (m = le(m, (I) => (0, tu.jsx)(Aa.Provider, { value: K, children: I }), [K])),
      (m = T(C({ id: d, "data-active-item": y || void 0 }, m), {
        ref: ee(v, m.ref),
      ...
      (m = ho(m)),
      (m = gi(
        T(C({ store: r }, m), { getItem: A, shouldRegisterItem: d ? m.shouldRegisterItem : !1 })
      )),
      We(T(C({}, m), { "aria-setsize": S, "aria-posinset": P }))
    );
  }),
  wi = er(
    W(function (t) {
...
function im(e) {
  let [t, o] = (0, Ct.useState)(!1),
    r = (0, Ct.useCallback)(() => o(!0), []),
...
var Hr = U(function (t) {
    ...
    a = T(C({ "aria-activedescendant": H }, a), {
      ref: ee(c, d, a.ref),
      onKeyDownCapture: x,
      onKeyUpCapture: b,
      onFocusCapture: w,
...
var Ei = F(X(), 1),
  So = Ee([nu], [iu]),
  Qh = So.useContext,
  eb = So.useScopedContext,
  Vr = So.useProviderContext,
  su = So.ContextProvider,
  Lr = So.ScopedContextProvider,
...
var Co = U(function (t) {
    ...
    (Q(() => {
      ...
      Q(() => {
        ...
        if (typeof d == "number") return cu(d, y);
        let {
    ...
    let x = pr(l, i.hidden, n),
      b = i.style,
      g = (0, Nr.useMemo)(() => (x ? T(C({}, b), { display: "none" }) : b), [x, b]);
    return (
      (i = T(
        C(
          {
  ...
  cb = W(function (t) {
    ...
    let i = yo(),
      s = n.store || i;
    return fe(s, (u) => !r || u?.mounted) === !1 ? null : (0, Ii.jsx)(um, C({}, n));
  });
function wo(e = {}) {
...
function du(e = {}) {
  ...
  let f = (l, d, v = !1) => {
      ...
      return (
        ...
        () => {
          d((b) => {
            if (!p) return (v && n.delete(l.id), b.filter(({ id: y }) => y !== l.id));
            let g = b.findIndex(({ id: y }) => y === l.id);
            if (g === -1) return b;
            let w = b.slice();
...
function hr(e = {}) {
  ...
  let a = (u = "next", c = {}) => {
    ...
    let l = s.getState(),
      ...
      M = P ? y && !S : !y || S,
      A = p && !d,
      R = S ? go(hm(hu(w), v, A)) : w;
    if (((R = M ? Fr(R) : R), (R = S ? bm(R) : R), v == null))
    ...
    let k = x && (S ? x !== "horizontal" : x !== "vertical"),
      E = H && b && (S ? b !== "horizontal" : b !== "vertical"),
      D = P ? (!H || S) && k && g : S ? g : !1;
    if (k) {
      let I = E && !D ? R : vu(R, _.rowId),
        q = pm(I, v, D),
        N = jt(q, v);
      return N?.id;
    }
...
var ym = "hr",
  Di = U(function (t) {
    ...
    return ((n = Ai(T(C({}, n), { orientation: s }))), n);
  }),
  Sm = W(function (t) {
    let o = Di(t);
    return z(ym, o);
...
var Em = "span",
  Im = U(function (t) {
    return (
      (t = T(C({ "data-focus-trap": "", tabIndex: 0, "aria-hidden": !0 }, t), {
...
var Vi = U(function (t) {
    ...
    return (
      Q(() => {
        ...
        let P = S.isConnected;
        if (
          (P || (m || Om(y)).appendChild(S),
          S.id || (S.id = y.id ? `portal/${y.id}` : Am()),
          d(S),
          no(s, S),
          !P)
        )
      ...
      (0, et.useEffect)(() => {
        ...
        let y = 0,
          S = (P) => {
            ...
            if ((cancelAnimationFrame(y), M)) return ja(l);
            y = requestAnimationFrame(() => {
              Wa(l, !0);
            });
          };
        return (
          l.addEventListener("focusin", S, !0),
      ...
      (u = le(
        ...
        (y) => {
            ...
            children: [
              ...
              r &&
                ...
                (0, Le.jsx)(Oo, {
                  ...
                  onFocus: (P) => {
                    bt(P, l) ? nr(yi()) : nr(w.current);
                  },
                }),
            ],
          })),
            l && (y = (0, Hi.createPortal)(y, l)));
          let S = (0, Le.jsxs)(Le.Fragment, {
            children: [
              r &&
                l &&
                (0, Le.jsx)(Oo, {
                  ...
                  onFocus: (P) => {
                    !(P.relatedTarget === w.current) && bt(P, l) ? nr(b.current) : nr(yi());
                  },
                }),
          ...
          return (
            v && r && (S = (0, Hi.createPortal)(S, v)),
            (0, Le.jsxs)(Le.Fragment, { children: [S, y] })
          );
        },
        [l, m, a, u.id, r, v]
      )),
...
var Eu = F(X(), 1),
  Iu = F(ie(), 1);
function Mu({ level: e, children: t }) {
  let o = (0, Eu.useContext)(Li),
    r = Math.max(Math.min(e || o + 1, 6), 1);
  return (0, Iu.jsx)(Li.Provider, { value: r, children: t });
}
var Ou = F(ie(), 1),
  Dm = "div",
  Ni = U(function (t) {
    ...
    let n = re(e),
      ...
      d = () => {
        ...
        let { scrollX: b, scrollY: g, visualViewport: w } = i,
          ...
          S = (x = w?.offsetTop) != null ? x : 0,
          P = Ao(a, {
            position: "fixed",
            overflow: "hidden",
            top: `${-(g - Math.floor(S))}px`,
...
function Ku({ store: e, backdrop: t, alwaysVisible: o, hidden: r }) {
  ...
  if (!t) return null;
  if ((0, Kr.isValidElement)(t)) return (0, An.jsx)(zr, T(C({}, a), { render: t }));
  let u = typeof t != "boolean" ? t : "div";
  return (0, An.jsx)(zr, T(C({}, a), { render: (0, An.jsx)(u, {}) }));
}
function ko(e = {}) {
  return wo(e);
}
...
var Gi = U(function (t) {
  ...
  (Bu(k, B, d && !E), ku(M, m, R));
  let { wrapElement: D, nestedDialogs: K } = Hu(M);
  ((y = le(y, D, [D])),
    Q(() => {
      if (!h) return;
      let G = P.current,
    ...
    (0, Te.useEffect)(() => {
      if (!a || !O || !R) return;
      let G = P.current;
      if (!(!G || G.querySelector("[data-dialog-dismiss]"))) return Ru(G, M.hide);
    }, [M, a, O, R]),
    Q(() => {
      if (!Rn() || h || !O || !R) return;
      let G = P.current;
  ...
  ((0, Te.useEffect)(
    ...
    (y = le(y, (G) => (0, mt.jsx)(Mu, { level: a ? 1 : void 0, children: G }), [a])));
  let Gt = y.hidden,
    ct = y.alwaysVisible;
  y = le(
    y,
    (G) =>
      c
        ? (0, mt.jsxs)(mt.Fragment, {
            children: [
              (0, mt.jsx)(Ku, { store: M, backdrop: c, hidden: Gt, alwaysVisible: ct }),
              G,
            ],
          })
        : G,
  ...
  return (
    ...
    (y = Ni(T(C({}, y), { autoFocusOnShow: Ce }))),
    (y = Co(C({ store: M }, y))),
    (y = Bt(T(C({}, y), { focusable: s }))),
    (y = Vi(T(C({ portal: u }, y), { portalRef: A, preserveTabOrder: H }))),
    y
  );
});
function br(e, t = Vr) {
...
async function Hn(e, t) {
  ...
  return {
    top: (b.top - S.top + v.top) / y.y,
    bottom: (S.bottom - b.bottom + v.bottom) / y.y,
    left: (b.left - S.left + v.left) / y.x,
    right: (S.right - b.right + v.right) / y.x,
  };
}
var Qu = (e) => ({
  name: "arrow",
        ...
        fn(t) {
          ...
          if (u) {
            let w = l === "y" ? "height" : "width",
              y = i.reference[l] - i.floating[w] + x.mainAxis,
              S = i.reference[l] + i.reference[w] - x.mainAxis;
            d < y ? (d = y) : d > S && (d = S);
          }
          if (c) {
            var b, g;
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          let x = d - u.top - u.bottom,
            ...
            S = g,
            P = w;
          if ((m ? (P = f || y ? st(w, b) : b) : (S = f || y ? st(g, x) : x), y && !f)) {
            let A = Ke(u.left, 0),
              R = Ke(u.right, 0),
              _ = Ke(u.top, 0),
              H = Ke(u.bottom, 0);
            m
              ...
              : (S = d - 2 * (_ !== 0 || H !== 0 ? _ + H : Ke(u.top, u.bottom)));
          }
          await s({ ...t, availableWidth: P, availableHeight: S });
...
function cc(e) {
  let t = $t(e);
  return Sr(t) ? (e.ownerDocument ? e.ownerDocument.body : e.body) : dt(t) && $r(t) ? t : cc(t);
}
function Ur(e, t, o) {
  var r;
...
function pc(e) {
  return Cr(Et(e)).left + Lo(e).scrollLeft;
}
function ed(e) {
  let t = Et(e),
    o = Lo(e),
...
function vc(e, t) {
  let o = $t(e);
  return o === t || !at(o) || Sr(o) ? !1 : ut(o).position === "fixed" || vc(o, t);
}
function od(e, t) {
  let o = t.get(e);
  if (o) return o;
...
function hc(e, t) {
  ...
  return r && Sr(r) && Xi(r) && !Vn(r) ? o : r || uc(e) || o;
}
...
function hd(e) {
  ...
  return (te(!t || t.every(pd), !1), yc({ padding: e.overflowPadding, fallbackPlacements: t }));
}
function bd(e) {
...
function xd(e, t) {
  if (e) return Cc({ element: e, padding: t.arrowPadding });
}
var Qi = U(function (t) {
    var o = t,
      {
    ...
    let M = r.useState("arrowElement"),
      ...
      k = (0, Nn.useRef)(null),
      [E, D] = (0, Nn.useState)(!1),
      { portalRef: K, domReady: I } = Dr(i, S.portalRef),
      q = $(w),
      N = $(y),
      he = !!y;
    (Q(() => {
    ...
    }, [r, O, _, M, A, _, B, h, I, c, f, m, l, d, v, p, x, b, g, q, he, N]),
      Q(() => {
    ...
    return (
      (S = le(
        ...
        (ye) =>
          (0, Zi.jsx)(
            "div",
            T(C({}, u), {
              style: C({ position: Ce, top: 0, left: 0, width: "max-content" }, u?.style),
      ...
      (S = le(S, (ye) => (0, Zi.jsx)(or, { value: r, children: ye }), [r])),
      (S = T(C({ "data-placing": !E || void 0 }, S), {
        style: C({ position: "relative" }, S.style),
      })),
      (S = Gi(
        T(
          C(
...
function Sd(e) {
  ...
  return (
    ...
    (r = T(C({ autoFocusOnHide: n, finalFocus: c }, r), { onFocus: u })),
    r
  );
}
var Mc = (0, Pe.createContext)(null),
  Bn = U(function (t) {
    var o = t,
      {
        store: r,
    ...
    ((c = le(
      ...
      (h) =>
        (0, es.jsx)(wn, {
          value: r,
          children: (0, es.jsx)(Mc.Provider, { value: H, children: h }),
        }),
      [r, H]
    )),
      (c = T(C({}, c), { ref: ee(m, c.ref) })),
      (c = Sd(C({ store: r }, c))));
    let B = r.useState((h) => n || h.autoFocusOnShow);
    return (
      (c = Qi(
        T(C({ store: r, modal: n, portal: i, autoFocusOnShow: B }, c), {
          portalRef: x,
          hideOnEscape(h) {
            return ur(s, h)
              ? !1
...
var wr = F(X(), 1),
  ...
  ts = U(function (t) {
    ...
    let c = i.onMouseMove,
      ...
      l = $((x) => {
        ...
        let { showTimeout: g, timeout: w } = r.getState(),
          ...
          S = g ?? w;
        S === 0 ? y() : (u.current = window.setTimeout(y, S));
      }),
      d = i.onClick,
      v = $((x) => {
    ...
    return ((i = T(C({}, i), { ref: ee(p, i.ref), onMouseMove: l, onClick: v })), (i = Bt(i)), i);
  }),
  wd = W(function (t) {
    let o = ts(t);
    return z(Cd, o);
...
var Rc = F(X(), 1),
  ...
  FS = jo.useProviderContext,
  HS = jo.ContextProvider,
  VS = jo.ScopedContextProvider,
  LS = (0, Rc.createContext)(void 0);
var Ed = "div",
  zo = U(function (t) {
    var o = t,
      { store: r } = o,
      n = j(o, ["store"]);
    let i = vr();
    return ((r = r || i), (n = T(C({}, n), { ref: ee(r?.setAnchorElement, n.ref) })), n);
  }),
  KS = W(function (t) {
    let o = zo(t);
    return z(Ed, o);
...
var Gr = F(X(), 1),
  ...
  rs = U(function (t) {
    ...
    return (
      ...
      (t = T(C({ role: !n && r !== "a" ? "button" : void 0 }, t), { ref: ee(o, t.ref) })),
      (t = ho(t)),
      t
    );
  }),
...
var Yr = F(X(), 1),
  ...
  os = U(function (t) {
    ...
    return (
      (i = T(C(C({ "aria-expanded": u, "aria-controls": b?.id }, p), i), {
        ref: ee(a, i.ref),
        onClick: x,
      })),
      (i = rs(i)),
...
var Od = "button",
  ns = U(function (t) {
    ...
    return ((n = C({ "aria-haspopup": Qt(s, "dialog") }, n)), (n = os(C({ store: r }, n))), n);
  }),
  dC = W(function (t) {
    let o = ns(t);
    return z(Od, o);
...
var Ko = U(function (t) {
    ...
    let a = i.onKeyDownCapture,
      ...
      c = $((f) => {
        ...
        for (let S of g) {
          let P = S.ariaDisabled === "true" || ("disabled" in S && !!S.disabled);
          p.push({ id: S.id, element: S, disabled: P });
        }
        if ((g.length && (p = fo(p, (S) => S.element)), !Td(f, p))) return ss();
        (f.preventDefault(),
        ...
        ((qt += w), (p = _d(p, w, d)));
        let y = p.find((S) => Kn(S, qt));
        y ? r.move(y.id) : ss();
      });
    return ((i = T(C({}, i), { onKeyDownCapture: c })), We(i));
  }),
  Fd = W(function (t) {
    let o = Ko(t);
    return z(Ad, o);
...
var Uo = U(function (t) {
    ...
    return ((s = T(C({}, s), { ref: ee(p, s.ref), onMouseMove: m, onMouseLeave: v })), We(s));
  }),
  Nd = er(
    W(function (t) {
      let o = Uo(t);
...
var ls = U(function (t) {
    ...
    s = le(s, (M) => (0, Lc.jsx)(cs, { value: r, children: M }), [r]);
    let g = jd(C({ store: r }, s)),
      w = r.useState("mounted"),
      y = pr(w, s.hidden, n),
      S = y ? T(C({}, s.style), { display: "none" }) : s.style;
    s = T(C({ id: m, "aria-labelledby": g, hidden: y }, s), {
    ...
    return (
      ...
      (s = Hr(C({ store: r, composite: i }, s))),
      (s = Ko(C({ store: r, typeahead: !P }, s))),
      s
    );
  }),
  zd = W(function (t) {
...
var It = F(X(), 1),
  ...
  Ud = U(function (t) {
    ...
    let l = (0, It.useRef)(null),
      ...
      p = !!d,
      x = !!v && !p;
    f = T(C({}, f), { ref: ee(l, f.ref) });
    let b = ls(C({ store: r, alwaysVisible: c }, f)),
      { "aria-labelledby": g } = b;
    f = j(b, ["aria-labelledby"]);
    let [y, S] = (0, It.useState)(),
    ...
    return (
      k !== void 0 && (f = C({ preserveTabOrderAnchor: k }, f)),
      (f = Bn(
        T(
          C(
...
var Gd = U(function (t) {
    ...
    let c = (0, Bc.useRef)(null),
      ...
      S = a.onClick,
      P = $((H) => {
        if ((S?.(H), H.defaultPrevented || !r)) return;
        let B = !H.detail,
          { open: h } = r.getState();
        ((!h || B) &&
    ...
    ((a = le(a, (H) => (0, fs.jsx)(qo, { value: r, children: H }), [r])),
      l && (a = T(C({}, a), { render: (0, fs.jsx)(zr.div, { render: a.render }) })));
    let M = De(a.id),
      A = fe(f?.combobox || f, "contentElement"),
      R = l || d ? co(A, "menuitem") : void 0,
      _ = r.useState("contentElement");
    return (
      (a = T(C({ id: M, role: R, "aria-haspopup": Qt(_, "menu") }, a), {
        ref: ee(c, a.ref),
        onFocus: b,
        onKeyDown: y,
        onClick: P,
      ...
      (a = ts(
        T(C({ store: r, focusable: n, accessibleWhenDisabled: i }, a), {
          showOnHover: (H) => {
            if (
              !(() => {
...
var jc = U(function (t) {
    ...
    let m = u.onClick,
      ...
      b = co(x, "menuitem");
    return (
      (u = T(C({ role: b }, u), { onClick: p })),
      (u = _r(C({ store: r, preventScrollOnKeyDown: i }, u))),
      (u = Uo(
        T(C({ store: r }, u), {
          focusOnHover(g) {
            let w = () => (typeof s == "function" ? s(g) : (s ?? !0));
            if (!r || !w()) return !1;
            let { baseElement: y, items: S } = r.getState();
            return v
              ? (g.currentTarget.hasAttribute("aria-expanded") && g.currentTarget.focus(), !0)
              : Xd(y, S, g.currentTarget)
...
function Gn(e = {}) {
  let t = Pr(e);
  return (0, Uc.jsx)(qo, { value: t, children: e.children });
}
var Zd = "hr",
  Qd = U(function (t) {
    var o = t,
      ...
      n = j(o, ["store"]);
    let i = pt();
    return ((r = r || i), (n = Di(C({ store: r }, n))), n);
  }),
  Yn = W(function (t) {
    let o = Qd(t);
    return z(Zd, o);
...
var np = U(function (t) {
    ...
    ((0, _e.useEffect)(() => {
      ...
      (0, _e.useEffect)(() => {
        if (!_ || !H || !k || !$c(E, k, R) || !qc(h, k)) return;
        let ne = Ft;
        return (
          queueMicrotask(() => {
            let Se = y.current;
            if (!Se) return;
            let { start: Ie, end: rt } = Or(Se),
              At = h.length,
              Ve = k.length;
            (lo(Se, At, Ve),
              (ne = () => {
                if (!nt(Se)) return;
                let { start: ar, end: pf } = Or(Se);
                ar === At && pf === Ve && lo(Se, Ie, rt);
              }));
          }),
          () => ne()
        );
    ...
    let Ce = r.useState("resetValueOnSelect");
    (ot(() => {
      var L, ne;
      let Se = M.current;
      if (!r || !D || (!Se && !Ce)) return;
      ...
      (0, _e.useEffect)(() => {
        ...
        for (let Ie of ne) Ie.addEventListener("focusout", Se);
        return () => {
          for (let Ie of ne) Ie.removeEventListener("focusout", Se);
        };
      }, [_, K, r, I]));
    let ye = (L) => L.currentTarget.value.length >= u,
      ...
      Ue = $((L) => {
        ...
        let ne = L.currentTarget,
          { value: Se, selectionStart: Ie, selectionEnd: rt } = ne,
          At = L.nativeEvent;
        if (
    ...
    return (
      ...
      (g = Hr(
        T(C({ store: r, focusable: n }, g), {
          moveOnKeyPress: (L) => (ur(x, L) ? !1 : (_ && B(!0), !0)),
        })
      )),
      (g = zo(C({ store: r }, g))),
      C({ autoComplete: "off" }, g)
    );
  }),
  Xn = W(function (t) {
    let o = np(t);
...
var Gc = U(function (t) {
    ...
    (x && b != null && (l = C({ "aria-selected": b }, l)),
      (l = le(
        l,
        (h) =>
          (0, ms.jsx)(yu.Provider, {
            value: n,
    ...
    l = T(C({ role: ap(H), children: n }, l), { onClick: A, onKeyDown: _ });
    let B = se(f);
    return (
      (l = _r(
        T(C({ store: r }, l), {
...
var Zn = F(X(), 1),
  ...
  Yc = U(function (t) {
    ...
    let c = (0, Zn.useRef)(null),
      ...
      l = pr(m, i.hidden, n),
      d = l ? T(C({}, i.style), { display: "none" }) : i.style,
    ...
    (Q(() => {
      ...
      g || (i = C({ role: "listbox", "aria-multiselectable": b }, i)),
      (i = le(
        i,
        (P) =>
          (0, ds.jsx)(xu, {
    ...
    let S = f && (!s || !u) ? r.setContentElement : null;
    return ((i = T(C({ id: f, hidden: l }, i), { ref: ee(S, c, i.ref), style: d })), We(i));
  }),
  Xo = W(function (t) {
    let o = Yc(t);
    return z(up, o);
...
function fp(e) {
  let t = Xc();
  return ((e = T(C({}, e), { tag: e.tag !== void 0 ? e.tag : t })), gn(e));
}
function mp(e, t, o) {
  return (
    ot(t, [o.tag]),
        ...
        S = (0, V.jsxs)(Gn, {
          ...
          children: [
              ...
              (0, V.jsxs)(qn, {
                ...
                render: (P) =>
                  (0, V.jsx)(uf, {
                    ...P,
                    hasSubmenu: !0,
                    className: ue(P.className, f && ys, f && f.padding !== "compact" && Ss),
                  }),
                children: [
            ...
            (0, V.jsx)($n, {
              ...
              className: ue(gl, y && xl, r?.className, oa),
              style: { width: a },
...
var wp = pe.memo(function ({
  ...
  Pp = (e) => (0, V.jsx)(Yn, { ...e, className: ue(bl, e.className) }),
  of = 14,
  af = ({ icon: e }) => {
...
var uf = pe.memo(
  ...
  Ip = pe.memo(
    pe.forwardRef(function (
      ...
      let { closeOnSelect: y, startTime: S, mouseDidMove: P } = Xl(),
        M = Zo(),
        A = pt(),
        R = Fs(l);
      ...
      let _ = pe.useRef(null),
        ...
        K = pe.useCallback(
          (J) => {
            ...
            !B || !Ys(J.button) || (Vs(P, S) && (O.suppressFor(J.currentTarget), h?.(J), D(J)));
          },
          [h, D, S, P, O, B]
        ),
        I = pe.useCallback(
...
var Rp = pe.memo(({ items: e, onSelect: t, submenuPlacement: o }) => {
  ...
  return e.map((n) => {
    let i = n.path.join("+");
    if (n.type === "separator") return (0, V.jsx)(Pp, {}, i);
...
function fM({
  ...
  ((0, He.useEffect)(() => {
    ...
    return (
      window.addEventListener("mouseup", M, { signal: S.signal }),
      window.addEventListener("mousemove", A, { once: !0, signal: S.signal }),
      () => {
        (S.abort(), x(!1));
      }
    );
  ...
  let b = (0, He.useCallback)(() => e?.config.location ?? null, [e?.config.location]),
    ...
    y = (0, He.useMemo)(
      () => ({
        ...
        className: ue(yl, e?.config?.className),
        onKeyDown: n,
        onKeyUp: i,
      }),
...
function mf(e) {
  return !(
    ...
    e.enabled === !1 ||
    Tt(e.submenu) ||
    (Us(e.submenu) && e.submenu.length === 0)
  );
}
function df(e) {
  let t = 0;
...
//# sourceMappingURL=chunk-QPOPYKW6.mjs.map
