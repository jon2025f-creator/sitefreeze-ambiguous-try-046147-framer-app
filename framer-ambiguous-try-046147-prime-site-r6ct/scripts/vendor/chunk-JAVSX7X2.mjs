import { b as E, c as W, d as V, e as y } from "chunk-VF7G4YEJ.mjs";
import { a as o } from "chunk-M27JGL5N.mjs";
import { a as n, b as T } from "chunk-R2DMEYVU.mjs";
import { a as c, b as r, c as e } from "chunk-WIC6DAGD.mjs";
...
var p = "0px 3px 6px 0px rgba(0, 0, 0, 0.08)",
  h = `${p}, 0px 0px 0px 1px rgba(0, 0, 0, 0.05)`,
...
var br = {
  ...
  kr = { menu: `${p}, 0px 0px 0px 1px ${r.dark72}` },
  xr = {
...
var tr = i.default.forwardRef(function ({ mode: m, children: l, className: B, ...b }, g) {
    let x = ar(),
      d = fr(),
      v = m || x || d,
      lr = Pr(v) ? er[v] : void 0;
    return (0, u.jsx)(M.Provider, {
      value: v,
      children: (0, u.jsx)("div", { ref: g, className: R(cr, lr, B), ...b, children: l }),
    });
  }),
...
//# sourceMappingURL=chunk-JAVSX7X2.mjs.map
