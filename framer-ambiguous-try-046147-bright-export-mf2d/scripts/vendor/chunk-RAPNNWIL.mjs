import { b as h, h as E, m as P, p as b } from "chunk-LA34HORX.mjs";
...
var p = !1,
  v = class {
    ...
    get(n) {
      this.assertOnUse &&
        g(p, () => `Tried to read state of ${n} before update, await on .updated first`);
    ...
    isOn(n) {
      return (
        this.assertOnUse &&
          g(p, () => `Tried to read the state of ${n} before update, await on .updated first`),
        this.is(n, "on")
      );
    }
    getVariantName(n) {
...
function Te(e, n) {
  ((l.isEnterprise.Team = n === "enterprise"), (l.hashes.Team = u(e)));
}
function Ce(e) {
  l.channel = e;
}
...
function te() {
  let e = {};
  try {
    let n = JSON.parse(localStorage[C()] || "{}");
    Object.assign(e, n);
  } catch {}
  return e;
}
...
function De({ resetStorage: e, resetSession: n } = {}) {
  if (!(typeof window > "u")) {
    if ((e && localStorage.removeItem(C()), n)) {
...
function Fe(e) {
  ...
  let o = { ...t, ...e };
  for (let r of w(o)) m.getInitial(r) === o[r] && delete o[r];
  try {
...
//# sourceMappingURL=chunk-RAPNNWIL.mjs.map
