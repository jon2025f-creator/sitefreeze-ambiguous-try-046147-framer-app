...
import { f as tt } from "chunk-EFB2P3QE.mjs";
...
import { g as Ie, q as K } from "chunk-ONZSSKY2.mjs";
...
function br(i, e, t, n = i.getParent(t.id), r = Ee(i, t)) {
  ...
  return (
    Ce(t) && ve(t.layout) && Oe(t) && !qe(t) && ((o.width[2] = !1), (o.height[2] = !1)),
...
//# sourceMappingURL=chunk-G4K74QH6.mjs.map
