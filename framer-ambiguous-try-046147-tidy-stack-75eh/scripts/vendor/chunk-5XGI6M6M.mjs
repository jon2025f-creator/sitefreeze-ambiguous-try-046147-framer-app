...
v.prototype = {
  constructor: v,
  find: function (i) {
    for (var e = 0; e < this.content.length; e += 2) if (this.content[e] === i) return e;
    return -1;
  },
  get: function (i) {
    var e = this.find(i);
  ...
  update: function (i, e, t) {
    var n = t && t != i ? this.remove(t) : this,
      r = n.find(i),
      s = n.content.slice();
    return (r == -1 ? s.push(t || i, e) : ((s[r + 1] = e), t && (s[r] = t)), new v(s));
  },
  remove: function (i) {
    var e = this.find(i);
    if (e == -1) return this;
  ...
  addToStart: function (i, e) {
    return new v([i, e].concat(this.remove(i).content));
  },
  addToEnd: function (i, e) {
    var t = this.remove(i).content.slice();
    return (t.push(i, e), new v(t));
  },
  addBefore: function (i, e, t) {
    var n = this.remove(e),
      r = n.content.slice(),
      s = n.find(i);
    return (r.splice(s == -1 ? r.length : s, 0, e, t), new v(r));
  },
  forEach: function (i) {
    for (var e = 0; e < this.content.length; e += 2) i(this.content[e], this.content[e + 1]);
  },
  prepend: function (i) {
    return ((i = v.from(i)), i.size ? new v(i.content.concat(this.subtract(i).content)) : this);
  },
  append: function (i) {
    return ((i = v.from(i)), i.size ? new v(this.subtract(i).content.concat(i.content)) : this);
  },
  subtract: function (i) {
    var e = this;
    i = v.from(i);
...
function Qe(i, e, t) {
  for (let n = 0; ; n++) {
    ...
    if (r.isText && r.text != s.text) {
      for (let l = 0; r.text[l] == s.text[l]; l++) t++;
      return t;
    }
    if (r.content.size || s.content.size) {
      let l = Qe(r.content, s.content, t + 1);
      if (l != null) return l;
    }
    t += r.nodeSize;
  }
...
function Xe(i, e, t, n) {
  for (let r = i.childCount, s = e.childCount; ;) {
    ...
    if (!l.sameMarkup(o)) return { a: t, b: n };
    ...
    if (l.content.size || o.content.size) {
      let a = Xe(l.content, o.content, t - 1, n - 1);
      if (a) return a;
    }
    ((t -= h), (n -= h));
  }
...
var p = class i {
  ...
  nodesBetween(e, t, n, r = 0, s) {
    for (let l = 0, o = 0; o < t; l++) {
      let h = this.content[l],
        a = o + h.nodeSize;
      if (a > e && n(h, r + o, s || null, l) !== !1 && h.content.size) {
        let c = o + 1;
        h.nodesBetween(Math.max(0, e - c), Math.min(h.content.size, t - c), n, r + c);
      }
      o = a;
    }
  }
  ...
  textBetween(e, t, n, r) {
    ...
    return (
      this.nodesBetween(
        ...
        (o, h) => {
          let a = o.isText
            ? o.text.slice(Math.max(e, h) - h, t - h)
            : o.isLeaf
              ? r
                ? typeof r == "function"
                  ? r(o)
                ...
                : o.type.spec.leafText
                  ...
                  : ""
              : "";
          (o.isBlock && ((o.isLeaf && a) || o.isTextblock) && n && (l ? (l = !1) : (s += n)),
            (s += a));
        },
        0
      ),
  ...
  append(e) {
    ...
    let t = this.lastChild,
      ...
      s = 0;
    for (
      t.isText && t.sameMarkup(n) && ((r[r.length - 1] = t.withText(t.text + n.text)), (s = 1));
      s < e.content.length;
      s++
    )
      r.push(e.content[s]);
    ...
    if (t > e)
      for (let s = 0, l = 0; l < t; s++) {
        ...
        (h > e &&
          ((l < e || h > t) &&
            (o.isText
              ? (o = o.cut(Math.max(0, e - l), Math.min(o.text.length, t - l)))
              : (o = o.cut(Math.max(0, e - l - 1), Math.min(o.content.size, t - l - 1)))),
          n.push(o),
          (r += o.nodeSize)),
          (l = h));
      }
...
p.empty = new p([], 0);
var ue = { index: 0, offset: 0 };
function $(i, e) {
  return ((ue.index = i), (ue.offset = e), ue);
}
function ee(i, e) {
  if (i === e) return !0;
  ...
  if (t) {
    ...
    for (let n = 0; n < i.length; n++) if (!ee(i[n], e[n])) return !1;
  } else {
    for (let n in i) if (!(n in e) || !ee(i[n], e[n])) return !1;
    for (let n in e) if (!(n in i)) return !1;
  }
  return !0;
}
var w = class i {
  ...
  addToSet(e) {
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      if (this.type.excludes(s.type)) t || (t = e.slice(0, r));
        ...
        (!n && s.type.rank > this.type.rank && (t || (t = e.slice(0, r)), t.push(this), (n = !0)),
          t && t.push(s));
      }
    }
...
var A = class extends Error {},
  g = class i {
    ...
    insertAt(e, t) {
      let n = Ze(this.content, e + this.openStart, t);
      return n && new i(n, this.openStart, this.openEnd);
    }
    removeBetween(e, t) {
      return new i(
        Ye(this.content, e + this.openStart, t + this.openStart),
        this.openStart,
        this.openEnd
      );
    }
    ...
    static fromJSON(e, t) {
      ...
      return new i(p.fromJSON(e, t.content), n, r);
    }
...
g.empty = new g(p.empty, 0, 0);
function Ye(i, e, t) {
  let { index: n, offset: r } = i.findIndex(e),
    s = i.maybeChild(n),
    { index: l, offset: o } = i.findIndex(t);
  if (r == e || s.isText) {
    if (o != t && !i.child(l).isText) throw new RangeError("Removing non-flat range");
    return i.cut(0, e).append(i.cut(t));
  }
  if (n != l) throw new RangeError("Removing non-flat range");
  return i.replaceChild(n, s.copy(Ye(s.content, e - r - 1, t - r - 1)));
}
function Ze(i, e, t, n) {
  let { index: r, offset: s } = i.findIndex(e),
    l = i.maybeChild(r);
  if (s == e || l.isText)
    return n && !n.canReplace(r, r, t) ? null : i.cut(0, e).append(t).append(i.cut(e));
  let o = Ze(l.content, e - s - 1, t, l);
  return o && i.replaceChild(r, l.copy(o));
}
function Jt(i, e, t) {
  if (t.openStart > i.depth) throw new A("Inserted content deeper than insertion position");
  if (i.depth - t.openStart != e.depth - t.openEnd) throw new A("Inconsistent open depths");
  return je(i, e, t, 0);
}
function je(i, e, t, n) {
  let r = i.index(n),
  ...
  if (r == e.index(n) && n < i.depth - t.openStart) {
    let l = je(i, e, t, n + 1);
    return s.copy(s.content.replaceChild(r, l));
  } else if (t.content.size)
    if (!t.openStart && !t.openEnd && i.depth == n && e.depth == n) {
      let l = i.parent,
        o = l.content;
      return I(l, o.cut(0, i.parentOffset).append(t.content).append(o.cut(e.parentOffset)));
    } else {
      let { start: l, end: o } = Dt(t, i);
      return I(s, _e(i, l, o, e, n));
    }
  else return I(s, te(i, e, n));
}
function $e(i, e) {
  if (!e.type.compatibleContent(i.type))
    throw new A("Cannot join " + e.type.name + " onto " + i.type.name);
}
function de(i, e, t) {
  let n = i.node(t);
  return ($e(n, e.node(t)), n);
}
function R(i, e) {
  let t = e.length - 1;
...
function q(i, e, t, n) {
  let r = (e || i).node(t),
    s = 0,
    l = e ? e.index(t) : r.childCount;
  i && ((s = i.index(t)), i.depth > t ? s++ : i.textOffset && (R(i.nodeAfter, n), s++));
  for (let o = s; o < l; o++) R(r.child(o), n);
  e && e.depth == t && e.textOffset && R(e.nodeBefore, n);
}
function I(i, e) {
  return (i.type.checkContent(e), i.copy(e));
}
function _e(i, e, t, n, r) {
  let s = i.depth > r && de(i, e, r + 1),
    l = n.depth > r && de(t, n, r + 1),
    o = [];
  return (
    q(null, i, r, o),
    s && l && e.index(r) == t.index(r)
      ? ($e(s, l), R(I(s, _e(i, e, t, n, r + 1)), o))
      : (s && R(I(s, te(i, e, r + 1)), o), q(e, t, r, o), l && R(I(l, te(t, n, r + 1)), o)),
    q(n, null, r, o),
    new p(o)
  );
}
function te(i, e, t) {
  let n = [];
  if ((q(null, i, t, n), i.depth > t)) {
    let r = de(i, e, t + 1);
    R(I(r, te(i, e, t + 1)), n);
  }
  return (q(e, null, t, n), new p(n));
}
function Dt(i, e) {
  let t = e.depth - i.openStart,
    r = e.node(t).copy(i.content);
  for (let s = t - 1; s >= 0; s--) r = e.node(s).copy(p.from(r));
  return {
...
var ne = class i {
    ...
    marks() {
      ...
      for (var l = 0; l < s.length; l++)
        s[l].type.spec.inclusive === !1 &&
          (!r || !s[l].isInSet(r.marks)) &&
          (s = s[l--].removeFromSet(s));
      return s;
    }
    marksAcross(e) {
    ...
    blockRange(e = this, t) {
      ...
      for (
        let n = this.depth - (this.parent.inlineContent || this.pos == e.pos ? 1 : 0);
        n >= 0;
        n--
      )
        if (e.pos <= this.end(n) && (!t || t(this.node(n)))) return new ge(this, e, n);
      return null;
    }
    sameParent(e) {
    ...
    static resolveCached(e, t) {
      ...
      else Je.set(e, (n = new me()));
      let r = (n.elts[n.i] = i.resolve(e, t));
      return ((n.i = (n.i + 1) % Bt), r);
    }
  },
  me = class {
    constructor() {
  ...
  b = class i {
    ...
    hasMarkup(e, t, n) {
      return (
        this.type == e &&
        ee(this.attrs, t || e.defaultAttrs || Wt) &&
        w.sameSet(this.marks, n || w.none)
      );
    }
    copy(e = null) {
      return e == this.content ? this : new i(this.type, this.attrs, e, this.marks);
    }
    mark(e) {
      return e == this.marks ? this : new i(this.type, this.attrs, this.content, e);
    }
    ...
    slice(e, t = this.content.size, n = !1) {
      ...
      let r = this.resolve(e),
        s = this.resolve(t),
        l = n ? 0 : r.sharedDepth(t),
        o = r.start(l),
        a = r.node(l).content.cut(r.pos - o, s.pos - o);
      return new g(a, r.depth - l, s.depth - l);
    }
    replace(e, t, n) {
    ...
    canReplace(e, t, n = p.empty, r = 0, s = n.childCount) {
      let l = this.contentMatchAt(e).matchFragment(n, r, s),
        o = l && l.matchFragment(this.content, t);
      if (!o || !o.validEnd) return !1;
      for (let h = r; h < s; h++) if (!this.type.allowsMarks(n.child(h).marks)) return !1;
      return !0;
    }
...
var ye = class i extends b {
  ...
  toString() {
    return this.type.spec.toDebugString
      ...
      : et(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
var z = class i {
  ...
  fillBefore(e, t = !1, n = 0) {
    let r = [this];
    function s(l, o) {
      let h = l.matchFragment(e, n);
      if (h && (!t || h.validEnd)) return p.from(o.map((a) => a.createAndFill()));
      for (let a = 0; a < l.next.length; a++) {
        let { type: c, next: f } = l.next[a];
        if (!(c.isText || c.hasRequiredAttrs()) && r.indexOf(f) == -1) {
          r.push(f);
          let u = s(f, o.concat(c));
          if (u) return u;
        }
      }
      return null;
  ...
  computeWrapping(e) {
    ...
    for (; n.length;) {
      ...
      if (s.matchType(e)) {
        let l = [];
        for (let o = r; o.type; o = o.via) l.push(o.type);
        return l.reverse();
      }
      for (let l = 0; l < s.next.length; l++) {
        let { type: o, next: h } = s.next[l];
        !o.isLeaf &&
          !o.hasRequiredAttrs() &&
          !(o.name in t) &&
          (!r.type || h.validEnd) &&
          (n.push({ match: o.contentMatch, type: o, via: r }), (t[o.name] = !0));
      }
    }
    return null;
  }
    ...
    return (
      ...
      e.map((n, r) => {
        ...
        for (let l = 0; l < n.next.length; l++)
          s += (l ? ", " : "") + n.next[l].type.name + "->" + e.indexOf(n.next[l].next);
        return s;
      }).join(`
`)
    );
...
function Gt(i) {
  ...
  function s(l, o) {
    if (l.type == "choice") return l.exprs.reduce((h, a) => h.concat(s(a, o)), []);
    if (l.type == "seq")
      for (let h = 0; ; h++) {
        let a = s(l.exprs[h], o);
        if (h == l.exprs.length - 1) return a;
        r(a, (o = t()));
      }
    else if (l.type == "star") {
      let h = t();
      return (n(o, h), r(s(l.expr, h), h), [n(h)]);
    } else if (l.type == "plus") {
      let h = t();
      return (r(s(l.expr, o), h), r(s(l.expr, h), h), [n(h)]);
    } else {
      if (l.type == "opt") return [n(o)].concat(s(l.expr, o));
      if (l.type == "range") {
        let h = o;
        ...
        if (l.max == -1) r(s(l.expr, h), h);
        else
          for (let a = l.min; a < l.max; a++) {
            let c = t();
            (n(h, c), r(s(l.expr, h), c), (h = c));
          }
        return [n(h)];
      } else {
        if (l.type == "name") return [n(o, void 0, l.value)];
...
function Ht(i) {
  ...
  function t(n) {
    let r = [];
    n.forEach((l) => {
      i[l].forEach(({ term: o, to: h }) => {
        if (!o) return;
        let a;
        for (let c = 0; c < r.length; c++) r[c][0] == o && (a = r[c][1]);
        Be(i, h).forEach((c) => {
          (a || r.push([o, (a = [])]), a.indexOf(c) == -1 && a.push(c));
        });
      });
    });
    let s = (e[n.join(",")] = new z(n.indexOf(i.length - 1) > -1));
    for (let l = 0; l < r.length; l++) {
      let o = r[l][1].sort(nt);
      s.next.push({ type: r[l][0], next: e[o.join(",")] || t(o) });
    }
    return s;
  }
}
function Kt(i, e) {
  for (let t = 0, n = [i]; t < n.length; t++) {
    ...
    for (let o = 0; o < r.next.length; o++) {
      let { type: h, next: a } = r.next[o];
      (l.push(h.name),
        s && !(h.isText || h.hasRequiredAttrs()) && (s = !1),
...
function lt(i, e) {
  let t = Object.create(null);
  if (e) for (let n in e) t[n] = new xe(i, n, e[n]);
  return t;
}
var re = class i {
  constructor(e, t, n) {
    ((this.name = e),
      ...
      (this.attrs = lt(e, n.attrs)),
      (this.defaultAttrs = rt(this.attrs)),
  ...
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : it(this.attrs, e);
  }
  create(e = null, t, n) {
    if (this.isText) throw new Error("NodeType.create can't construct text nodes");
    return new b(this, this.computeAttrs(e), p.from(t), w.setFrom(n));
  }
  createChecked(e = null, t, n) {
    return (
      (t = p.from(t)),
      this.checkContent(t),
      new b(this, this.computeAttrs(e), t, w.setFrom(n))
    );
  }
  createAndFill(e = null, t, n) {
    ...
    let r = this.contentMatch.matchFragment(t),
      s = r && r.fillBefore(p.empty, !0);
    return s ? new b(this, e, t.append(s), w.setFrom(n)) : null;
  }
  validContent(e) {
...
function Qt(i, e, t) {
  ...
  return (r) => {
    ...
    if (n.indexOf(s) < 0)
      throw new RangeError(`Expected value of type ${n} for attribute ${e} on type ${i}, got ${s}`);
  };
}
var xe = class {
    constructor(e, t, n) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(n, "default")),
        ...
        (this.validate = typeof n.validate == "string" ? Qt(e, t, n.validate) : n.validate));
    }
    get isRequired() {
  ...
  V = class i {
    constructor(e, t, n, r) {
      ((this.name = e),
        ...
        (this.schema = n),
        (this.spec = r),
        (this.attrs = lt(e, r.attrs)),
        (this.excluded = null));
      let s = rt(this.attrs);
      this.instance = s ? new w(this, s) : null;
    }
    create(e = null) {
      return !e && this.instance ? this.instance : new w(this, it(this.attrs, e));
    }
    static compile(e, t) {
      let n = Object.create(null),
        r = 0;
      return (e.forEach((s, l) => (n[s] = new i(s, r++, t, l))), n);
    }
    removeFromSet(e) {
  ...
  We = class {
    constructor(e) {
      ...
      ((t.nodes = fe.from(e.nodes)),
        (t.marks = fe.from(e.marks || {})),
        (this.nodes = re.compile(this.spec.nodes, this)),
        (this.marks = V.compile(this.spec.marks, this)));
      let n = Object.create(null);
      for (let r in this.nodes) {
        ...
        let s = this.nodes[r],
          ...
          o = s.spec.marks;
        if (
          ((s.contentMatch = n[l] || (n[l] = z.parse(l, this.nodes))),
        ...
        s.markSet =
          o == "_" ? null : o ? Pe(this, o.split(" ")) : o == "" || !s.inlineContent ? [] : null;
      }
      for (let r in this.marks) {
        let s = this.marks[r],
          l = s.spec.excludes;
        s.excluded = l == null ? [s] : l == "" ? [] : Pe(this, l.split(" "));
      }
      ((this.nodeFromJSON = (r) => b.fromJSON(this, r)),
        (this.markFromJSON = (r) => w.fromJSON(this, r)),
    ...
    text(e, t) {
      ...
      return new ye(n, n.defaultAttrs, e, w.setFrom(t));
    }
    mark(e, t) {
...
function Pe(i, e) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    if (s) t.push(s);
      ...
      for (let o in i.marks) {
        let h = i.marks[o];
        (r == "_" || (h.spec.group && h.spec.group.split(" ").indexOf(r) > -1)) && t.push((l = h));
      }
    if (!l) throw new SyntaxError("Unknown mark type: '" + e[n] + "'");
  }
  return t;
}
function Xt(i) {
...
var Le = class i {
    ...
    parse(e, t = {}) {
      let n = new ie(this, t, !1);
      return (n.addAll(e, w.none, t.from, t.to), n.finish());
    }
    parseSlice(e, t = {}) {
      let n = new ie(this, t, !0);
      return (n.addAll(e, w.none, t.from, t.to), g.maxOpen(n.finish()));
    }
    matchTag(e, t, n) {
    ...
    static schemaRules(e) {
      ...
      function n(r) {
        ...
        for (; l < t.length; l++) {
          let o = t[l];
          if ((o.priority == null ? 50 : o.priority) < s) break;
        }
        t.splice(l, 0, r);
      }
      for (let r in e.marks) {
        ...
        s &&
          s.forEach((l) => {
            (n((l = Ue(l))), l.mark || l.ignore || l.clearMark || (l.mark = r));
          });
      }
      for (let r in e.nodes) {
        ...
        s &&
          s.forEach((l) => {
            (n((l = Ue(l))), l.node || l.ignore || l.mark || (l.node = r));
          });
      }
      return t;
    }
    static fromSchema(e) {
      return e.cached.domParser || (e.cached.domParser = new i(e, i.schemaRules(e)));
    }
  },
  ot = {
    address: !0,
  ...
  Zt = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  ht = { ol: !0, ul: !0 },
  G = 1,
  ke = 2,
  U = 4;
...
var W = class {
    constructor(e, t, n, r, s, l) {
      ((this.type = e),
        ...
        (this.match = s || (l & U ? null : e.contentMatch)));
    }
    findWrapping(e) {
      if (!this.match) {
        if (!this.type) return [];
    ...
    finish(e) {
      if (!(this.options & G)) {
        ...
        if (n && n.isText && (r = /[ \t\r\n\u000c]+$/.exec(n.text))) {
          let s = n;
          n.text.length == r[0].length
            ? this.content.pop()
            : (this.content[this.content.length - 1] = s.withText(
                s.text.slice(0, s.text.length - r[0].length)
              ));
        }
      }
      let t = p.from(this.content);
      return (
        !e && this.match && (t = t.append(this.match.fillBefore(p.empty, !0))),
    ...
    inlineContext(e) {
      return this.type
        ...
        : this.content.length
          ...
          : e.parentNode && !ot.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
    }
  },
  ie = class {
    constructor(e, t, n) {
      ...
      let r = t.topNode,
        s,
        l = qe(null, t.preserveWhitespace, 0) | (n ? U : 0);
      (r
        ? (s = new W(r.type, r.attrs, w.none, !0, t.topMatch || r.type.contentMatch, l))
        : n
          ? (s = new W(null, null, w.none, !0, null, l))
          : (s = new W(e.schema.topNodeType, null, w.none, !0, null, l)),
        (this.nodes = [s]),
    ...
    addTextNode(e, t) {
      let n = e.nodeValue,
        r = this.top,
        s = r.options & ke ? "full" : this.localPreserveWS || (r.options & G) > 0;
...
`
          ...
          let l = r.content[r.content.length - 1],
            o = e.previousSibling;
          (!l || (o && o.nodeName == "BR") || (l.isText && /[ \t\r\n\u000c]$/.test(l.text))) &&
            (n = n.slice(1));
        }
    ...
    addElement(e, t, n) {
      ...
      let l = e.nodeName.toLowerCase(),
        o;
      ht.hasOwnProperty(l) && this.parser.normalizeLists && jt(e);
      let h =
        (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
        (o = this.parser.matchTag(e, this, n));
      e: if (h ? h.ignore : Zt.hasOwnProperty(l)) (this.findInside(e), this.ignoreFallback(e, t));
      else if (!h || h.skip || h.closeParent) {
        h && h.closeParent
          ? (this.open = Math.max(0, this.open - 1))
          : h && h.skip.nodeType && (e = h.skip);
        let a,
          c = this.needsBlock;
        if (ot.hasOwnProperty(l))
        ...
        let f = h && h.skip ? t : this.readStyles(e, t);
        (f && this.addAll(e, f), a && this.sync(s), (this.needsBlock = c));
      } else {
        let a = this.readStyles(e, t);
        a && this.addElementByRule(e, h, a, h.consuming === !1 ? o : void 0);
      }
...
`),
        ...
        for (let r = 0; r < this.parser.matchedStyles.length; r++) {
          ...
          if (l)
            for (let o = void 0; ;) {
              ...
              if (
                (h.clearMark
                  ? (t = t.filter((a) => !h.clearMark(a)))
                  : (t = t.concat(this.parser.schema.marks[h.mark].create(h.attrs))),
                h.consuming === !1)
              )
                o = h;
              else break;
    ...
    addElementByRule(e, t, n, r) {
      ...
      if (t.node)
        if (((l = this.parser.schema.nodes[t.node]), l.isLeaf))
          this.insertNode(l.create(t.attrs), n, e.nodeName == "BR") || this.leafFallback(e, n);
        else {
          let h = this.enter(l, t.attrs || null, n, t.preserveWhitespace);
          h && ((s = !0), (n = h));
        }
      else {
        let h = this.parser.schema.marks[t.mark];
        n = n.concat(h.create(t.attrs));
      }
      let o = this.top;
      if (l && l.isLeaf) this.findInside(e);
        ...
        (this.findInside(e),
          t.getContent(e, this.parser.schema).forEach((h) => this.insertNode(h, n, !1)));
      else {
        let h = e;
        (typeof t.contentElement == "string"
          ? (h = e.querySelector(t.contentElement))
          : typeof t.contentElement == "function"
            ? (h = t.contentElement(e))
            : t.contentElement && (h = t.contentElement),
          this.findAround(e, h, !0),
          this.addAll(h, n),
          this.findAround(e, h, !1));
      }
    ...
    addAll(e, t, n, r) {
      let s = n || 0;
      for (
        let l = n ? e.childNodes[n] : e.firstChild, o = r == null ? null : e.childNodes[r];
        l != o;
        l = l.nextSibling, ++s
      )
        (this.findAtPoint(e, s), this.addDOM(l, t));
    ...
    findPlace(e, t, n) {
      ...
      for (let l = this.open, o = 0; l >= 0; l--) {
        let h = this.nodes[l],
          a = h.findWrapping(e);
        if (a && (!r || r.length > a.length + o) && ((r = a), (s = h), !a.length)) break;
        if (h.solid) {
          if (n) break;
          o += 2;
        }
      ...
      if (!r) return null;
      this.sync(s);
      for (let l = 0; l < r.length; l++) t = this.enterInner(r[l], null, t, !1);
      return t;
    }
    insertNode(e, t, n) {
      ...
      if (r) {
        ...
        for (let o of r.concat(e.marks))
          (s.type ? s.type.allowsMarkType(o.type) : Ve(o.type, e.type)) && (l = o.addToSet(l));
        return (s.content.push(e.mark(l)), !0);
      }
      return !1;
    }
    enter(e, t, n, r) {
      let s = this.findPlace(e.create(t), n, !1);
      return (s && (s = this.enterInner(e, t, n, !0, r)), s);
    }
    enterInner(e, t, n, r = !1, s) {
      this.closeExtra();
      let l = this.top;
      l.match = l.match && l.match.matchType(e);
      let o = qe(e, s, l.options);
      l.options & U && l.content.length == 0 && (o |= U);
      let h = w.none;
      return (
        (n = n.filter((a) =>
          (l.type ? l.type.allowsMarkType(a.type) : Ve(a.type, e)) ? ((h = a.addToSet(h)), !1) : !0
        )),
        this.nodes.push(new W(e, t, h, r, null, o)),
        this.open++,
        n
      );
    }
    ...
    sync(e) {
      for (let t = this.open; t >= 0; t--) {
        ...
        this.localPreserveWS && (this.nodes[t].options |= G);
      }
      return !1;
    }
    get currentPos() {
      ...
      let t = e.split("/"),
        ...
        l = (o, h) => {
          for (; o >= 0; o--) {
            let a = t[o];
            if (a == "") {
              if (o == t.length - 1 || o == 0) continue;
              for (; h >= s; h--) if (l(o - 1, h)) return !0;
              return !1;
            } else {
              let c =
                h > 0 || (h == 0 && r)
                  ...
                  : n && h >= s
                    ? n.node(h - s).type
                    : null;
              if (!c || (c.name != a && !c.isInGroup(a))) return !1;
              h--;
            }
          }
          return !0;
...
function $t(i, e) {
  return (i.matches || i.msMatchesSelector || i.webkitMatchesSelector || i.mozMatchesSelector).call(
    i,
    e
  );
}
    ...
    let s = [],
      l = (o) => {
        ...
        for (let h = 0; h < o.edgeCount; h++) {
          let { type: a, next: c } = o.edge(h);
          if (a == e || (s.indexOf(c) < 0 && l(c))) return !0;
        }
      };
...
var Ge = class i {
  ...
  serializeFragment(e, t = {}, n) {
    ...
    return (
      e.forEach((l) => {
        ...
        r.appendChild(this.serializeNodeInner(l, t));
      }),
      n
    );
  }
  serializeNodeInner(e, t) {
    let { dom: n, contentDOM: r } = _(pe(t), this.nodes[e.type.name](e), null, e.attrs);
    if (r) {
  ...
  serializeMark(e, t, n = {}) {
    ...
    return r && _(pe(n), r(e, t), null, e.attrs);
  }
  ...
  static fromSchema(e) {
    return (
      ...
      (e.cached.domSerializer = new i(this.nodesFromSchema(e), this.marksFromSchema(e)))
    );
  }
...
function _t(i) {
  let e = Ke.get(i);
  return (e === void 0 && Ke.set(i, (e = en(i))), e);
}
function en(i) {
  let e = null;
  function t(n) {
    if (n && typeof n == "object")
      if (Array.isArray(n))
        ...
        else for (let r = 0; r < n.length; r++) t(n[r]);
      else for (let r in n) t(n[r]);
  }
  return (t(i), e);
}
function _(i, e, t, n) {
  if (typeof e == "string") return { dom: i.createTextNode(e) };
  ...
  if (a && typeof a == "object" && a.nodeType == null && !Array.isArray(a)) {
    ...
    for (let f in a)
      if (a[f] != null) {
        let u = f.indexOf(" ");
        u > 0
          ? h.setAttributeNS(f.slice(0, u), f.slice(u + 1), a[f])
          : f == "style" && h.style
            ? (h.style.cssText = a[f])
            : h.setAttribute(f, a[f]);
      }
  }
  for (let f = c; f < e.length; f++) {
    ...
    if (u === 0) {
      ...
      let { dom: d, contentDOM: m } = _(i, u, t, n);
      if ((h.appendChild(d), m)) {
...
var pt = 1,
  ...
  Q = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (pt | se)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (dt | se)) > 0;
    }
    get deletedAcross() {
  ...
  C = class i {
    constructor(e, t = !1) {
      if (((this.ranges = e), (this.inverted = t), !e.length && i.empty)) return i.empty;
    }
    recover(e) {
      let t = 0,
        n = at(e);
    ...
    _map(e, t, n) {
      ...
      for (let o = 0; o < this.ranges.length; o += 3) {
        let h = this.ranges[o] - (this.inverted ? r : 0);
        if (h > e) break;
        let a = this.ranges[o + s],
          c = this.ranges[o + l],
          f = h + a;
        if (e <= f) {
          let u = a ? (e == h ? -1 : e == f ? 1 : t) : t,
            d = h + r + (u < 0 ? 0 : c);
          if (n) return d;
          let m = e == (t < 0 ? h : f) ? null : tn(o / 3, e - h),
            y = e == h ? dt : e == f ? pt : se;
          return ((t < 0 ? e != h : e != f) && (y |= mt), new Q(d, y, m));
        }
        r += c - a;
      }
      return n ? e + r : new Q(e + r, 0, null);
    }
    touches(e, t) {
      let n = 0,
        r = at(t),
        ...
        l = this.inverted ? 1 : 2;
      for (let o = 0; o < this.ranges.length; o += 3) {
        let h = this.ranges[o] - (this.inverted ? n : 0);
        if (h > e) break;
        let a = this.ranges[o + s],
          c = h + a;
        if (e <= c && o == r * 3) return !0;
        n += this.ranges[o + l] - a;
      }
      return !1;
    }
    forEach(e) {
      ...
      for (let r = 0, s = 0; r < this.ranges.length; r += 3) {
        let l = this.ranges[r],
          o = l - (this.inverted ? s : 0),
          h = l + (this.inverted ? 0 : s),
          a = this.ranges[r + t],
          c = this.ranges[r + n];
        (e(o, o + a, h, h + c), (s += c - a));
      }
...
var Ee = class i {
    ...
    copy() {
      return new i(this.maps.slice(), this.mirror && this.mirror.slice(), this.from, this.to);
    }
    appendMap(e, t) {
      ...
      for (let s = this.from; s < this.to; s++) {
        ...
        if (o.recover != null) {
          ...
          if (h != null && h > s && h < this.to) {
            ((s = h), (e = this.maps[h].recover(o.recover)));
            continue;
          }
        }
        ((r |= o.delInfo), (e = o.pos));
      }
      return n ? e : new Q(e, r, null);
    }
  },
  ...
  k = class {
    ...
    static jsonID(e, t) {
      if (e in Se) throw new RangeError("Duplicate use of step JSON ID " + e);
      return ((Se[e] = t), (t.prototype.jsonID = e), t);
    }
  },
  S = class i {
    constructor(e, t) {
    ...
    static fromReplace(e, t, n, r) {
      try {
        return i.ok(e.replace(t, n, r));
      } catch (s) {
        if (s instanceof A) return i.fail(s.message);
        throw s;
      }
    }
  };
function Ce(i, e, t) {
  ...
  for (let r = 0; r < i.childCount; r++) {
    let s = i.child(r);
    (s.content.size && (s = s.copy(Ce(s.content, e, s))),
      s.isInline && (s = e(s, t, r)),
      n.push(s));
  }
  return p.fromArray(n);
}
var X = class i extends k {
  constructor(e, t, n) {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      ...
      s = new g(
        Ce(
          t.content,
          (l, o) =>
            !l.isAtom || !o.type.allowsMarkType(this.mark.type)
              ? l
    ...
    return S.fromReplace(e, this.from, this.to, s);
  }
  invert() {
  ...
  map(e) {
    ...
    return (t.deleted && n.deleted) || t.pos >= n.pos ? null : new i(t.pos, n.pos, this.mark);
  }
  merge(e) {
    return e instanceof i && e.mark.eq(this.mark) && this.from <= e.to && this.to >= e.from
...
var F = class i extends k {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      n = new g(
        Ce(t.content, (r) => r.mark(this.mark.removeFromSet(r.marks)), e),
        t.openStart,
        t.openEnd
      );
...
k.jsonID("removeMark", F);
var Y = class i extends k {
  constructor(e, t) {
  ...
  apply(e) {
    ...
    return S.fromReplace(e, this.pos, this.pos + 1, new g(p.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
      ...
      if (n.length == t.marks.length) {
        for (let r = 0; r < t.marks.length; r++)
          if (!t.marks[r].isInSet(n)) return new i(this.pos, t.marks[r]);
...
k.jsonID("addNodeMark", Y);
var Z = class i extends k {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
  ...
  invert(e) {
    let t = e.nodeAt(this.pos);
    return !t || !this.mark.isInSet(t.marks) ? this : new Y(this.pos, this.mark);
  }
  map(e) {
    let t = e.mapResult(this.pos, 1);
    return t.deletedAfter ? null : new i(t.pos, this.mark);
...
k.jsonID("removeNodeMark", Z);
var E = class i extends k {
  constructor(e, t, n, r = !1) {
    (super(), (this.from = e), (this.to = t), (this.slice = n), (this.structure = r));
  }
  apply(e) {
    return this.structure && be(e, this.from, this.to)
      ? S.fail("Structure replace would overwrite content")
      : S.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  map(e) {
    ...
    return t.deletedAcross && n.deletedAcross
      ? null
      : new i(t.pos, Math.max(t.pos, n.pos), this.slice);
  }
  merge(e) {
  ...
  static fromJSON(e, t) {
    ...
    return new i(t.from, t.to, g.fromJSON(e, t.slice), !!t.structure);
  }
};
k.jsonID("replace", E);
var O = class i extends k {
  constructor(e, t, n, r, s, l, o = !1) {
    (super(),
      (this.from = e),
      (this.to = t),
      (this.gapFrom = n),
  ...
  apply(e) {
    if (this.structure && (be(e, this.from, this.gapFrom) || be(e, this.gapTo, this.to)))
  ...
  map(e) {
    ...
    return (t.deletedAcross && n.deletedAcross) || r < t.pos || s > n.pos
      ? null
      : new i(t.pos, n.pos, r, s, this.slice, this.insert, this.structure);
  }
  toJSON() {
    let e = {
  ...
  static fromJSON(e, t) {
    ...
    return new i(t.from, t.to, t.gapFrom, t.gapTo, g.fromJSON(e, t.slice), t.insert, !!t.structure);
  }
};
k.jsonID("replaceAround", O);
function be(i, e, t) {
  let n = i.resolve(e),
    r = t - e,
    s = n.depth;
...
function rn(i, e, t, n) {
  let r = [],
    ...
    l,
    o;
  (i.doc.nodesBetween(e, t, (h, a, c) => {
    if (!h.isInline) return;
    let f = h.marks;
    if (!n.isInSet(f) && c.type.allowsMarkType(n.type)) {
      let u = Math.max(a, e),
        d = Math.min(a + h.nodeSize, t),
        m = n.addToSet(f);
      for (let y = 0; y < f.length; y++)
        f[y].isInSet(m) ||
          (l && l.to == u && l.mark.eq(f[y]) ? (l.to = d) : r.push((l = new F(u, d, f[y]))));
      o && o.to == u ? (o.to = d) : s.push((o = new X(u, d, n)));
    }
  }),
    r.forEach((h) => i.step(h)),
    s.forEach((h) => i.step(h)));
}
function sn(i, e, t, n) {
  let r = [],
    s = 0;
  (i.doc.nodesBetween(e, t, (l, o) => {
    ...
    if (h && h.length) {
      ...
      for (let c = 0; c < h.length; c++) {
        ...
        for (let d = 0; d < r.length; d++) {
          let m = r[d];
          m.step == s - 1 && f.eq(r[d].style) && (u = m);
        }
        u ? ((u.to = a), (u.step = s)) : r.push({ style: f, from: Math.max(o, e), to: a, step: s });
      }
    }
  }),
    r.forEach((l) => i.step(new F(l.from, l.to, l.style))));
}
function Te(i, e, t, n = t.contentMatch, r = !0) {
  ...
  for (let h = 0; h < s.childCount; h++) {
    let a = s.child(h),
      c = o + a.nodeSize,
      f = n.matchType(a.type);
    if (!f) l.push(new E(o, c, g.empty));
    else {
      n = f;
      for (let u = 0; u < a.marks.length; u++)
        t.allowsMarkType(a.marks[u].type) || i.step(new F(o, c, a.marks[u]));
      if (r && a.isText && t.whitespace != "pre") {
        let u,
          d = /\r?\n|\r/g,
          m;
        for (; (u = d.exec(a.text));)
  ...
  if (!n.validEnd) {
    let h = n.fillBefore(p.empty, !0);
    i.replace(o, o, new g(h, 0, 0));
  }
  for (let h = l.length - 1; h >= 0; h--) i.step(l[h]);
}
function ln(i, e, t) {
...
function Rn(i) {
  ...
  for (let n = i.depth; ; --n) {
    let r = i.$from.node(n),
      s = i.$from.index(n),
      l = i.$to.indexAfter(n);
    if (n < i.depth && r.canReplace(s, l, t)) return n;
    if (n == 0 || r.type.spec.isolating || !ln(r, s, l)) break;
  }
  return null;
}
function on(i, e, t) {
  let { $from: n, $to: r, depth: s } = e,
    l = n.before(s + 1),
    o = r.after(s + 1),
    h = l,
    a = o,
    c = p.empty,
    f = 0;
  for (let m = s, y = !1; m > t; m--)
    y || n.index(m) > 0 ? ((y = !0), (c = p.from(n.node(m).copy(c))), f++) : h--;
  let u = p.empty,
    d = 0;
  for (let m = s, y = !1; m > t; m--)
    y || r.after(m + 1) < r.end(m) ? ((y = !0), (u = p.from(r.node(m).copy(u))), d++) : a++;
  i.step(new O(h, a, l, o, new g(c.append(u), f, d), c.size - f, !0));
}
function In(i, e, t = null, n = i) {
  let r = hn(i, e),
    s = r && an(n, e);
  return s ? r.map(ct).concat({ type: e, attrs: t }).concat(s.map(ct)) : null;
}
function ct(i) {
  return { type: i, attrs: null };
}
function hn(i, e) {
  let { parent: t, startIndex: n, endIndex: r } = i,
    s = t.contentMatchAt(n).findWrapping(e);
  if (!s) return null;
  let l = s.length ? s[0] : e;
  return t.canReplaceWith(n, r, l) ? s : null;
}
function an(i, e) {
  let { parent: t, startIndex: n, endIndex: r } = i,
    s = t.child(n),
  ...
  for (let a = n; h && a < r; a++) h = h.matchType(t.child(a).type);
...
function cn(i, e, t) {
  ...
  for (let l = t.length - 1; l >= 0; l--) {
    if (n.size) {
      let o = t[l].type.contentMatch.matchFragment(n);
      if (!o || !o.validEnd)
        throw new RangeError(
          "Wrapper type given to Transform.wrap does not form valid content of its parent wrapper"
        );
    }
    n = p.from(t[l].type.create(t[l].attrs, n));
  }
  let r = e.start,
    s = e.end;
  i.step(new O(r, s, r, s, new g(n, 0, 0), t.length, !0));
}
function fn(i, e, t, n, r) {
  ...
  i.doc.nodesBetween(e, t, (l, o) => {
    let h = typeof r == "function" ? r(l) : r;
    if (l.isTextblock && !l.hasMarkup(n, h) && un(i.doc, i.mapping.slice(s).map(o), n)) {
      let a = null;
      if (n.schema.linebreakReplacement) {
        let d = n.whitespace == "pre",
          m = !!n.contentMatch.matchType(n.schema.linebreakReplacement);
        d && !m ? (a = !1) : !d && m && (a = !0);
      }
      (a === !1 && yt(i, l, o, s), Te(i, i.mapping.slice(s).map(o, 1), n, void 0, a === null));
      let c = i.mapping.slice(s),
        f = c.map(o, 1),
        u = c.map(o + l.nodeSize, 1);
      return (
        i.step(new O(f, u, f + 1, u - 1, new g(p.from(n.create(h, null, l.marks)), 0, 0), 1, !0)),
        a === !0 && gt(i, l, o, s),
        !1
      );
    }
...
function yt(i, e, t, n) {
  e.forEach((r, s) => {
    if (r.type == r.type.schema.linebreakReplacement) {
      let l = i.mapping.slice(n).map(t + 1 + s);
      i.replaceWith(
        l,
        l + 1,
        e.type.schema.text(`
...
function pn(i, e, t, n, r) {
  ...
  t || (t = s.type);
  let l = t.create(n, null, r || s.marks);
  if (s.isLeaf) return i.replaceWith(e, e + s.nodeSize, l);
  if (!t.validContent(s.content)) throw new RangeError("Invalid content for node type " + t.name);
  i.step(new O(e, e + s.nodeSize, e + 1, e + s.nodeSize - 1, new g(p.from(l), 0, 0), 1, !0));
}
function An(i, e, t = 1, n) {
  let r = i.resolve(e),
    s = r.depth - t,
    l = (n && n[n.length - 1]) || r.parent;
  if (
    s < 0 ||
    ...
    return !1;
  for (let a = r.depth - 1, c = t - 2; a > s; a--, c--) {
    let f = r.node(a),
      u = r.index(a);
    if (f.type.spec.isolating) return !1;
    let d = f.content.cutByIndex(u, f.childCount),
      m = n && n[c + 1];
    m && (d = d.replaceChild(0, m.type.create(m.attrs)));
    let y = (n && n[c]) || f;
    if (!f.canReplace(u + 1, f.childCount) || !y.type.validContent(d)) return !1;
  }
  let o = r.indexAfter(s),
    h = n && n[0];
  return r.node(s).canReplaceWith(o, o, h ? h.type : r.node(s + 1).type);
}
function dn(i, e, t = 1, n) {
  let r = i.doc.resolve(e),
    s = p.empty,
    l = p.empty;
  for (let o = r.depth, h = r.depth - t, a = t - 1; o > h; o--, a--) {
    s = p.from(r.node(o).copy(s));
    let c = n && n[a];
    l = p.from(c ? c.type.create(c.attrs, l) : r.node(o).copy(l));
  }
  i.step(new E(e, e, new g(s.append(l), t, t), !0));
}
function zn(i, e) {
  let t = i.resolve(e),
    n = t.index();
  return wt(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(n, n + 1);
}
function mn(i, e) {
  e.content.size || i.type.compatibleContent(e.type);
  let t = i.contentMatchAt(i.childCount),
    { linebreakReplacement: n } = i.type.schema;
  for (let r = 0; r < e.childCount; r++) {
    let s = e.child(r),
      l = s.type == n ? i.type.schema.nodes.text : s.type;
    if (((t = t.matchType(l)), !t || !i.type.allowsMarks(s.marks))) return !1;
  }
  return t.validEnd;
}
function wt(i, e) {
  return !!(i && e && !i.isLeaf && mn(i, e));
}
function Fn(i, e, t = -1) {
  let n = i.resolve(e);
  for (let r = n.depth; ; r--) {
    ...
    if (
      (r == n.depth
        ? ((s = n.nodeBefore), (l = n.nodeAfter))
        : t > 0
          ? ((s = n.node(r + 1)), o++, (l = n.node(r).maybeChild(o)))
          : ((s = n.node(r).maybeChild(o - 1)), (l = n.node(r + 1))),
      s && !s.isTextblock && wt(s, l) && n.node(r).canReplace(o, o + 1))
    )
      return e;
    if (r == 0) break;
    e = t < 0 ? n.before(r) : n.after(r);
  }
}
function gn(i, e, t) {
  let n = null,
    { linebreakReplacement: r } = i.doc.type.schema,
    s = i.doc.resolve(e - t),
    l = s.node().type;
  if (r && l.inlineContent) {
    let c = l.whitespace == "pre",
      f = !!l.contentMatch.matchType(r);
    c && !f ? (n = !1) : !c && f && (n = !0);
  }
  let o = i.steps.length;
  if (n === !1) {
    let c = i.doc.resolve(e + t);
    yt(i, c.node(), c.before(), o);
  }
  l.inlineContent && Te(i, e + t - 1, l, s.node().contentMatchAt(s.index()), n == null);
  let h = i.mapping.slice(o),
    a = h.map(e - t);
  if ((i.step(new E(a, h.map(e + t, -1), g.empty, !0)), n === !0)) {
    let c = i.doc.resolve(a);
    gt(i, c.node(), c.before(), i.steps.length);
  }
  return i;
}
function yn(i, e, t) {
...
function Jn(i, e, t) {
  ...
  for (let s = 1; s <= (t.openStart == 0 && t.size ? 2 : 1); s++)
    for (let l = n.depth; l >= 0; l--) {
      let o = l == n.depth ? 0 : n.pos <= (n.start(l + 1) + n.end(l + 1)) / 2 ? -1 : 1,
        h = n.index(l) + (o > 0 ? 1 : 0),
        a = n.node(l),
        c = !1;
      if (s == 1) c = a.canReplace(h, h, r);
      else {
        let f = a.contentMatchAt(h).findWrapping(r.firstChild.type);
        c = f && a.canReplaceWith(h, h, f[0]);
      }
      if (c) return o == 0 ? n.pos : o < 0 ? n.before(l + 1) : n.after(l + 1);
    }
  return null;
}
function wn(i, e, t = e, n = g.empty) {
  if (e == t && !n.size) return null;
  let r = i.resolve(e),
    s = i.resolve(t);
  return xt(r, s, n) ? new E(e, t, n) : new Oe(r, s, n).fit();
}
function xt(i, e, t) {
  return (
    !t.openStart &&
...
var Oe = class {
  constructor(e, t, n) {
    ...
    for (let r = 0; r <= e.depth; r++) {
      let s = e.node(r);
      this.frontier.push({ type: s.type, match: s.contentMatchAt(e.indexAfter(r)) });
    }
    for (let r = e.depth; r > 0; r--) this.placed = p.from(e.node(r).copy(this.placed));
  }
  get depth() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let r,
          s = null;
        n
          ? ((s = ve(this.unplaced.content, n - 1).firstChild), (r = s.content))
          : (r = this.unplaced.content);
        let l = r.firstChild;
        for (let o = this.depth; o >= 0; o--) {
          let { type: h, match: a } = this.frontier[o],
            c,
            f = null;
          if (
            t == 1 &&
            (l
              ? a.matchType(l.type) || (f = a.fillBefore(p.from(l), !1))
              : s && h.compatibleContent(s.type))
          )
            return { sliceDepth: n, frontierDepth: o, parent: s, inject: f };
          if (t == 2 && l && (c = a.findWrapping(l.type)))
            return { sliceDepth: n, frontierDepth: o, parent: s, wrap: c };
  ...
  openMore() {
    ...
    return !r.childCount || r.firstChild.isLeaf
      ? !1
      : ((this.unplaced = new g(e, t + 1, Math.max(n, r.size + t >= e.size - n ? t + 1 : 0))), !0);
  }
  dropNode() {
    let { content: e, openStart: t, openEnd: n } = this.unplaced,
      r = ve(e, t);
    if (r.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new g(H(e, t - 1, 1), t - 1, s ? t - 1 : n);
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: r, wrap: s }) {
    ...
    if (r) {
      for (let y = 0; y < r.childCount; y++) c.push(r.child(y));
      f = f.matchFragment(r);
    }
    ...
    for (; a < o.childCount;) {
      ...
      if (!M) break;
      (a++,
        (a > 1 || h == 0 || y.content.size) &&
          ((f = M),
          c.push(kt(y.mark(u.allowedMarks(y.marks)), a == 1 ? h : 0, a == o.childCount ? d : -1))));
    }
    let m = a == o.childCount;
    (m || (d = -1),
      (this.placed = K(this.placed, t, p.from(c))),
    ...
    for (let y = 0, M = o; y < d; y++) {
      let N = M.lastChild;
      (this.frontier.push({ type: N.type, match: N.contentMatchAt(N.childCount) }),
        (M = N.content));
    }
    this.unplaced = m
      ? e == 0
        ? g.empty
        : new g(H(l.content, e - 1, 1), e - 1, d < 0 ? l.openEnd : e - 1)
      : new g(H(l.content, e, a), l.openStart, l.openEnd);
  }
  mustMoveInline() {
    ...
    if (
      !e.type.isTextblock ||
      !Me(this.$to, this.$to.depth, e.type, e.match, !1) ||
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      ...
      if (l) {
        for (let o = t - 1; o >= 0; o--) {
          let { match: h, type: a } = this.frontier[o],
            c = Me(e, o, a, h, !0);
          if (!c || c.childCount) continue e;
        }
        return { depth: t, fit: l, move: s ? e.doc.resolve(e.after(t + 1)) : e };
      }
    }
  }
  close(e) {
  ...
  openFrontierNode(e, t = null, n) {
    ...
    ((r.match = r.match.matchType(e)),
      (this.placed = K(this.placed, this.depth, p.from(e.create(t, n)))),
      this.frontier.push({ type: e, match: e.contentMatch }));
  }
  closeFrontierNode() {
    let t = this.frontier.pop().match.fillBefore(p.empty, !0);
    t.childCount && (this.placed = K(this.placed, this.frontier.length, t));
  }
};
function H(i, e, t) {
  return e == 0
    ? i.cutByIndex(t, i.childCount)
    : i.replaceChild(0, i.firstChild.copy(H(i.firstChild.content, e - 1, t)));
}
function K(i, e, t) {
  return e == 0
    ? i.append(t)
    : i.replaceChild(i.childCount - 1, i.lastChild.copy(K(i.lastChild.content, e - 1, t)));
}
function ve(i, e) {
...
function kt(i, e, t) {
  ...
  let n = i.content;
  return (
    e > 1 && (n = n.replaceChild(0, kt(n.firstChild, e - 1, n.childCount == 1 ? t - 1 : 0))),
    e > 0 &&
      ((n = i.type.contentMatch.fillBefore(n).append(n)),
      t <= 0 && (n = n.append(i.type.contentMatch.matchFragment(n).fillBefore(p.empty, !0)))),
    i.copy(n)
  );
}
function Me(i, e, t, n, r) {
  let s = i.node(e),
    l = r ? i.indexAfter(e) : i.index(e);
  if (l == s.childCount && !t.compatibleContent(s.type)) return null;
  let o = n.fillBefore(s.content, !0, l);
  return o && !xn(t, s.content, l) ? o : null;
}
function xn(i, e, t) {
  for (let n = t; n < e.childCount; n++) if (!i.allowsMarks(e.child(n).marks)) return !0;
  return !1;
}
function kn(i) {
...
function Sn(i, e, t, n) {
  ...
  let r = i.doc.resolve(e),
    s = i.doc.resolve(t);
  if (xt(r, s, n)) return i.step(new E(e, t, n));
  let l = vt(r, i.doc.resolve(t));
  l[l.length - 1] == 0 && l.pop();
  let o = -(r.depth + 1);
  l.unshift(o);
  for (let u = r.depth, d = r.pos - 1; u > 0; u--, d--) {
    let m = r.node(u).type.spec;
    if (m.defining || m.definingAsContext || m.isolating) break;
    l.indexOf(u) > -1 ? (o = u) : r.before(u) == d && l.splice(1, 0, -u);
  }
  let h = l.indexOf(o),
    a = [],
    c = n.openStart;
  for (let u = n.content, d = 0; ; d++) {
    let m = u.firstChild;
    if ((a.push(m), d == n.openStart)) break;
    u = m.content;
  }
  for (let u = c - 1; u >= 0; u--) {
    let d = a[u],
      m = kn(d.type);
    if (m && !d.sameMarkup(r.node(Math.abs(o) - 1))) c = u;
    else if (m || !d.type.isTextblock) break;
  }
  for (let u = n.openStart; u >= 0; u--) {
    let d = (u + c + 1) % (n.openStart + 1),
      m = a[d];
    if (m)
      for (let y = 0; y < l.length; y++) {
        let M = l[(y + h) % l.length],
          N = !0;
        M < 0 && ((N = !1), (M = -M));
        let Ft = r.node(M - 1),
          Fe = r.index(M - 1);
        if (Ft.canReplaceWith(Fe, Fe, m.type, m.marks))
          return i.replace(
            r.before(M),
            N ? s.after(M) : t,
            new g(St(n.content, 0, n.openStart, d), d, n.openEnd)
          );
      }
  }
  let f = i.steps.length;
  for (let u = l.length - 1; u >= 0 && (i.replace(e, t, n), !(i.steps.length > f)); u--) {
    let d = l[u];
    d < 0 || ((e = r.before(d)), (t = s.after(d)));
  }
}
function St(i, e, t, n, r) {
  if (e < t) {
    let s = i.firstChild;
    i = i.replaceChild(0, s.copy(St(s.content, e + 1, t, n, s)));
  }
  if (e > n) {
    let s = r.contentMatchAt(0),
      l = s.fillBefore(i).append(i);
    i = l.append(s.matchFragment(l).fillBefore(p.empty, !0));
  }
  return i;
}
function vn(i, e, t, n) {
  if (!n.isInline && e == t && i.doc.resolve(e).parent.content.size) {
    let r = yn(i.doc, e, n.type);
    r != null && (e = t = r);
  }
  i.replaceRange(e, t, new g(p.from(n), 0, 0));
}
function Mn(i, e, t) {
  ...
  for (let l = 0; l < s.length; l++) {
    let o = s[l],
      h = l == s.length - 1;
    if ((h && o == 0) || n.node(o).type.contentMatch.validEnd)
      return i.delete(n.start(o), r.end(o));
    if (o > 0 && (h || n.node(o - 1).canReplace(n.index(o - 1), r.indexAfter(o - 1))))
      return i.delete(n.before(o), r.after(o));
  }
  for (let l = 1; l <= n.depth && l <= r.depth; l++)
    if (
      e - n.start(l) == n.depth - l &&
      t > n.end(l) &&
      r.end(l) - t != r.depth - l &&
      n.start(l - 1) == r.start(l - 1) &&
      n.node(l - 1).canReplace(n.index(l - 1), r.index(l - 1))
    )
      return i.delete(n.before(l), t);
  i.delete(e, t);
}
function vt(i, e) {
  let t = [],
...
var le = class i extends k {
  ...
  apply(e) {
    ...
    return S.fromReplace(e, this.pos, this.pos + 1, new g(p.from(r), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return C.empty;
  }
...
P.prototype.name = "TransformError";
var he = class {
  constructor(e) {
    ((this.doc = e), (this.steps = []), (this.docs = []), (this.mapping = new Ee()));
  }
  get before() {
  ...
  step(e) {
    ...
    if (t.failed) throw new P(t.failed);
    return this;
  }
  maybeStep(e) {
  ...
  replace(e, t = e, n = g.empty) {
    let r = wn(this.doc, e, t, n);
    return (r && this.step(r), this);
  }
  replaceWith(e, t, n) {
    return this.replace(e, t, new g(p.from(n), 0, 0));
  }
  delete(e, t) {
  ...
  lift(e, t) {
    return (on(this, e, t), this);
  }
  join(e, t = 1) {
    return (gn(this, e, t), this);
  }
  wrap(e, t) {
    return (cn(this, e, t), this);
  }
  setBlockType(e, t = e, n, r = null) {
    return (fn(this, e, t, n, r), this);
  }
  ...
  addNodeMark(e, t) {
    return (this.step(new Y(e, t)), this);
  }
  removeNodeMark(e, t) {
    if (!(t instanceof w)) {
...
var Ne = Object.create(null),
  x = class {
    constructor(e, t, n) {
      ((this.$anchor = e), (this.$head = t), (this.ranges = n || [new Ie(e.min(t), e.max(t))]));
    }
    get anchor() {
    ...
    replace(e, t = g.empty) {
      let n = t.content.lastChild,
        r = null;
      for (let o = 0; o < t.openEnd; o++) ((r = n), (n = n.lastChild));
      let s = e.steps.length,
        l = this.ranges;
      for (let o = 0; o < l.length; o++) {
        let { $from: h, $to: a } = l[o],
          c = e.mapping.slice(s);
        (e.replaceRange(c.map(h.pos), c.map(a.pos), o ? g.empty : t),
          o == 0 && bt(e, s, (n ? n.isInline : r && r.isTextblock) ? -1 : 1));
      }
    }
    replaceWith(e, t) {
      ...
      for (let s = 0; s < r.length; s++) {
        let { $from: l, $to: o } = r[s],
          ...
          a = h.map(l.pos),
          c = h.map(o.pos);
        s ? e.deleteRange(a, c) : (e.replaceRangeWith(a, c, t), bt(e, n, t.isInline ? -1 : 1));
      }
    }
    static findFrom(e, t, n = !1) {
      let r = e.parent.inlineContent ? new B(e) : L(e.node(0), e.parent, e.pos, e.index(), t, n);
      if (r) return r;
      for (let s = e.depth - 1; s >= 0; s--) {
        let l =
          t < 0
            ? L(e.node(0), e.node(s), e.before(s + 1), e.index(s), t, n)
            : L(e.node(0), e.node(s), e.after(s + 1), e.index(s) + 1, t, n);
        if (l) return l;
      }
      return null;
    }
    ...
    static atStart(e) {
      return L(e, e, 0, 0, 1) || new D(e);
    }
    static atEnd(e) {
      return L(e, e, e.content.size, e.childCount, -1) || new D(e);
    }
    static fromJSON(e, t) {
    ...
    static jsonID(e, t) {
      if (e in Ne) throw new RangeError("Duplicate use of selection JSON ID " + e);
...
var B = class i extends x {
  ...
  map(e, t) {
    ...
    if (!n.parent.inlineContent) return x.near(n);
    let r = e.resolve(t.map(this.anchor));
    return new i(r.parent.inlineContent ? r : n, n);
  }
  replace(e, t = g.empty) {
  ...
  getBookmark() {
    return new ce(this.anchor, this.head);
  }
  toJSON() {
  ...
  static between(e, t, n) {
    ...
    if (((!n || r) && (n = r >= 0 ? 1 : -1), !t.parent.inlineContent)) {
      let s = x.findFrom(t, n, !0) || x.findFrom(t, -n, !0);
      if (s) t = s.$head;
      else return x.near(t, n);
    }
    return (
      e.parent.inlineContent ||
        (r == 0
          ? (e = t)
          : ((e = (x.findFrom(e, -n, !0) || x.findFrom(e, n, !0)).$anchor),
            e.pos < t.pos != r < 0 && (e = t))),
      new i(e, t)
    );
  }
  ...
  T = class i extends x {
    ...
    map(e, t) {
      let { deleted: n, pos: r } = t.mapResult(this.anchor),
        s = e.resolve(r);
      return n ? x.near(s) : new i(s);
    }
    content() {
      return new g(p.from(this.node), 0, 0);
    }
    eq(e) {
...
var Ae = class i {
    ...
    map(e) {
      ...
      return t ? new ce(n, n) : new i(n);
    }
    resolve(e) {
      let t = e.resolve(this.anchor),
        n = t.nodeAfter;
      return n && T.isSelectable(n) ? new T(t) : x.near(t);
    }
  },
  D = class i extends x {
    constructor(e) {
...
function L(i, e, t, n, r, s = !1) {
  if (e.inlineContent) return B.create(i, t);
  for (let l = n - (r > 0 ? 0 : 1); r > 0 ? l < e.childCount : l >= 0; l += r) {
    let o = e.child(l);
    if (o.isAtom) {
      if (!s && T.isSelectable(o)) return T.create(i, t - (r < 0 ? o.nodeSize : 0));
    } else {
      let h = L(i, o, t + r, r < 0 ? o.childCount : 0, r, s);
      if (h) return h;
    }
    t += o.nodeSize * r;
  }
...
function bt(i, e, t) {
  ...
  if (n < e) return;
  let r = i.steps[n];
  if (!(r instanceof E || r instanceof O)) return;
  let s = i.mapping.maps[n],
    l;
  (s.forEach((o, h, a, c) => {
    l == null && (l = c);
  }),
    i.setSelection(x.near(i.doc.resolve(l), t)));
}
var Ot = 1,
  ae = 2,
  Ct = 4,
  ze = class extends he {
    ...
    setSelection(e) {
      ...
      return (
        (this.curSelection = e),
        (this.curSelectionFor = this.steps.length),
        (this.updated = (this.updated | Ot) & ~ae),
    ...
    setStoredMarks(e) {
      return ((this.storedMarks = e), (this.updated |= ae), this);
    }
    ensureMarks(e) {
      return (
        w.sameSet(this.storedMarks || this.selection.$from.marks(), e) || this.setStoredMarks(e),
        this
      );
    }
    addStoredMark(e) {
    ...
    addStep(e, t) {
      (super.addStep(e, t), (this.updated = this.updated & ~ae), (this.storedMarks = null));
    }
    setTime(e) {
    ...
    replaceSelectionWith(e, t = !0) {
      ...
      return (
        t &&
          (e = e.mark(
            this.storedMarks || (n.empty ? n.$from.marks() : n.$from.marksAcross(n.$to) || w.none)
          )),
    ...
    insertText(e, t, n) {
      ...
      if (t == null) return e ? this.replaceSelectionWith(r.text(e), !0) : this.deleteSelection();
      {
        ...
        if (!s) {
          ...
          s = n == t ? l.marks() : l.marksAcross(this.doc.resolve(n));
        }
        return (
          this.replaceRangeWith(t, n, r.text(e, s)),
          this.selection.empty || this.setSelection(x.near(this.selection.$to)),
          this
        );
      }
    }
...
var J = class {
    constructor(e, t, n) {
      ((this.name = e), (this.init = Tt(t.init, n)), (this.apply = Tt(t.apply, n)));
    }
  },
  bn = [
    new J("doc", {
    ...
    new J("selection", {
      init(i, e) {
        return i.selection || x.atStart(e.doc);
      },
      apply(i) {
        return i.selection;
      },
        ...
        t &&
          t.forEach((n) => {
            ...
            (this.plugins.push(n),
              ...
              n.spec.state && this.fields.push(new J(n.key, n.spec.state, n)));
          }));
    }
  },
  Nt = class i {
    ...
    applyTransaction(e) {
      ...
      for (;;) {
        ...
        for (let l = 0; l < this.config.plugins.length; l++) {
          let o = this.config.plugins[l];
          if (o.spec.appendTransaction) {
            let h = r ? r[l].n : 0,
              a = r ? r[l].state : this,
              c = h < t.length && o.spec.appendTransaction.call(o, h ? t.slice(h) : t, a, n);
            if (c && n.filterTransaction(c, l)) {
              if ((c.setMeta("appendedTransaction", e), !r)) {
                r = [];
                for (let f = 0; f < this.config.plugins.length; f++)
                  r.push(f < l ? { state: n, n: t.length } : { state: this, n: 0 });
              }
              (t.push(c), (n = n.applyInner(c)), (s = !0));
            }
            r && (r[l] = { state: n, n: t.length });
          }
        }
    ...
    static create(e) {
      let t = new j(e.doc ? e.doc.type.schema : e.schema, e.plugins),
        n = new i(t);
      for (let r = 0; r < t.fields.length; r++) n[t.fields[r].name] = t.fields[r].init(e, n);
      return n;
    }
    reconfigure(e) {
      let t = new j(this.schema, e.plugins),
        n = t.fields,
        r = new i(t);
      for (let s = 0; s < n.length; s++) {
        let l = n[s].name;
        r[l] = this.hasOwnProperty(l) ? this[l] : n[s].init(e, r);
      }
      return r;
    }
    toJSON(e) {
    ...
    static fromJSON(e, t, n) {
      ...
      let r = new j(e.schema, e.plugins),
        s = new i(r);
      return (
        r.fields.forEach((l) => {
          if (l.name == "doc") s.doc = b.fromJSON(e.schema, t.doc);
          else if (l.name == "selection") s.selection = x.fromJSON(s.doc, t.selection);
            ...
            if (n)
              for (let o in n) {
                ...
                if (
                  ...
                  s[l.name] = a.fromJSON.call(h, e, t[o], s);
                  return;
                }
              }
            s[l.name] = l.init(e, s);
...
function At(i, e, t) {
  for (let n in i) {
    let r = i[n];
    (r instanceof Function ? (r = r.bind(e)) : n == "handleDOMEvents" && (r = At(r, e, {})),
      (t[n] = r));
  }
  return t;
}
var Rt = class {
    constructor(e) {
      ((this.spec = e),
        (this.props = {}),
        e.props && At(e.props, this, this.props),
        (this.key = e.key ? e.key.key : zt("plugin")));
    }
    getState(e) {
      return e[this.key];
    }
...
function zt(i) {
  return i in Re ? i + "$" + ++Re[i] : ((Re[i] = 0), i + "$");
}
var It = class {
  constructor(e = "key") {
    this.key = zt(e);
...
//# sourceMappingURL=chunk-5XGI6M6M.mjs.map
