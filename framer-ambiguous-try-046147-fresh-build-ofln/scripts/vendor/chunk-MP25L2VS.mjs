import { d as q } from "chunk-2X47X23S.mjs";
import { i as X } from "chunk-Q3WX3LWW.mjs";
import { b as k, i as S } from "chunk-G5MFIWCZ.mjs";
import { c as W, e as Y } from "chunk-VNAJ22F5.mjs";
import { a as A } from "chunk-XD24P57D.mjs";
import { a as z } from "chunk-WC34TENX.mjs";
...
function Z(e, n, a) {
  ...
  if (n.editors > (a.maxEditors ?? 1 / 0)) return "editors";
  if (e !== "freeSite" && n.abTests > (a.maxAbTests ?? 1 / 0)) return "abTests";
  let s = a.maxBandwidthInGB ?? 1 / 0,
    { previousMonth: m, twoMonthsAgo: C, currentMonth: t } = n.bandwidthInGB,
    p = m > s && C > s,
    g = m > s && t > s;
  if ((p || g) && !(X === s)) return "bandwidth";
}
var fe = {
...
function Xe({ isEnterprise: e, count: n, maxLimit: a, selfServeMax: s }) {
  return e ? 3 : n <= a ? 1 : n <= s ? 0 : 2;
}
var J = ((i) => (
...
function d(e, n, a) {
  return e.find(({ resourceLimits: s }) => (s[a] ?? 1 / 0) > (n[a] ?? 1 / 0))?.licenseType ?? null;
}
function u(e, n, a) {
  return e.find(({ featureFlags: s }) => s[n] === a)?.licenseType ?? null;
}
function Je(e, n, a, s, m) {
  let t = a
  ...
  switch (e) {
    ...
    case "fileUploadLimitInMB":
      return d(t, s, "fileUploadLimitInMB");
    case "staticFiles":
      return d(t, s, "staticFiles");
    case "cmsCollections":
      return d(t, s, "cmsCollections");
    case "cmsItems":
      return d(t, s, "cmsItems");
    case "canUseEditorPermissions":
      return u(t, "canUseEditorPermissions", "on");
    case "canPublishToCustomDomain":
    case "customDomainRecoverUpsell":
    case "domainToBuyUpsell":
      return u(t, "canPublishToCustomDomain", "on");
    case "canInviteEditors":
    case "canInviteProjectEditors":
      return d(t, s, "maxEditors");
    case "translatableWords":
    case "localeAddon":
      return d(t, s, "maxLocales");
    case "canUseBatchAITranslation":
      return u(t, "canUseBatchAITranslation", "on");
    case "canUseBranching":
      return u(t, "canUseBranching", "on");
    case "canUseUTMTracking":
      return u(t, "canUseUTMTracking", "on");
    case "canUseFunnels":
      return u(t, "canUseFunnels", "upsell");
    case "canUseTriggers":
      return u(t, "canUseTriggers", "upsell");
    case "abTests":
      return d(t, s, "maxAbTests");
    case "trackingEventsLimit":
      return d(t, s, "maxTrackingEventsLimit");
    case "canUseRedirects":
      return u(t, "canUseRedirects", "on");
    case "canUseInternalRewrites":
      return u(t, "canUseInternalRewrites", "on");
    case "canUseCustomHeaders":
      return u(t, "canUseCustomHeaders", "on");
    case "canUseCustomCanonicalUrl":
      return u(t, "canUseCustomCanonicalUrl", "upsell");
    case "canUseFirewall":
      return u(t, "canUseFirewall", "on");
    case "canUseCustomLocaleRegions":
      return u(t, "canUseCustomLocaleRegions", "on");
    case "canUsePasswordProtection":
      return u(t, "canUsePasswordProtection", "on");
    case "canUseStagingEnvironment":
      return u(t, "canUseStagingEnvironment", "on");
    case "canUseWellKnown":
      return u(t, "canUseWellKnown", "on");
    case "analyticsRangeInDays":
      return d(t, s, "analyticsRangeInDays");
    case "bandwidthInGB":
      return d(t, s, "bandwidthInGB");
    case "aiCredits":
      return d(t, s, "aiCredits");
  }
}
var ge = ["baseten", "fireworks"],
  l = { provider: "baseten", modelId: "contour-1", environment: "production", deployment: "" };
function he(e) {
  return ge.some((n) => n === e);
}
function I(e, n, a) {
  let s = e[n];
  return G(s) ? s : a;
...
function sn(e) {
  return P(e)
    ? {
        provider: he(e.provider) ? e.provider : l.provider,
        modelId: I(e, "modelId", l.modelId),
        environment: I(e, "environment", l.environment),
        deployment: I(e, "deployment", l.deployment),
      }
    : { ...l };
}
function tn() {
  return z()?.stores.persistedUserDefaults.contourOverride ?? l;
}
function V(e, n) {
  return e.trim() || n;
}
function ee(e = l) {
  return V(e.modelId, l.modelId);
}
function ne(e = l) {
  let n = ee(e),
    a = e.deployment.trim();
  ...
  let s = V(e.environment, l.environment);
...
function on(e = l) {
  return (
    ...
    ee(e) !== l.modelId ||
    V(e.environment, l.environment) !== l.environment ||
    Ce(e)
  );
}
var ae = [
  ...
  O = Ge,
  cn = ae.map((e) => e.languageModel),
  _ = new Map(O.map((e) => [e.languageModel, e]));
function M(e) {
  return _.has(e);
}
function mn(e, n) {
  let a = _.get(e);
  A(a, "Unknown Contour variant");
  let { selection: s } = a;
...
function fn(e, n) {
  let a = O.filter((s) => "override" in s.selection || s.selection.provider === e).map((s) => [
    s.languageModel,
    n(s),
  ]);
...
var se = new Set(["low", "high", "max"]),
  ...
  xe = w((e) => (e.base === "triton" ? "low" : e.base === "hex" ? "none" : "enabled")),
  Fe = new Set([
    "none",
    "enabled",
    "minimal",
...
function wn(e) {
  ...
  for (let n in e) {
    if (!k(n)) return !1;
    let a = e[n];
    if (!Oe(a) || !K[n].has(a)) return !1;
  }
  return !0;
}
function Ln(e) {
  if (!P(e)) return !1;
  for (let n in e) if (!k(n) || typeof e[n] != "boolean") return !1;
  return !0;
}
function bn(e) {
  return K[e];
  ...
  switch (e) {
    ...
    case "high": {
      if (n === "anthropic/claude-sonnet-4.6") {
        let a = ve[e];
        if (!F(a)) return { enabled: !0, max_tokens: a };
      }
...
function kn(e, n) {
  if (!(F(e) || !B(n) || !be(e))) return { verbosity: e };
}
var te = "effort";
function In(e, n) {
  let a = Ae(e, n);
...
function Bn(e, n) {
  if (n) {
    if (ie[e]) return "fast";
    if (oe[e]) return "priority";
  }
}
var Ve = Ie["openai/gpt-5.6-sol"];
function r(e, n, a) {
  return { multiplier: n, description: { name: e, body: a(`${n}\xD7`, Ve) } };
}
var R = {
  "openai/gpt-5.6-sol": r(
    "GPT 5.6 Sol",
    1,
...
function o(e) {
  return { allowedFileTypes: ["image/*"], maxAttachments: re, totalSizeLimit: le, ...e };
}
var U = {
  "openai/gpt-5.1": o(),
  "openai/gpt-5.2": o(),
  "openai/gpt-5.2-codex": o(),
  "openai/gpt-5.3-codex": o(),
  "openai/gpt-5.1-codex-mini": o(),
  "openai/gpt-5.4": o(),
  "openai/gpt-5.5": o(),
  ...
  "meta/muse-spark-1.3": o(),
  "z-ai/glm-5.3-flash": o(),
  "thinkingmachines/inkling": o(),
  "thinkingmachines/inkling-small": o(),
  "deepseek/deepseek-v4.1-flash": o(),
  "x-ai/grok-build-0.1": _e,
  "anthropic/claude-sonnet-4.5": o(c),
  "anthropic/claude-opus-4.5": o(c),
  "anthropic/claude-sonnet-4.6": o(c),
  "anthropic/claude-sonnet-5": o(c),
  "anthropic/claude-opus-4.6": o(c),
  "anthropic/claude-opus-4.7": o(c),
  "anthropic/claude-opus-4.8": o(c),
  "anthropic/claude-opus-5": o(c),
  "anthropic/claude-fable-5": o(c),
  "anthropic/claude-fable-5.1": o(c),
  "anthropic/claude-haiku-4.5": o(c),
};
function Ee(e = S) {
...
function Dn(e = S) {
  return Ee(e) !== void 0 || Be(e) !== void 0 || Ke(e) !== void 0;
}
function Re(e) {
  return e * 1024 * 1024;
}
function $n(e) {
  if (M(e)) return "framer";
  switch (e) {
    case "anthropic/claude-haiku-4.5":
    case "anthropic/claude-sonnet-4.5":
    case "anthropic/claude-sonnet-4.6":
...
async function qn({
  ...
  if (a.size > L) {
    if (L < D && t) t(a.size);
      ...
      let h = new Intl.NumberFormat("en", { style: "unit", unit: "megabyte" }).format(C ?? D / $);
      m({
        type: "add",
        key: g,
        variant: "error",
        primaryText: "File exceeds",
        secondaryText: `limit of ${h}.`,
        duration: 1e4,
        icon: "error",
        moveToTop: !0,
      });
  ...
  let y = 0,
    ...
    me = 100 / j;
  try {
    let h = await q(e, { [n]: a }, (v) => {
      if (b) return;
      let T = Math.round(v * j);
      if (T === y) return;
      y = T;
      let x = Math.round(y * me * 0.95);
      (!N && x >= 90) ||
        ((N = !0),
        m({
          type: "add",
    ...
    b = !0;
    let v = h instanceof Error ? (p?.(h) ?? h.message) : String(h),
      T = ue(v.trim()),
      x = T ? `${T}.` : "Please try again.";
    return (
      m({
        type: "add",
        key: g,
...
var ce = { aiCredits: "Monthly Credits", contentEditors: "Content Editor Seat" };
function ia(e) {
  return ce[e];
}
function oa(e) {
...
//# sourceMappingURL=chunk-MP25L2VS.mjs.map
