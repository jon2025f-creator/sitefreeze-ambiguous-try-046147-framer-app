...
import { a as G } from "chunk-B45SUEOE.mjs";
import { a as K } from "chunk-QFU6OGL3.mjs";
import { d as ve } from "chunk-3WKMMIQB.mjs";
...
var oe = s(A()),
  Ae = z.default.memo(
    z.default.forwardRef(function (r, g) {
      let {
          value: f,
          enabled: p = !0,
          readOnly: x,
          ...
          onScroll: E,
          className: B,
          stopUpDownKeyPropagation: M = !0,
          truncate: H = !0,
          disabledIsReadOnly: O = !0,
          autoComplete: i = "off",
          selectOnFocus: m,
          name: I,
          ...n
      ...
      return (0, oe.jsx)("input", {
        ref: v,
        type: "text",
        className: K(Z, Y, H && G, B),
        value: W,
        onChange: N,
        readOnly: O ? !u : void 0,
        disabled: O && W.length > 0 ? void 0 : !u,
        onBlur: U,
        onFocus: V,
        onKeyDown: P,
        onScroll: y,
...
//# sourceMappingURL=chunk-6SV7P3JH.mjs.map
