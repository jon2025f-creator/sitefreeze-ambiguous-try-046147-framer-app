import { c as hr } from "chunk-7L62NXFY.mjs";
import { L as ur, M as fr, P as Cr } from "chunk-CWYMBH5V.mjs";
import { a as ee } from "chunk-7C7APAFD.mjs";
import { a as ge } from "chunk-36BO4RML.mjs";
import { c as ye } from "chunk-YMW3ZYBS.mjs";
import { f as lr, p as cr, q as E } from "chunk-2XYJYMIT.mjs";
...
import { b as mr } from "chunk-XWXAHGWM.mjs";
  ...
  for (let [m, i] of a) {
    ...
    d[m] = ar(
      ...
      ir({
        ...
        getCanvasTree: () => e,
        componentLoader: r,
        fontPreview: p.cache.fontPreview,
      })
    );
  }
...
var A = c(C(), 1),
  ...
  $t = N.default.forwardRef(function (r, t) {
    ...
    H(r, u, f);
    let h = gr(a, n);
    if ((le() && ((h = Er(h)), vr(m || {})), o === !1)) return null;
...
function Er(e) {
  return e.map((r) => {
    ...
    let t = r.props.style || {};
    return (vr(t), N.default.cloneElement(r, { style: t }));
  });
}
var br = c(L(), 1);
function eo() {
...
function _r(e, r) {
  ...
  return ve(t)
    ? lr(t)
      ? !0
      : r === "canvasComponent"
    : !!(be(t) && (t.type === "canvasComponent" || t.type === "screen"));
}
var Br = /\s*(?:at|in) (\S+)/;
function Hr(e, r) {
  let t = [];
...
function Yr({
  ...
  let R = d?.get(l)?.get(p.id) ?? h?.get(p.id),
    v = r.repeatArrayTransforms?.length ? Oe(e, r) : void 0,
    x = v ? tr(v, r.cache, d, g, g, r.cache.activeRouterLocale, { startValue: R }) : R;
  return !U(x) || !x.every(W)
    ? (a.set(t, void 0, M), null)
    : (a.set(t, x, M, v ? "shallow" : "identity"),
      x.length === 0
        ? null
        : {
...
function Tn(e, r, t, o) {
  $(e, r, t, (n, a) => (n.type === "vectorsetitem" && b(a) && Y(a) ? o(a) : a));
}
function Vn(e, r, t) {
  let o = [];
  return ($(e, r, t, (n, a) => (n.type === "vectorsetitem" && b(a) && Y(a) && o.push(a), a)), o);
}
function Dn(e, r, t) {
...
//# sourceMappingURL=chunk-BHUXRVAK.mjs.map
