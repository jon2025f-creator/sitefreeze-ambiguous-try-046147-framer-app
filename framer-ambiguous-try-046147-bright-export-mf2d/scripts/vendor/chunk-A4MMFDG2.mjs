import { g as Qs } from "chunk-SR2NVY3J.mjs";
import { a as ia } from "chunk-37LRUORR.mjs";
import { a as si } from "chunk-YGN7H5WF.mjs";
import { e as Js } from "chunk-7AUGB2CM.mjs";
import { a as Zs } from "chunk-ZRYKVWJA.mjs";
import { a as ea, c as ta } from "chunk-YY75G3LC.mjs";
import { c as oa } from "chunk-D6Z5WEZY.mjs";
import { b as ni } from "chunk-WPWSHZF5.mjs";
import { a as na, b as sa } from "chunk-VLGNAOWL.mjs";
import { a as ra } from "chunk-VD6KMVU6.mjs";
import { d as ii } from "chunk-TGD6QXFE.mjs";
import { a as Qo } from "chunk-HAPAFTZO.mjs";
import { b as _t } from "chunk-F3WIGDOL.mjs";
import { a as vf } from "chunk-SJ5ZASSS.mjs";
import { a as kt } from "chunk-B45SUEOE.mjs";
import { c as Ys, d as Xs } from "chunk-3PIOJLHR.mjs";
import { a as aa } from "chunk-LVTM6NBN.mjs";
import { a as ue } from "chunk-QFU6OGL3.mjs";
import { d as Gs } from "chunk-7BWPFUCH.mjs";
import { a as oi } from "chunk-LUZ6ND5K.mjs";
import { a as ie } from "chunk-2FCXHKEL.mjs";
import { b as Er, e as Us, h as $s, m as Dt, o as Tt, s as qs } from "chunk-LA34HORX.mjs";
import { a as X } from "chunk-SWYZG2NI.mjs";
import { b as ri, c as Ks } from "chunk-4JY5UMT2.mjs";
import { l as zs } from "chunk-MQDP3TYU.mjs";
import { d as $e, u as Zr, v as js } from "chunk-VHFKZWVR.mjs";
import { d as Ws } from "chunk-VJ7UYMJI.mjs";
...
var hf = Object.defineProperty,
  ...
  Z = (e, t) => {
    ...
    if (en) for (var o of en(t)) la.call(t, o) && ua(e, o, t[o]);
    return e;
  },
  ce = (e, t) => bf(e, gf(t)),
  Ir = (e, t) => {
    ...
    if (e != null && en) for (var r of en(e)) t.indexOf(r) < 0 && la.call(e, r) && (o[r] = e[r]);
    return o;
  };
function Ft(...e) {}
function Qr(e, t) {
...
function Me(e, ...t) {
  let o = e,
    ...
    p = (A, R, _ = c) => (
      ...
      () => {
        var H;
        ((H = m.get(R)) == null || H(), m.delete(R), f.delete(R), _.delete(R));
      }
    ),
    x = (A, R) => p(A, R),
    ...
    M = {
      getState: C,
      setState: P,
      __unstableInternals: { setup: d, init: v, subscribe: x, sync: b, batch: g, pick: w, omit: y },
    };
  return M;
}
function we(e, ...t) {
...
var Cf = Object.defineProperty,
  ...
  S = (e, t) => {
    for (var o in t || (t = {})) ma.call(t, o) && fa(e, o, t[o]);
    if (tn) for (var o of tn(t)) da.call(t, o) && fa(e, o, t[o]);
    return e;
  },
  T = (e, t) => Sf(e, wf(t)),
  j = (e, t) => {
    var o = {};
    for (var r in e) ma.call(e, r) && t.indexOf(r) < 0 && (o[r] = e[r]);
    if (e != null && tn) for (var r of tn(e)) t.indexOf(r) < 0 && da.call(e, r) && (o[r] = e[r]);
    return o;
  };
var pa = F(X(), 1);
function no(e, t) {
...
function Pf(e) {
  return !e || !(0, pa.isValidElement)(e) ? !1 : "ref" in e.props || "ref" in e;
}
function va(e) {
  return Pf(e) ? S({}, e.props).ref || e.ref : null;
}
function ha(e, t) {
  let o = S({}, e);
  for (let r in t) {
...
function Ge(e) {
  ...
  return t === "button" ? !0 : t === "input" && e.type ? If.indexOf(e.type) !== -1 : !1;
}
var If = ["button", "color", "file", "image", "reset", "submit"];
function ao(e) {
...
function fo(e, t) {
  ...
  return (
    o.sort(([n, i], [s, a]) => {
      let u = t(i),
        c = t(a);
      return u === c || !u || !c ? 0 : Mf(u, c) ? (n > s && (r = !0), -1) : (n < s && (r = !0), 1);
    }),
    r ? o.map(([n, i]) => i) : e
  );
}
...
var Of = F(X(), 1),
  ...
  pi = S({}, Of),
  xa = pi.useId,
  hv = pi.useDeferredValue,
  ya = pi.useInsertionEffect,
...
function fn(e, t, o) {
  let r = e.onLoadedMetadataCapture,
    n = (0, ve.useMemo)(() => Object.assign(() => {}, T(S({}, r), { [t]: o })), [r, t, o]);
...
var vi = !1,
  ...
  wa = 0;
function Af(e) {
  let t = e.movementX || e.screenX - Sa,
    o = e.movementY || e.screenY - wa;
  return ((Sa = e.screenX), (wa = e.screenY), t || o || !1);
}
function Df(e) {
  Af(e) && (vi = !0);
}
...
var je = F(X(), 1),
  mr = F(ie(), 1);
function W(e) {
  let t = je.forwardRef((o, r) => e(T(S({}, o), { ref: r })));
...
function z(e, t) {
  ...
  if (je.isValidElement(n)) {
    let u = T(S({}, n.props), { ref: s });
    a = je.cloneElement(n, ha(i, u));
...
function Ee(e = [], t = []) {
  let o = je.createContext(void 0),
    ...
    a = (c) =>
      e.reduceRight(
        (l, m) => (0, mr.jsx)(m, T(S({}, c), { children: l })),
...
var mo = Ee(),
  Ma = mo.useContext,
  wv = mo.useScopedContext,
  Pv = mo.useProviderContext,
  Oa = mo.ContextProvider,
  Ra = mo.ScopedContextProvider;
var hi = F(X(), 1),
  po = Ee([Oa], [Ra]),
  Nt = po.useContext,
  Ov = po.useScopedContext,
  Aa = po.useProviderContext,
  xt = po.ContextProvider,
  tr = po.ScopedContextProvider,
  Da = (0, hi.createContext)(void 0),
  Ta = (0, hi.createContext)(void 0);
var Tf = { id: null };
function ka(e, t, o = !1) {
...
var Bt = U(function (t) {
    ...
    ((0, Qe.useEffect)(() => {
      r && (Ga || (xe("mousedown", Uf, !0), xe("keydown", $f, !0), (Ga = !0)));
    }, [r]),
      Ua &&
        (0, Qe.useEffect)(() => {
          if (!r) return;
    ...
    let d = Ci(a.onKeyPressCapture, c),
      ...
      b = $((E) => {
        ...
        let N = Wa(D.parentElement);
        ($a(N, !0),
          gt(D, "mouseup", () => {
            (D.removeEventListener("focusin", I, !0), $a(N, !1), !K && hn(D));
          }));
      }),
      g = (E, D) => {
      ...
      P = $((E) => {
        ...
        let D = E.currentTarget,
          K = () => g(E, D);
        Si || Bf(E.target) ? gt(E.target, "focusout", K) : f(!1);
      }),
      M = a.onBlur,
      A = $((E) => {
      ...
      h = r && zf(H),
      O = a.style,
      k = (0, Qe.useMemo)(() => (l ? S({ pointerEvents: "none" }, O) : O), [l, O]);
    return (
      (a = T(
        S(
          {
        ...
        ),
        {
          ref: ee(u, _, a.ref),
          style: k,
          tabIndex: Kf(r, l, B, h, a.tabIndex),
  ...
  ho = U(function (t) {
    ...
    let [c, l] = (0, rr.useState)(!1),
      ...
      x = $((w) => {
        ...
        if (w.defaultPrevented || d || f || !Ae(w) || ke(y) || y.isContentEditable) return;
        let C = r && w.key === "Enter",
          P = n && w.key === " ",
          M = w.key === "Enter" && !r,
          A = w.key === " " && !n;
          ...
          if (C) {
            if (!R) {
              ...
              let _ = w,
                ...
                B = j(_, ["view"]),
                h = () => di(y, B);
              fi() ? gt(y, "keyup", h) : queueMicrotask(h);
            }
      ...
      g = $((w) => {
        ...
        let y = n && w.key === " ";
        if (m.current && y && ((m.current = !1), !Ja(w))) {
    ...
    return (
      (i = T(S(S({ "data-active": c || void 0, type: a ? "button" : void 0 }, v), i), {
        ref: ee(s, i.ref),
        onKeyDown: x,
        onKeyUp: g,
      })),
...
var Ct = F(X(), 1),
  Za = F(vf(), 1),
  { useSyncExternalStore: Qa } = Za.default,
  eu = () => () => {};
function fe(e, t = to) {
  let o = Ct.useCallback((n) => (e ? Jt(e, null, n) : eu()), [e]),
    r = () => {
...
function bo(e, t) {
  let o = Ct.useRef({}),
    r = Ct.useCallback((i) => (e ? Jt(e, null, i) : eu()), [e]),
    n = () => {
      let i = e?.getState(),
        s = !1,
        a = o.current;
...
function ze(e, t) {
  ...
  let n = Ct.useCallback((a) => fe(o, a), [o]),
    i = Ct.useMemo(() => T(S({}, o), { useState: n }), [o, n]),
    s = $(() => {
...
function tu(e, t, o, r = !1) {
  ...
  for (let l = 0; l < i.length; l += 1) {
    ...
    if (((u = o(l)), !u)) break;
    if (u === m) continue;
    let f = (n = yt(t, u)) == null ? void 0 : n.element;
    if (!f) continue;
    let v = Zf(f, r) - a,
      p = Math.abs(v);
    if ((r && v <= 0) || (!r && v >= 0)) {
...
var _r = U(function (t) {
    ...
    let d = De(m.id),
      ...
      _ = (0, Wt.useRef)(!1),
      H = $((I) => {
        if ((R?.(I), I.defaultPrevented || on(I) || !d || !r || Qf(I, r))) return;
        let { virtualFocus: q, baseElement: N } = r.getState();
        if (
          (r.setActiveId(d),
          uo(I.currentTarget) && Ha(I.currentTarget),
          !q || !Ae(I) || Xf(I.currentTarget) || !N?.isConnected)
        )
          return;
        (Lt() &&
          ...
          (_.current = !0),
          I.relatedTarget === N || dr(r, I.relatedTarget) ? Va(N) : N.focus());
      }),
      B = m.onBlurCapture,
      h = $((I) => {
      ...
      D = $((I) => {
        ...
        let { currentTarget: q } = I,
          ...
          Oe = () => !!(Se || J || !N.baseElement || !ke(N.baseElement)),
          Ue = {
            ArrowUp: (Se || ye) && r.up,
            ...
            PageUp: () => tu(q, r, r?.up, !0),
            PageDown: () => tu(q, r, r?.down),
          }[I.key];
        if (Ue) {
          if (uo(q)) {
            let Ne = Or(q),
    ...
    return (
      (m = le(m, (I) => (0, ru.jsx)(Da.Provider, { value: K, children: I }), [K])),
      (m = T(S({ id: d, "data-active-item": y || void 0 }, m), {
        ref: ee(v, m.ref),
      ...
      (m = ho(m)),
      (m = gi(
        T(S({ store: r }, m), { getItem: A, shouldRegisterItem: d ? m.shouldRegisterItem : !1 })
      )),
      We(T(S({}, m), { "aria-setsize": C, "aria-posinset": P }))
    );
  }),
  wi = er(
    W(function (t) {
...
function ou(e, t, o) {
  return $((r) => {
    ...
    let a = r,
      ...
      l = o?.current;
    (s !== l && s.focus(),
      ga(s, r.type, c) || r.preventDefault(),
      r.currentTarget.contains(s) && r.stopPropagation());
  });
}
function nm(e) {
  return _a(go(Fr(Fa(e))));
}
function im(e) {
...
var Hr = U(function (t) {
    ...
    let c = (0, St.useRef)(null),
      ...
      m = im(r),
      f = r.useState("moves"),
      [, d] = Pa(n ? r.setBaseElement : null);
    ((0, St.useEffect)(() => {
      var h;
      if (!r || !f || !n || !i) return;
      let { activeId: O } = r.getState(),
        k = (h = yt(r, O)) == null ? void 0 : h.element;
      k && Ka(k);
    }, [r, f, n, i]),
      Q(() => {
        if (!r || !f || !n) return;
    ...
    Q(() => {
      ...
      let E = ((h = yt(r, v)) == null ? void 0 : h.element) || Je(O);
      E !== O && fr(O, { relatedTarget: E });
    }, [r, v, p, n]);
    let x = ou(r, a.onKeyDownCapture, l),
      b = ou(r, a.onKeyUpCapture, l),
      g = a.onFocusCapture,
      w = $((h) => {
        ...
        let k = h.relatedTarget,
          E = La(h.currentTarget);
        Ae(h) && E && (h.stopPropagation(), (l.current = k));
      }),
      y = a.onFocus,
      C = $((h) => {
        if ((y?.(h), h.defaultPrevented || !n || !r)) return;
      ...
      M = $((h) => {
        ...
        if (!k) return;
        let D = (O = yt(r, E)) == null ? void 0 : O.element,
          K = h.relatedTarget,
          I = dr(r, K),
          q = l.current;
        ((l.current = null),
    ...
    a = le(a, (h) => (0, nu.jsx)(xt, { value: r, children: h }), [r]);
    let H = r.useState((h) => {
      var O;
      if (r && n && h.virtualFocus) return (O = yt(r, h.activeId)) == null ? void 0 : O.id;
    });
    a = T(S({ "aria-activedescendant": H }, a), {
      ref: ee(c, d, a.ref),
      onKeyDownCapture: x,
      onKeyUpCapture: b,
      onFocusCapture: w,
...
var xo = Ee(),
  Gh = xo.useContext,
  Yh = xo.useScopedContext,
  yo = xo.useProviderContext,
  iu = xo.ContextProvider,
  su = xo.ScopedContextProvider;
var Ei = F(X(), 1),
  Co = Ee([iu], [su]),
  Qh = Co.useContext,
  eb = Co.useScopedContext,
  Vr = Co.useProviderContext,
  au = Co.ContextProvider,
  Lr = Co.ScopedContextProvider,
  uu = (0, Ei.createContext)(void 0),
  cu = (0, Ei.createContext)(void 0);
var Nr = F(X(), 1),
  mu = F(oi(), 1),
  Ii = F(ie(), 1),
  sm = "div";
...
var So = U(function (t) {
    ...
    (Q(() => {
      ...
      Q(() => {
        ...
        if (typeof d == "number") return lu(d, y);
        let {
      ...
      (i = le(i, (w) => (0, Ii.jsx)(Lr, { value: r, children: w }), [r])));
    let x = pr(f, i.hidden, n),
      b = i.style,
      g = (0, Nr.useMemo)(() => (x ? T(S({}, b), { display: "none" }) : b), [x, b]);
    return (
      (i = T(
        S(
          {
  ...
  cb = W(function (t) {
    ...
    let i = yo(),
      s = n.store || i;
    return fe(s, (u) => !r || u?.mounted) === !1 ? null : (0, Ii.jsx)(um, S({}, n));
  });
function wo(e = {}) {
...
function pu(e = {}) {
  ...
  let l = (f, d, v = !1) => {
      ...
      return (
        ...
        () => {
          d((b) => {
            if (!p) return (v && n.delete(f.id), b.filter(({ id: y }) => y !== f.id));
            let g = b.findIndex(({ id: y }) => y === f.id);
            if (g === -1) return b;
            let w = b.slice();
  ...
  we(s, () =>
    ge(s, ["renderedItems", "activeId"], (u) => {
      s.setState("activeId", (c) => {
        var l;
        return c !== void 0 ? c : (l = jt(u.renderedItems)) == null ? void 0 : l.id;
      });
    })
  );
  let a = (u = "next", c = {}) => {
    ...
    let f = s.getState(),
      ...
      M = P ? y && !C : !y || C,
      A = p && !d,
      R = C ? go(hm(bu(w), v, A)) : w;
    if (((R = M ? Fr(R) : R), (R = C ? bm(R) : R), v == null))
      return (l = jt(R)) == null ? void 0 : l.id;
    let _ = R.find((I) => I.id === v);
...
var xn = F(X(), 1),
  ...
  xu = Eo.ContextProvider,
  yu = Eo.ScopedContextProvider,
  Cu = (0, xn.createContext)(void 0),
  Su = (0, xn.createContext)(!1);
var xm = "hr",
  Ai = U(function (t) {
    var o = t,
...
var ym = "hr",
  Di = U(function (t) {
    ...
    return ((n = Ai(T(S({}, n), { orientation: s }))), n);
  }),
  Cm = W(function (t) {
    let o = Di(t);
    return z(ym, o);
...
var Io = Ee([bn], [or]),
  Sm = Io.useContext,
  sg = Io.useScopedContext,
  Mo = Io.useProviderContext,
  wu = Io.ContextProvider,
  wn = Io.ScopedContextProvider;
function Pn(e) {
...
var Em = "span",
  Im = U(function (t) {
    return (
      (t = T(S({ "data-focus-trap": "", tabIndex: 0, "aria-hidden": !0 }, t), {
...
var Vi = U(function (t) {
    ...
    return (
      Q(() => {
        ...
        let P = C.isConnected;
        if (
          (P || (m || Om(y)).appendChild(C),
          C.id || (C.id = y.id ? `portal/${y.id}` : Am()),
          d(C),
          no(s, C),
          !P)
        )
      ...
      (0, et.useEffect)(() => {
        ...
        let y = 0,
          C = (P) => {
            ...
            if ((cancelAnimationFrame(y), M)) return za(f);
      ...
      (u = le(
        u,
        (y) => {
          if (((y = (0, Le.jsx)(_i.Provider, { value: f || m, children: y })), !a)) return y;
          if (!f)
            ...
            children: [
              ...
              r &&
                ...
                (0, Le.jsx)(Oo, {
                  ...
                  onFocus: (P) => {
                    bt(P, f) ? nr(yi()) : nr(w.current);
                  },
                }),
            ],
          })),
            f && (y = (0, Hi.createPortal)(y, f)));
            ...
            children: [
              r &&
                ...
                (0, Le.jsx)(Oo, {
                  ...
                  onFocus: (P) => {
                    !(P.relatedTarget === w.current) && bt(P, f) ? nr(b.current) : nr(yi());
                  },
                }),
          ...
          return (
            ...
            (0, Le.jsxs)(Le.Fragment, { children: [C, y] })
          );
        },
        [f, m, a, u.id, r, v]
      )),
...
var Eu = F(X(), 1),
  Li = (0, Eu.createContext)(0);
var Iu = F(X(), 1),
  Mu = F(ie(), 1);
function Ou({ level: e, children: t }) {
  let o = (0, Iu.useContext)(Li),
...
var Ru = F(ie(), 1),
  ...
  Ni = U(function (t) {
    ...
    return ((n = le(n, (i) => (0, Ru.jsx)(dn.Provider, { value: r, children: i }), [r])), n);
  }),
  Hg = W(function (t) {
    let o = Ni(t);
    return z(Dm, o);
    ...
    T(S({}, i), {
      ...
      listener: (s) => {
        let { contentElement: a } = e.getState(),
          u = n.current;
        u && ao(u) && To(u, a?.id) && Ui(t, s) && e.hide();
      },
    })
  ),
    Ki(
...
var ft = F(X(), 1),
  Hu = F(ie(), 1),
  Fu = (0, ft.createContext)({});
function Vu(e) {
  let t = (0, ft.useContext)(Fu),
    [o, r] = (0, ft.useState)([]),
    n = (0, ft.useCallback)(
      (a) => {
        var u;
  ...
  return {
    wrapElement: (0, ft.useCallback)(
      (a) => (0, Hu.jsx)(Fu.Provider, { value: i, children: a }),
      [i]
    ),
    nestedDialogs: o,
  };
...
var On = F(X(), 1),
  Lu = F(oi(), 1);
function Nu({ attribute: e, contentId: t, contentElement: o, enabled: r }) {
  let [n, i] = ln(),
    s = (0, On.useCallback)(() => {
      if (!r || !o) return !1;
      let { body: a } = re(o),
  ...
  return (
    (0, On.useEffect)(() => {
      ...
      let u = new MutationObserver(() => (0, Lu.flushSync)(i));
...
function $i(e, t) {
  ...
  return be(...r, zu(e), Ao(e, { pointerEvents: "none", userSelect: "none", cursor: "default" }));
}
function Ku(e, t) {
  let o = [],
    r = t.map((i) => i?.id);
...
var Kr = F(X(), 1),
  An = F(ie(), 1);
function Uu({ store: e, backdrop: t, alwaysVisible: o, hidden: r }) {
  ...
  if (!t) return null;
  if ((0, Kr.isValidElement)(t)) return (0, An.jsx)(zr, T(S({}, a), { render: t }));
  let u = typeof t != "boolean" ? t : "div";
  return (0, An.jsx)(zr, T(S({}, a), { render: (0, An.jsx)(u, {}) }));
}
function ko(e = {}) {
  return wo(e);
}
...
var Gi = U(function (t) {
  ...
  let C = Vr(),
    ...
    { portalRef: A, domReady: R } = Dr(u, y.portalRef),
    _ = y.preserveTabOrder,
    H = fe(M, (G) => _ && !a && G.mounted),
    B = De(y.id),
    h = fe(M, "open"),
    O = fe(M, "mounted"),
    k = fe(M, "contentElement"),
    E = pr(O, y.hidden, y.alwaysVisible);
  (Wu(k, B, d && !E), _u(M, m, R));
  let { wrapElement: D, nestedDialogs: K } = Vu(M);
  ((y = le(y, D, [D])),
    Q(() => {
      if (!h) return;
      let G = P.current,
    ...
    (0, Te.useEffect)(() => {
      if (!a || !O || !R) return;
      let G = P.current;
      if (!(!G || G.querySelector("[data-dialog-dismiss]"))) return Au(G, M.hide);
    }, [M, a, O, R]),
    Q(() => {
      if (!Rn() || h || !O || !R) return;
      let G = P.current;
  ...
  Q(() => {
    ...
    return a ? be(zi(B, ae), Ku(B, ae)) : zi(B, [G, ...ae]);
  }, [B, M, I, q, K, a, w]);
  let N = !!v,
    he = se(v),
    [Se, ye] = (0, Te.useState)(!1);
  (0, Te.useEffect)(() => {
    if (!h || !N || !R || !k?.isConnected) return;
    let G =
        Gu(x, !0) || k.querySelector("[data-autofocus=true],[autofocus]") || Ba(k, !0, u && H) || k,
      oe = Ze(G);
    he(oe ? G : null) &&
      (ye(!0),
      queueMicrotask(() => {
        (G.focus(), qu && oe && G.scrollIntoView({ block: "nearest", inline: "nearest" }));
      }));
  }, [h, N, R, k, x, u, H, he]);
  let J = !!p,
    Oe = se(p),
      ...
      !R || !O
        ...
        : xe(
            ...
            (oe) => {
              ...
              (ae.tagName === "BODY" || me(Re, ae) || !Be || me(Be, ae)) && Ot(oe) && M.hide();
            },
            !0
          ),
    [M, R, O, Ot]
  ),
    (y = le(y, (G) => (0, mt.jsx)(Ou, { level: a ? 1 : void 0, children: G }), [a])));
  let Gt = y.hidden,
    ct = y.alwaysVisible;
  y = le(
    y,
    (G) =>
      c
        ? (0, mt.jsxs)(mt.Fragment, {
            children: [
              (0, mt.jsx)(Uu, { store: M, backdrop: c, hidden: Gt, alwaysVisible: ct }),
              G,
            ],
          })
        : G,
  ...
  return (
    (y = le(
      ...
      (G) =>
        (0, mt.jsx)(Lr, {
          value: M,
          children: (0, mt.jsx)(uu.Provider, {
            value: Yt,
            children: (0, mt.jsx)(cu.Provider, { value: Xt, children: G }),
          }),
        }),
      [M]
    )),
    ...
    (y = Ni(T(S({}, y), { autoFocusOnShow: Se }))),
    (y = So(S({ store: M }, y))),
    (y = Bt(T(S({}, y), { focusable: s }))),
    (y = Vi(T(S({ portal: u }, y), { portalRef: A, preserveTabOrder: H }))),
    y
  );
});
function br(e, t = Vr) {
...
async function Hn(e, t) {
  ...
  return {
    top: (b.top - C.top + v.top) / y.y,
    bottom: (C.bottom - b.bottom + v.bottom) / y.y,
    left: (b.left - C.left + v.left) / y.x,
    right: (C.right - b.right + v.right) / y.x,
  };
}
var ec = (e) => ({
  name: "arrow",
  ...
  async fn(t) {
    ...
    let m = Yi(l),
      ...
      y = i.reference[v] + i.reference[d] - f[d] - i.floating[v],
      C = f[d] - i.reference[d],
        ...
        fn(t) {
          ...
          if (u) {
            let w = f === "y" ? "height" : "width",
              y = i.reference[f] - i.floating[w] + x.mainAxis,
          ...
          if (c) {
            ...
            let w = f === "y" ? "width" : "height",
              ...
              C =
                i.reference[m] -
                i.floating[w] +
                ((y && ((b = s.offset) == null ? void 0 : b[m])) || 0) +
                (y ? 0 : x.crossAxis),
              P =
                i.reference[m] +
                i.reference[w] +
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          let x = d - u.top - u.bottom,
            ...
            C = g,
            P = w;
          if ((m ? (P = l || y ? st(w, b) : b) : (C = l || y ? st(g, x) : x), y && !l)) {
            let A = Ke(u.left, 0),
              R = Ke(u.right, 0),
              _ = Ke(u.top, 0),
              H = Ke(u.bottom, 0);
...
function Et(e) {
  var t;
  return (t = (ac(e) ? e.ownerDocument : e.document) || window.document) == null
    ? void 0
    : t.documentElement;
}
function ac(e) {
...
function $t(e) {
  ...
  let t = e.assignedSlot || e.parentNode || (sc(e) && e.host) || Et(e);
  return sc(t) ? t.host : t;
}
function lc(e) {
  let t = $t(e);
  return Cr(t) ? (e.ownerDocument ? e.ownerDocument.body : e.body) : dt(t) && $r(t) ? t : lc(t);
}
function Ur(e, t, o) {
  var r;
  ...
  if (i) {
    ...
    for (; p && r && d !== v;) {
      let x = qr(p),
        ...
        y = b.top + (p.clientTop + parseFloat(g.paddingTop)) * x.y;
      ((u *= x.x),
        (c *= x.y),
        (l *= x.x),
        (m *= x.y),
...
function hc(e, t) {
  let o = $t(e);
  return o === t || !at(o) || Cr(o) ? !1 : ut(o).position === "fixed" || hc(o, t);
}
function od(e, t) {
  let o = t.get(e);
  if (o) return o;
  let r = Ur(e, [], !1).filter((a) => at(a) && yr(a) !== "body"),
    n = null,
...
function bc(e, t) {
  ...
  let r = mc(e, t);
  for (; r && uc(r) && Xi(r);) r = mc(r, t);
  return r && Cr(r) && Xi(r) && !Vn(r) ? o : r || cc(e) || o;
}
var ad = async function (e) {
  let t = this.getOffsetParent || bc,
...
function hd(e) {
  ...
  return (te(!t || t.every(pd), !1), Cc({ padding: e.overflowPadding, fallbackPlacements: t }));
}
function bd(e) {
...
var Qi = U(function (t) {
    ...
    (Q(() => {
      ...
      let ye = dd(A, q),
        J = async () => {
          ...
          let Ue = M || k.current,
            Xe = [
              vd(Ue, { gutter: x, shift: m }),
              hd({ flip: l, overflowPadding: g }),
              bd({ slide: f, shift: m, overlap: d, overflowPadding: g }),
              xd(Ue, { arrowPadding: b }),
    ...
    }, [r, O, _, M, A, _, B, h, I, c, l, m, f, d, v, p, x, b, g, q, he, N]),
      Q(() => {
        if (!h || !I || !_?.isConnected || !H?.isConnected) return;
        let ye = () => {
    ...
    return (
      ...
      (C = le(C, (ye) => (0, Zi.jsx)(or, { value: r, children: ye }), [r])),
      (C = T(S({ "data-placing": !E || void 0 }, C), {
        style: S({ position: "relative" }, C.style),
      })),
      (C = Gi(
        T(
          S(
...
var Pe = F(X(), 1),
  ...
  yd = "div";
function Rc(e, t, o, r) {
  return it(t) ? !0 : e ? !!(me(t, e) || (o && me(o, e)) || r?.some((n) => Rc(e, n, o))) : !1;
}
function Cd(e) {
  var t = e,
    { store: o } = t,
  ...
  return (
    ...
    (r = T(S({ autoFocusOnHide: n, finalFocus: c }, r), { onFocus: u })),
    r
  );
}
var Oc = (0, Pe.createContext)(null),
  Bn = U(function (t) {
    var o = t,
      {
        store: r,
    ...
    ((c = le(
      ...
      (h) =>
        (0, es.jsx)(wn, {
          value: r,
          children: (0, es.jsx)(Oc.Provider, { value: H, children: h }),
        }),
      [r, H]
    )),
      (c = T(S({}, c), { ref: ee(m, c.ref) })),
      (c = Cd(S({ store: r }, c))));
    let B = r.useState((h) => n || h.autoFocusOnShow);
    return (
      (c = Qi(
        T(S({ store: r, modal: n, portal: i, autoFocusOnShow: B }, c), {
          portalRef: x,
          hideOnEscape(h) {
            return ur(s, h)
              ? !1
...
var wr = F(X(), 1),
  ...
  ts = U(function (t) {
    ...
    let c = i.onMouseMove,
      ...
      f = $((x) => {
        ...
        let { showTimeout: g, timeout: w } = r.getState(),
          ...
          C = g ?? w;
        C === 0 ? y() : (u.current = window.setTimeout(y, C));
      }),
      d = i.onClick,
      v = $((x) => {
    ...
    return ((i = T(S({}, i), { ref: ee(p, i.ref), onMouseMove: f, onClick: v })), (i = Bt(i)), i);
  }),
  wd = W(function (t) {
    let o = ts(t);
    return z(Sd, o);
...
var Ac = F(X(), 1),
  jo = Ee([xt], [tr]),
  Dc = jo.useContext,
  Tc = jo.useScopedContext,
  FC = jo.useProviderContext,
  HC = jo.ContextProvider,
  VC = jo.ScopedContextProvider,
  LC = (0, Ac.createContext)(void 0);
var Ed = "div",
  zo = U(function (t) {
    var o = t,
      { store: r } = o,
      n = j(o, ["store"]);
    let i = vr();
    return ((r = r || i), (n = T(S({}, n), { ref: ee(r?.setAnchorElement, n.ref) })), n);
  }),
  KC = W(function (t) {
    let o = zo(t);
    return z(Ed, o);
...
var Gr = F(X(), 1),
  ...
  rs = U(function (t) {
    ...
    return (
      ...
      (t = T(S({ role: !n && r !== "a" ? "button" : void 0 }, t), { ref: ee(o, t.ref) })),
      (t = ho(t)),
      t
    );
  }),
...
var Yr = F(X(), 1),
  ...
  os = U(function (t) {
    ...
    return (
      (i = T(S(S({ "aria-expanded": u, "aria-controls": b?.id }, p), i), {
        ref: ee(a, i.ref),
        onClick: x,
      })),
      (i = rs(i)),
...
var _c = F(ie(), 1),
  ...
  is = U(function (t) {
    ...
    return (
      (n = le(n, (u) => (0, _c.jsx)(or, { value: r, children: u }), [r])),
      (n = T(S({}, n), { onClick: a })),
      (n = zo(S({ store: r }, n))),
      (n = ns(S({ store: r }, n))),
      n
    ...
    let a = i.onKeyDownCapture,
      ...
      c = $((l) => {
        ...
        let { renderedItems: m, items: f, activeId: d, id: v } = r.getState(),
          p = kd(f.length > m.length ? f : m),
          x = re(l.currentTarget),
        ...
        if ((g.length && (p = fo(p, (C) => C.element)), !Td(l, p))) return ss();
        (l.preventDefault(),
        ...
        ((qt += w), (p = _d(p, w, d)));
        let y = p.find((C) => Kn(C, qt));
        y ? r.move(y.id) : ss();
      });
    return ((i = T(S({}, i), { onKeyDownCapture: c })), We(i));
  }),
  Fd = W(function (t) {
    let o = Ko(t);
    return z(Ad, o);
...
var Uo = U(function (t) {
    ...
    let u = Tr(),
      ...
      p = (0, Hc.useCallback)((x) => {
        x && (x[as] = !0);
      }, []);
    return ((s = T(S({}, s), { ref: ee(p, s.ref), onMouseMove: m, onMouseLeave: v })), We(s));
  }),
  Nd = er(
    W(function (t) {
      let o = Uo(t);
...
var Lc = F(X(), 1),
  $o = Ee([xt, wu], [tr, wn]),
  pt = $o.useContext,
  us = $o.useScopedContext,
  ir = $o.useProviderContext,
  qo = $o.ContextProvider,
  cs = $o.ScopedContextProvider;
var Bd = (0, Lc.createContext)(void 0);
var Un = F(X(), 1),
  Nc = F(ie(), 1),
  Wd = "div";
function jd(e) {
...
var ls = U(function (t) {
    ...
    let u = r.parent,
      ...
      p = v !== "vertical",
      x = fe(c, (M) => !!M && M.orientation !== "vertical"),
      b = $((M) => {
    ...
    s = le(s, (M) => (0, Nc.jsx)(cs, { value: r, children: M }), [r]);
    let g = jd(S({ store: r }, s)),
      w = r.useState("mounted"),
      y = pr(w, s.hidden, n),
      C = y ? T(S({}, s.style), { display: "none" }) : s.style;
    s = T(S({ id: m, "aria-labelledby": g, hidden: y }, s), {
...
var It = F(X(), 1),
  ...
  Ud = U(function (t) {
    ...
    let f = (0, It.useRef)(null),
      ...
      p = !!d,
      x = !!v && !p;
    l = T(S({}, l), { ref: ee(f, l.ref) });
    let b = ls(S({ store: r, alwaysVisible: c }, l)),
      { "aria-labelledby": g } = b;
    l = j(b, ["aria-labelledby"]);
    let [y, C] = (0, It.useState)(),
    ...
    return (
      k !== void 0 && (l = S({ preserveTabOrderAnchor: k }, l)),
      (l = Bn(
        T(
          S(
          ...
          ),
          {
            ...
            hideOnHoverOutside(E) {
              ...
              return (typeof u == "function" ? u(E) : (u ?? (p ? !0 : x ? (D ? !it(D) : !0) : !1)))
                ? E.defaultPrevented || !p || !D || (ba(D, "mouseout", E), !it(D))
                  ? !0
                  : (requestAnimationFrame(() => {
                      it(D) || r?.hide();
                    }),
...
var Gd = U(function (t) {
    ...
    ((a = le(a, (H) => (0, fs.jsx)(qo, { value: r, children: H }), [r])),
      f && (a = T(S({}, a), { render: (0, fs.jsx)(zr.div, { render: a.render }) })));
    let M = De(a.id),
      A = fe(l?.combobox || l, "contentElement"),
      R = f || d ? co(A, "menuitem") : void 0,
      _ = r.useState("contentElement");
    return (
      (a = T(S({ id: M, role: R, "aria-haspopup": Qt(_, "menu") }, a), {
        ref: ee(c, a.ref),
        onFocus: b,
        onKeyDown: y,
        onClick: P,
      ...
      (a = ts(
        T(S({ store: r, focusable: n, accessibleWhenDisabled: i }, a), {
          showOnHover: (H) => {
            if (
              !(() => {
...
var zc = U(function (t) {
    ...
    let m = u.onClick,
      ...
      b = co(x, "menuitem");
    return (
      (u = T(S({ role: b }, u), { onClick: p })),
      (u = _r(S({ store: r, preventScrollOnKeyDown: i }, u))),
      (u = Uo(
        T(S({ store: r }, u), {
          focusOnHover(g) {
            let w = () => (typeof s == "function" ? s(g) : (s ?? !0));
            if (!r || !w()) return !1;
            let { baseElement: y, items: C } = r.getState();
            return v
              ? (g.currentTarget.hasAttribute("aria-expanded") && g.currentTarget.focus(), !0)
              : Xd(y, C, g.currentTarget)
...
function Kc(e = {}) {
  ...
  let u = a.getState(),
    ...
    m = ce(Z(Z({}, c.getState()), l.getState()), {
...
var Zd = "hr",
  Qd = U(function (t) {
    var o = t,
      ...
      n = j(o, ["store"]);
    let i = pt();
    return ((r = r || i), (n = Di(S({ store: r }, n))), n);
  }),
  Yn = W(function (t) {
    let o = Qd(t);
    return z(Zd, o);
...
var np = U(function (t) {
    ...
    ((0, _e.useEffect)(() => {
      ...
      (0, _e.useEffect)(() => {
        if (!_ || !H || !k || !qc(E, k, R) || !Gc(h, k)) return;
        let ne = Ft;
        return (
          queueMicrotask(() => {
            let Ce = y.current;
    ...
    (ot(() => {
      ...
      (0, _e.useEffect)(() => {
        ...
        let L = y.current;
        if (!L) return;
        let ne = [L, K].filter((Ie) => !!Ie),
          Ce = (Ie) => {
            ne.every((rt) => bt(Ie, rt)) && r?.setValue(I);
          };
        for (let Ie of ne) Ie.addEventListener("focusout", Ce);
        return () => {
          for (let Ie of ne) Ie.removeEventListener("focusout", Ce);
        };
      }, [_, K, r, I]));
    let ye = (L) => L.currentTarget.value.length >= u,
      J = g.onChange,
      Oe = se(c ?? ye),
      vt = se(a ?? !r.tag),
      Ue = $((L) => {
        ...
        let ne = L.currentTarget,
          { value: Ce, selectionStart: Ie, selectionEnd: rt } = ne,
          At = L.nativeEvent;
        if (
          ((M.current = !0), tp(At) && (At.isComposing && ((M.current = !1), (A.current = !0)), _))
        ) {
      ...
      oe = g.onBlur,
      Re = $((L) => {
        ((M.current = !1), oe?.(L), L.defaultPrevented);
      }),
      ae = De(g.id),
      Be = rp(b) ? b : void 0,
...
var Yc = U(function (t) {
    ...
    (x && b != null && (f = S({ "aria-selected": b }, f)),
      (f = le(
        f,
        (h) =>
          (0, ms.jsx)(Cu.Provider, {
            value: n,
            children: (0, ms.jsx)(Su.Provider, { value: b ?? !1, children: h }),
          }),
        [n, b]
      )));
    let H = (0, Jn.useContext)(yn);
    f = T(S({ role: ap(H), children: n }, f), { onClick: A, onKeyDown: _ });
    let B = se(l);
    return (
      (f = _r(
        T(S({ store: r }, f), {
      ...
      (f = Uo(S({ store: r, focusOnHover: c }, f))),
      f
    );
  }),
  Yo = er(
...
var Zn = F(X(), 1),
  ...
  Xc = U(function (t) {
    ...
    let c = (0, Zn.useRef)(null),
      ...
      f = pr(m, i.hidden, n),
      d = f ? T(S({}, i.style), { display: "none" }) : i.style,
    ...
    (Q(() => {
      ...
      g || (i = S({ role: "listbox", "aria-multiselectable": b }, i)),
      (i = le(
        i,
        (P) =>
          (0, ds.jsx)(yu, {
    ...
    return ((i = T(S({ id: l, hidden: f }, i), { ref: ee(C, c, i.ref), style: d })), We(i));
  }),
  Xo = W(function (t) {
    let o = Xc(t);
    return z(up, o);
...
var ps = F(X(), 1),
  ...
  xE = (0, ps.createContext)(null),
  Jo = Ee([xt], [tr]),
  Jc = Jo.useContext,
  yE = Jo.useScopedContext,
  CE = Jo.useProviderContext,
  SE = Jo.ContextProvider,
  wE = Jo.ScopedContextProvider;
var cp = Lt() && rn();
function Zc(e = {}) {
  var t = e,
    { tag: o } = t,
...
function fp(e) {
  let t = Jc();
  return ((e = T(S({}, e), { tag: e.tag !== void 0 ? e.tag : t })), gn(e));
}
function mp(e, t, o) {
  return (
    ot(t, [o.tag]),
...
function Qn(e = {}) {
  let t = vs(e);
  return (0, Qc.jsx)(xu, { value: t, children: e.children });
}
var He = F(X(), 1);
var el = 800,
  tl = 0.9,
  rl = 4,
  ol = _t.values.menuPadding * 2,
  nl = -_t.values.menuPadding,
  il = 1,
  sl = "mu6ry6k",
  al = ue(Qs, "i1irwbe6"),
  ul = "bqwxsfx",
  ...
  ei = class extends Ps.default.Component {
    ...
    getSnapshotBeforeUpdate(t) {
      return this.props.animationEnabled !== !1
        ? Dl(this.props.dependencies, t.dependencies)
          ? null
...
var _l = "uchctd1";
var Is = F(ie());
function Fl({ direction: e = "down", ...t }) {
  return (0, Is.jsx)("svg", {
    role: "presentation",
    xmlns: "http://www.w3.org/2000/svg",
    width: "8",
    height: "8",
    className: ue(e === "up" && _l),
    ...t,
    children: (0, Is.jsx)("path", {
      d: "m1 2.75 3 3 3-3",
      fill: "transparent",
      strokeWidth: "1.5",
      stroke: "currentColor",
...
var Ms = class {
  ...
  vp = (0, Jr.createContext)(new Map());
function Os(e, t, o) {
  if (typeof IntersectionObserver > "u") return;
  let r = aa(() => `${o.rootMargin}`),
    n = (0, Jr.useContext)(vp),
    { enabled: i } = o;
  (0, Jr.useEffect)(() => {
    let s = e.current;
    if (!i || !s) return;
    ...
    if (!a || a.root !== o.root?.current) {
      let { root: u, ...c } = o;
      ((a = new Ms({ ...c, root: u?.current })), n.set(r, a));
    }
...
function Jl({
  ...
  return (0, _s.jsx)(As.Provider, { value: i, children: e });
}
var Ts = (0, sr.createContext)(!1);
Ts.displayName = "WithinMenuComboboxContext";
function Zo() {
  return (0, sr.useContext)(Ts);
}
function ks({ children: e, withinCombobox: t }) {
  return (0, _s.jsx)(Ts.Provider, { value: t, children: e });
}
var Fe = F(ie(), 1),
  Zl = 50,
  Ql = { enabled: !0 },
  Fs = ({ menuHeight: e, children: t }) => {
    let o = Zo(),
      n = ta() * tl,
      i = Math.min(n, el);
    return e > i
      ? (0, Fe.jsx)(bp, { children: t })
  ...
  bp = ({ children: e }) => {
    ...
    return (0, Fe.jsxs)("div", {
      className: Hl,
      children: [
        i && !u && (0, Fe.jsx)(ef, { direction: "up", onMouseEnter: f, onMouseLeave: v }),
        (0, Fe.jsx)(sa, {
          ref: o,
          onWheel: v,
          className: ue(i && jl),
          children: (0, Fe.jsxs)("div", {
            className: ql,
            children: [
              (0, Fe.jsx)("div", { ref: r, className: Yl }),
              (0, Fe.jsx)("div", { className: ue(t && Rs), children: e }),
              (0, Fe.jsx)("div", { ref: n, className: Xl }),
            ],
          }),
        }),
        i && !l && (0, Fe.jsx)(ef, { direction: "down", onMouseEnter: d, onMouseLeave: v }),
      ],
    });
  },
  ef = ({ direction: e, onMouseEnter: t, onMouseLeave: o }) =>
    (0, Fe.jsxs)(Qo, {
      gap: 0,
      className: e === "up" ? Bl : Wl,
      children: [
        e === "down" && (0, Fe.jsx)("div", { className: Ul }),
        (0, Fe.jsx)("div", {
          role: "presentation",
          ...
          onMouseLeave: o,
          className: $l,
          children: (0, Fe.jsx)(Fl, { direction: e }),
        }),
        e === "up" && (0, Fe.jsx)("div", { className: Kl }),
      ],
    });
var ti = F(X(), 1);
var gp = !0;
function Hs(e, t) {
  let [o, r] = (0, ti.useState)(() =>
    Tt(e) || t?.every((n) => Tt(n.enabled) || n.enabled === !1) ? gp : e === !1
  );
  return (
    (0, ti.useEffect)(() => {
      let n = !0;
        ...
        C = (0, V.jsxs)(Gn, {
          ...
          children: [
              ...
              (0, V.jsxs)(qn, {
                ...
                render: (P) =>
                  (0, V.jsx)(uf, {
                    ...P,
                    hasSubmenu: !0,
                    className: ue(P.className, l && ys, l && l.padding !== "compact" && Cs),
                  }),
                children: [
            ...
            (0, V.jsx)($n, {
              ...
              ...r,
              [nf]: !0,
              gutter: r?.gutter ?? (x ? ol : rl),
              shift: r?.shift ?? (x ? nl : void 0),
              className: ue(xl, y && yl, r?.className, na),
              style: { width: a },
              render: (P) => (0, V.jsx)(ii, { mode: f, children: (0, V.jsx)("div", { ...P }) }),
              children: (0, V.jsx)(wp, {
                searchValue: s,
                itemsLength: t.length,
                menuHeight: w,
                withinCombobox: p,
                children: (0, V.jsx)(Rp, { items: t, onSelect: i, submenuPlacement: u }),
              }),
            }),
          ],
        });
...
var wp = pe.memo(function ({
    ...
    return (
      ...
      i
            ...
            children: (0, V.jsxs)("div", {
              ...
              children: [
                (0, V.jsxs)("div", {
                  className: wl,
                  children: [
                    (0, V.jsx)("div", { className: El, children: (0, V.jsx)(Al, {}) }),
                    (0, V.jsx)(Xn, {
                      ref: s,
                      autoFocus: !0,
                      autoSelect: !0,
                ...
                (0, V.jsx)(Fs, {
                  ...
                  children: (0, V.jsx)(Xo, {
                    children: (0, V.jsx)(ei, {
                      ...
                      children:
                        r === 0
                          ? (0, V.jsx)("div", { className: Il, children: "No search results" })
                          : t,
                    }),
                  }),
                }),
        ...
        : (0, V.jsx)(ks, {
            withinCombobox: i,
            children: (0, V.jsx)(Fs, { menuHeight: n, children: t }),
          })
    );
  }),
  Pp = (e) => (0, V.jsx)(Yn, { ...e, className: ue(gl, e.className) }),
  of = 14,
  af = ({ icon: e }) => {
...
var uf = pe.memo(
    pe.forwardRef(function ({ ...t }, o) {
      ...
      return (0, V.jsx)("div", {
        ref: r,
        className: ue(sl, oa),
        children: (0, V.jsx)(Ip, { ref: o, wrapperRef: r, ...t }),
      });
    })
  ),
  Ip = pe.memo(
    pe.forwardRef(function (
      ...
      let { closeOnSelect: y, startTime: C, mouseDidMove: P } = Ds(),
        M = Zo(),
        A = pt(),
        R = Hs(f);
      ...
      let _ = pe.useRef(null),
        ...
        E = pe.useCallback(
          (J) => {
            ...
            if (B && J.key === "Enter") {
              (J.preventDefault(),
                J.stopPropagation(),
                A.getState().open ? (h?.(Ep(J)), A.hideAll()) : k());
              return;
            }
        ...
        D = pe.useCallback(
          (J) => (!y || J.currentTarget.hasAttribute("aria-expanded") ? !1 : (A.hideAll(), !0)),
          [y, A]
        ),
        K = pe.useCallback(
          (J) => {
            ...
            !B || !Xs(J.button) || (Ls(P, C) && (O.suppressFor(J.currentTarget), h?.(J), D(J)));
          },
          [h, D, C, P, O, B]
        ),
        I = pe.useCallback(
      ...
      (c
        ? (N.children = (0, V.jsxs)(V.Fragment, {
            children: [
              (0, V.jsx)(ia, { avatar: c.src, displayName: c.displayName }),
        ...
        l &&
          (N.children = (0, V.jsxs)(Qo, {
            ...
            children: [
              ...
              (0, V.jsx)("span", { className: dl, children: l }),
            ],
          })),
        s &&
          !m &&
            ...
            ? (N.children = (0, V.jsxs)(V.Fragment, {
                children: [
                  ...
                  i
                    ...
                    : (0, V.jsx)("span", { className: ue(ml, n), children: r }),
                ],
              }))
            : m
      ...
      return d
        ? (0, V.jsxs)(V.Fragment, {
            children: [
              Se,
              (0, V.jsx)(Op, { anchorRef: R && p ? b : _, className: v, children: d }),
            ],
          })
        : Se;
    })
...
var Op = pe.memo(function ({ anchorRef: t, className: o, children: r }) {
  let n = pt();
...
function cf({ acceleratorLabelTokens: e }) {
  ...
  return (0, V.jsx)("span", {
    ...
    children: e.map((r, n) => {
      ...
      return (0, V.jsxs)(
        "span",
        { className: ll, children: [r, i && (0, V.jsx)("span", { className: fl, children: o })] },
        r
      );
    }),
  });
}
var Rp = pe.memo(({ items: e, onSelect: t, submenuPlacement: o }) => {
  let { reserveCheckmarkColumn: r } = Ds(),
    n = r || e.some((i) => i.type !== "separator" && i.checked === !0 && !i.icon);
  return e.map((i) => {
    let s = i.path.join("+");
    if (i.type === "separator") return (0, V.jsx)(Pp, {}, s);
    let a = ue(n && i.checked !== !0 && !i.icon && hl),
      u = Dp(i);
    if (i.submenu) {
...
function Ls(e, t) {
  return !e || !Us(t) ? !1 : zs.isAutomation ? !0 : performance.now() - t >= 200;
}
var Bs = F(ie(), 1),
  Tp = 10,
...
function fM({
  ...
  let [s, a] = (0, He.useState)(""),
    ...
    c = (0, He.useMemo)(
      () =>
        !e || e.config.searchable === !1 ? !1 : e.config.searchable === !0 ? !0 : df(e.items) > Tp,
      [e]
    ),
    l = (0, He.useDeferredValue)(s),
    m = (0, He.useMemo)(
      () => (!c || !e?.items ? (e?.items ?? []) : ff(l, e.items)),
      [c, e?.items, l]
    ),
    f = Pr({ ...lf, placement: e?.config.placement ?? lf.placement }),
  ...
  let b = (0, He.useCallback)(() => e?.config.location ?? null, [e?.config.location]),
          ...
          kp(() => {
            ...
            (M && r?.(M),
              e?.config.onSelect
                ...
                : P.click
                  ? P.click()
                  : P.role && Js(P.role, { fromContextMenu: !0 }));
          }, o);
      },
      [e, r, o]
    ),
    ...
    y = (0, He.useMemo)(
      () => ({
        ...
        className: ue(Cl, e?.config?.className),
        onKeyDown: n,
        onKeyUp: i,
      }),
...
function mM(e) {
  return e instanceof Element ? !!e.closest(sf) || Ns(e) : !1;
}
function kp(e, t) {
  ...
  try {
    ...
    throw (t?.errorInEventHandler(Ws(o)), o);
  } finally {
    t?.exitEventHandling();
  }
}
...
//# sourceMappingURL=chunk-A4MMFDG2.mjs.map
