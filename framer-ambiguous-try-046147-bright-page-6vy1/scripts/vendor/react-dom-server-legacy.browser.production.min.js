  ...
  (function (w, F) {
    "object" === typeof exports && "undefined" !== typeof module
      ...
      : "function" === typeof define && define.amd
        ...
        : ((w = w || self), F((w.ReactDOMServer = {}), w.React));
  })(this, function (w, F) {
    function l(a) {
      for (
    ...
    function ra(a) {
      if (v.call(sa, a)) return !0;
      if (v.call(ta, a)) return !1;
      if (hb.test(a)) return (sa[a] = !0);
      ta[a] = !0;
      return !1;
    }
    ...
    function jb(a, b, c) {
      switch (b) {
        case "select":
          return y(1, null != c.value ? c.value : c.defaultValue);
        case "svg":
          return y(2, null);
        case "math":
          return y(3, null);
      ...
      return 4 <= a.insertionMode || 0 === a.insertionMode ? y(1, null) : a;
    }
    function ua(a, b, c) {
        ...
        if (v.call(c, d)) {
          ...
          if (null != f && "boolean" !== typeof f && "" !== f) {
            if (0 === d.indexOf("--")) {
              ...
              void 0 !== g
                ? (e = g)
                : ((g = r(e.replace(kb, "-$1").toLowerCase().replace(lb, "-ms-"))),
                  va.set(e, g),
                  (e = g));
              f =
                "number" === typeof f
    ...
    function x(a, b, c, d) {
      ...
      if (!(2 < c.length) || ("o" !== c[0] && "O" !== c[0]) || ("n" !== c[1] && "N" !== c[1]))
        if (((b = p.hasOwnProperty(c) ? p[c] : null), null !== b)) {
          switch (typeof d) {
            case "function":
            case "symbol":
              return;
          ...
          switch (b.type) {
            case 3:
              ...
              break;
            case 4:
              !0 === d ? a.push(" ", c, '=""') : !1 !== d && a.push(" ", c, '="', r(d), '"');
              break;
            case 5:
              isNaN(d) || a.push(" ", c, '="', r(d), '"');
              break;
            case 6:
              !isNaN(d) && 1 <= d && a.push(" ", c, '="', r(d), '"');
              break;
            default:
              (b.sanitizeURL && (d = "" + d), a.push(" ", c, '="', r(d), '"'));
          }
        } else if (ra(c)) {
          switch (typeof d) {
            case "function":
    ...
    function mb(a) {
      var b = "";
      F.Children.forEach(a, function (a) {
        null != a && (b += a);
      });
      return b;
    }
    ...
    function z(a) {
      var b = wa.get(a);
      if (void 0 === b) {
        if (!nb.test(a)) throw Error(l(65, a));
        b = "<" + a;
        wa.set(a, b);
      }
      return b;
      ...
      switch (b) {
        ...
        case "textarea":
          ...
          if (null != t) {
            ...
            if (ba(t) && 1 < t.length) throw Error(l(93));
            e = "" + t;
          }
          "string" === typeof e && "\n" === e[0] && a.push("\n");
          null !== e && a.push(r("" + e));
        ...
        case "input":
          ...
          null !== t ? x(a, d, "checked", t) : null !== m && x(a, d, "checked", m);
        ...
        case "missing-glyph":
          return aa(a, c, b, d);
        case "html":
          return (0 === f.insertionMode && a.push("<!DOCTYPE html>"), aa(a, c, b, d));
        default:
          if (-1 === b.indexOf("-") && "string" !== typeof c.is) return aa(a, c, b, d);
          a.push(z(b));
          g = e = null;
          for (n in c)
            if (v.call(c, n) && ((h = c[n]), null != h))
              switch (n) {
                case "children":
                  e = h;
                  break;
    ...
    function ya(a, b, c, d) {
      ...
      "" === b ? (a = d) : (d && a.push("\x3c!-- --\x3e"), a.push(r(b)), (a = !0));
      return a;
    }
    function da(a) {
      ...
      if ("object" === typeof a)
        switch (a.$$typeof) {
          ...
          case Ha:
            ...
            return a;
          case Ia:
            return ((b = a.displayName || null), null !== b ? b : da(a.type) || "Memo");
          case ea:
            b = a._payload;
            a = a._init;
            try {
    ...
    function Na(a, b) {
      ...
      a.depth === b.depth ? N(a, b) : Na(a, b);
    }
    function Oa(a, b) {
      var c = b.parent;
      if (null === c) throw Error(l(402));
      a.depth === c.depth ? N(a, c) : Oa(a, c);
      b.context._currentValue2 = b.value;
    }
    function O(a) {
      var b = D;
    ...
    function Pa(a, b, c, d) {
      ...
      "function" === typeof g &&
        ((g = g(c, f)), (f = null === g || void 0 === g ? f : G({}, f, g)), (a.state = f));
      if (
        ...
        if (
          ...
          b !== a.state && Qa.enqueueReplaceState(a, a.state, null),
    ...
    function fa(a, b, c) {
      ...
      if (30 < e) {
        ...
        d >>= g;
        f -= g;
        return { id: (1 << (32 - P(b) + f)) | (c << f) | d, overflow: e + a };
      }
      return { id: (1 << e) | (c << f) | d, overflow: a };
    }
    function tb(a) {
      a >>>= 0;
      return 0 === a ? 32 : (31 - ((ub(a) / vb) | 0)) | 0;
    }
    function wb(a, b) {
    ...
    function Ta(a, b, c) {
      ...
      a = a === Sa ? ("function" === typeof b ? b() : b) : void 0 !== c ? c(b) : b;
      k.memoizedState = a;
      a = k.queue = { last: null, dispatch: null };
      a = a.dispatch = xb.bind(null, B, a);
    ...
    function Bb(a, b, c, d, f, e, g, h, m) {
      ...
      b = {
        ...
        completedBoundaries: [],
        partialBoundaries: [],
        onError: void 0 === f ? Ab : f,
        onAllReady: void 0 === e ? I : e,
        onShellReady: void 0 === g ? I : g,
        onShellError: void 0 === h ? I : h,
        onFatalError: void 0 === m ? I : m,
      };
      c = U(b, 0, null, c, !1, !1);
      c.parentFlushed = !0;
      a = ka(b, a, null, c, l, Ka, null, Cb);
      n.push(a);
      return b;
    }
    function ka(a, b, c, d, f, e, g, h) {
      a.allPendingTasks++;
    ...
    function Wa(a, b, c, d, f) {
      ...
      ja = b;
      K = 0;
      for (a = c(d, f); S;) ((S = !1), (K = 0), (Q += 1), (k = null), (a = c(d, f)));
      ia();
      return a;
    }
    function Xa(a, b, c, d, f) {
      f = c.render();
      var e = d.childContextTypes;
      if (null !== e && void 0 !== e) {
        var g = b.legacyContext;
        if ("function" !== typeof c.getChildContext) d = g;
        else {
          c = c.getChildContext();
          for (var h in c) if (!(h in e)) throw Error(l(108, da(d) || "Unknown", h));
          d = G({}, g, c);
        }
        b.legacyContext = d;
        u(a, b, f);
    ...
    function la(a, b, c, d, f) {
      if ("function" === typeof c)
        if (c.prototype && c.prototype.isReactComponent) {
          f = Ja(c, b.legacyContext);
          var e = c.contextType;
          e = new c(d, "object" === typeof e && null !== e ? e._currentValue2 : f);
          Pa(e, c, d, f);
          Xa(a, b, e, c);
        } else {
          e = Ja(c, b.legacyContext);
          f = Wa(a, b, c, d, e);
          var g = 0 !== K;
          if (
            "object" === typeof f &&
            ...
            (Pa(f, c, d, e), Xa(a, b, f, c));
          else if (g) {
            d = b.treeContext;
            b.treeContext = fa(d, 1, 0);
            try {
              u(a, b, f);
            } finally {
              b.treeContext = d;
        ...
        f = b.blockedSegment;
        e = ob(f.chunks, c, d, a.responseState, f.formatContext);
        f.lastPushedText = !1;
        g = f.formatContext;
        f.formatContext = jb(g, c, d);
        ma(a, b, e);
        f.formatContext = g;
        switch (c) {
          case "area":
          ...
          case Da:
            a: {
              ...
              var h = {
                ...
                m = U(a, f.chunks.length, h, f.formatContext, !1, !1);
              f.children.push(m);
              f.lastPushedText = !1;
              var n = U(a, 0, null, f.formatContext, !1, !1);
              n.parentFlushed = !0;
              b.blockedBoundary = h;
              b.blockedSegment = n;
              try {
                ...
                ((n.status = 4), (h.forceClientRender = !0), (h.errorDigest = J(a, t)));
              } finally {
                ((b.blockedBoundary = c), (b.blockedSegment = f));
              }
              b = ka(a, e, c, m, g, b.legacyContext, b.context, b.treeContext);
        ...
        if ("object" === typeof c && null !== c)
          switch (c.$$typeof) {
            case Ha:
              d = Wa(a, b, c.render, d, f);
              if (0 !== K) {
                c = b.treeContext;
                b.treeContext = fa(c, 1, 0);
                try {
                  u(a, b, d);
                } finally {
                  b.treeContext = c;
            ...
            case Ga:
              ...
              d = a.parentValue;
              a.context._currentValue2 = d === Gb ? a.context._defaultValue : d;
              a = D = a.parent;
              b.context = a;
              return;
            case Fa:
    ...
    function u(a, b, c) {
      ...
      if ("object" === typeof c && null !== c) {
        ...
        null === c || "object" !== typeof c
          ? (d = null)
          : ((d = ($a && c[$a]) || c["@@iterator"]), (d = "function" === typeof d ? d : null));
        if (d && (d = d.call(c))) {
          c = d.next();
          if (!c.done) {
            var f = [];
      ...
      "string" === typeof c
        ? ((d = b.blockedSegment),
          (d.lastPushedText = ya(b.blockedSegment.chunks, c, a.responseState, d.lastPushedText)))
        : "number" === typeof c &&
          ((d = b.blockedSegment),
          (d.lastPushedText = ya(
    ...
    function ma(a, b, c) {
      ...
      try {
        ...
        if ((ia(), "object" === typeof m && null !== m && "function" === typeof m.then)) {
          c = m;
    ...
    function ab(a, b, c) {
      if (null === b) {
        ...
        a.pendingRootTasks--;
        0 === a.pendingRootTasks && ((a.onShellError = I), (b = a.onShellReady), b());
      } else
        (b.pendingTasks--,
          b.forceClientRender ||
            (0 === b.pendingTasks
              ? (c.parentFlushed && 1 === c.status && W(b, c),
                b.parentFlushed && a.completedBoundaries.push(b),
                b.fallbackAbortableTasks.forEach(Ib, a),
    ...
    function Va(a) {
      if (2 !== a.status) {
        ...
        try {
            ...
            if (0 === m.status) {
              ...
              try {
                (u(h, g, g.node),
                  ...
                  g.abortSet.delete(g),
                  (m.status = 1),
                  ab(h, g.blockedBoundary, m));
              } catch (C) {
                if ((ia(), "object" === typeof C && null !== C && "function" === typeof C.then)) {
                  var l = g.ping;
                  C.then(l, l);
                } else {
                  g.abortSet.delete(g);
                  m.status = 4;
                  var k = g.blockedBoundary,
                    p = C,
                    q = J(h, p);
                  null === k
                    ? V(h, p)
                    : (k.pendingTasks--,
                      k.forceClientRender ||
                        ...
                        (k.errorDigest = q),
                        k.parentFlushed && h.clientRenderedBoundaries.push(k)));
                  h.allPendingTasks--;
          ...
          f.splice(0, e);
          null !== a.destination && oa(a, a.destination);
        } catch (C) {
          (J(a, C), V(a, C));
        } finally {
          ((X = d), (na.current = c), c === cb && O(b));
        }
      }
    }
    function Y(a, b, c) {
      ...
      if (d.forceClientRender)
        return (
          a.responseState.generateStaticMarkup ||
            ...
            b.push("\x3c!--$!--\x3e"),
            b.push("<template"),
            d && (b.push(' data-dgst="'), (d = r(d)), b.push(d), b.push('"')),
            b.push("></template>")),
          Y(a, b, c),
    ...
    function eb(a, b, c) {
      for (var d = c.completedSegments, f = 0; f < d.length; f++) fb(a, b, c, d[f]);
      d.length = 0;
      a = a.responseState;
      d = c.id;
      c = c.rootSegmentID;
    ...
    function gb(a, b, c, d) {
      ...
      a = Bb(
        a,
        sb(c, b ? b.identifierPrefix : void 0),
    ...
    [
      ...
      var b = a[0];
      p[b] = new q(b, 1, !1, a[1], null, !1, !1);
    });
    ["contentEditable", "draggable", "spellCheck", "value"].forEach(function (a) {
      p[a] = new q(a, 2, !1, a.toLowerCase(), null, !1, !1);
    });
    ["autoReverse", "externalResourcesRequired", "focusable", "preserveAlpha"].forEach(
      function (a) {
        p[a] = new q(a, 2, !1, a, null, !1, !1);
      }
    );
    "allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope"
      .split(" ")
      .forEach(function (a) {
        p[a] = new q(a, 3, !1, a.toLowerCase(), null, !1, !1);
      });
    ["checked", "multiple", "muted", "selected"].forEach(function (a) {
      p[a] = new q(a, 3, !0, a, null, !1, !1);
    });
    ["capture", "download"].forEach(function (a) {
      p[a] = new q(a, 4, !1, a, null, !1, !1);
    });
    ["cols", "rows", "size", "span"].forEach(function (a) {
      p[a] = new q(a, 6, !1, a, null, !1, !1);
    });
    ["rowSpan", "start"].forEach(function (a) {
      p[a] = new q(a, 5, !1, a.toLowerCase(), null, !1, !1);
    });
    var pa = /[\-:]([a-z])/g,
      qa = function (a) {
    ...
    "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height"
      ...
      .forEach(function (a) {
        ...
        p[b] = new q(b, 1, !1, a, null, !1, !1);
      });
    "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type"
      .split(" ")
      .forEach(function (a) {
        var b = a.replace(pa, qa);
        p[b] = new q(b, 1, !1, a, "http://www.w3.org/1999/xlink", !1, !1);
      });
    ["xml:base", "xml:lang", "xml:space"].forEach(function (a) {
      var b = a.replace(pa, qa);
      p[b] = new q(b, 1, !1, a, "http://www.w3.org/XML/1998/namespace", !1, !1);
    });
    ["tabIndex", "crossOrigin"].forEach(function (a) {
      p[a] = new q(a, 1, !1, a.toLowerCase(), null, !1, !1);
    });
    p.xlinkHref = new q("xlinkHref", 1, !1, "xlink:href", "http://www.w3.org/1999/xlink", !0, !1);
    ["src", "href", "action", "formAction"].forEach(function (a) {
      p[a] = new q(a, 1, !1, a.toLowerCase(), null, !0, !0);
    });
    var L = {
    ...
    var ib = /["'&<>]/,
      ...
      Fb = Symbol.for("react.scope"),
      Eb = Symbol.for("react.debug_trace_mode"),
      Db = Symbol.for("react.legacy_hidden"),
      Gb = Symbol.for("react.default_value"),
      $a = Symbol.iterator,
      Ka = {},
      D = null,
      Qa = {
      ...
      Cb = { id: 1, overflow: "" },
      P = Math.clz32 ? Math.clz32 : tb,
      ub = Math.log,
      vb = Math.LN2,
      yb = "function" === typeof Object.is ? Object.is : wb,
      B = null,
      ja = null,
      R = null,
      k = null,
      ...
      cb = {
        ...
        useId: function () {
          var a = ja.treeContext;
          var b = a.overflow;
          a = a.id;
          a = (a & ~(1 << (32 - P(a) - 1))).toString(32) + b;
          var c = X;
      ...
      X = null,
      na = F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;
    w.renderToNodeStream = function () {
      throw Error(l(207));
    };
    w.renderToStaticMarkup = function (a, b) {
      return gb(
        a,
        b,
        !0,
    ...
    w.renderToStaticNodeStream = function () {
      throw Error(l(208));
    };
    w.renderToString = function (a, b) {
      return gb(
        a,
        b,
        !1,
