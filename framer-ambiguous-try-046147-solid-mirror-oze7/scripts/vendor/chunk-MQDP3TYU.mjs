import { a as te, c as ie, e as Be, f as Ct, i as Ot, j as wt } from "chunk-3HBIYPN4.mjs";
import { r as Dt, s as kt, y as qn } from "chunk-VHFKZWVR.mjs";
import { a as Wn, b as At, d as Yn, i as zn } from "chunk-VJ7UYMJI.mjs";
var Pt = class {
    get log() {
...
function wg({ name: e, security: t }) {
  Ro ||
    ((Ro = !0),
    Wn(({ error: n, tags: r, extras: o, fingerprint: i, critical: s }) => {
      ye((a) => {
        (a.setTags(r),
          o && a.setExtras(o),
...
//# sourceMappingURL=chunk-MQDP3TYU.mjs.map
