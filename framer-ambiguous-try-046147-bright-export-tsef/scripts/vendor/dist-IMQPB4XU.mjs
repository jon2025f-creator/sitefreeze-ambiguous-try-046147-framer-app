import { A as C, r as v } from "chunk-5XGI6M6M.mjs";
...
var m = class {
  constructor(e, t) {
    ...
    ((this.editorView = e),
      ...
      (this.element = null),
      (this.timeout = -1),
      (this.width = (i = t.width) !== null && i !== void 0 ? i : 1),
  ...
  updateOverlay() {
    let e = this.editorView.state.doc.resolve(this.cursorPos),
      ...
      i,
      o = this.editorView.dom,
      d = o.getBoundingClientRect(),
      r = d.width / o.offsetWidth,
      h = d.height / o.offsetHeight;
    if (t) {
      let s = e.nodeBefore,
        n = e.nodeAfter;
      if (s || n) {
        ...
        if (a) {
          ...
          s &&
            n &&
            (u = (u + this.editorView.nodeDOM(this.cursorPos).getBoundingClientRect().top) / 2);
          let w = (this.width / 2) * h;
          i = { left: c.left, right: c.right, top: u - w, bottom: u + w };
        }
      }
    }
    if (!i) {
    ...
    if (!l || (l == document.body && getComputedStyle(l).position == "static"))
      ...
      let s = l.getBoundingClientRect(),
        n = s.width / l.offsetWidth,
        a = s.height / l.offsetHeight;
      ((f = s.left - l.scrollLeft * n), (p = s.top - l.scrollTop * a));
    }
    ((this.element.style.left = (i.left - f) / r + "px"),
      (this.element.style.top = (i.top - p) / h + "px"),
      (this.element.style.width = (i.right - i.left) / r + "px"),
      (this.element.style.height = (i.bottom - i.top) / h + "px"));
  }
  scheduleRemoval(e) {
  ...
  dragover(e) {
    ...
    let t = this.editorView.posAtCoords({ left: e.clientX, top: e.clientY }),
      i = t && t.inside >= 0 && this.editorView.state.doc.nodeAt(t.inside),
      o = i && i.type.spec.disableDropCursor,
      d = typeof o == "function" ? o(this.editorView, t, e) : o;
    if (t && !d) {
      let r = t.pos;
...
//# sourceMappingURL=dist-IMQPB4XU.mjs.map
