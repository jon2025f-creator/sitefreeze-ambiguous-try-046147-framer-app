import { a as Hn, h as On } from "chunk-HFLAFPWM.mjs";
import { $d as Ln, Gd as An, Yd as p, Zd as ln, ae as Dn, u as nn } from "chunk-ZELQ7EFH.mjs";
import { Kj as fn, lb as Fn } from "chunk-KZ3J5BLF.mjs";
import { a as Pn } from "chunk-7BWPFUCH.mjs";
import { q as _n } from "chunk-6IRUXYG7.mjs";
import { l as G } from "chunk-6BQLHAAI.mjs";
import { h as Mn } from "chunk-KPMZENE5.mjs";
function Vn(n) {
  let e = Object.create(Object.prototype);
  return (
    (e.master = n.master),
    n.inheritsFrom && (e.inheritsFrom = n.inheritsFrom),
    (e.overrides = kn(n.overrides)),
    e
  );
}
function kn(n) {
  ...
  if (Array.isArray(n)) {
    let e = [];
    for (let t = 0; t < n.length; t++) e[t] = kn(n[t]);
    return e;
  }
  if (typeof n == "object") {
    let e = Object.create(Object.prototype);
    for (let t in n) {
      let d = n[t];
      t === "styledText" && d && typeof d.toJS == "function" ? (e[t] = d.toJS()) : (e[t] = kn(d));
    }
    return e;
  }
  return n;
...
function i(n, e) {
  if (e.replicaInfo) n.children = [];
    ...
    let t = (n.children = []);
    for (let d of e.children) t.push(M(d));
  }
}
function f(n, e) {
...
function on(n, e) {
  ((n.isExternalMaster = e.isExternalMaster),
    ...
    (n.replicaInfo = e.replicaInfo ? Vn(e.replicaInfo) : null));
}
function rn(n, e) {
...
function ft(n, e) {
  (o(n, e), f(n, e), Jn(n, e), jn(n, e), ze(n, e));
  for (let t in e) t.startsWith("$control__") && (n[t] = e[t]);
}
function lt(n, e) {
  (o(n, e), i(n, e), f(n, e), Z(n, e), ne(n, e), Ye(n, e));
...
function pt(n, e) {
  (o(n, e), i(n, e), Jn(n, e), ne(n, e), Ve(n, e));
}
function Yn(n, e) {
  (o(n, e), i(n, e), f(n, e));
}
...
function Tt(n, e) {
  (o(n, e), i(n, e), te(n, e), je(n, e));
}
function mt(n, e) {
  (o(n, e), i(n, e), an(n, e), Cn(n, e), Kn(n, e), te(n, e), Ne(n, e));
}
function gt(n, e) {
  (o(n, e), i(n, e), $(n, e), $n(n, e), Re(n, e));
}
function ut(n, e) {
  (o(n, e),
    w(n, e),
...
function Ct(n, e) {
  (o(n, e), i(n, e), ie(n, e), Je(n, e));
}
function Et(n, e) {
  (o(n, e), Se(n, e));
}
function yt(n, e) {
  (o(n, e), i(n, e), $(n, e), Tn(n, e), De(n, e));
}
function Nt(n, e) {
  (o(n, e), i(n, e), f(n, e), w(n, e), x(n, e), g(n, e), z(n, e), B(n, e));
}
function It(n, e) {
  (o(n, e), i(n, e), f(n, e), w(n, e), x(n, e), z(n, e), B(n, e), Te(n, e));
}
function zt(n, e) {
  (o(n, e), i(n, e), f(n, e), O(n, e), Z(n, e), gn(n, e), Gn(n, e));
}
function Bt(n, e) {
  (o(n, e), i(n, e), f(n, e), qn(n, e), Ee(n, e));
}
function Rt(n, e) {
  (o(n, e), He(n, e));
}
...
function _t(n, e) {
  (o(n, e), i(n, e), N(n, e), on(n, e), sn(n, e), $e(n, e));
}
function Ft(n, e) {
  (o(n, e),
    c(n, e),
...
function Ht(n, e) {
  (o(n, e), i(n, e), $(n, e), Tn(n, e), $n(n, e));
}
function Ot(n, e) {
  (o(n, e), i(n, e), $(n, e), Tn(n, e), bn(n, e), Pe(n, e));
}
function Vt(n, e) {
  (o(n, e),
    i(n, e),
...
function Yt(n, e) {
  (o(n, e), i(n, e), ae(n, e), nt(n, e));
  for (let t in e) t.startsWith("$plugin__") && (n[t] = e[t]);
}
function Xt(n, e) {
  (o(n, e), i(n, e), yn(n, e), Ae(n, e));
}
function Wt(n, e) {
  (o(n, e), i(n, e), Qe(n, e));
}
...
function Kt(n, e) {
  (o(n, e), i(n, e), c(n, e), l(n, e), k(n, e), u(n, e), S(n, e), H(n, e));
}
function $t(n, e) {
  (o(n, e), i(n, e), Le(n, e));
}
function Jt(n, e) {
  (o(n, e), i(n, e), f(n, e), h(n, e), O(n, e), Z(n, e), gn(n, e), xn(n, e), Gn(n, e), Be(n, e));
  for (let t in e) t.startsWith("$plugin__") && (n[t] = e[t]);
}
function Zt(n, e) {
  (o(n, e),
...
function Qt(n, e) {
  (o(n, e), i(n, e), f(n, e), w(n, e), x(n, e), z(n, e), K(n, e), he(n, e));
}
function bt(n, e) {
  (o(n, e), i(n, e), f(n, e), on(n, e), wn(n, e), Xn(n, e), Wn(n, e), Zn(n, e), ye(n, e));
  for (let t in e) t.startsWith("$plugin__") && (n[t] = e[t]);
}
function vt(n, e) {
  (o(n, e), i(n, e), f(n, e), O(n, e), Z(n, e));
}
function jt(n, e) {
  (o(n, e),
    i(n, e),
...
var eo = "generated";
function to(n) {
  return no(n) && eo in n && n.generated === !0;
}
function de(n) {
  return typeof n == "string" || to(n) ? n : null;
}
function cn(n, e) {
  if (n.charCodeAt(0) < 109) {
    let d = n.length < 2 ? -1 : n.charCodeAt(1);
    if (d !== -1 && d < 111) {
      let r = n.length < 3 ? -1 : n.charCodeAt(2);
      if (r !== -1 && r < 110) {
        if (n === "fillConicGradient") return p(e);
        if (n === "fillLinearGradient") return p(e);
        if (n === "fillRadialGradient") return p(e);
      } else {
        if (n === "centerAnchorX") return In(e);
        if (n === "centerAnchorY") return In(e);
      }
    } else {
      let r = n.length < 3 ? -1 : n.charCodeAt(2);
      if (r !== -1 && r < 114) {
        if (n === "guidesX") return ln(Array.isArray(e) ? e : []);
        if (n === "guidesY") return ln(Array.isArray(e) ? e : []);
        if (n === "exportOptions") return p(e);
      } else {
        if (n === "formBooleanInputCheckedBoxShadow") return p(e);
        if (n === "formInputFocusedBoxShadow") return p(e);
        if (n === "boxShadows") return p(e);
      }
    }
  } else {
    let d = n.length < 2 ? -1 : n.charCodeAt(1);
    if (d !== -1 && d < 104) {
      let r = n.length < 3 ? -1 : n.charCodeAt(2);
      if (r !== -1 && r < 115) {
        if (n === "name") return de(e);
        if (n === "replicaInfo") return Ln(e);
      } else {
        if (n === "masks") return Dn(e);
        if (n === "pathSegments") return p(e);
      }
    } else {
      let r = n.length < 3 ? -1 : n.charCodeAt(2);
      if (r !== -1 && r < 105) {
        if (n === "shadows") return p(e);
        if (n === "previewSettings") return p(e);
      } else {
        if (n === "whileHoverBoxShadow") return p(e);
        if (n === "whileTapBoxShadow") return p(e);
        if (n === "styledText") return p(e);
      }
    }
  }
  return e;
...
var b = Object.values({ valueFromNode: M, reviveProperty: cn }).every((n) => n !== se);
function ce(n, e, t) {
  n.setProp(e, t);
}
function fe(n, e, t, d = !1) {
  let r = null,
    v = Fn(e),
    q = !1;
  for (let s in t) {
    ...
    let C = s;
    if (C === "id" || C === "__class") continue;
    let y = t[s];
    if (s === "replicaInfo" && y) {
      let I = e.replicaInfo;
      if (I?.master === y.master && I?.inheritsFrom === y.inheritsFrom) continue;
      y = { ...y, overrides: I?.overrides ?? {} };
    }
    if (Hn(s, e[C], y)) continue;
    r || (r = e.asDraft(n));
    let U = cn(s, y);
    (s.startsWith("$") ? r.setProp(s, U) : ce(r, C, U), (q ||= v && fn(s)));
  }
  let j = t._deleted;
  if (j)
    for (let s of j) {
      ...
      C === "id" ||
        ...
        (e[C] !== void 0 &&
          (r || (r = e.asDraft(n)),
          On(s) ? r.deleteProp(s) : d ? r.resetToDefault(s) : ce(r, C, void 0),
          (q ||= v && fn(s))));
    }
  return (q && e.cache.controlPropVersion++, r);
}
var W = Mn("tree-library");
function oo() {
  if (!G.isDebugBuild) return;
  !b && G.isTest;
}
function io() {
  if (!b || !G.isDebugBuild) return !0;
  for (let n of An()) if (!Pn(M(n), nn.generics.valueFromNode(n))) return !1;
  return !0;
}
function ro(n) {
  oo();
  ...
  if (
    (b
      ? e
        ? G.isDebugBuild
          ? W.debug("FastTreeLibrary build and up to date.")
          : W.debug("FastTreeLibrary build found.")
        : W.warn(
  ...
  let d = _n.isOn("fastTreeLibrary") && !!1;
  if ((W.debug("setup:", d ? "useFast" : "generic"), d)) {
    if (n.mode === "fast") return;
    n.updateIntegration("fast", { valueFromNode: M, updateNode: fe });
  } else {
    if (n.mode === "generic") return;
    n.resetIntegration();
  }
...
function le(n, e) {
  return e.map((t) => {
    if (!t) return null;
    let d = t["Average Time (ns)"];
    if (!d) return t;
    if (t["Task Name"] === "baseline") t.Faster = "-";
    else {
      let r = d / 1e6;
      t.Faster = (n / r).toFixed(2);
    }
    return (
      delete t.Margin,
      delete t["Average Time (ns)"],
      (t["Average Time (s)"] = (d / 1e9).toFixed(3)),
      t
    );
  });
}
async function ao(n) {
  let { default: e } = await import("https://app.framerstatic.com/dist-2WCISAY3.mjs"),
    t = new e();
  (t.add("baseline", () => nn.generics.valueFromNode(n)),
    t.add("new", () => M(n)),
    await t.warmup(),
    await t.run());
  let d = le(t.results[0]?.mean ?? 0, t.table()),
    r = [...n.walk()].length;
  (console.log(`Results for serializing ${n.__class} with ${r} nodes`), console.table(d));
}
async function so(n, e) {
  let {
      ...
      loadOneRootChild: d,
      TreeAssembler: r,
    } = await import("https://app.framerstatic.com/partialDocument-FWKTANJN.mjs"),
    { VekterEngine: v } = await import("https://app.framerstatic.com/VekterEngine-2ONOCOKW.mjs"),
    { DocumentParser: q } =
    ...
    { default: s } = await import("https://app.framerstatic.com/dist-2WCISAY3.mjs"),
    C = j(n.toJS()),
    y = new q(C),
    U = () => {
      let zn = new v(),
        pe = t(y, zn.componentLoader, e),
        Bn = new Map();
      for (; !d(y, Bn););
      let Rn = new r(zn, pe, Bn);
      for (; !Rn.assembleOnePage(););
      Rn.buildCompleteTree();
    };
  ...
  (I.add("baseline", U),
    ...
    console.log("run"),
    await I.run());
  let ke = le(I.results[0]?.mean ?? 0, I.table());
  console.table(ke);
}
export { ao as a, so as b, ro as c };
//# sourceMappingURL=chunk-L33RXXDO.mjs.map
