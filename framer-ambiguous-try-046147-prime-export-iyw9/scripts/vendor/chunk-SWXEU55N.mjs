import { a as h } from "chunk-7UYVZYL3.mjs";
import { a as ye, t as V, u as L } from "chunk-2XYJYMIT.mjs";
import {
  b as i,
  c as k,
  fs as fe,
...
import { p as Me } from "chunk-QVHG2R47.mjs";
import { y as ne } from "chunk-DTSMQR7C.mjs";
import { b as H } from "chunk-LA34HORX.mjs";
import { b as x } from "chunk-4JY5UMT2.mjs";
import { i as C } from "chunk-VJ7UYMJI.mjs";
...
function S(
  e,
  t,
  { identifierPrefix: o, packageInfo: n, file: u, moduleIdentifier: a, update: f },
  y
) {
  let l;
  a
  ...
  if ((Ve(t) && (s.name = t.displayName), p === "data")) {
    let r = s,
      g = c(t);
    return (
      g
  ...
  if (A(s))
    return (
      E(t) && E(t.propertyControls) && (s.properties = V(Ne(t.propertyControls))),
...
function Ve(e) {
  if ((!E(e) && !He(e)) || !("displayName" in e)) return !1;
  let t = e.displayName;
...
var Ie = class {
  ...
  errorForIdentifier(t) {
    ...
    if (b(o) || (u && this.localModulesInitialized)) {
      let f = "Component does not exist.";
      return (
        b(o) && o.type === "codeFile" && (f = "Component file does not exist."),
        h(t, f, { fileDoesNotExist: !0 })
      );
    }
    return null;
  }
...
async function Ao(e, t, o, n, u, a) {
  let { file: f, debugName: y } = $e(t, u),
    l = Ke(o);
  if (l) {
    ee.error("Error in", y, ":", l);
    let m = D(t),
      d = h(m, l.message, { file: f });
    n.push(d);
    return;
  }
  ...
  await Promise.all(
    Object.entries(s).map(async ([m, d]) => {
      let r;
      switch (d.type) {
        case "override":
          r = "override";
...
export { Ie as a, Ao as b, $e as c, Ke as d, To as e, Fo as f, Oo as g, Po as h, No as i };
//# sourceMappingURL=chunk-SWXEU55N.mjs.map
