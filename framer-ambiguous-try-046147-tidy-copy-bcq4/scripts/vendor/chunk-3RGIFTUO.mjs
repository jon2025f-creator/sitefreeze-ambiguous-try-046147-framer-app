...
import { b as rj } from "chunk-FCTIHBDR.mjs";
import { V as KA, X as CA, Y as xA } from "chunk-2T3LV3JH.mjs";
import { Rb as C } from "chunk-BI6CB6GF.mjs";
import { s as H } from "chunk-7ZCOVLUS.mjs";
import { a as AA } from "chunk-OOA4IV6W.mjs";
import { g as N } from "chunk-UP54SRFV.mjs";
import {
  Bw as TA,
  De as _A,
  Ew as qA,
...
import { b as hA } from "chunk-OZWGB5BP.mjs";
import {
  Ao as yA,
  Ca as O,
  Ea as dA,
...
import { c as h, d as LA } from "chunk-JGLE5AEB.mjs";
import { f as R } from "chunk-YUU3UMLD.mjs";
import { a as XA } from "chunk-GBWZWM2Q.mjs";
import { a as m } from "chunk-6TFWVVAP.mjs";
import { g as RA } from "chunk-CGZFAXEO.mjs";
...
async function y() {
  if (!w) {
    let A = new Worker(hA("./modulesCompilerWorker.js")),
      j = SA(A);
    ((w = j
...
function F6(A, j, t, r, { shouldOpenPage: e = !0, renamedIds: k = new f() } = {}) {
  ...
  return (
    A.stores.persistedUserDefaults.newContentAsDraft &&
      a.set({ isDraft: !0, duplicatedFrom: fA(a.duplicatedFrom, j.id) }),
...
async function $j(
  ...
  if (l.ok) {
    ...
    for (let E of l.value.relative) {
      let g = PA(E.specifier, `${t.module.type}/`);
      if (!g) {
...
function dj(A, j, t, r) {
  j.stores.canvasStore.invalidateTransformUntilRendered(() => {
    ...
    e &&
      ...
      j.stores.canvasStore.zoomToCenter(bA(j.tree, e), { animated: !1, maxZoom: 1 }));
  });
}
function Dj(A, j) {
...
function F7(A, j, t, r) {
  for (let e of A.variables) {
    if (e.type === "divider" || !yA(e)) continue;
...
//# sourceMappingURL=chunk-3RGIFTUO.mjs.map
