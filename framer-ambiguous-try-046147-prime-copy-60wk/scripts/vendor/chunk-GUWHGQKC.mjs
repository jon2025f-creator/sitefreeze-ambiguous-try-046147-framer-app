...
var Ls = ["__class", "isMaster", "isFormContainer", "replicaInfo", "master", "dataIdentifier"],
  Ps = ["__class"],
  gt = class s {
    table;
    branchData;
      ...
      (n instanceof _e
        ? (this.withTiming("latest_index", () =>
          ...
          this.withTiming("hierarchy_latest_replay", () => {
            let i = this.hierarchyMode === "full" ? Ls : Ps;
...
//# sourceMappingURL=chunk-GUWHGQKC.mjs.map
