...
function $n(s) {
  ...
  for (let n = 0; n < r.length; n++) {
    ...
    if (o === "parentid") {
      ...
      if ((l(typeof u == "string", () => `parentid is not a string for row: ${i}`), wt(u)))
        continue;
      let f = new Map(),
        p;
      for (let m = n + 1; m < r.length; m++) {
        ...
        let O = e.key.get(g),
          j = e.id.get(g),
          ne = e.value.get(g);
        if (t.has(g) || typeof O != "number" || j !== `${u}.children` || ne === Ve || ne === It)
          continue;
        p === void 0 && (p = M);
        let ae = Sr(ne);
        (l(ae, () => `should be a valid object reference: ${JSON.stringify(ne)}`),
          ae === a ? e.value._set(i, wr(u, O)) : f.set(ae, O),
          t.add(g));
      }
      for (let m of f.keys()) {
        let g;
    ...
    if (!t.has(i) && a.endsWith(".children") && h && typeof o == "number") {
      ...
      for (let p = n + 1; p < r.length; p++) {
        let m = r[p];
        if (e.client.get(m) !== d) continue;
        if (e.seq.get(m) !== u) break;
        let M = e.key.get(m),
          O = e.id.get(m);
        if (M !== "parentid" || O !== h) continue;
        let j = e.value.get(m);
        if (
          !wt(j) &&
...
function ii(s) {
  ...
  if (e.client instanceof E || e.client instanceof P) {
    ...
    for (let r in t) t[r] = qr(t[r]);
  } else
    for (let t = 0; t < e.length; ++t) {
      let r = e.client.get(t);
      e.client._set(t, qr(r));
    }
}
var Lr = { description: "Migrates row `client` to u32", migrate: ii };
function qr(s) {
  return s >>> 0;
}
var Re = 62,
  ...
  for (let [t, r] of e) {
    ...
    for (let o = 0; o < n.length; o++) {
      ...
      for (let u of c) {
        ...
        let f = de([{ position: a, client: s.client.get(u) }]);
...
function Si(s) {
  ...
  for (let [r, n] of t) {
    ...
    for (let h of n.referenceRowIdx) e.id._set(h, N);
    n.itemRowIdxs.sort((h, u) => {
      let f = e.seq.get(h),
        p = e.seq.get(u);
      if (f < p) return -1;
      if (f > p) return 1;
      let m = e.client.get(h),
        g = e.client.get(u);
...
function Ci(s) {
  ...
  for (let [n, i] of r) {
    ...
    for (let d = 0; d < i.length; d++) {
      ...
      let u = e.key.get(c);
      l(u !== Gr, () => `array reference key cannot be $keep: ${u}`);
      let f = e.value.get(c);
      if (
        (l(
          f === y || zt(f),
    ...
    for (let d = 0; d < i.length; d++) {
      ...
      if (u === y) {
        ...
        let m = o.get(p);
        h === m ? e.key._set(c, p) : e.id._set(c, _t);
        continue;
      }
      l(zt(u), () => `array reference value must be object reference: ${JSON.stringify(u)}`);
      let f = u.slice(4, -1);
      (e.key._set(c, f), e.value._set(c, h));
    }
  }
}
function xi(s) {
  ...
  Ne = class s {
    ...
    add(e) {
      ...
      return n
        ? n.add(r)
          ? ((this._count += 1),
            n instanceof D && n.count > nn && this.containers.set(t, qi(n)),
            !0)
          : !1
    ...
    andNot(e) {
      ...
      for (let r of this.keys) {
        ...
        let o = rn(n, i);
        o &&
          (o instanceof z && o.count <= nn && (o = Li(o)),
    ...
    *[Symbol.iterator]() {
      for (let e of this.keys) {
        ...
        if (t) for (let r of t) yield (((e << Lt) >>> 0) + r) >>> 0;
      }
    }
    serialize(e) {
  ...
  andNot(e) {
    ...
    for (let r of Q(this.seqMapByClient)) {
      ...
      for (let d of Q(n)) {
        ...
        if (!c) continue;
        let h = i?.get(d),
          u = h ? c.andNot(h) : c.clone();
        u.count <= 0 || (o.set(d, u), (a += u.count));
      }
...
function Fi(s) {
  ...
  for (let [n, i] of e) {
    ...
    for (let [a, d] of i) {
      ...
      for (let h in d) {
        let u = d[h];
        (S(u.parentFrom) && (u.parentFrom = v(u.parentFrom)),
          S(u.parentTo) && (u.parentTo = v(u.parentTo)),
          c.set(Number(h), u));
      }
      o.set(a, c);
    }
...
var Ft = class {
  ...
  decode(e, t, r) {
    ...
    for (let o = 0; o < n; o++) {
      ...
      let h = new q(this, a, e.version),
        u = new k(c, t.dataAvailability);
      for (; !u.endOfFile();) {
        let f = u.readUint32(),
          p = u.readFloat64(),
          m = new k(u.readDeferredBytes(p), t.dataAvailability);
        switch (f) {
          case 1129270355:
            this.decodeColumns(h.columns, m, a, r);
            break;
          case 1296649816:
            h.minIndexCache = os(m);
            break;
          case 1212761426:
            h.hierarchyData = ds(m);
            break;
          case 1296125510:
            h.manifest = ls(m);
            break;
    ...
    ((e.branches = i), e.branches.has(I) || e.branches.set(I, new q(this, I, e.version)));
  }
  fromSerializableRow(e) {
    let t = S(e.value) ? v(e.value) : e.value;
    return {
          ...
          if (Array.isArray(h.value) && Array.isArray(u.value)) {
            ...
            Array.isArray(h.value)
              ...
              : Array.isArray(u.value)
                ...
                : (e.columns.value._set(h.row, y), e.columns.value._set(u.row, y));
        }
      }
    }
  },
  ...
  Yt = class {
    ...
    resolveHierarchyNodeChange(e, t) {
      ...
      let d = o.user.get(i),
        ...
        h = n.getParentId(r);
      if (typeof c == "string" && typeof h == "string")
        return (t.add(d), this.createNodeChangeMoved(e, c, h, t));
      if (typeof c == "string") return (t.add(d), this.createNodeChangeRemoved(e, c, t));
      if (typeof h == "string") return (t.add(d), this.createNodeChangeAdded(e, h, t));
    }
...
var at = class s {
  ...
  sortParentHistory() {
    ...
    this.parentHistory.sort((t, r) => Le(e, t, r));
  }
  depthFirstWalk(e) {
...
var Ss = 1e3,
  ...
  ht = class {
    ...
    addChild(e, t, r, n = !1) {
      ...
      let i = e.cachedChildren,
        o = J(i, t, (a, d) => {
          ...
          l(L(c), () => `invalid key in hierarchy, row ${a}`);
          let h = this.getHierarchyKey(d);
          if ((l(L(h), () => `invalid key in hierarchy, row ${d}`), c < h)) return -1;
          if (c > h) return 1;
      ...
      return (
        t.cachedChildrenSorted ||
          (r.sort((n, i) => {
            ...
            l(L(o), () => `invalid key in hierarchy, row ${n}`);
            let a = this.getHierarchyKey(i);
            if ((l(L(a), () => `invalid key in hierarchy, row ${i}`), o < a)) return -1;
            if (o > a) return 1;
    ...
    updateLatestValue(e, t, r) {
      ...
      switch (t) {
        ...
        case "master": {
          ...
          if (h === c || (c && this.indexes.syncRemovedReplicaOwner(c, e), !h)) return;
    ...
    getPositionIndex(e, t) {
      ...
      return J(r, t, (n, i) => {
        let o = this.getHierarchyKey(n);
        return (l(L(o), () => `invalid key in hierarchy, row ${n}`), o < i ? -1 : o > i ? 1 : 0);
      });
    }
    getChildPosition(e) {
    ...
    getOwnParentBySeq(e, t, r) {
      ...
      for (let a of n.parentIdHistory) {
        ...
        if (!o || d > o.seq || (d === o.seq && c > o.client)) {
          let h = i.id.get(a),
            u = this.getParentOverride(h, d, c);
          o = {
            id: h,
            seq: d,
            client: c,
          ...
          for (let [d, c] of a)
            if (!(d < e)) {
              ...
              for (let [h, u] of c) {
                ...
                let A = u.parentFrom === b ? (this.getParentBySeq(o, d)?.value ?? b) : u.parentFrom,
                  M = R(A);
                if (M !== y && M !== b) {
                  ...
                  if (L(u.parentFrom)) {
                    if (this.base && O.childrenById)
                      for (let j of O.childrenById.values()) {
                        ...
                        if (this.getHierarchyKey(ne) === u.parentFrom) {
                          let Fn = {
                            ...u,
      ...
      for (let [r, n] of this.parentOverrides) {
        ...
        for (let o of n.values())
          for (let a of o.values())
            a.rowIdx === i && L(a.parentFrom) && R(a.parentFrom) === e && t.push(ee(a.parentFrom));
      }
      return t;
    }
    postProcess(e) {
    ...
    resolveCycles(e) {
      ...
      this.parentHistorySorted ||
        (this.parentHistory.sort((o, a) => Le(n, o, a)), (this.parentHistorySorted = !0));
    ...
    resolveCycleForRow(e, t) {
      ...
      if (c) {
        ...
        let u = this.getOwnParentBySeq(n, i, !1),
          f;
        (u && u.value !== b && !this.findAncestorIdsBefore(R(u.value), n, i) && (f = u),
          l(f?.value !== b, "previous parent cannot be inherited"));
        let m = h.resolvedParentId === e,
        ...
        if ((this.setParentOverride(A), m))
          if (
            ...
            (this.addChild(O, n, f.index),
              O.inTree ? this.markInTree(O, h, n) : this.clearInTree(h, n));
...
var ft = class {
  ...
  collectDependencyLinks(e) {
    ...
    for (; i.length > 0;) {
      ...
      } else if (c !== void 0 || h !== void 0) return;
    ...
    build(e = !1) {
      ...
      for (let c = t.length - 1; c >= 0; c--) {
        ...
        if (e) {
          let p = this.len[h],
            m = this.off[h] + (p << 1);
          ((this.arena[m] = u), (this.arena[m + 1] = c), (this.len[h] = p + 1), this.upd[h]++);
          continue;
        }
        let f = this.getAt(h, u);
        (f === pt || W(t, c, f)) && this.setAt(h, u, c);
      }
    }
    replayLatestValues(e, t) {
      ...
      for (let h = i.length - 1; h >= 0; h--) {
        ...
        let m = p * n + f,
          g = c[m];
        (g === 0 || W(i, h, g - 1)) &&
          ((c[m] = h + 1), t(this.idCol.uniques[p], this.keyCol.uniques[u], h));
      }
    }
    get(e, t) {
...
function Os(s) {
  return "key" in s || ("offset" in s && "style" in s);
}
function En(s) {
...
function Es(s, e, t) {
  ...
  for (;;) {
    ...
    let o = n < s.length,
      a = n < e.length,
      d = o ? s[n] : { position: Ns, client: Ds },
      c = a && !i ? e[n] : { position: ks, client: Bs };
      ...
      Pn
        ...
        : e.length === 0
          ...
          : i
            ? (h = (f, p) => Hn(f, p, 8192, 2))
            : (h = _s);
      let u = h(d.position + 1, c.position - 1);
      return (r.push({ position: u, client: t }), r);
    }
    if ((r.push({ ...d }), !i)) {
      let h = d.position < c.position,
...
var Ps = ["__class", "isMaster", "isFormContainer", "replicaInfo", "master", "dataIdentifier"],
  Hs = ["__class"],
  gt = class s {
    table;
    branchData;
      ...
      (n instanceof _e
        ? (this.withTiming("latest_index", () =>
          ...
          this.withTiming("hierarchy_latest_replay", () => {
            let i = this.hierarchyMode === "full" ? Ps : Hs;
    ...
    runMutation(e) {
      ...
      try {
        ...
        for (let h = 0; h < r; h++) {
          ...
          i[h] = { id: a.get(u), key: d.get(u), value: c.get(u) };
    ...
    capturePreviousIndex(e, t, r) {
      ...
      if (
        ...
        t === "parentid" && r === y && L(this.hierarchy.getHierarchyKey(e)))
      ) {
      ...
      let t = [],
        ...
        n = (o) => {
          ...
          for (let [h, u] of d) {
            ...
            (t.push({ id: o, key: h, value: f }), c ? n(h) : i(f));
          }
        },
        i = (o) => {
          if (F(o) || re(o) || te(o)) {
    ...
    replayRowList(e, t) {
      ...
      let n = new Map(),
        ...
        d = t?.regenerateHierarchyPositions ? Us(e) : void 0;
      return (
        this.batch(() => {
          let c = this.seq,
            h = c;
    ...
    regenerateReplayHierarchyPosition(e, t) {
      if (e.key !== "parentid" || !ot(e.value) || !L(e.value)) return e.value;
      let r = ee(e.value),
        n = R(e.value),
        i;
    ...
    validateObjectUpdate(e, t) {
      if (!qe(t)) throw new Error("Store.setObject: object is not an object");
    ...
    createHierarchyKey(e, t, r = -1) {
      ...
      if (o === r && o >= 0) {
        ...
        return (l(L(p), "Existing position cannot be deleted or inherited"), p);
      }
      if (r < 0) {
      ...
      let h = d ? this.hierarchy.getChildPosition(d) : void 0,
    ...
    createAtomicArray(e, t) {
      ...
      for (let n = 0; n < t.length; n++) {
        let i = t[n];
        if (qe(i)) r.push(this.resolveObjectInArrayReference(e, i, n));
        else if (Kn(i)) {
    ...
    getObjectInner(e, t = 1 / 0) {
      let r = [{ depth: 0, id: e, parent: void 0 }],
        ...
        d = (c, h) => {
          ...
          let u = o.get(h);
          u !== y && (a[c] = this.getReferenceValue(u));
        };
      for (; r.length > 0;) {
        let { id: c, depth: h, parent: u } = r.pop();
        if (i.has(c)) continue;
        i.add(c);
        ...
        if (f) {
          ...
          if (h < t && f.has("children")) {
            ...
            for (let g = m.length - 1; g >= 0; --g) {
              let A = m[g];
              this.isMaterializableNode(A) && r.push({ id: A, depth: h + 1, parent: p });
            }
          }
        }
      }
      ...
      for (let d of r) {
        ...
        switch (d.operation) {
          case "delete":
            ...
            break;
          case "insert": {
            let h = or(o[d.index - 1], o[d.index], this.positionClientId);
            (this.updateKeyValue(e, c, h), o.splice(d.index, 0, h), a++);
            break;
          }
        }
      }
        ...
        for (let [o, a] of i)
          for (let [d, c] of a) {
            ...
            l(
              h === c,
              () =>
                `Update row count does not match batch row count. Batch: ${d} Update count: ${c} Batch count: ${h}`
            );
          }
    }
    ...
    *childBranchIds() {
      for (let e of this.hierarchy.getCachedChildrenIds(cr))
        e !== I && Ln(this.mainStore, e) === this.branchId && (yield e);
    }
...
function Us(s) {
  let e = new Map();
  for (let t of s) {
    if (t.key !== "parentid" || !ot(t.value) || !L(t.value)) continue;
    let r = R(t.value),
      n = e.get(r);
...
var Fs = (s) => (typeof s.__class == "string" && Ks(s.__class) ? s.id : void 0);
function su(s, e = mr(), t = {}) {
  return new gt({
    atomicArrays: "strict",
    latestMap: "map",
    ...t,
...
//# sourceMappingURL=chunk-E4PQ7Y5U.mjs.map
