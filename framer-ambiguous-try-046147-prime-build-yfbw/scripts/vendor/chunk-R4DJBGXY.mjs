import { e as F } from "chunk-MLOIKGGE.mjs";
import {
  E as me,
  Zd as I,
  c as ae,
...
import { Ew as ce, Mj as se, oy as pe, zf as re } from "chunk-XOWJWQ6B.mjs";
import {
  Hb as q,
  Nj as E,
  Ob as Q,
...
import { a as $, c as te } from "chunk-UYIYJ4FN.mjs";
...
function ue(t) {
  if (!le(t) || t === null) throw Error("Invalid document.");
...
function tt(t, e, o) {
  ...
  (s.verify(), (s = se.treeDidLoad(s, e, o).didNonLinearMove(e)));
  let d = [];
  return (
    k(s, d) &&
      (d.forEach((a) => {
...
function he(t, e = []) {
  let o = t.children,
    n = o.find(we);
  n === void 0 &&
    (e.push(`${t.id}: Root does not contain a page`), (n = new me({ id: ae(t) })), o.push(n));
...
function D(t, e, o, n) {
  for (o.setProp("parentid", n); t.has(o.id);)
    (e.push(`${o.id}: duplicate id in document`), (o.id = te()));
  t.set(o.id, o);
  let r = o.children;
  if (r) for (let i of r) D(t, e, i, o.id);
}
function ge(t, e, o) {
  for (let n of e.walk())
    (C(n.isMutable()),
      b(n) && Ce(t, n.id, new Set([n.id]), n, o),
      L(n) && ve(t, n, n, o),
      A(n) && (ye(t, n, o), Ne(t, n, o)),
      R(n) && Te(n, o));
}
function Se(t, e, o) {
  for (let n of e.walk()) (C(n.isMutable()), A(n) ? Ne(t, n, o) : R(n) && Te(n, o));
}
function Ce(t, e, o, n, r) {
  function i(a) {
    if (!g(a)) return !1;
...
export { k as a, tt as b, ot as c, K as d, B as e, mt as f, pt as g, ft as h, S as i, be as j };
//# sourceMappingURL=chunk-R4DJBGXY.mjs.map
