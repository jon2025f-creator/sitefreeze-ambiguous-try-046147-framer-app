import { c as hr } from "chunk-TMZ32JG5.mjs";
import { L as cr, M as ur, P as fr } from "chunk-PCBCKFY3.mjs";
import { a as ee } from "chunk-TYTUOSIS.mjs";
import { a as ge } from "chunk-KAFMYPLT.mjs";
import { c as ye } from "chunk-RPZVJJY4.mjs";
import { g as mr, q as lr, r as E } from "chunk-3OVH26OY.mjs";
...
import { a as Cr } from "chunk-XIRXJQX2.mjs";
...
function Yr({
  ...
  let R = d?.get(l)?.get(p.id) ?? h?.get(p.id),
    ...
    x = v ? Qe(v, r.cache, d, g, g, r.cache.activeRouterLocale, { startValue: R }) : R;
...
//# sourceMappingURL=chunk-V5CFU7T4.mjs.map
