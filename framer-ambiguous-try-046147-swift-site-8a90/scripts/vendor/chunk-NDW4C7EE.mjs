import {
  ...
  m as x,
  n as v,
} from "chunk-3Q7ROSGO.mjs";
import { a as dr } from "chunk-VBCXFFMV.mjs";
import { a as yr, b as mr, c as gr, d as Ue, e as br } from "chunk-YX57V7JF.mjs";
import {
  a as I,
  b as cr,
  c as hr,
  ...
  j as Pe,
  k as ur,
} from "chunk-GBD3AMAR.mjs";
import { b as l } from "chunk-4JY5UMT2.mjs";
var jn = ["client", "seq", "id", "key", "value", "user"],
  bt = class {
    encode(e, t) {
      let r = e.main;
      for (let n of jn) {
    ...
    fromSerializableRow(e) {
      let t = S(e.value) ? v(e.value) : e.value;
      return {
        client: e.client,
        seq: e.seq,
        id: e.id,
  ...
  Ir = { description: "Sets up migration with initial codec", migrate() {}, codec: new bt() };
var Ve = "$deleted",
  It = "$keep_value";
function $n(s) {
  ...
  for (let n = 0; n < r.length; n++) {
    ...
    if (o === "parentid") {
      ...
      if ((l(typeof h == "string", () => `parentid is not a string for row: ${i}`), wt(h)))
        continue;
      let f = new Map(),
        p;
      for (let m = n + 1; m < r.length; m++) {
        ...
        let M = e.seq.get(g);
        if (p !== void 0 && M > p) break;
        let O = e.key.get(g),
          j = e.id.get(g),
          ne = e.value.get(g);
        if (t.has(g) || typeof O != "number" || j !== `${h}.children` || ne === Ve || ne === It)
          continue;
        p === void 0 && (p = M);
        let ae = Sr(ne);
        (l(ae, () => `should be a valid object reference: ${JSON.stringify(ne)}`),
          ae === a ? e.value._set(i, wr(h, O)) : f.set(ae, O),
          t.add(g));
      }
      for (let m of f.keys()) {
        let g;
        for (let A = n + 1; A < r.length; A++) {
          let M = r[A];
          if (e.client.get(M) !== d) continue;
          let j = e.id.get(M),
            ne = e.key.get(M),
            ae = e.value.get(M);
          if (!(j !== m || ne !== "parentid" || ae !== h)) {
            if (wt(ae)) break;
            g = M;
            break;
          }
        }
        (l(g !== void 0, () => `failed to find parentid row for ${m}`),
          e.value._set(g, wr(h, f.get(m))));
      }
      continue;
    }
    if (o === "children") {
    ...
    let c = e.value.get(i);
    if (a.endsWith(".children") && c === It) {
      t.add(i);
      continue;
    }
    if (a.endsWith(".children") && c === Ve) {
      t.add(i);
      continue;
    }
    let u = Sr(c);
    if (!t.has(i) && a.endsWith(".children") && u && typeof o == "number") {
      let h = e.seq.get(i),
        f = !1;
      for (let p = n + 1; p < r.length; p++) {
        let m = r[p];
        if (e.client.get(m) !== d) continue;
        if (e.seq.get(m) !== h) break;
        let M = e.key.get(m),
          O = e.id.get(m);
        if (M !== "parentid" || O !== u) continue;
        let j = e.value.get(m);
        if (
          !wt(j) &&
          (l(typeof j == "string", () => `expecting value to be a string for rowIdx ${m}`),
          a.startsWith(j))
        ) {
          ((f = !0), e.value._set(m, `${j}@${o}`), t.add(i));
          break;
        }
      }
      if (!f) {
        let p = a.split(".", 2)[0];
        (e.id._set(i, u), e.key._set(i, "parentid"), e.value._set(i, `${p}@${o}`));
      }
    }
  }
  for (let n of t) e.id.get(n).endsWith(".children") && e.id._set(n, Ve);
}
var vr = {
...
var Gn = 2 ** 17,
  ie = class {
    ...
    bucketMask;
    get type() {
      return `BucketedColumn(${Ke(this.arrayConstructor)})`;
    }
    add(e) {
    ...
    *readSlices() {
    ...
    slice(e, t) {
      ...
      if (r === n) {
        ...
        for (let p = d; p < f; ++p) o[a++] = c.buffer[p];
        return o;
      }
      for (let f = d; f < this.bucketSize; ++f) o[a++] = c.buffer[f];
      for (let f = r + 1; f < n; ++f) {
        let p = this.buckets[f];
        for (let m = 0; m < p.length; ++m) o[a++] = p.buffer[m];
      }
      let u = t & this.bucketMask,
        h = this.buckets[n];
      if (h) for (let f = 0; f < u; ++f) o[a++] = h.buffer[f];
      return o;
    }
    serialize(e) {
      ...
      if (t?.zeroCopyIndices) {
        for (let i = 0; i < r.length; i += this.bucketSize) {
          ...
          if (o.length === this.bucketSize)
            ...
            for (let d = 0; d < o.length; d++) a.push(o[d]);
            this.buckets.push(a);
          }
        }
        return;
...
var P = class s {
  constructor(e, t) {
    this.arrayConstructor = e;
    if (((this.indices = new ie(e, t)), e === Uint8Array)) this.maxUniques = 2 ** 8 - 1;
  ...
  cursor = 0;
  get type() {
    return `LazyNormalizedBucketedColumn(ref: ${Ke(this.arrayConstructor)})`;
  }
  ...
  serialize(e) {
    (e.writeString(JSON.stringify(this.uniques, (t, r) => (C(r) ? x(r) : r))),
...
var vt = (1 << 29) - 24,
  ...
  Ct = new TextDecoder();
function Ar(s, e) {
  return Array.isArray(e) ? e.map((t) => (C(t) ? x(t) : t)) : C(e) ? x(e) : e;
}
function Tr(s) {
  let e = typeof s;
...
function Yn(s) {
  for (let e = 0; e < s.length; ++e) if (!Tr(s[e])) return !1;
  return !0;
}
function Xn(s) {
  return Tr(s) ? JSON.stringify(s) : (JSON.stringify(s, Ar) ?? "null");
}
function xt(s) {
  if (Array.isArray(s)) {
    for (let e = 0; e < s.length; ++e) S(s[e]) && (s[e] = v(s[e]));
    return s;
  }
  return S(s) ? v(s) : s;
}
  ...
  $e = class {
    ...
    get(e) {
      ...
      if (this.hydrated[e] === 0) {
        let t = e * 2,
          ...
          n = this.offsets[t + 1];
        try {
          this.values[e] = xt(JSON.parse(Ct.decode(this.bytes.subarray(r, n))));
        } catch (i) {
          throw new Error(
    ...
    ensureIndex() {
      ...
      let e = new Uint32Array(Math.max(16, this.estimatedLength * 2)),
        t = 0,
        r = this.dataAvailability ? new St(this.bytes, this.dataAvailability) : void 0,
        n = r?.skipWhitespace(0) ?? G(this.bytes, 0);
      if (this.bytes[n] !== xe)
        throw new Error(`uniques array: expected '[' at byte ${n} of ${this.bytes.length}`);
      for (n = r?.skipWhitespace(n + 1) ?? G(this.bytes, n + 1); this.bytes[n] !== K;) {
        let i = r?.scanValueEnd(n) ?? Br(this.bytes, n);
        if ((t + 1) * 2 > e.length) {
        ...
        if (
          ...
          (e[t * 2 + 1] = i),
          (t += 1),
          (n = r?.skipWhitespace(i) ?? G(this.bytes, i)),
          r?.ensure(n + 1),
          this.bytes[n] === ue)
        ) {
          if (
            ((n = r?.skipWhitespace(n + 1) ?? G(this.bytes, n + 1)),
            r?.ensure(n + 1),
            this.bytes[n] === K)
          )
            throw new Error(
      ...
      if (((n = r?.skipWhitespace(n + 1) ?? G(this.bytes, n + 1)), n !== this.bytes.length))
...
function ei() {
  ...
  return Number.isFinite(s) && s > 0 ? Math.min(s, vt - 2) : void 0;
}
function kr(s, e, t) {
  if (t && (t?.bodyBytes > vt || (t.mixed && t.bodyBytes >= Jn))) {
    Rr(s, e);
    return;
  }
  try {
    let r = Yn(e) ? JSON.stringify(e) : JSON.stringify(e, Ar);
    s.writeString(r);
  } catch (r) {
...
function Rr(s, e) {
  ...
  for (let i = 0; i < e.length; ++i) {
    ...
    let o = Xn(e[i]),
      a = o.length * 3;
    if (a > Qn) {
      s.writeBytes(xr.encode(o));
      continue;
    }
    a > n.length && (n = new Uint8Array(a));
    let { written: d } = xr.encodeInto(o, n);
    s.writeBytes(n.subarray(0, d));
  }
  (s.writeUint8(K), s.writePaddedVarUintAt(t, s.byteOffset - r));
}
function Dr(s, e, t = !1) {
  let r = s.readVarUint(),
    n = s.readBytes(r);
  if (n.length > vt) return (e && ((e.mixed = void 0), (e.bodyBytes = n.length)), ti(n));
  let i = JSON.parse(Ct.decode(n));
  if (t) return (e && ((e.mixed = !1), (e.bodyBytes = n.length)), i);
  let o = !1;
  for (let a = 0; a < i.length; ++a) {
    let d = i[a];
    (typeof d == "object" && d !== null && (o = !0), (i[a] = xt(d)));
  }
...
function ti(s, e = Zn) {
  ...
  if (((r = G(s, r)), r !== s.length))
    throw new Error(`uniques array: unexpected trailing bytes at ${r} of ${s.length}`);
  return t;
}
function ri(s, e, t, r) {
  try {
    let n = "[" + Ct.decode(e.subarray(t, r)) + "]",
      i = JSON.parse(n);
    for (let o = 0; o < i.length; ++o) s.push(xt(i[o]));
  } catch (n) {
...
var St = class {
  ...
  skipString(e) {
    ...
    for (;;) {
      this.ensure(t + 1);
      let r = this.availableBytes.indexOf(je, t);
      if (r === -1) {
      ...
      let n = 0;
      for (let i = r - 1; i > e && this.bytes[i] === Nr; --i) n += 1;
      if (n % 2 === 0) return r + 1;
      t = r + 1;
    }
  }
...
var le = class {
  ...
  E = class {
    ...
    get uniques() {
      if (this.uniquesArray instanceof fe) return this.uniquesArray.values;
      let e = this.uniquesArray.toArray();
      return ((this.uniquesArray = new fe(e)), e);
    }
    set uniques(e) {
      this.uniquesArray = new fe(e);
    }
    get type() {
    ...
    serialize(e) {
      (kr(e, this.uniques, this.uniquesHints),
    ...
    deserialize(e, t) {
      ...
      if (t?.lazyUniques) {
        let n = e.readDeferredBytes(e.readVarUint()),
          i = new $e(n, t.estimatedUniqueCount ?? this.count, e.dataAvailability);
      ...
      ((this.uniques = Dr(e, r, t?.stringCodeMap === !0)),
        (this.uniquesHints = r),
        (this.lookup = t?.stringCodeMap === !0 ? new Rt() : new le()),
        this.readIndices(e, t?.zeroCopyIndices));
    }
    rehydrate() {
...
var Er = "$keep_value",
  ...
  zr = {
    ...
    migrate(s) {
      let e = s.main.columns;
      if (e.value instanceof E || e.value instanceof P) {
        let t = e.value.uniques;
        for (let r in t) t[r] === _r ? (t[r] = y) : t[r] === Er && (t[r] = B);
      } else
        for (let t = 0; t < e.length; ++t) {
          let r = e.value.get(t);
          r === _r ? e.value._set(t, y) : r === Er && e.value._set(t, B);
        }
    },
  };
function ii(s) {
  let e = s.main.columns;
  if (e.client instanceof E || e.client instanceof P) {
    let t = e.client.uniques;
    for (let r in t) t[r] = Lr(t[r]);
  } else
    for (let t = 0; t < e.length; ++t) {
      let r = e.client.get(t);
      e.client._set(t, Lr(r));
    }
}
var qr = { description: "Migrates row `client` to u32", migrate: ii };
function Lr(s) {
  return s >>> 0;
}
var Re = 62,
  ...
  Pr = {};
for (let s = 0; s < At.length; s++) Pr[At[s]] = s;
function Tt(s, e) {
  if (
  ...
  let t = [],
    r = s;
  for (; r > 0;) (t.push(At[r % Re]), (r = Math.floor(r / Re)));
...
function Ot(s) {
  ...
  for (let t = 0; t < s.length; t++) {
    let r = s[t],
      n = Pr[r];
    (l(n !== void 0, () => `Invalid base62 character: ${r} in string ${s}`), (e = e * Re + n));
  }
...
var pe = 5,
  ...
  Mt = pe + Hr;
function si(s) {
  let e = Tt(s.position, pe),
    t = Tt(s.client, Hr);
  return e + t;
}
function oi(s) {
  l(s.length === Mt, () => `Component string must be ${Mt} chars, got ${s.length}`);
  let e = s.slice(0, pe),
    t = s.slice(pe);
  return { position: Ot(e), client: Ot(t) };
}
var Nt = ":";
function de(s) {
  return s.map(si).join(Nt);
}
function ye(s) {
  l(s.length > 0, "Position ID is empty");
  let e = s.split(Nt);
  return (l(e.length > 0, "Position ID has no parts"), e.map(oi));
}
function me(s) {
  if (typeof s != "string" || s.length === 0) return !1;
  let e = s.split(Nt);
  for (let t of e) if (t.length !== Mt) return !1;
  return !0;
}
var Ae = "$deleted",
  ai = "$keep",
...
function hi(s) {
  for (let e = 0; e < s.client.length; e++)
    s.key.get(e) !== -1 || s.value.get(e) !== B || s.key._set(e, ai);
}
function ui(s) {
  let e = li(s);
  for (let [t, r] of e) {
    let n = Array.from(r.keys()).sort((o, a) => o - a),
      i = Math.floor(We / (n.length + 3));
    l(i > 0, "step must be positive");
    for (let o = 0; o < n.length; o++) {
      let a = (o + 1) * i;
      l(a <= We, "position exceeds max position");
      let d = n[o],
        c = r.get(d);
      c.sort((h, f) => fi(s, h, f));
      let u = [];
      for (let h of c) {
        if (s.value.get(h) === y) {
          let p = u.pop();
          (l(p, "expected to have a previous position to delete"), s.key._set(h, p));
          continue;
        }
        let f = de([{ position: a, client: s.client.get(h) }]);
        (s.key._set(h, f), u.push(f));
      }
    }
  }
}
...
function yi(s) {
  let e = new Map();
  for (let t = 0; t < s.client.length; t++) {
    if (s.id.get(t) === Ae || s.key.get(t) !== "parentid") continue;
    let i = s.value.get(t);
    if (i === y) continue;
    l(typeof i == "string");
    let o = i.split("@");
...
function gi(s, e, t, r) {
  let n = de([{ position: r, client: s.client.get(e) }]);
  s.value._set(e, `${t}@${n}`);
}
var Vr = 27,
  Kr = 2 ** Vr - 1,
  ...
  Dt = 1,
  Bt = 2 ** Vr;
function Te({ batchNo: s, rowCount: e }) {
  return (
    l(e >= kt && e <= Kr, () => `rowCount out of range: ${e}`),
    l(s >= Dt && s <= Fr, () => `batchNo out of range: ${s}`),
...
function jr(s) {
  let e = Ge(s);
  return { rowCount: s - e * Bt, batchNo: e };
}
var _o = {
  ROW_COUNT_MIN: kt,
  ROW_COUNT_MAX: Kr,
  BATCH_NO_MIN: Dt,
  BATCH_NO_MAX: Fr,
  MIN_BATCH_ID: Te({ batchNo: Dt, rowCount: kt }),
};
var Ii = ["client", "seq", "batch", "id", "key", "value", "user"],
  Et = class {
    encode(e, t) {
      let r = e.main;
      for (let n of Ii) {
...
function wi(s) {
  ...
  let r = new Map();
  for (let [i, o] of t) r.set(i, Te({ batchNo: 1, rowCount: o }));
...
function Si(s) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    (!i.isAtomic && a === y) || ((i.isAtomic = !0), i.itemRowIdxs.push(r));
  }
  for (let [r, n] of t) {
    if (!n.isAtomic) continue;
    for (let u of n.referenceRowIdx) e.id._set(u, N);
    n.itemRowIdxs.sort((u, h) => {
      let f = e.seq.get(u),
        p = e.seq.get(h);
      if (f < p) return -1;
      if (f > p) return 1;
      let m = e.client.get(u),
        g = e.client.get(h);
    ...
    let o = i.pop(),
      ...
      d = [],
      c = n.keepRowIdx;
    (l(c !== -1, () => `array reference has no keep row: ${r}`),
      e.id._set(c, a),
      e.key._set(c, o),
      e.value._set(c, []));
    for (let u of n.itemRowIdxs) {
      e.id._set(u, a);
      let h = e.key.get(u),
        f = e.value.get(u);
      if (f === y) {
        let p = d.findIndex((m) => m.key === h);
        p !== -1 && d.splice(p, 1);
      } else {
        let p = d.findIndex((m) => m.key > h);
        p !== -1 ? d.splice(p, 0, { key: h, value: f }) : d.push({ key: h, value: f });
      }
      (e.key._set(u, o),
        e.value._set(
          u,
...
var Wr = { description: "Migrates arrays of primitives to atomic array values", migrate: Si };
var Gr = "$keep",
  _t = "$deleted";
function Ci(s) {
  let e = s.main.columns,
  ...
  for (let [n, i] of r) {
    ...
    for (let d = 0; d < i.length; d++) {
      let c = i[d],
        u = e.id.get(c);
      l(u === n, () => `array reference id does not match row id: ${u}`);
      let h = e.key.get(c);
      l(h !== Gr, () => `array reference key cannot be $keep: ${h}`);
      let f = e.value.get(c);
      if (
        (l(
          f === y || zt(f),
    ...
    for (let d = 0; d < i.length; d++) {
      ...
      if (h === y) {
        ...
        let m = o.get(p);
        u === m ? e.key._set(c, p) : e.id._set(c, _t);
        continue;
      }
      l(zt(h), () => `array reference value must be object reference: ${JSON.stringify(h)}`);
      let f = h.slice(4, -1);
      (e.key._set(c, f), e.value._set(c, u));
    }
  }
}
function xi(s) {
...
function Ai(s, e) {
  ...
  for (let r = 0; r < s.client.length; r++) {
    let n = s.id.get(r);
    if (!t.has(n) || s.key.get(r) === Gr) continue;
    let o = s.value.get(r);
    (l(o === y || zt(o), "only DELETED_VALUE and object references can be reference array items"),
      t.get(n).push(r));
  }
  return t;
}
  ...
  U = class {
    ...
    add(e, t) {
      ...
      (this.seqs.splice(r, 0, e),
        ...
        this.seqs.length > this.maxSize + ki && this.trimToMaxSize());
    }
    trimToMaxSize() {
      if (this.maxSize) {
...
var Zr = [1, 128, 16384, 2097152, 268435456, 34359738368, 4398046511104, 562949953421312],
  Ye = 4294967295,
  k = class {
    constructor(e, t) {
      this.buffer = e;
    ...
    readVarUint() {
      ...
      for (;;) {
        ...
        let i = e[t++];
        if (((r += (i & 127) * Zr[n]), (i & 128) === 0)) break;
        if (((n += 1), n >= Zr.length)) throw new Error("VarUint is too big");
      }
    ...
    readString() {
      let e = this.readVarUint(),
        t = this.byteOffset + e;
      if (!Number.isSafeInteger(t) || t > Ye) throw new Error("Invalid string length");
    ...
    readBytes(e) {
      ...
      if (!Number.isSafeInteger(t) || e < 0 || t > Ye) throw new Error("Invalid byte length");
      let r = this.ensureAvailable(t);
    ...
    readDeferredBytes(e) {
      let t = this.byteOffset + e;
      if (!Number.isSafeInteger(t) || e < 0 || t > Ye)
    ...
    readTypedArray(e) {
      ...
      let n = this.byteOffset + this.buffer.byteOffset,
        i = t * r;
      if (!Number.isSafeInteger(i) || i < 0 || i > Ye)
      ...
      if (n % r !== 0) {
        let d = new ArrayBuffer(i);
        return (
          new Uint8Array(d).set(new Uint8Array(this.buffer.buffer, n, i)),
          (this.byteOffset += i),
          new e(d, 0, t)
        );
      }
...
var Y = 1024 * 1024,
  _ = class {
    ...
    writeUint8(e) {
      ...
      let t = Math.floor(this.byteOffset / Y);
      ((this.chunks[t][this.byteOffset % Y] = e), (this.byteOffset += 1));
    }
    writeUint16(e) {
    ...
    writePaddedVarUint(e) {
      this.writeBytes(en(e));
    }
    writePaddedVarUintAt(e, t) {
      this.writeBytesAt(e, en(t));
    }
    writeString(e) {
    ...
    currentChunkOffset() {
      return this.byteOffset % Y;
    }
    remainingInCurrentChunk() {
      return this.byteOffset === this.chunks.length * Y ? 0 : Y - this.currentChunkOffset();
    }
    addChunk() {
      this.chunks.push(new Uint8Array(Y));
    }
    getChunk(e) {
      let t = Math.floor(e / Y),
        r = this.chunks[t];
...
var Oe = 2048,
  z = class s {
    constructor(e = new Uint32Array(Oe), t = 0) {
      this.words = e;
      this._count = t;
    }
    words;
    ...
    *[Symbol.iterator]() {
    ...
    deserialize(e) {
      ...
      (l(t.length === Oe, () => `unexpected bitmap word count: ${t.length}`), this.words.set(t));
    }
  };
var Me = { Array: 0, Bitmap: 1 };
function rn(s, e) {
  if (s instanceof D && e instanceof D) return Di(s, e);
  if (s instanceof D && e instanceof z) return Bi(s, e);
  if (s instanceof z && e instanceof D) return Ei(s, e);
  if (s instanceof z && e instanceof z) return _i(s, e);
}
function Di(s, e) {
  let t = [],
    r = s.values,
  ...
  Ne = class s {
    ...
    add(e) {
      ...
      return n
        ? n.add(r)
          ? ((this._count += 1),
            n instanceof D && n.count > nn && this.containers.set(t, Li(n)),
            !0)
          : !1
    ...
    andNot(e) {
      ...
      for (let r of this.keys) {
        ...
        let o = rn(n, i);
        o &&
          (o instanceof z && o.count <= nn && (o = qi(o)),
    ...
    *[Symbol.iterator]() {
      for (let e of this.keys) {
        ...
        if (t) for (let r of t) yield (((e << qt) >>> 0) + r) >>> 0;
      }
    }
    serialize(e) {
      ...
      for (let t of this.keys) {
        ...
        (l(r, () => `missing container for key ${t}`),
          e.writeUint16(t),
          e.writeUint8(r instanceof D ? Me.Array : Me.Bitmap),
          r.serialize(e));
      }
    }
    deserialize(e) {
      ...
      for (let r = 0; r < t; r++) {
        let n = e.readUint16(),
          i = e.readUint8(),
          o;
        (i === Me.Array ? (o = new D()) : i === Me.Bitmap && (o = new z()),
...
var De = class s {
  ...
  add(e, t) {
    (ke(e, "client"), on(t, "seq"));
    let { seqHigh: r, seqLow: n } = an(t),
      i = this.seqMapByClient.get(e);
    i || ((i = new Map()), this.seqMapByClient.set(e, i));
    let o = i.get(r);
    o || ((o = new Ne()), i.set(r, o));
    let a = o.add(n);
  ...
  andNot(e) {
    let t = new s();
    for (let r of Q(this.seqMapByClient)) {
      ...
      for (let d of Q(n)) {
        ...
        if (!c) continue;
        let u = i?.get(d),
          h = u ? c.andNot(u) : c.clone();
        h.count <= 0 || (o.set(d, h), (a += h.count));
      }
  ...
  *[Symbol.iterator]() {
    for (let e of Q(this.seqMapByClient)) {
      let t = this.seqMapByClient.get(e);
      if (t)
        for (let r of Q(t)) {
          let n = t.get(r);
          if (n) for (let i of n) yield { client: e, seq: Hi(r, i) };
        }
    }
  }
  toArray() {
...
var V = class s {
    ...
    toMaxSeqArray() {
      let e = [];
      for (let t of Q(this.clientState)) {
    ...
    deserialize(e) {
      (l(this.timestamps.count === 0, "Manifest deserialize must be called when empty"),
        l(e.readUint32() === dn, "Manifest magic mismatch"),
        l(e.readUint16() === cn, "Manifest version mismatch"),
        (this.timestamps = new De()),
  ...
  dn = 1414743629,
  cn = 1;
var un = ["client", "seq", "batch", "id", "key", "value", "user"];
var Ht = class {
  encode(e, t) {
    let r = e.main;
  ...
  decode(e, t) {
    ...
    for (; !t.endOfFile();) {
      let n = t.readUint32(),
        i = t.readFloat64(),
        o = new k(t.readBytes(i));
      switch (n) {
        case 1129270355:
          this.decodeColumns(r.columns, o);
          break;
        case 1296649816: {
          r.minIndexCache = Vi(o);
          break;
        }
        case 1212761426:
          r.hierarchyData = Fi(o);
          break;
        case 1296125510:
          r.manifest = Gi(o);
          break;
      ...
      [...n].map(([i, o]) => [
        ...
        Object.fromEntries(
          [...o].map(([a, d]) => {
            ...
            return (
              C(c.parentFrom) && (c.parentFrom = x(c.parentFrom)),
              C(c.parentTo) && (c.parentTo = x(c.parentTo)),
              [a, c]
            );
          })
        ),
...
function Fi(s) {
  ...
  for (let [n, i] of e) {
    ...
    for (let [a, d] of i) {
      ...
      for (let u in d) {
        let h = d[u];
        (S(h.parentFrom) && (h.parentFrom = v(h.parentFrom)),
          S(h.parentTo) && (h.parentTo = v(h.parentTo)),
          c.set(Number(u), h));
      }
      o.set(a, c);
    }
...
var ln = { description: "Adds named sections to binary documents", codec: new Ht(), migrate() {} };
var ge = class {
    values = new ie(Float64Array);
    skippedLength;
    get type() {
...
function Yi(s) {
  return (
    l(s >= -fn && s <= fn, () => `seq delta out of zigzag-safe range: ${s}`),
    s >= 0 ? s * 2 : -s * 2 - 1
  );
}
function Xi(s) {
...
var pn = {
  forVersion(s) {
    return s >= Be ? new ge() : new ie(Float64Array);
  },
};
var Vt = class {
...
var yn = ["client", "seq", "batch", "id", "key", "value", "user"];
var Kt = class {
  encode(e, t) {
    let r = e.branches;
    ...
    for (let [n, i] of r) {
      t.writeString(n);
      let o = new _();
      (this.writeSection(1296389185, o, (c) => {
        ts(i.metadata, c);
      }),
        this.writeSection(1296125510, o, (c) => {
          ns(i.manifest, c);
        }),
        this.writeSection(1129270355, o, (c) => {
          this.encodeColumns(i.columns, c);
        }));
      let a = i.hierarchyData;
      (a &&
        this.writeSection(1212761426, o, (c) => {
          Zi(a, c);
        }),
        this.writeSection(1296649816, o, (c) => {
          Ji(i.minIndexCache, c);
        }));
      let d = o.getBuffer();
  ...
  decode(e, t) {
    ...
    for (let i = 0; i < r; i++) {
      let o = t.readString(),
        a = new L(this, o, e.version),
        d = t.readFloat64(),
        c = new k(t.readBytes(d));
      for (; !c.endOfFile();) {
        let u = c.readUint32(),
          h = c.readFloat64(),
          f = new k(c.readBytes(h));
        switch (u) {
          case 1129270355:
            this.decodeColumns(a.columns, f);
            break;
          case 1296649816:
            a.minIndexCache = Qi(f);
            break;
          case 1212761426:
            a.hierarchyData = es(f);
            break;
          case 1296125510:
            a.manifest = is(f);
            break;
    ...
    ((e.branches = n), e.branches.has(I) || e.branches.set(I, new L(this, I, e.version)));
  }
  fromSerializableRow(e) {
    let t = S(e.value) ? v(e.value) : e.value;
    return {
...
var mn = { description: "Stores table data by branches", codec: new Kt(), migrate() {} };
var gn = ["client", "seq", "batch", "id", "key", "value", "user"];
var Ft = class {
  encode(e, t) {
    let r = e.branches;
    t.writeUint32(r.size);
  ...
  decode(e, t, r) {
    ...
    for (let o = 0; o < n; o++) {
      let a = t.readString(),
        d = t.readFloat64(),
        c = t.readDeferredBytes(d);
      if (r?.branchIds && !r.branchIds.has(a)) continue;
      let u = new L(this, a, e.version),
        h = new k(c, t.dataAvailability);
      for (; !h.endOfFile();) {
        let f = h.readUint32(),
          p = h.readFloat64(),
          m = new k(h.readDeferredBytes(p), t.dataAvailability);
        switch (f) {
          case 1129270355:
            this.decodeColumns(u.columns, m, a, r);
            break;
          case 1296649816:
            u.minIndexCache = os(m);
            break;
          case 1212761426:
            u.hierarchyData = ds(m);
            break;
          case 1296125510:
            u.manifest = ls(m);
            break;
      ...
      ((u.metadata.branchId = u.metadata.branchId ?? a), i.set(a, u));
    }
  ...
  decodeColumns(e, t, r, n) {
    ...
    for (let o = 0; o < i; o++) {
      let a = t.readString(),
        d = e[a];
      l(d, () => `Column ${a} not found`);
      let c = t.readString();
      if (c !== d.type)
        throw new Error(
          `Column type does not match in branch "${r}": ${c} (actual) != ${d.type} (expected)`
        );
      ...
      (d.deserialize(t, {
        ...
        n?.onTiming?.(`column_${a}`, performance.now() - u));
    }
  }
  writeSection(e, t, r) {
    t.writeUint32(e);
  ...
  migrate: (s) => {
    for (let e of s.branches.values())
      ((e.hierarchyData = void 0),
        (e.minIndexCache = new U({ maxSize: 1e3 })),
        (e.metadata.seq = 0),
        (e.manifest = new V()));
  },
};
    ...
    for (let e of s.branches.values()) {
      ...
      for (let c = 0; c < r.length; c++) {
        ...
        if (a.has(u)) {
          ...
          if (h === "_deleted") {
            let f = d.get(u);
            f === void 0 && ((f = {}), d.set(u, f));
            let p = f._deleted;
            (p === void 0 || $(i.get(c), o.get(c), i.get(p.row), o.get(p.row))) &&
          ...
          if (Array.isArray(u.value) && Array.isArray(h.value)) {
            ...
            Array.isArray(u.value)
              ...
              : Array.isArray(h.value)
                ...
                : (e.columns.value._set(u.row, y), e.columns.value._set(h.row, y));
        }
      }
    }
  },
...
var Xe = Object.keys(be).reduce((s, e) => {
  let [, t] = e.split("_");
...
l(Number.isFinite(Xe), "No migrations found");
var vn = "FRAMERCRDT";
function jt(s) {
  let e = s.readString();
  return (l(e === vn, () => `Not a framer document: ${e}`), { version: s.readUint16() });
}
function $t(s, e) {
  (e.writeString(vn), e.writeUint16(s));
}
function ps(s, e) {
  let t = `m${s}_${e}`;
  return (l(be[t], () => `Migration from ${s} to ${e} does not exist`), be[t]);
}
function Cn(s, e = 1) {
...
var ce = class s {
  ...
  toBuffer() {
    let e = new _();
    return ($t(this.version, e), this.codec.encode(this, e), e.getBuffer());
  }
  async writeToStream(e) {
    let t = new _();
    return ($t(this.version, t), this.codec.encode(this, t), t.writeToStream(e));
  }
  ...
  static fromBuffer(e, t) {
    let r = new k(e, t?.dataAvailability),
      { version: n } = jt(r),
      i = new s(n);
...
var Ze = class {
  ...
  Gt = class {
    ...
    getChangeGroup(e) {
      ...
      if (!(!t || t.size === 0)) return new rt(e, this.nodeChangeByNodeId, t);
    }
    *changeGroups() {
      for (let [e, t] of this.nodeChangeGroupIndex.entries())
        yield new rt(e, this.nodeChangeByNodeId, t);
    }
  },
  nt = class {
    constructor(e, t) {
      ...
      this.nodeChangeResolver = new Yt(e, n);
    }
    store;
    baseStore;
    nodeChangeResolver;
    ...
    nodeChangeGroupIndex = new et();
    nodeChangeDependencyIndex = new tt();
    read() {
    ...
    cursorsAreCurrent(e, t) {
      ...
      if (!r || !Rn(r, e) || this.baseStoreCursors.length !== t.length) return !1;
      for (let n = 0; n < t.length; n++) {
        let i = this.baseStoreCursors[n],
          o = t[n];
        if (!i || !o || !Rn(i, o)) return !1;
      }
      return !0;
    }
    canUpdateIncrementally(e, t) {
      let r = this.branchCursor;
      if (!r || !An(r, e) || this.baseStoreCursors.length !== t.length) return !1;
      for (let n = 0; n < t.length; n++) {
        let i = this.baseStoreCursors[n],
          o = t[n];
        if (!i || !o || !An(i, o)) return !1;
      }
      return !0;
    }
    rebuildChanges() {
      ((this.nodeChangeByNodeId = new Map()),
        (this.nodeChangeGroupIndex = new et()),
        (this.nodeChangeDependencyIndex = new tt()),
        (this.nodeChanges = new Gt(this.nodeChangeByNodeId, this.nodeChangeGroupIndex)));
      ...
      return (
        (this.branchCursor = Xt(this.store)),
        (this.baseStoreCursors = xn(this.store)),
        this.nodeChanges
      );
    }
    ...
    collectRowChanges(e, t, r, n, i) {
      ...
      for (let a = t; a < r; a++) {
        ...
        u &&
          (n.add(u),
          this.nodeChangeDependencyIndex.addChangedNodeIdsForDependency(u, n),
          i && c === "parentid" && i.add(u));
      }
    }
    ...
    addNodeChange(e) {
      let t = new Set(),
        r = { branch: new Ze(this.store, t), base: new Ze(this.baseStore, t) },
  ...
  Yt = class {
    ...
    resolveHierarchyNodeChange(e, t) {
      ...
      if (typeof c == "string" && typeof u == "string")
        return (t.add(d), this.createNodeChangeMoved(e, c, u, t));
      if (typeof c == "string") return (t.add(d), this.createNodeChangeRemoved(e, c, t));
      if (typeof u == "string") return (t.add(d), this.createNodeChangeAdded(e, u, t));
    }
    resolveChangedKeys(e, t) {
      ...
      for (let [i, o] of e.latestPropertyRowIndexByStoreId) {
        ...
        for (let [d, c] of o) {
          ...
          let u = r.value.get(c);
          if (u === b) continue;
          let h = this.baseStore.getCurrentValue(i, d);
          if (ys(u, h)) continue;
          let f = r.user.get(c);
          (t.add(f), a.set(d, f));
        }
...
function ys(s, e) {
  return !!(
    e === s ||
    ((e === void 0 || e === y) && (s === void 0 || s === y)) ||
    (Array.isArray(e) && Array.isArray(s) && Pe(e, s))
  );
}
function Ee(s, e = 0) {
  let t = s.byteLength,
    r = Math.trunc(t / 4) * 4,
    n = new DataView(s.buffer, s.byteOffset, t),
    i = e >>> 0;
  for (let a = 0; a < r; a += 4) {
...
var st = "@";
function q(s) {
  return s !== void 0 && s !== y && s !== b;
}
function ot(s) {
  if (s === y || s === b) return !0;
  if (typeof s != "string") return !1;
  let e = s.lastIndexOf(st);
...
function ee(s) {
  (l(s !== y, "trying to get positionId of deleted child"),
...
var at = class s {
  ...
  sortParentHistory() {
    ...
    this.parentHistory.sort((t, r) => qe(e, t, r));
  }
  depthFirstWalk(e) {
  ...
  emitInWindowParentIdRows() {
    ...
    for (let r = this.windowStartIdx; r < e.length; r++) {
      ...
      if (!(d && a !== void 0 && a < this.windowStartIdx)) {
        ...
        (!this.visited.has(o) && !d && !t.inTree(o)) || this.emitParentIdRow(i, r);
      }
    }
  }
  emitRow(e) {
  ...
  emitParentIdRow(e, t) {
    (this.emittedParentIdRowIndexes.add(t),
      this.source.base && e.id !== N && e.value !== y && this.retainedNodeIds.add(e.id));
  ...
  emitOwnRevivedNodes() {
    ...
    for (let n of e.parentHistory) {
      ...
      t.has(i) ||
        (t.add(i),
        this.source.base.getParentId(i) === y &&
          e.getOwnParentId(i) !== y &&
          e.inTree(i) &&
          er(this.hierarchy, i, this.retainedNodeIds, r));
    }
  }
  emitOwnDeletedNodes() {
    if (!this.source.base) return;
    ...
    for (let r of e.parentHistory) {
      ...
      if (t.has(n) || (t.add(n), e.getOwnParentId(n) !== y)) continue;
  ...
  emitRowsWithTombstoneAnchors() {
    ...
    for (let t of this.source.latest.keys()) {
      ...
      let r = Z(this.hierarchy, t);
      if (r === void 0 || tr(this.source, r)) continue;
      let n = e.get(r);
      (e.has(r) ||
        ((n = kn(this.source, r)), e.set(r, n), n !== void 0 && this.tombstoneAnchorNodeIds.add(n)),
        n !== void 0 &&
          (this.emitObjectRows(t),
          t === r && this.hierarchy.getOwnParentId(t) !== y && this.emitResolvedParent(t)));
    }
  }
  emitTombstoneAnchors() {
    let e = [];
    for (let t of this.tombstoneAnchorNodeIds)
      this.hierarchy.getOwnParentId(t) === y && (this.emitResolvedParent(t), e.push(t));
  ...
  emitOutOfTreeNodes() {
    ...
    for (let n of e.parentHistory) {
      let i = t.get(n);
      if (r.has(i) || (r.add(i), this.visited.has(i)) || e.getOwnParentId(i) === y || e.inTree(i))
        continue;
      let o = Nn(e, i);
      if (o) {
        for (let a of o)
          (e.getParentId(a) === y && this.tombstoneAnchorNodeIds.add(a),
  ...
  emitObjectRows(e) {
    ...
    let t = this.source.latest.getOwnLatest(e),
      ...
      n;
    (t?.forEachOwn((o, a) => {
      let d = this.source.branchData.getRow(a);
      if (this.shouldDropPropertyTombstone(e, o, a, d)) {
        n ??= d;
        return;
      }
      (this.emitRow(d), (r = !0));
  ...
  emitMergeableArrayRows(e) {
    ...
    if (r)
      for (let n of r.keys())
        n !== w && this.source.getCurrentValue(e, n) !== y && this.emitObjectRows(n);
  }
  followReferences(e) {
    if (F(e) || re(e)) {
      this.emitObjectRows(T(e));
      return;
    }
    if (te(e)) {
      this.emitMergeableArrayRows(T(e));
      return;
    }
  ...
  maybeEmitOverride(e, t) {
    ...
    for (; o && R(o.value) !== R(n.parentTo);) o = i.getOwnParentBySeq(o.id, o.seq, !1);
...
function bs(s, e) {
  ...
  for (let i of t.parentHistory) {
    ...
    r.has(o) ||
      (r.add(o),
      t.getOwnParentId(o) !== y &&
        (e.add(o), s.base?.getParentId(o) === y && t.inTree(o) && er(t, o, e, n)));
  }
}
function er(s, e, t, r) {
  if (!r.has(e)) {
    ...
    for (let n of s.getChildrenIds(e))
      (s.getOwnParentRowIdx(n) === void 0 && t.add(n), er(s, n, t, r));
  }
}
function Is(s, e) {
  if (!s.base) return;
  ...
  for (let r of s.latest.keys()) {
    ...
    let n = Z(s.getHierarchy(), r);
    if (n === void 0 || t.has(n) || (t.add(n), tr(s, n))) continue;
    let i = kn(s, n);
    i !== void 0 && e.add(i);
  }
  ws(s, e);
...
function ws(s, e) {
  ...
  for (let n of t.parentHistory) {
    ...
    if (r.has(i) || (r.add(i), t.getOwnParentId(i) === y) || t.inTree(i)) continue;
    let o = Nn(t, i);
    if (o) for (let a of o) t.getParentId(a) === y && e.add(a);
  }
}
function Nn(s, e) {
  let t = [e],
...
function tr(s, e) {
  return s.getHierarchy().getOwnParentId(e) === y;
}
function kn(s, e) {
  if (!s.base || tr(s, e)) return;
  if (s.base.getParentId(e) === y) return e;
  let t = new Set([e]),
    r = s.getParentId(e);
  for (; r !== void 0 && r !== y;) {
    if (t.has(r)) return;
    if ((t.add(r), s.getParentId(r) === y)) return r;
    r = s.getParentId(r);
  }
}
var Se = class {
...
var dt = class {
  ...
  ct = class {
    constructor(e) {
      this.base = e;
      ((this.classToIds = new ve(this.base.classToIds)),
        (this.masterIdToReplicaIds = new ve(this.base.masterIdToReplicaIds)),
        (this.formContainerIds = new Se(this.base.formContainerIds)),
        (this.withDataIdentifierIds = new Se(this.base.withDataIdentifierIds)),
        (this.dataIdentifierToIds = new ve(this.base.dataIdentifierToIds)));
    }
    base;
    classToIds;
    ...
    dataIdentifierToIds;
    getMutableIndexSet(e, t) {
      return e.ensureOwned(t, (r) => new Se(r));
    }
    removeFromIndexSet(e, t, r, n = !1) {
      if (!e.get(t)) return;
    ...
    syncRemovedMapSetIndex(e, t, r, n, i = !1, o = !1) {
      ...
      let c = e.getOwned(r);
      (c?.reset(n), o && c?.size === 0 && !d && e.delete(r));
    }
  ...
  ht = class {
    constructor(e, t, r) {
      ...
      ((this.branchData = e.branchData),
        this.base
          ? ((this.indexes = new ct(this.base.indexes)), (this.rootNodeId = this.base.rootNodeId))
          : (this.indexes = new dt()));
    }
    store;
    latest;
    ...
    trimHierarchyInvalidations() {
      let e = this.hierarchyInvalidations.length - Ss;
      e <= 0 ||
    ...
    getLatestReplicaChild(e) {
      ...
      for (let i = 7; i < e.length - 9 + 2; i++)
        if (i !== 9 && ((r = e.slice(0, i)), (n = this.getNodeData(r)), n && this.inTree(r))) {
          ...
          return !d || !this.inTree(a) || d.inMaster !== o ? void 0 : [r, n, a, d];
        }
    }
    computeTreeHash() {
      let e = 0,
    ...
    addChild(e, t, r, n = !1) {
      ...
      let i = e.cachedChildren,
        o = J(i, t, (a, d) => {
          ...
          l(q(c), () => `invalid key in hierarchy, row ${a}`);
          let u = this.getHierarchyKey(d);
          if ((l(q(u), () => `invalid key in hierarchy, row ${d}`), c < u)) return -1;
          if (c > u) return 1;
      ...
      return (
        t.cachedChildrenSorted ||
          (r.sort((n, i) => {
            ...
            l(q(o), () => `invalid key in hierarchy, row ${n}`);
            let a = this.getHierarchyKey(i);
            if ((l(q(a), () => `invalid key in hierarchy, row ${i}`), o < a)) return -1;
            if (o > a) return 1;
      ...
      switch (t) {
        case "__class": {
          ...
          if (
            ...
            for (let u of i.childrenById.keys()) {
              let h = this.getNodeData(u);
              h && this.markInTree(i, h, u);
            }
          (o &&
            (o !== c || d) &&
            (d ? this.indexes.resetClass(o, e) : this.indexes.syncRemovedClass(o, e)),
        ...
        case "isFormContainer": {
          let i = n.get(r),
            ...
            a = o.isFormContainer,
            d = i === b;
          d ? o.inherit("isFormContainer") : (o.isFormContainer = i === !0);
          let c = o.isFormContainer;
          if (a === c && !d) return;
          (o.inTree &&
        ...
        case "master": {
          ...
          if (i === b) {
            ...
            let h = d.replicaInfoMaster;
            (c && this.indexes.resetReplicaOwner(c, e), h && this.indexes.resetReplicaOwner(h, e));
            return;
          }
          d.replicaInfoMaster = typeof i == "string" && i.length > 0 ? i : void 0;
          let u = d.replicaInfoMaster;
          if (u === c || (c && this.indexes.syncRemovedReplicaOwner(c, e), !u)) return;
        ...
        case "dataIdentifier": {
          let i = n.get(r),
            ...
            a = o.dataIdentifier,
            d = i === b;
          d ? o.inherit("dataIdentifier") : (o.dataIdentifier = typeof i == "string" ? i : void 0);
          let c = o.dataIdentifier;
          if (a === c && !d) return;
    ...
    rehydrate(e) {
      ...
      for (let [r, n] of this.parentOverrides)
        for (let [i, o] of n) for (let [a, d] of o) t.set(d.rowIdx, d);
    ...
    rehydrateMinimal(e) {
      ...
      for (let i of this.parentHistory) {
        ...
        ((a === void 0 || $(r.seq.get(i), r.client.get(i), r.seq.get(a), r.client.get(a))) &&
          (o.resolvedParentId = i),
          o.parentIdHistory.push(i));
      }
      for (let [i, o] of this.nodeData) {
        let a = o.resolvedParentId;
        if (a === void 0) continue;
        let d = t.get(a)?.parentTo ?? r.value.get(a),
          c = R(d);
        if (c === y || c === b) continue;
        let u = this.ensureNodeData(c);
        ((u.childrenById ??= new Map()),
          u.childrenById.set(i, a),
          (u.cachedChildrenCurrentCounter += 1));
      }
    ...
    insertParentHistory(e) {
      let t = this.parentHistory,
        ...
        n = t[t.length - 1];
      if (!this.parentHistorySorted || n === void 0 || !W(r, n, e)) {
        t.push(e);
        return;
      }
      let i = J(t, e, (o, a) => (W(r, o, a) ? 1 : -1));
      t.splice(i, 0, e);
    }
    ...
    applyParentIdRow(e, t, r) {
      let n = this.ensureNodeData(e),
        ...
        d = a.seq.get(t),
        c = a.client.get(t);
      if (o === void 0 || $(d, c, a.seq.get(o), a.client.get(o))) {
        let h = r?.parentTo ?? a.value.get(t);
        ((n.resolvedParentId = t), this.updateParent(n, e, h, t, i));
      }
    ...
    getPositionIndex(e, t) {
      ...
      return J(r, t, (n, i) => {
        let o = this.getHierarchyKey(n);
        return (l(q(o), () => `invalid key in hierarchy, row ${n}`), o < i ? -1 : o > i ? 1 : 0);
      });
    }
    getChildPosition(e) {
    ...
    getOwnParentBySeq(e, t, r) {
      ...
      for (let a of n.parentIdHistory) {
        ...
        if (!o || d > o.seq || (d === o.seq && c > o.client)) {
          let u = i.id.get(a),
            h = this.getParentOverride(u, d, c);
          o = {
            id: u,
            seq: d,
            client: c,
    ...
    findAncestorIdsBefore(e, t, r) {
      ...
      for (;;) {
        if (e === t) return n;
        if (e === void 0 || e === y || e === b || n.has(e) || (n.add(e), !this.getNodeData(e)))
          return;
          ...
          for (let [d, c] of a)
            if (!(d < e)) {
              ...
              for (let [u, h] of c) {
                ...
                (r.push(h), i.add(h.nodeId));
                let g = R(h.parentTo);
                (l(g !== b, "override parent cannot be inherited"),
                  g !== y && (this.removeChild(g, o), i.add(g)));
                let A = h.parentFrom === b ? (this.getParentBySeq(o, d)?.value ?? b) : h.parentFrom,
                  M = R(A);
                if (M !== y && M !== b) {
                  let O = this.ensureNodeData(M);
                  if (q(h.parentFrom)) {
                    if (this.base && O.childrenById)
                      for (let j of O.childrenById.values()) {
                        let ne = this.branchData.columns.id.get(j);
                        if (this.getHierarchyKey(ne) === h.parentFrom) {
                          let Fn = {
                            ...h,
                            parentTo: this.createOverrideHierarchyKey(h.parentFrom, o),
                          };
                          n.push(Fn);
                        }
                      }
                    (this.addChild(O, o, f, !1),
                      O.inTree ? this.markInTree(O, p, o) : this.clearInTree(p, o));
                  } else
                    ((O.cachedChildrenCurrentCounter += 1),
                      O.inTree ? this.resetInTree(p, o) : this.clearInTree(p, o));
                  i.add(M);
    ...
    createOverrideHierarchyKey(e, t) {
      ...
      function a(h) {
        ...
        for (let f = 0; f < i.length - 1; f++) {
          let p = i[f],
            m = h[f];
          if (p.position !== m.position || p.client !== m.client) return !1;
        }
        return !0;
      }
      let d = new Set(),
      ...
      if (c)
        for (let h of c.keys()) {
          ...
          if (!a(p)) continue;
          let m = p[p.length - 1];
          m.position === o.position && d.add(m.client);
        }
      let u = yr.find((h) => !d.has(h));
      return (
      ...
      for (let [r, n] of this.parentOverrides) {
        ...
        for (let o of n.values())
          for (let a of o.values())
            a.rowIdx === i && q(a.parentFrom) && R(a.parentFrom) === e && t.push(ee(a.parentFrom));
      }
      return t;
    }
    postProcess(e) {
    ...
    resolveCycles(e) {
      ...
      this.parentHistorySorted ||
        (this.parentHistory.sort((o, a) => qe(n, o, a)), (this.parentHistorySorted = !0));
      let i = J(this.parentHistory, e, (o, a) => n.seq.get(o) - a);
    ...
    resolveCycleForRow(e, t) {
      ...
      let a = o === b ? this.getParentBySeq(n, i) : void 0,
        d = a ? R(a.value) : R(o),
        c = this.findAncestorIdsBefore(d, n, i);
      if (c) {
        let u = this.getNodeData(n);
        l(u, () => `node not in tree, id: ${n}`);
        let h = this.getOwnParentBySeq(n, i, !1),
          f;
        (h && h.value !== b && !this.findAncestorIdsBefore(R(h.value), n, i) && (f = h),
          l(f?.value !== b, "previous parent cannot be inherited"));
        let m = u.resolvedParentId === e,
          g = m ? this.getParentId(n) : void 0,
          A = {
            nodeId: n,
            parentFrom: o,
            parentTo: f && f.value !== y ? this.createOverrideHierarchyKey(f.value, n) : y,
            rowIdx: e,
          };
        if ((this.setParentOverride(A), m))
          if (
            (l(g && g !== y, () => `unable to resolve parent of ${n}`),
            this.removeChild(g, n),
            f && f.value !== y)
          ) {
            let M = R(f.value),
              O = this.ensureNodeData(M);
            (this.addChild(O, n, f.index),
              O.inTree ? this.markInTree(O, u, n) : this.clearInTree(u, n));
          } else this.clearInTree(u, n);
        (t.push(A), this.broadcastParentId(n), this.recordInvalidation(c));
      }
    }
  };
var nr = class {
  ...
  ut = class {
    ...
    getLatestOrCreateGhost(e) {
      ...
      return (t || ((t = new nr()), this.map.set(e, t)), t);
    }
    *keys() {
  ...
  lt = class {
    ...
    getLatestOrCreateGhost(e) {
      ...
      return (t || ((t = new ir(this.base.getLatestOrCreateGhost(e))), this.ownMap.set(e, t)), t);
    }
    *keys() {
      let e = new Set();
...
var ft = class {
  ...
  computeCurrentGeneration(e, t) {
    ...
    if (
      ...
      n.dependencies.every((d, c) => d.generation === o[c]?.generation)
    )
      return n.generation;
  ...
  collectDependencyLinks(e) {
    ...
    for (; i.length > 0;) {
      ...
      if (!a?.inTree) return;
      if ((this.physicalParentIds.set(o, Bn(t, o)), this.store.getChecksum(o) === void 0)) continue;
      let d = this.store.getReplayableValue(o, "replicaInfo"),
        c = this.store.getObjectKey(`${o}.replicaInfo`, "master"),
        u = a.replicaInfoMaster;
      if (d != null && d !== y) {
        if (
          !F(d) ||
          T(d) !== `${o}.replicaInfo` ||
...
var _e = class {
    ...
    build(e = !1) {
      ...
      let t = this.columns,
        ...
        i = this.idCol.uniques.indexOf(N),
      ...
      ((this.off = new Uint32Array(a)),
        ...
        this.upd.length < a && (this.upd = Ce(this.upd, a)));
      ...
      let d = 0;
      for (let c = 0; c < this.idCol.uniques.length; c++)
        ((this.off[c] = d * 2), (d += this.cap[c]));
      ((this.arena = new Uint32Array(Math.max(1024, d * 2))),
        (this.top = d * 2),
        (this.abandoned = 0),
      ...
      for (let c = t.length - 1; c >= 0; c--) {
        ...
        if (e) {
          let p = this.len[u],
            m = this.off[u] + (p << 1);
          ((this.arena[m] = h), (this.arena[m + 1] = c), (this.len[u] = p + 1), this.upd[u]++);
          continue;
        }
        let f = this.getAt(u, h);
        (f === pt || W(t, c, f)) && this.setAt(u, h, c);
      }
    }
    replayLatestValues(e, t) {
      ...
      for (let u = i.length - 1; u >= 0; u--) {
        ...
        let m = p * n + f,
          g = c[m];
        (g === 0 || W(i, u, g - 1)) &&
          ((c[m] = u + 1), t(this.idCol.uniques[p], this.keyCol.uniques[h], u));
      }
    }
    get(e, t) {
    ...
    viewFor(e, t) {
      ...
      if (!r) {
        ...
        (n ? (this.ghosts.delete(t), (n.node = e), (r = n)) : (r = new yt(this, e, t)),
    ...
    getLatestOrCreateGhost(e) {
      ...
      return (r || ((r = new yt(this, -1, e)), this.ghosts.set(e, r)), r);
    }
    getLatest(e) {
      let t = this.idCol.codeOf(e);
    ...
    *values() {
    ...
    getAt(e, t) {
      if (e > this.maxNode) return pt;
      let r = this.arena,
        n = this.off[e],
        i = n + (this.len[e] << 1);
      for (let o = n; o < i; o += 2) if (r[o] === t) return r[o + 1];
      return pt;
    }
    setAt(e, t, r) {
      ...
      let d = this.off[e] + (o << 1);
      ((this.arena[d] = t), (this.arena[d + 1] = r), (this.len[e] = o + 1), this.upd[e]++);
    }
    ensureNode(e) {
      if (e >= this.off.length) {
        let t = e + 1;
        ((this.off = Ce(this.off, t)),
          (this.len = Ce(this.len, t)),
          (this.cap = Ce(this.cap, t)),
          (this.upd = Ce(this.upd, t)));
      }
    ...
    growSlab(e) {
      ...
      this.top + i > this.arena.length &&
        ...
        this.top + i > this.arena.length && (this.arena = Ce(this.arena, this.top + i)));
      let o = this.off[e],
        a = this.top;
      ((this.top += i),
...
var mt = class {
  ...
  isMergeableArray(e, t) {
    ...
    if (t.length === 1) return t[0] === w;
    for (let r of t) {
      let n = this.getCurrentValue(e, r);
      if (n !== void 0 && n !== y && n !== B) return me(n);
    }
    return !0;
  }
  getItemIds(e) {
...
function _n(s, e, t, r) {
  s !== "relaxed" &&
    l(Ts(e, t, r), () => `Atomic arrays must only contain primitives: ${JSON.stringify(e)}`);
}
function Rs(s, e, t, r) {
...
var As = [];
function Ts(s, e, t) {
  return s.some(En) ? s.every((r) => En(r) && Rs(As, r, e, t)) : !0;
}
function En(s) {
...
function qn(s, e) {
  ...
  for (; n !== e;) {
    ...
    i.add(n);
    let o = Ln(s, n);
    (Os(o, r) && (r = o), (n = o.baseId));
  }
  return r.branchId === e ? I : t.baseId;
}
function Ln(s, e) {
  let t = s.latest.get(e, hr);
...
function Os(s, e) {
  return $(e.seq, e.client, s.seq, s.client);
}
function sr(s) {
  if (!gr(s.client)) return `invalid CRDT client id: ${s.client}`;
  if (!Ue(s.seq)) return `invalid CRDT seq: ${s.seq}`;
}
var Ms = 0,
  Ns = 62 ** 5,
  ks = 0,
...
function Bs(s, e, t) {
  ...
  for (;;) {
    ...
    let o = n < s.length,
      a = n < e.length,
      d = o ? s[n] : { position: Ms, client: ks },
      c = a && !i ? e[n] : { position: Ns, client: Ds };
      ...
      Pn
        ...
        : e.length === 0
          ...
          : i
            ? (u = (f, p) => Hn(f, p, 8192, 2))
            : (u = Es);
      let h = u(d.position + 1, c.position - 1);
      return (r.push({ position: h, client: t }), r);
    }
    if ((r.push({ ...d }), !i)) {
      let u = d.position < c.position,
        h = a && d.position === c.position && d.client < c.client;
      i = u || h;
    }
    n++;
  }
...
function Un(s, e) {
  let t = e - s + 1;
  return Math.floor(_s() * t) + s;
}
var oe = "meta",
  ze = { ROOT_ID: "rootId", VERSION: "version" },
  Vn = 5e4;
function zs(s, e) {
...
var qs = ["__class", "isMaster", "isFormContainer", "replicaInfo", "master", "dataIdentifier"],
  Ps = ["__class"],
  gt = class s {
    table;
    branchData;
    ...
    constructor({
      ...
      base: d,
      table: c,
      extractIdFromObject: u,
      useHierarchyCache: h = !0,
      writeAuthorizer: f,
      valueTransformer: p,
    }) {
      ((this.client = e),
    ...
    init(e = !0) {
      ((this.batchNo = 0),
        ...
        (this.latest = this.createLatestMap()),
        (this.hierarchy = new ht(this, this.latest, this.base?.hierarchy)),
        (this.branchOwnWriteIndex = this.base ? new Je(this.branchData) : void 0),
        (this.sortedArrayCache = new mt(
          this.latest,
          (t, r) => this.getCurrentValue(t, r),
          this.base?.sortedArrayCache,
          (t) => this.branchData.columns.value.get(t)
        )),
        (this.checksumIndex = new it(this)),
        (this.resolvedSubtreeGenerationIndex = new ft(this)),
    ...
    createLatestMap() {
      return this.base
        ? new lt(this.base.latest)
        : this.latestMapType === "slab"
          ? new _e(this.branchData.columns)
          : new ut();
    }
    withTiming(e, t) {
      ...
      (n instanceof _e
        ? (this.withTiming("latest_index", () =>
          ...
          this.withTiming("hierarchy_latest_replay", () => {
            let i = this.hierarchyMode === "full" ? qs : Ps;
            n.replayLatestValues(i, (o, a, d) => {
              this.hierarchy.updateLatestValue(o, a, d);
            });
          }))
        : this.withTiming("latest_index", () => {
    ...
    setRoot(e) {
      this.setObjectKey(oe, ze.ROOT_ID, e);
    }
    getRoot() {
      return this.getCurrentValue(oe, ze.ROOT_ID);
    }
    getVersion() {
      return this.getCurrentValue(oe, ze.VERSION);
    }
    setVersion(e) {
      this.setObjectKey(oe, ze.VERSION, e);
    }
    isRoot(e) {
      return this.getCurrentValue(oe, ze.ROOT_ID) === e;
    }
    get seq() {
    ...
    runMutation(e) {
      ...
      try {
        ...
        let n = [],
          ...
          o = this.branchId === I ? y : b,
          { id: a, key: d, value: c } = this.branchData.columns;
        for (let u = 0; u < r; u++) {
          let h = t.startIndex + u,
            f = t.previousObjectRows.get(h);
          if (f) for (let g of f) n.push(g);
          i[u] = { id: a.get(h), key: d.get(h), value: c.get(h) };
          let p = t.previousIndices[u],
            m = p === -1 ? h : p;
          n.push({ id: a.get(m), key: d.get(m), value: p === -1 ? o : c.get(p) });
        }
        return t.operation === "insertNode"
          ? { previousRows: n.filter((u) => u.key === "parentid"), nextRows: i }
    ...
    capturePreviousIndex(e, t, r) {
      ...
      if (
        ...
        t === "parentid" && r === y && q(this.hierarchy.getHierarchyKey(e)))
      ) {
      ...
      if (o !== -1) {
        ...
        re(a) && n.previousObjectRows.set(this.length, this.getOwnRowsForObject(T(a)));
      }
    }
      ...
      let t = [],
        ...
        n = (o) => {
          ...
          for (let [u, h] of d) {
            ...
            (t.push({ id: o, key: u, value: f }), c ? n(u) : i(f));
          }
        },
        i = (o) => {
          if (F(o) || re(o) || te(o)) {
    ...
    mergeRows(e) {
      ...
      let t = new Set(this.getRows().map((n) => ar(n))),
        r = 1 / 0;
      for (let n of e) {
        let i = ar(n);
        t.has(i) ||
    ...
    addSerializableRows(e, { authorizer: t, onDenied: r, onInvalid: n } = {}) {
      ...
      for (let o of e) {
        let a = o.value;
        if ((S(a) && (a = v(a)), t && !this.isWriteAuthorized(t, o.id, o.key, a, o))) {
          r?.(o);
          continue;
        }
        let d = sr(o);
        ...
        (this.addRowData(o.id, o.key, a, o.client, o.seq, o.user, o.batch),
          (i = Math.min(i, o.seq)),
    ...
    replayRowList(e, t) {
      ...
      let n = new Map(),
        ...
        a = (c) => {
          ...
          let h = this.latest.getLatest(c) !== void 0;
          return (n.set(c, h), h);
        },
        d = t?.regenerateHierarchyPositions ? Hs(e) : void 0;
      return (
        this.batch(() => {
          let c = this.seq,
            u = c;
          for (let h of e) {
            if (!a(h.id)) i.add(h.id);
            else {
              let p = `${h.id}\0${h.key}`;
              if (!o.has(p)) {
                o.add(p);
                let g = (
                  h.key === "parentid"
                    ? this.hierarchy.getParentId(h.id) !== void 0
                    : this.latest.has(h.id, h.key)
                )
                  ? this.getReplayableValue(h.id, h.key)
                  : y;
                if (re(g)) for (let A of this.getOwnRowsForObject(T(g))) r.supersededRows.push(A);
                r.supersededRows.push({ id: h.id, key: h.key, value: g });
              }
            }
            let f = d ? this.regenerateReplayHierarchyPosition(h, d) : h.value;
            (this.assertLocalValueIsStorable(h.id, h.key, f),
              this.addRowData(h.id, h.key, f, this.client, c++, h.user ?? this.user));
          }
          (this.sortedArrayCache.clear(), this.hierarchy.postProcess(u));
        }),
        (r.addedNodeIds = [...i]),
        r
      );
    ...
    regenerateReplayHierarchyPosition(e, t) {
      if (e.key !== "parentid" || !ot(e.value) || !q(e.value)) return e.value;
      let r = ee(e.value),
        n = R(e.value),
        i;
    ...
    batch(e) {
      ...
      try {
        ...
        if (n === 0) return r;
        let i = 0;
        for (let o = 0; o < n; o += Vn) {
          let a = Math.min(Vn, n - o);
          (this.batchNo++, (i = Te({ batchNo: this.batchNo, rowCount: a })));
    ...
    updateRowIndex(e, t, r, n, i, o, a) {
      ...
      if ((this.branchOwnWriteIndex?.indexOwnRow(e), n === "parentid")) {
        ...
        (d === void 0 || $(t, o, c.seq.get(d), c.client.get(d))) &&
          (this.latest.set(r, n, e), this.hierarchy.updateLatestValue(r, n, e));
      if (!this.optimizedReading) {
        let u = r.indexOf(".");
        u !== -1 && this.latest.getLatest(r.slice(0, u))?.updated();
      }
    ...
    getReferenceValue(e) {
      return Array.isArray(e)
        ...
        : te(e)
          ? (this.getMergeableArray(T(e)) ?? [])
          : F(e)
            ? this.getObjectInner(T(e))
            : re(e)
              ? this.getObjectInner(T(e))
              : e;
    }
    ...
    getCurrentRawValueOrDoesNotExist(e, t) {
      let r =
        t === "parentid"
          ? this.hierarchy.getOwnParentRowIdx(e)
          : this.latest.getOwnLatest(e)?.ownGet(t);
      if (r === void 0) return this.base ? this.base.getCurrentRawValueOrDoesNotExist(e, t) : He;
      let n = this.branchData.columns.value.get(r);
    ...
    deleteRemovedKeys(e, t) {
      ...
      if (r) for (let n of r.keys()) n !== w && (n in t || this.setObjectKey(e, n, y));
    }
    ...
    createHierarchyKey(e, t, r = -1) {
      ...
      if ((this.assertPositionIsValid(r), r === -1 || r >= n.length)) {
        let p = n.at(-1),
          m = p ? this.hierarchy.getChildPosition(p) : void 0,
          g = this.allocatePositionBetween(t, m, void 0);
        return we(t, g);
      }
      ...
      let u = d ? this.hierarchy.getChildPosition(d) : void 0,
        h = c ? this.hierarchy.getChildPosition(c) : void 0,
        f = this.allocatePositionBetween(t, u, h);
      return we(t, f);
    }
    allocatePositionBetween(e, t, r) {
      ...
      return or(n, r, this.positionClientId);
    }
    ensureHasChildren(e) {
    ...
    removeNode(e) {
      (this.captureMutationOperation("removeNode"),
        ...
        this.setObjectKey(e, "parentid", y));
    }
    updateNode(e, t) {
    ...
    resolveObjectInArrayReference(e, t, r) {
      ...
      let i = this.getCurrentValue(e, n) === y,
        o = this.inserting;
    ...
    createAtomicArray(e, t) {
      ...
      for (let n = 0; n < t.length; n++) {
        let i = t[n];
        if (Le(i)) r.push(this.resolveObjectInArrayReference(e, i, n));
        else if (Kn(i)) {
          let o = this.createStoreId(e, n.toString());
          (this.setMergeableArray(o, i), r.push(Qt(o)));
        } else
          Array.isArray(i)
      ...
      if (F(e) || r) {
        ...
        if (t === b) {
          if (r) {
            ...
            if (i) for (let o of i.keys()) o !== w && this.inheritExistingKeys(o);
          }
    ...
    setTransformedObjectKey(e, t, r) {
      ...
      if (r instanceof fr) {
        if (
          ...
          n &&
          re(i) &&
          ur(this.getReferenceValue(i), r.value)
        )
          return;
        let d = lr(),
          c = this.createStoreId(e, `${t}.${d}`);
        (this.setObject(c, r.value), this.updateKeyValue(e, t, On(c)));
        return;
      }
      if (Le(r)) {
        let d = F(i) ? T(i) : void 0,
          c = d ?? this._getIdFromObject(r) ?? this.createStoreId(e, t),
          u = this.inserting;
        this.inserting = this.inserting || !d;
        try {
          (this.setObject(c, r), (!d || this.inserting) && this.updateKeyValue(e, t, Zt(c)));
        } finally {
          this.inserting = u;
        }
        return;
      ...
      if (Kn(r) || (r.length === 0 && te(i))) {
        let d = te(i) ? T(i) : void 0,
        ...
        try {
          (this.setMergeableArray(c, r),
            (!d || this.inserting || (n && !this.shouldPreserveInheritedValues)) &&
              this.updateKeyValue(e, t, Qt(c)));
        } finally {
          this.inserting = h;
        }
        return;
      }
      (_n(this.atomicArrays, r, t, e),
    ...
    setObjectKeyPath(e, t, r) {
      ...
      for (let o = 0; o < t.length - 1; ++o) {
        ...
        if (c === y) {
          let u = Ls(t.slice(o + 1), r);
          this.setObjectKey(n, a, u);
          return;
        }
        ...
        (d === b && this.updateKeyValue(n, a, c), (n = T(c)));
      }
      let i = t[t.length - 1];
    ...
    collectSubtreeValue(e, t) {
      if (F(e) || re(e)) {
        this.collectSubtreeObject(T(e), t);
        return;
      }
      if (te(e)) {
        this.collectSubtreeObject(T(e), t);
    ...
    getObjectKey(e, t) {
      ...
      if (this.getCurrentValue(e, w) !== y && r !== y) return this.getReferenceValue(r);
    }
    ...
    getRawObjectKey(e, t) {
      let r = this.getCurrentValue(e, t);
      return this.latest.get(e, t) === void 0 ? He : r === y ? r : this.getReferenceValue(r);
    }
    getObject(e) {
    ...
    getObjectInner(e, t = 1 / 0) {
      let r = [{ depth: 0, id: e, parent: void 0 }],
        ...
        a = {},
        d = (c, u) => {
          if (c === w || c === "children" || c === "parentid") return;
          let h = o.get(u);
          h !== y && (a[c] = this.getReferenceValue(h));
        };
      for (; r.length > 0;) {
        let { id: c, depth: u, parent: h } = r.pop();
        if (i.has(c)) continue;
        i.add(c);
        let f = this.latest.getLatest(c);
        if (!f && this.hierarchy.getParentRowIdx(c) === void 0) continue;
        if (this.base) {
          if (this.getCurrentValue(c, w) === y) continue;
        } else {
          let m = f?.ownGet(w);
          if (m !== void 0 && o.get(m) === y) continue;
        }
        let p = {};
        if ((n === void 0 && (n = p), h && h.children.push(p), this.isRoot(c))) p.parentid = null;
        else {
          let m = this.getParentId(c);
          m && (p.parentid = m);
        }
        if (f) {
          if (this.base)
            for (let m of f.keys()) {
              if (m === w) continue;
              let g = this.getCurrentRawValueOrDoesNotExist(c, m);
              g === He ||
                g === y ||
                m === "children" ||
                m === "parentid" ||
                (p[m] = this.getReferenceValue(g));
            }
          else ((a = p), f.forEachOwn(d));
          if (u < t && f.has("children")) {
            let m = this.getChildrenIds(c);
            p.children = [];
            for (let g = m.length - 1; g >= 0; --g) {
              let A = m[g];
              this.isMaterializableNode(A) && r.push({ id: A, depth: u + 1, parent: p });
            }
          }
        }
      }
    ...
    applyArrayEdits(e, t, r, n) {
      ...
      let i = new Set(n),
        o = t.map((d) => this.getCurrentValue(e, d)),
        a = 0;
      for (let d of r) {
        let c = d.value;
        switch (d.operation) {
          case "delete":
            (o.splice(d.index + a, 1), i.has(d.value) || this.updateKeyValue(e, c, y), a--);
            break;
          case "insert": {
            let u = or(o[d.index - 1], o[d.index], this.positionClientId);
            (this.updateKeyValue(e, c, u), o.splice(d.index, 0, u), a++);
            break;
          }
        }
      }
    ...
    setMergeableArray(e, t) {
      ...
      if (!r) {
        ...
        if (a) for (let d of a.keys()) this.updateKeyValue(e, d, y);
        r = [];
      }
      (n || this.inserting) && this.updateKeyValue(e, w, B);
      let i = [];
      for (let a = 0; a < t.length; a++) {
        let d = this.resolveObjectInArrayReference(e, t[a], a);
        i.push(T(d));
      }
      let o = zn(r, i);
    ...
    static verifyBatches(e) {
      ...
      for (let n of e) {
        ...
        if (r.has(a)) continue;
        r.add(a);
        let d = t.get(n.client);
        d || ((d = new Map()), t.set(n.client, d));
        let c = d.get(o);
        c || ((c = new Map()), d.set(o, c));
        let u = c.get(n.batch) ?? 0;
        c.set(n.batch, u + 1);
      }
      for (let [n, i] of t)
        for (let [o, a] of i)
          for (let [d, c] of a) {
            ...
            l(
              u === c,
              () =>
                `Update row count does not match batch row count. Batch: ${d} Update count: ${c} Batch count: ${u}`
            );
          }
    }
    ...
    *childBranchIds() {
      for (let e of this.hierarchy.getCachedChildrenIds(cr))
        e !== I && qn(this.mainStore, e) === this.branchId && (yield e);
    }
    compactBranch(e, t, r, n, i) {
      ...
      for (let h of this.childBranchIds()) {
        ...
        let p = new Set(),
          m = new Set(),
          g = f.compactBranch(e, p, m, n, i);
        d ||= g !== f;
        for (let A of p) o.add(A);
        for (let A of m) a.add(A);
      }
      if (!d && this.branchData.metadata.compactedLength === this.length) {
        ((this.branchData.metadata.compactedAt = n),
          ...
          Mn(this, t, r));
        for (let h of o) t.add(h);
        for (let h of a) r.add(h);
        return this;
      }
      let c = new s({
          user: this.user,
        ...
        u = i ? this.branchData.metadata.compactedLength : this.length;
      (at.run(this, c, u, o, a),
    ...
    compact(e = Date.now(), t = {}) {
      ...
      let r = new ce(this.table.version);
...
function Hs(s) {
  let e = new Map();
  for (let t of s) {
    if (t.key !== "parentid" || !ot(t.value) || !q(t.value)) continue;
    let r = R(t.value),
      n = e.get(r);
    n ? n.push(ee(t.value)) : e.set(r, [ee(t.value)]);
  }
...
var Ks = (s) => (typeof s.__class == "string" && Vs(s.__class) ? s.id : void 0);
function iu(s, e = mr(), t = {}) {
  return new gt({
    atomicArrays: "strict",
    latestMap: "map",
    ...t,
...
//# sourceMappingURL=chunk-NDW4C7EE.mjs.map
