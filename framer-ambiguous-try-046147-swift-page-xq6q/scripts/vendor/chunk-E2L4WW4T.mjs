import { b as h, h as w, m as P, p as b } from "chunk-LA34HORX.mjs";
import { a as y } from "chunk-EQBCTBZ3.mjs";
import { a as T } from "chunk-UZNETSBG.mjs";
...
function q(e) {
  ...
  for (let t in e) {
    let o = e[t];
    if (typeof o == "object") ((n[t] = o.value), (L[t] = o.variants));
...
var O = q({
    ...
    invoke: "off",
    jsonRichTextStorage: A(["cms"], "off"),
    layoutScroll: "off",
    lazySmartComponentLocales: "on",
    liveZoomStepScaleFactor: "off",
    localCache: A(["syncWorker"], "on"),
...
var C = {
  ...
  k = {
    aiCreditsIntroExperiment: { sample: 0.5, scope: "User", includeEnterprise: !1, variant: "on" },
    crdtTreeEditUndo: {
      sample: 0.1,
      scope: "Project",
      includeEnterprise: !1,
...
function j(e) {
  return function ({ children: t, ...o }) {
    ...
    return E(e, i, r) ? c.default.createElement(c.default.Fragment, null, t) : null;
  };
}
function Q(e, n) {
  u = !0;
...
function B() {
  ...
  return (
    (t === "alpha" || t === "local" || r) && Object.assign(e, C, I),
    t === "beta" && Object.assign(e, C),
    e
  );
}
function te() {
...
function De({ resetStorage: e, resetSession: n } = {}) {
  if (!(typeof window > "u")) {
    if ((e && localStorage.removeItem(N()), n)) {
...
function Fe(e) {
  ...
  let o = { ...t, ...e };
  for (let r of T(o)) m.getInitial(r) === o[r] && delete o[r];
  try {
...
//# sourceMappingURL=chunk-E2L4WW4T.mjs.map
