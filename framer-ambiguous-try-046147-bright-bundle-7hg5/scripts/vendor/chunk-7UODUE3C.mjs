import {
  ...
  m as x,
  n as S,
} from "chunk-K3FIARHK.mjs";
import { a as dr } from "chunk-VBCXFFMV.mjs";
import { a as pr, b as yr, c as mr, d as Ue, e as gr } from "chunk-AFIURHLI.mjs";
import {
  a as I,
  b as cr,
  c as hr,
  ...
  h as Le,
  j as Pe,
} from "chunk-Z2D6QWS4.mjs";
import { b as l } from "chunk-4JY5UMT2.mjs";
var Fn = ["client", "seq", "id", "key", "value", "user"],
  bt = class {
    encode(e, t) {
      let r = e.main;
      for (let n of Fn) {
  ...
  br = { description: "Sets up migration with initial codec", migrate() {}, codec: new bt() };
var Ke = "$deleted",
  It = "$keep_value";
function jn(s) {
    ...
    if (o === "parentid") {
      ...
      for (let m = n + 1; m < r.length; m++) {
        ...
        let O = e.key.get(g),
          j = e.id.get(g),
          re = e.value.get(g);
        if (t.has(g) || typeof O != "number" || j !== `${u}.children` || re === Ke || re === It)
          continue;
        p === void 0 && (p = M);
        let oe = wr(re);
        (l(oe, () => `should be a valid object reference: ${JSON.stringify(re)}`),
          oe === a ? e.value._set(i, Ir(u, O)) : f.set(oe, O),
          t.add(g));
      }
      for (let m of f.keys()) {
        let g;
  ...
  for (let n of t) e.id.get(n).endsWith(".children") && e.id._set(n, Ke);
}
var Sr = {
...
var Wn = 2 ** 17,
  ne = class {
    ...
    bucketMask;
    get type() {
      return `BucketedColumn(${Ve(this.arrayConstructor)})`;
    }
    add(e) {
...
var P = class s {
  constructor(e, t) {
    this.arrayConstructor = e;
    if (((this.indices = new ne(e, t)), e === Uint8Array)) this.maxUniques = 2 ** 8 - 1;
  ...
  cursor = 0;
  get type() {
    return `LazyNormalizedBucketedColumn(ref: ${Ve(this.arrayConstructor)})`;
  }
...
function Gn(s) {
  for (let e = 0; e < s.length; ++e) if (!Ar(s[e])) return !1;
  return !0;
}
function Yn(s) {
  return Ar(s) ? JSON.stringify(s) : (JSON.stringify(s, Rr) ?? "null");
}
function xt(s) {
  if (Array.isArray(s)) {
...
var xe = 91,
  ...
  $e = class {
    ...
    ensureIndex() {
      ...
      for (n = r?.skipWhitespace(n + 1) ?? G(this.bytes, n + 1); this.bytes[n] !== V;) {
        let i = r?.scanValueEnd(n) ?? Dr(this.bytes, n);
        if ((t + 1) * 2 > e.length) {
...
function Nr(s, e, t) {
  if (t && (t?.bodyBytes > vt || (t.mixed && t.bodyBytes >= Xn))) {
    xr(s, e);
    return;
  }
  try {
    let r = Gn(e) ? JSON.stringify(e) : JSON.stringify(e, Rr);
    s.writeString(r);
  } catch (r) {
...
function xr(s, e) {
  ...
  for (let i = 0; i < e.length; ++i) {
    ...
    let o = Yn(e[i]),
      a = o.length * 3;
    if (a > Jn) {
      s.writeBytes(Cr.encode(o));
      continue;
    }
    a > n.length && (n = new Uint8Array(a));
    let { written: d } = Cr.encodeInto(o, n);
    s.writeBytes(n.subarray(0, d));
  }
  (s.writeUint8(V), s.writePaddedVarUintAt(t, s.byteOffset - r));
}
function kr(s, e, t = !1) {
  let r = s.readVarUint(),
    n = s.readBytes(r);
  if (n.length > vt) return (e && ((e.mixed = void 0), (e.bodyBytes = n.length)), ei(n));
...
function ri(s, e) {
  ...
  for (;;) {
    ...
    let n = 0;
    for (let i = r - 1; i > e && s[i] === Mr; --i) n += 1;
    if (n % 2 === 0) return r + 1;
    t = r + 1;
  }
}
...
var St = class {
  ...
  skipString(e) {
    ...
    for (;;) {
      ...
      let n = 0;
      for (let i = r - 1; i > e && this.bytes[i] === Mr; --i) n += 1;
      if (n % 2 === 0) return r + 1;
      t = r + 1;
    }
  }
...
var le = class {
  ...
  E = class {
    ...
    serialize(e) {
      (Nr(e, this.uniques, this.uniquesHints),
    ...
    deserialize(e, t) {
      ...
      ((this.uniques = kr(e, r, t?.stringCodeMap === !0)),
        (this.uniquesHints = r),
  ...
  _r = {
    ...
    migrate(s) {
      ...
      if (e.value instanceof E || e.value instanceof P) {
        ...
        for (let r in t) t[r] === Er ? (t[r] = y) : t[r] === Br && (t[r] = B);
      } else
        for (let t = 0; t < e.length; ++t) {
          let r = e.value.get(t);
          r === Er ? e.value._set(t, y) : r === Br && e.value._set(t, B);
        }
    },
  };
function ni(s) {
  ...
  if (e.client instanceof E || e.client instanceof P) {
    ...
    for (let r in t) t[r] = zr(t[r]);
  } else
    for (let t = 0; t < e.length; ++t) {
      let r = e.client.get(t);
      e.client._set(t, zr(r));
    }
}
var qr = { description: "Migrates row `client` to u32", migrate: ni };
function zr(s) {
  return s >>> 0;
}
var Re = 62,
  ...
  Lr = {};
for (let s = 0; s < At.length; s++) Lr[At[s]] = s;
function Tt(s, e) {
  if (
...
function ci(s) {
  for (let e = 0; e < s.client.length; e++)
    s.key.get(e) !== -1 || s.value.get(e) !== B || s.key._set(e, oi);
}
function hi(s) {
  let e = ui(s);
  for (let [t, r] of e) {
    ...
    for (let o = 0; o < n.length; o++) {
      ...
      for (let u of c) {
        ...
        let f = ae([{ position: a, client: s.client.get(u) }]);
...
function mi(s, e, t, r) {
  let n = ae([{ position: r, client: s.client.get(e) }]);
  s.value._set(e, `${t}@${n}`);
}
var Ur = 27,
  Kr = 2 ** Ur - 1,
...
function Te({ batchNo: s, rowCount: e }) {
  return (
    ...
    l(s >= Dt && s <= Vr, () => `batchNo out of range: ${s}`),
...
var bi = ["client", "seq", "batch", "id", "key", "value", "user"],
  Et = class {
    encode(e, t) {
      let r = e.main;
      for (let n of bi) {
...
var $r = { description: "Migrates arrays of primitives to atomic array values", migrate: wi };
var Wr = "$keep",
  _t = "$deleted";
function vi(s) {
  let e = s.main.columns,
  ...
  for (let [n, i] of r) {
    ...
    for (let d = 0; d < i.length; d++) {
      ...
      let u = e.key.get(c);
      l(u !== Wr, () => `array reference key cannot be $keep: ${u}`);
      let f = e.value.get(c);
      if (
        (l(
          f === y || zt(f),
...
function Ri(s, e) {
  ...
  for (let r = 0; r < s.client.length; r++) {
    let n = s.id.get(r);
    if (!t.has(n) || s.key.get(r) === Wr) continue;
    let o = s.value.get(r);
  ...
  U = class {
    ...
    add(e, t) {
      ...
      (this.seqs.splice(r, 0, e),
        ...
        this.seqs.length > this.maxSize + Ni && this.trimToMaxSize());
    }
    trimToMaxSize() {
      if (this.maxSize) {
...
var Y = 1024 * 1024,
  _ = class {
    ...
    writePaddedVarUint(e) {
      this.writeBytes(Zr(e));
    }
    writePaddedVarUintAt(e, t) {
      this.writeBytesAt(e, Zr(t));
    }
    writeString(e) {
...
function tn(s, e) {
  if (s instanceof D && e instanceof D) return ki(s, e);
  if (s instanceof D && e instanceof z) return Di(s, e);
  if (s instanceof z && e instanceof D) return Bi(s, e);
  if (s instanceof z && e instanceof z) return Ei(s, e);
}
function ki(s, e) {
  let t = [],
    r = s.values,
  ...
  Ne = class s {
    ...
    add(e) {
      ...
      return n
        ? n.add(r)
          ? ((this._count += 1),
            n instanceof D && n.count > rn && this.containers.set(t, zi(n)),
            !0)
          : !1
    ...
    andNot(e) {
      ...
      for (let r of this.keys) {
        ...
        let o = tn(n, i);
        o &&
          (o instanceof z && o.count <= rn && (o = qi(o)),
...
var De = class s {
  ...
  add(e, t) {
    (ke(e, "client"), sn(t, "seq"));
    let { seqHigh: r, seqLow: n } = on(t),
  ...
  *[Symbol.iterator]() {
    for (let e of Q(this.seqMapByClient)) {
      ...
      if (t)
        for (let r of Q(t)) {
          let n = t.get(r);
          if (n) for (let i of n) yield { client: e, seq: Pi(r, i) };
        }
    }
  }
  toArray() {
...
var K = class s {
    ...
    deserialize(e) {
      (l(this.timestamps.count === 0, "Manifest deserialize must be called when empty"),
        l(e.readUint32() === an, "Manifest magic mismatch"),
        l(e.readUint16() === dn, "Manifest version mismatch"),
  ...
  an = 1414743629,
  dn = 1;
var hn = ["client", "seq", "batch", "id", "key", "value", "user"];
var Ht = class {
  encode(e, t) {
    let r = e.main;
    ...
    for (; !t.endOfFile();) {
      ...
      switch (n) {
        case 1129270355:
          ...
          break;
        case 1296649816: {
          r.minIndexCache = Ui(o);
          break;
        }
        case 1212761426:
          r.hierarchyData = Vi(o);
          break;
        case 1296125510:
          r.manifest = Wi(o);
          break;
...
var un = { description: "Adds named sections to binary documents", codec: new Ht(), migrate() {} };
var ge = class {
    values = new ne(Float64Array);
    skippedLength;
    get type() {
...
function Gi(s) {
  return (
    l(s >= -ln && s <= ln, () => `seq delta out of zigzag-safe range: ${s}`),
    s >= 0 ? s * 2 : -s * 2 - 1
  );
}
function Yi(s) {
...
var fn = {
  forVersion(s) {
    return s >= Be ? new ge() : new ne(Float64Array);
  },
};
var Kt = class {
...
var pn = ["client", "seq", "batch", "id", "key", "value", "user"];
var Vt = class {
  encode(e, t) {
    let r = e.branches;
      ...
      for (; !c.endOfFile();) {
        ...
        switch (h) {
          case 1129270355:
            ...
            break;
          case 1296649816:
            a.minIndexCache = Ji(f);
            break;
          case 1212761426:
            a.hierarchyData = Zi(f);
            break;
          case 1296125510:
            a.manifest = ns(f);
            break;
...
var yn = { description: "Stores table data by branches", codec: new Vt(), migrate() {} };
      ...
      for (; !u.endOfFile();) {
        ...
        switch (f) {
          case 1129270355:
            ...
            break;
          case 1296649816:
            h.minIndexCache = ss(m);
            break;
          case 1212761426:
            h.hierarchyData = as(m);
            break;
          case 1296125510:
            h.manifest = us(m);
            break;
...
var wn = { migrate() {}, description: "Dummy migration. Does nothing" };
var be = {
  m1_2: br,
  m2_3: Sr,
  m3_4: _r,
...
function jt(s) {
  let e = s.readString();
  return (l(e === Sn, () => `Not a framer document: ${e}`), { version: s.readUint16() });
}
function $t(s, e) {
  (e.writeString(Sn), e.writeUint16(s));
}
function fs(s, e) {
  let t = `m${s}_${e}`;
...
var Ze = class {
  ...
  nt = class {
    ...
    cursorsAreCurrent(e, t) {
      ...
      if (!r || !xn(r, e) || this.baseStoreCursors.length !== t.length) return !1;
      for (let n = 0; n < t.length; n++) {
        let i = this.baseStoreCursors[n],
          o = t[n];
        if (!i || !o || !xn(i, o)) return !1;
      }
      return !0;
    }
...
var at = class s {
  ...
  emitRowsWithTombstoneAnchors() {
    ...
    for (let t of this.source.latest.keys()) {
      ...
      let n = e.get(r);
      (e.has(r) ||
        ((n = Nn(this.source, r)), e.set(r, n), n !== void 0 && this.tombstoneAnchorNodeIds.add(n)),
        n !== void 0 &&
  ...
  emitMergeableArrayRows(e) {
    ...
    if (r)
      for (let n of r.keys())
        n !== v && this.source.getCurrentValue(e, n) !== y && this.emitObjectRows(n);
  }
  followReferences(e) {
    if (F(e) || se(e)) {
...
var ws = 1e3,
  ...
  ht = class {
    ...
    trimHierarchyInvalidations() {
      let e = this.hierarchyInvalidations.length - ws;
      e <= 0 ||
                  ...
                  if (L(u.parentFrom)) {
                    if (this.base && O.childrenById)
                      for (let j of O.childrenById.values()) {
                        let re = this.branchData.columns.id.get(j);
                        if (this.getHierarchyKey(re) === u.parentFrom) {
                          let Vn = {
                            ...u,
...
var ft = class {
  ...
  collectDependencyLinks(e) {
    ...
    for (; i.length > 0;) {
      ...
      if (!a?.inTree) return;
      if ((this.physicalParentIds.set(o, Dn(t, o)), this.store.getChecksum(o) === void 0)) continue;
...
function En(s, e, t, r) {
  s !== "relaxed" &&
    l(As(e, t, r), () => `Atomic arrays must only contain primitives: ${JSON.stringify(e)}`);
}
function xs(s, e, t, r) {
...
var Rs = [Ts];
function As(s, e, t) {
  return s.some(Bn) ? s.every((r) => Bn(r) && xs(Rs, r, e, t)) : !0;
}
function Ts(s) {
...
function sr(s) {
  if (!mr(s.client)) return `invalid CRDT client id: ${s.client}`;
  ...
  gt = class s {
    ...
    constructor({
      ...
      ((this.client = e),
        ...
        (this.branchId = a),
        (this.base = d),
        (this.table = c ?? d?.table ?? new de()),
        (this.branchData = this.table.getOrCreateBranch(this.branchId)),
        (this.positionClientId = gr(this.branchId, this.client)),
        ...
        this.branchId !== I &&
          ...
          this.setObjectKey(this.branchId, v, B));
    }
    init(e = !0) {
      ((this.batchNo = 0),
    ...
    setRoot(e) {
      this.setObjectKey(he, ze.ROOT_ID, e);
    }
    getRoot() {
      return this.getCurrentValue(he, ze.ROOT_ID);
    }
    getVersion() {
      return this.getCurrentValue(he, ze.VERSION);
    }
    setVersion(e) {
      this.setObjectKey(he, ze.VERSION, e);
    }
    isRoot(e) {
      return this.getCurrentValue(he, ze.ROOT_ID) === e;
    }
    get seq() {
    ...
    capturePreviousIndex(e, t, r) {
      ...
      if (o !== -1) {
        ...
        se(a) && n.previousObjectRows.set(this.length, this.getOwnRowsForObject(T(a)));
      }
    }
            ...
            if (!a(u.id)) i.add(u.id);
              ...
              if (!o.has(p)) {
                ...
                let g = (
                  ...
                  : y;
                if (se(g)) for (let A of this.getOwnRowsForObject(T(g))) r.supersededRows.push(A);
    ...
    batch(e) {
      ...
      try {
        ...
        if (n === 0) return r;
        let i = 0;
        for (let o = 0; o < n; o += Un) {
          let a = Math.min(Un, n - o);
    ...
    deleteRemovedKeys(e, t) {
      ...
      if (r) for (let n of r.keys()) n !== v && (n in t || this.setObjectKey(e, n, y));
    }
      ...
      if (F(e) || r) {
        ...
        if (t === b) {
          if (r) {
            ...
            if (i) for (let o of i.keys()) o !== v && this.inheritExistingKeys(o);
          }
    ...
    setObjectKey(e, t, r) {
      ...
      if (r instanceof lr) {
        ...
        (this.setObject(c, r.value), this.updateKeyValue(e, t, Tn(c)));
        return;
      }
      if (qe(r)) {
      ...
      if (Kn(r) || (r.length === 0 && te(i))) {
        ...
        try {
          (this.setMergeableArray(c, r),
            (!d || this.inserting || n) && this.updateKeyValue(e, t, Qt(c)));
        } finally {
          this.inserting = u;
        }
        return;
      }
      (En(this.atomicArrays, r, t, e),
        typeof i == "string" && this.cleanExistingReferenceValue(i, r));
      let o = this.createStoreId(e, t),
        a = this.createAtomicArray(o, r);
      (!this.inserting && !n && Array.isArray(i) && Pe(a, i)) || this.updateKeyValue(e, t, a);
    }
    ...
    getObjectKey(e, t) {
      ...
      if (this.getCurrentValue(e, v) !== y && r !== y) return this.getReferenceValue(r);
    }
    ...
    getObjectInner(e, t = 1 / 0) {
      ...
      for (; r.length > 0;) {
        ...
        if (this.base) {
          if (this.getCurrentValue(c, v) === y) continue;
        } else {
          let m = f?.ownGet(v);
    ...
    setMergeableArray(e, t) {
      ...
      (n || this.inserting) && this.updateKeyValue(e, v, B);
      let i = [];
...
var Vs = (s) => (typeof s.__class == "string" && Ks(s.__class) ? s.id : void 0);
function iu(s, e = yr(), t = {}) {
  return new gt({
    atomicArrays: "strict",
    latestMap: "map",
    ...t,
...
//# sourceMappingURL=chunk-7UODUE3C.mjs.map
