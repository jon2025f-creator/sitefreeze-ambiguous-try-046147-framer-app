import { a as pr, c as ct, d as _r } from "chunk-VPDJYJ6F.mjs";
import {
  $d as $r,
  C as Hr,
  Da as Wr,
...
import { vb as Se, wb as Oe } from "chunk-J3JRWALL.mjs";
import {
  Aa as or,
  Cj as Dr,
  Ew as _t,
...
import { q as tt } from "chunk-ZB6LWF4P.mjs";
...
function di(e) {
  return !K(e) || e.type !== "object"
    ...
    : e.value === null
      ? !0
      : Object.values(e.value).every(li);
}
function Hl(e) {
  return er(e) && e.every((t) => Pr(t) && di(t));
}
var Ti = /^(.*?)(?:([^/])\.([^/.]+))?$/;
function vl(e) {
  let t = e.match(Ti);
...
function $(e) {
  var t;
  return (t = mi.get(e)) !== null && t !== void 0 ? t : n.UNKNOWN;
}
var m = n,
  pn = {
    [f.HTML]: new Set([
  ...
  rd = new Set([E.STYLE, E.SCRIPT, E.XMP, E.IFRAME, E.NOEMBED, E.NOFRAMES, E.PLAINTEXT]);
var c;
(function (e) {
  ((e[(e.DATA = 0)] = "DATA"),
    (e[(e.RCDATA = 1)] = "RCDATA"),
...
var le = class {
  ...
  _stateScriptDataDoubleEscapeStart(t) {
    if (this.preprocessor.startsWith(M.SCRIPT, !1) && An(this.preprocessor.peek(M.SCRIPT.length))) {
      this._emitCodePoint(t);
...
var Rn = new Set([n.DD, n.DT, n.LI, n.OPTGROUP, n.OPTION, n.P, n.RB, n.RP, n.RT, n.RTC]),
  ...
  Ni = new Set([...ve, n.OL, n.UL]),
  Ii = new Set([...ve, n.BUTTON]),
  In = new Set([n.ANNOTATION_XML, n.MI, n.MN, n.MO, n.MS, n.MTEXT]),
  gn = new Set([n.DESC, n.FOREIGN_OBJECT, n.TITLE]),
  gi = new Set([n.TR, n.TEMPLATE, n.HTML]),
  Ri = new Set([n.TBODY, n.TFOOT, n.THEAD, n.TEMPLATE, n.HTML]),
  Si = new Set([n.TABLE, n.TEMPLATE, n.HTML]),
  Oi = new Set([n.TD, n.TH]),
  we = class {
    ...
    hasInListItemScope(t) {
      return this.hasInDynamicScope(t, Ni);
    }
    hasInButtonScope(t) {
...
var Dn = "html",
  Di = "about:legacy-compat",
  Li = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd",
  Ln = [
  ...
  Pi = [...Ln, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"],
  yi = new Set([
  ...
  bi = [...Pn, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"];
function On(e, t) {
  return t.some((r) => e.startsWith(r));
}
function yn(e) {
  return e.name === Dn && e.publicId === null && (e.systemId === null || e.systemId === Di);
}
function bn(e) {
  if (e.name !== Dn) return B.QUIRKS;
  let { systemId: t } = e;
  if (t && t.toLowerCase() === Li) return B.QUIRKS;
  let { publicId: r } = e;
  if (r !== null) {
    if (((r = r.toLowerCase()), yi.has(r))) return B.QUIRKS;
    let s = t === null ? Pi : Ln;
    if (On(r, s)) return B.QUIRKS;
    if (((s = t === null ? Pn : bi), On(r, s))) return B.LIMITED_QUIRKS;
  }
  return B.NO_QUIRKS;
}
...
function xn(e, t, r, s) {
  return ((!s || s === f.HTML) && wi(e, t, r)) || ((!s || s === f.MATHML) && vi(e, t));
}
var Yi = "hidden",
  Vi = 8,
  Wi = 3,
...
var Ki = { startLine: -1, startCol: -1, startOffset: -1, endLine: -1, endCol: -1, endOffset: -1 },
  wn = new Set([n.TABLE, n.TBODY, n.TFOOT, n.THEAD, n.TR]),
  Hn = { scriptingEnabled: !0, sourceCodeLocationInfo: !1, treeAdapter: k, onParseError: null },
  pe = class {
    ...
    _err(t, r, s) {
      ...
      let o = (i = t.location) !== null && i !== void 0 ? i : Ki,
        d = {
          code: r,
    ...
    onEndTag(t) {
      ((this.skipNextNewLine = !1),
        (this.currentToken = t),
        this.currentNotInHTML ? go(this, t) : this._endTagOutsideForeignContent(t));
    }
...
function Ut(e, t) {
  for (let r = 0; r < Vi; r++) {
    ...
    let o = Xi(e, i, s.element),
      d = e.openElements.getCommonAncestor(s.element);
    (e.treeAdapter.detachNode(o), d && ji(e, d, o), qi(e, i, s));
  }
}
function Ft(e, t) {
...
function Zi(e, t) {
  ...
  let r = t.forceQuirks ? B.QUIRKS : bn(t);
  (yn(t) || e._err(t, u.nonConformingDoctype),
...
function Kn(e) {
  let t = He(e, V.TYPE);
  return t != null && t.toLowerCase() === Yi;
}
function Ra(e, t) {
  (e._reconstructActiveFormattingElements(),
    e._appendElement(t, f.HTML),
...
function Gn(e, t) {
  e.tmplInsertionModeStack.length > 0 ? Zn(e, t) : vt(e, t);
}
function Xa(e, t) {
  var r;
  (t.tagID === n.SCRIPT &&
...
function to(e, t) {
  (Kn(t) ? e._appendElement(t, f.HTML) : Ae(e, t), (t.ackSelfClosing = !0));
}
function ro(e, t) {
  !e.formElement &&
    e.openElements.tmplCount === 0 &&
...
function Io(e, t) {
  if (Bn(t)) (ts(e), e._startTagOutsideForeignContent(t));
    ...
    (s === f.MATHML ? Bt(t) : s === f.SVG && (kn(t), kt(t)),
      Ve(t),
...
function eT(e) {
  return typeof e == "string"
    ? it(e)
    : H(e)
      ? hr(ee(e), { preserveTrailingEmptyBlockNewLine: !0 })
      : "";
}
function ms(e) {
...
function Ec(e, t) {
  return typeof e == "string" ? e : Rr(e, t);
}
function VT(e, t) {
...
//# sourceMappingURL=chunk-GRRUNQYU.mjs.map
